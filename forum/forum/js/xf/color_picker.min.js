...
{};XF.trigger(h,"color-picker:reparse");this.destroyMenu();this.allowReparse=!0}}});XF.Element.register("color-picker","XF.ColorPicker");XF.ready(()=>{var b;const a=null==(b=h.querySelector(".js-colorPickerData"))?void 0:b.innerHTML;a&&(b=JSON.parse(a))&&(XF.Color.palette={...XF.Color.palette,...b},XF.Color.paletteParsed={},XF.trigger(h,"color-picker:reparse"))})})(window,document);
