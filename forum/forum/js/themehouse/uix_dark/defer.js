...
window.XF.HScroller.prototype.updateScroll = function () {
    ...
    var left = XF.normalizedScrollLeft(el);
    ...
    if (startActive) {
        this.scrollTarget.classList.add('th_scroller--start-active');
    } else {
        this.scrollTarget.classList.remove('th_scroller--start-active');
    }

    if (endActive) {
        this.scrollTarget.classList.add('th_scroller--end-active');
    } else {
        this.scrollTarget.classList.remove('th_scroller--end-active');
    }
