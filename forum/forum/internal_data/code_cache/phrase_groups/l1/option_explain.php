...
<strong>Note:</strong> Most search engines no longer support sitemap pings and this option should be considered to be deprecated.',
  ...
  'option_explain.thconnectedaccountproviders_autoCreateAccounts' => 'If enabled, this will bypass account creation prompt if possible, and automatically create an account from the provided 3rd party details.',
  'option_explain.thconnectedaccountproviders_bypass' => 'Enabled services will be able to associate existing accounts upon login. <strong>Important:</strong> enable this only for services that you trust to have verified the user before login, otherwise account hijacking may be possible.',
  'option_explain.thconnectedaccountproviders_enableConAccSect' => 'If disabled, users will not be able to access their accounts "connected accounts" section, where they can associated and disassociate connected accounts.',
  'option_explain.thconnectedaccountproviders_forceOauthLogin' => 'If enabled, users cannot login through a username/password combination, but only through connected account providers. This will effectively lock out users that do not have a connected account provider set up, so use with caution. This will disable the password change functionality for any non-administrator.',
  'option_explain.thconnectedaccountproviders_forceOauthRegistration' => 'If enabled, conventional registration will be disabled, and users can only register via one of the provided OAuth providers.',
  'option_explain.thconnectedaccountproviders_linkProfileFields' => '',
  'option_explain.thconnectedaccountproviders_mapToCustom' => 'If enabled, additional data will be synchronized to custom user fields. Rules must be provided in the format <pre style="display:inline">provider_key=custom_user_field_id</pre> or <pre style="display:inline">provider_id;provider_key=custom_user_field_id</pre>. One rule per line.',
  'option_explain.thconnectedaccountproviders_redirectAfterLogout' => 'If provided, users will be redirected to this page after logout instead. You can use {url} as token, which will be replaced with the page they were currently on while logging out. This option requires force OAuth login and redirect on single provider to be enabled.',
  'option_explain.thconnectedaccountproviders_redirectSingleProvider' => 'If enabled, the user will automatically be redirected to the OAuth service upon opening a registration/login form for methods that have "Force OAuth" enabled, <strong>if</strong> there is only a single provider to chose from.',
  'option_explain.thconnectedaccountproviders_updateEmail' => 'If enabled, email will be updated on login based on the connected account providers provided details. This will disable the email change functionality from the user account area.',
  'option_explain.thconnectedaccountproviders_updateUsername' => 'If enabled, username will be updated on login based on the connected account providers provided details.',
...
<li>Modular = Blank page with Main and Sidebar Widget Locations</li>
  ...
  'option_explain.xaAmsLocalizeGoogleMaps' => 'When enabled, will localize the Embed API google map, based on XF language settings for the viewing user.',
  'option_explain.xaAmsLocationDisplayType' => 'Controls how the location data will be displayed when viewing an article',
  'option_explain.xaAmsMaxAllowedContributors' => 'The maximum allowed number of contributors and or co-authors that can be set for a given article within categories that allow contributors/co-authors.',
...
<b><span style="color:red;">Important Note</span></b>:  If the viewing user does not have permission to view ams article attachments, the more in category block will be rendered in List View layout type regardless of this option setting.',
  ...
  'option_explain.xaAmsSeriesListShowTitleFilters' => 'If enabled, the title filter will be enabled on the series list page',
  'option_explain.xaAmsSeriesMinTags' => '',
  'option_explain.xaAmsSeriesPartsPerPage' => 'The number of series parts that will be listed per page on a series page.',
  ...
  'option_explain.xaAmsShowRatingFilters' => 'If enabled, the ave rating filter will be enabled on article listing pages',
  'option_explain.xaAmsShowTitleFilters' => 'If enabled, the title filter will be enabled on article listing pages',
  ...
  'option_explain.xfesConfig' => 'Please edit this via the "Enhanced search" section.',
  'option_explain.xfesEnabled' => '',
  'option_explain.xfesRecencyRelevance' => 'Please edit this via the "Enhanced search" section.',
  'option_explain.xfesSimilarThreads' => 'Please edit this via the "Enhanced search" section.',
  'option_explain.xfesSimilarThreadsExcludedForums' => 'Please edit this via the "Enhanced search" section.',
