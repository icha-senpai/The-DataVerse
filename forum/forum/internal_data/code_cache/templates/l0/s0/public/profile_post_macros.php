<?php
// FROM HASH: bac524a6105abf7f00c0ba884a7ee21d
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<article class="message message--simple ' . ($__templater->method($__vars['profilePost'], 'isIgnored', array()) ? 'is-ignored' : '') . ' js-inlineModContainer"
		...
		<div class="message-inner">
			<div class="message-cell message-cell--user">
				' . $__templater->callMacro(null, 'message_macros::user_info_simple', array(
	...
	if ($__templater->method($__vars['profilePost'], 'canReport', array())) {
		$__compilerTemp2 .= '
										<a href="' . $__templater->func('link', array('profile-posts/report', $__vars['profilePost'], ), true) . '" class="actionBar-action actionBar-action--report" data-xf-click="overlay" data-cache="false">' . 'Report' . '</a>
									';
	}
	$__compilerTemp2 .= '
	...
	if ($__templater->method($__vars['profilePost'], 'canComment', array())) {
		...
		$__finalCompiled .= '
			...
			'lastDate' => $__vars['lastProfilePostComment']['comment_date'],
