<?php
// FROM HASH: 8f618c8cbe215e1362c5464540378dca
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<dl class="pairs pairs--rows pairs--rows--centered fauxBlockLink">
		<dt>' . 'Messages' . '</dt>
		<dd>
			<a href="' . $__templater->func('link', array('search/member', null, array('user_id' => $__vars['user']['user_id'], ), ), true) . '" rel="nofollow" class="fauxBlockLink-linkRow u-concealed">
	...
	if ($__vars['xf']['options']['enableTrophies']) {
		...
		<dl class="pairs pairs--rows pairs--rows--centered fauxBlockLink">
			...
			<dd>
				<a href="' . $__templater->func('link', array('members/trophies', $__vars['user'], ), true) . '" rel="nofollow" data-xf-click="overlay" class="fauxBlockLink-linkRow u-concealed">
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canStartConversationWith', array($__vars['user'], ))) {
		$__compilerTemp2 .= '
				' . $__templater->button('
					' . 'Send direct message' . '
				', array(
			'href' => $__templater->func('link', array('direct-messages/add', null, array('to' => $__vars['user']['username'], ), ), false),
			'class' => 'button--link',
		), '', array(
		)) . '
			';
