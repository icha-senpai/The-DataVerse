<?php
// FROM HASH: f70d4c385ec68bb8f1cae05347d927a0
return array(
...
'status_featured' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
		$__finalCompiled .= '
						';
	if ($__vars['thread']['featured']) {
		$__finalCompiled .= '
							<li>
								<i class="structItem-status structItem-status--featured" aria-hidden="true" title="' . $__templater->filter('Featured', array(array('for_attr', array()),), true) . '"></i>
...
'statuses' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
					...
					' . $__templater->renderExtension('status_featured', $__vars, $__extensions) . '
...
'main_cell' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
				<a href="' . $__templater->func('link', array('threads' . ((($__templater->method($__vars['thread'], 'isUnread', array()) AND (!$__vars['forceRead']))) ? '/unread' : ''), $__vars['thread'], ), true) . '" class="" data-tp-primary="on" data-xf-init="' . ($__vars['canPreview'] ? 'preview-tooltip' : '') . '" data-preview-url="' . ($__vars['canPreview'] ? $__templater->func('link', array('threads/preview', $__vars['thread'], ), true) : '') . '"
					' . ((!$__templater->method($__vars['thread'], 'isSearchEngineIndexable', array())) ? 'rel="nofollow"' : '') . '>
					' . $__templater->escape($__vars['thread']['title']) . '
				</a>
			</div>
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['thread'], 'isUnread', array())) {
		$__finalCompiled .= '
				<a href="' . $__templater->func('link', array('threads/unread', $__vars['thread'], ), true) . '" ' . ((!$__templater->method($__vars['thread'], 'isSearchEngineIndexable', array())) ? 'rel="nofollow"' : '') . '>' . $__templater->func('prefix', array('thread', $__vars['thread'], ), true) . $__templater->escape($__vars['thread']['title']) . '</a>
			';
	} else {
		$__finalCompiled .= '
				<a href="' . $__templater->func('link', array('threads/post', $__vars['thread'], array('post_id' => $__vars['thread']['last_post_id'], ), ), true) . '" ' . ((!$__templater->method($__vars['thread'], 'isSearchEngineIndexable', array())) ? 'rel="nofollow"' : '') . '>' . $__templater->func('prefix', array('thread', $__vars['thread'], ), true) . $__templater->escape($__vars['thread']['title']) . '</a>
			';
	}
	$__finalCompiled .= '
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="contentRow">
		...
		<div class="contentRow-main contentRow-main--close">
			<a href="' . $__templater->func('link', array('threads', $__vars['thread'], ), true) . '" ' . ((!$__templater->method($__vars['thread'], 'isSearchEngineIndexable', array())) ? 'rel="nofollow"' : '') . '>' . $__templater->func('prefix', array('thread', $__vars['thread'], ), true) . $__templater->escape($__vars['thread']['title']) . '</a>
