<?php
// FROM HASH: 956b34f5a39851b733aa6f2197c7404a
return array(
...
<div class="blocks">
	';
	$__compilerTemp1 = '';
	$__compilerTemp2 = $__templater->method($__vars['xf']['style'], 'getVariations', array());
	if ($__templater->isTraversable($__compilerTemp2)) {
		foreach ($__compilerTemp2 AS $__vars['variation']) {
			$__compilerTemp1 .= '
							"' . $__templater->filter($__vars['variation'], array(array('escape', array('json', )),), true) . '": {
								"input": {
									"color": "' . $__templater->func('property_variation', array('textColor', $__vars['variation'], '#141414', ), true) . '",
									"font-family": "' . $__templater->func('property_variation', array('fontFamilyUi', $__vars['variation'], ), true) . '",
									"font-size": "16px",
									"line-height": "' . $__templater->func('property_variation', array('lineHeightDefault', $__vars['variation'], '1.4', ), true) . '"
								},
								"input.invalid": {
									"color": "#c84448"
								}
