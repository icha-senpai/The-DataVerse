<?php
// FROM HASH: b1aa752777caaf780777ce32ec416894
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__vars['extraKeysInput'] = $__templater->preEscaped($__templater->callMacro(null, 'option_macros::input_name', array(
		'id' => 'extraCaptchaKeys',
	), $__vars));
	$__finalCompiled .= '
...
Note: You must choose "reCAPTCHA v2" as the type when creating the key. If you would like to use set the invisible CAPTCHA option, you must also select the "Invisible reCAPTCHA badge" option when creating the key.',
	...
	array(
		...
		' . $__templater->callMacro(null, 'option_macros::listed_html', array(
		'id' => 'extraCaptchaKeys',
	), $__vars) . '
	',
	));
