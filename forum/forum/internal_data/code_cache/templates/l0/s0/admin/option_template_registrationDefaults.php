<?php
// FROM HASH: e6f9c732c456395022c371b37146faa2
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	array(
		...
		'label' => 'Receive email when a new direct message is received',
		'_type' => 'option',
	),
	array(
	...
	array(
		...
		<dl class="inputLabelPair">
			<dt><label for="' . $__templater->escape($__vars['inputName']) . '_aspc">' . 'Send direct messages to this user' . '</label></dt>
			<dd>' . $__templater->formSelect(array(
