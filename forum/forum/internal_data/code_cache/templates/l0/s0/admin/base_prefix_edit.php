<?php
// FROM HASH: a8c8441e95025f482fd98f7f03b9cb40
return array(
...
';
	...
	<div class="block-container">
		...
		'label' => 'Title',
			...
			' . $__templater->callMacro(null, 'base_prefix_edit_macros::display_style', array(
		...
		'displayStyles' => $__vars['displayStyles'],
			...
			' . $__templater->callMacro(null, 'base_prefix_edit_macros::prefix_groups', array(
		'prefix' => $__vars['prefix'],
