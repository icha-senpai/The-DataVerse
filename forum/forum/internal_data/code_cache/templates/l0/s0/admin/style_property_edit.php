<?php
// FROM HASH: 71c4651156c92603cc383b176a5a7e4a
return array(
...
';
	$__compilerTemp1 = '';
	if ((!$__templater->method($__vars['property'], 'exists', array())) OR $__templater->method($__vars['property'], 'canHaveVariations', array())) {
		$__compilerTemp1 .= '
					' . $__templater->formCheckBoxRow(array(
		), array(array(
			'name' => 'has_variations',
			'checked' => $__vars['property']['has_variations'],
			'label' => 'Enable variations',
			'hint' => 'Variations allow style properties to have multiple sets of values.',
			'_type' => 'option',
		)), array(
		)) . '
				';
