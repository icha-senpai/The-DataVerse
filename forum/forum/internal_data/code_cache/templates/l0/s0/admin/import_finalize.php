<?php
// FROM HASH: 445b3a5f355aa3164691fb8e7b381cd4
return array(
		...
		foreach ($__vars['notes']['totals'] AS $__vars['total']) {
			...
			if ($__vars['total']['total']) {
				...
				if ($__vars['total']['time'] > 3600) {
					$__compilerTemp2 .= '
							' . $__templater->func('parens', array('' . $__templater->func('number', array($__vars['total']['time'] / 3600, 0, ), false) . ' hours, ' . $__templater->func('number', array($__templater->func('floor', array($__vars['total']['time'] / 60, ), false) % 60, 0, ), false) . ' minutes', ), true) . '
						';
