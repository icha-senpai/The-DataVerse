<?php
// FROM HASH: 2f3389d3102428bfb3ce18ca09250c91
return array(
...
';
	...
	<div class="blockMessage blockMessage--important blockMessage--iconic">
		...
		<div style="margin: 1em 0; text-align: center">' . $__templater->callMacro(null, 'api_key_macros::copy_key', array(
			'apiKey' => $__vars['newKey'],
		), $__vars) . '</div>
		' . $__templater->callMacro(null, 'api_key_macros::key_usage', array(
			'apiKey' => $__vars['newKey'],
		), $__vars) . '
	</div>
';
				...
				$__compilerTemp1 .= $__templater->dataRow(array(
					...
					'explain' => '
								<ul class="listInline listInline--bullet">
									...
									<li>
										' . $__templater->callMacro(null, 'api_key_macros::key_type', array(
