<?php
// FROM HASH: 1ca50af3ff773194d3d42fa085f7b9f1
return array(
...
<div class="block">
	<div class="block-outer">
		<div class="block-outer-main">
			' . $__templater->callMacro(null, 'language_macros::language_change_menu', array(
		...
		'routeParams' => $__vars['linkParams'],
			...
			' . $__templater->callMacro(null, 'addon_macros::addon_change_menu', array(
