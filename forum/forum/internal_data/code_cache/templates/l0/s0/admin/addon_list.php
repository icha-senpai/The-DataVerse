<?php
// FROM HASH: 20c26a1e09b6c3b75b02be30c506a812
return array(
...
';
	if ($__vars['upgradeCheck']) {
		$__finalCompiled .= '
	' . $__templater->callMacro(null, 'upgrade_check_macros::installable_add_ons', array(
...
' . $__templater->callMacro(null, 'addon_list_macros::addon_list_filter', array(), $__vars) . '
...
';
	...
	<div class="addOnList">
		' . '
		' . $__templater->callMacro(null, 'addon_list_macros::addon_list_block', array(
