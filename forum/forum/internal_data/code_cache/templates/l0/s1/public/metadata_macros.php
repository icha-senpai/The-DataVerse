<?php
// FROM HASH: aa97afaab74c52362e0d0b654f9a3950
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
	';
	if ($__vars['oembedUrl'] AND $__vars['xf']['options']['allowExternalEmbed']) {
		$__finalCompiled .= '
		<link rel="alternate" type="application/json+oembed" href="' . $__templater->filter($__vars['oembedUrl'], array(array('for_attr', array()),), true) . '" title="' . $__templater->filter($__vars['title'], array(array('for_attr', array()),), true) . '" />
	';
	}
	$__finalCompiled .= '
';
