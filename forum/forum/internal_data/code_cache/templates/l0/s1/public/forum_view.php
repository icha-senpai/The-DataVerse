<?php
// FROM HASH: 819899050b9c25bd498c0b12cf401aa7
return array(
...
'featured' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
		$__finalCompiled .= '
		';
	if ($__vars['filters']['featured']) {
		$__finalCompiled .= '
			<li><a href="' . $__templater->func('link', array('forums', $__vars['forum'], $__templater->filter($__vars['filters'], array(array('replace', array('featured', null, )),), false), ), true) . '"
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . $__templater->renderExtension('featured', $__vars, $__extensions) . '
...
';
	...
	' . $__templater->button('
		' . ($__templater->escape($__templater->method($__vars['forum']['TypeHandler'], 'getTypeActionPhrase', array('cta', ))) ?: 'Post thread') . '
	', array(
