<?php
// FROM HASH: 5b9972146513146df1e0f99ee29de7ff
return array(
	...
	$__finalCompiled .= '.bbWrapper
{
	...
	h2.bbHeading { font-size: @xf-fontSizeLargest; }
	h3.bbHeading { font-size: @xf-fontSizeLarger; }
	h4.bbHeading { font-size: @xf-fontSizeLarge; }
	...
	a.link
	{
		color: @xf-linkUgcColor;
	}

	a.link:hover
	{
		color: @xf-linkUgcHoverColor;
	}
}
