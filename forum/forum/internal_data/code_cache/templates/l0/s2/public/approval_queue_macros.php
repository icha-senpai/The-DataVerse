<?php
// FROM HASH: f458bf1c2d19b629a1d0eb152540e1bc
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
		...
		<div class="message-inner">
			<div class="message-cell message-cell--user">
				...
				<section class="message-user"
					...
					' . ($__vars['user'] ? (('itemid="' . $__templater->func('link', array('canonical:members', $__vars['user'], ), true)) . '"') : '') . '>
	...
	if ($__vars['unapprovedItem'] AND $__vars['handler']) {
		$__finalCompiled .= '
					' . $__templater->callMacro(null, 'approval_queue_macros::action_radio', array(
			'unapprovedItem' => $__vars['unapprovedItem'],
			'handler' => $__vars['handler'],
		), $__vars) . '
				';
