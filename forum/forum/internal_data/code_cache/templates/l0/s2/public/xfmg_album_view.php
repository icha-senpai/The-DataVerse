<?php
// FROM HASH: 2ad2ed522d98b38b1d89fd85a0886e32
return array(
	...
	$__finalCompiled .= '
		...
		'defaultname' => $__vars['album']['username'],
				...
				<dl class="pairs pairs--justified">
					<dt>' . 'Rating' . '</dt>
					<dd>
						' . $__templater->callMacro(null, 'rating_macros::stars_text', array(
...
';
	...
	<link rel="alternate" type="application/rss+xml"
		title="' . $__templater->filter('RSS feed for ' . $__vars['album']['title'] . '', array(array('for_attr', array()),), true) . '"
		href="' . $__templater->func('link', array('media/albums/index.rss', $__vars['album'], ), true) . '" />
'));
	$__finalCompiled .= '
...
' . $__templater->callMacro(null, 'xfmg_media_list_macros::media_create_message', array(
...
<div class="block" data-xf-init="' . ($__vars['canInlineModMediaItems'] ? 'inline-mod' : '') . '" data-type="xfmg_media" data-href="' . $__templater->func('link', array('inline-mod', ), true) . '">
	...
	'), false) . '</div>
	<div class="block-container">
		' . $__templater->callMacro(null, 'xfmg_album_list_macros::list_filter_bar', array(
