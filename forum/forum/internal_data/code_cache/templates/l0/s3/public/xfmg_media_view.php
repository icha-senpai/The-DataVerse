<?php
// FROM HASH: 21d16da5625efbcd950695e697a57c55
return array(
...
' . $__templater->callMacro(null, 'xfmg_page_macros::xfmg_page_options', array(
...
' . $__templater->callMacro(null, 'xfmg_media_view_macros::media_status', array(
		'mediaItem' => $__vars['mediaItem'],
	), $__vars) . '
...
<div class="media">
	...
	if ($__vars['filmStripParams']['prevItem']) {
		$__finalCompiled .= '
		<a href="' . $__templater->func('link', array('media', $__vars['filmStripParams']['prevItem'], ), true) . '" class="media-button media-button--prev" title="' . $__templater->filter('Prev', array(array('for_attr', array()),), true) . '" data-xf-key="ArrowLeft">
	...
	<div class="media-container"
		...
		' . $__templater->callMacro(null, 'xfmg_media_view_macros::media_content', array(
		'mediaItem' => $__vars['mediaItem'],
	...
	if ($__vars['filmStripParams']['nextItem']) {
		$__finalCompiled .= '
		<a href="' . $__templater->func('link', array('media', $__vars['filmStripParams']['nextItem'], ), true) . '" class="media-button media-button--next" title="' . $__templater->filter('Next', array(array('for_attr', array()),), true) . '" data-xf-key="ArrowRight">
			<i class="media-button-icon" aria-hidden="true"></i>
...
<div class="block js-mediaInfoBlock">
	' . $__templater->callMacro(null, 'xfmg_media_view_macros::media_film_strip', array(
		'mediaItem' => $__vars['mediaItem'],
	...
	if ($__vars['xf']['options']['enableTagging'] AND (($__templater->method($__vars['mediaItem'], 'canEditTags', array()) OR $__vars['mediaItem']['tags']))) {
		$__finalCompiled .= '
									<li>
										' . $__templater->callMacro(null, 'tag_macros::list', array(
	...
	$__compilerTemp5 .= '
								' . $__templater->callMacro(null, 'bookmark_macros::button', array(
		'content' => $__vars['mediaItem'],
	...
	$__compilerTemp7 .= '
													';
	if ($__templater->method($__vars['mediaItem'], 'canFeatureUnfeature', array())) {
		$__compilerTemp7 .= '
														<a href="' . $__templater->func('link', array('media/feature', $__vars['mediaItem'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">
															';
		if ($__templater->method($__vars['mediaItem'], 'isFeatured', array())) {
			$__compilerTemp7 .= '
																' . 'Manage feature' . '
															';
		} else {
...
';
	...
	<div class="columnContainer">
		<div class="columnContainer-comments">
			' . $__templater->callMacro(null, 'xfmg_comment_macros::comment_list', array(
		...
		<div class="columnContainer-sidebar">
			...
			' . $__templater->callMacro(null, 'xfmg_media_view_macros::extra_info_sidebar', array(
			'mediaItem' => $__vars['mediaItem'],
		), $__vars) . '

			' . $__templater->callMacro(null, 'xfmg_media_view_macros::additional_sidebar', array(
			'mediaItem' => $__vars['mediaItem'],
		), $__vars) . '

			' . $__templater->callMacro(null, 'xfmg_media_view_macros::exif_sidebar', array(
			'mediaItem' => $__vars['mediaItem'],
		), $__vars) . '

			' . $__templater->callMacro(null, 'xfmg_media_view_macros::user_tags_sidebar', array(
			'mediaNotes' => $__vars['mediaNotes'],
		), $__vars) . '

			' . $__templater->callMacro(null, 'xfmg_media_view_macros::share_sidebar', array(
			'mediaItem' => $__vars['mediaItem'],
		), $__vars) . '
		</div>
	</div>
