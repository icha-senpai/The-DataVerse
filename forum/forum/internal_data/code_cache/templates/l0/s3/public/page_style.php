<?php
// FROM HASH: 3f47049b6472ff7a2c437bf023d0dae3
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if (!$__vars['uix_hideNavigation']) {
		...
		';
			...
			if ($__templater->func('property', array('uix_viewportWidthRemoveSubNav', ), false) != '100%') {
				$__finalCompiled .= '
				';
				$__vars['uix_stickyNavHeightTotal'] = ($__templater->func('uix_intval', array($__templater->func('property', array('uix_stickyNavHeight', ), false), ), false) + $__templater->func('uix_intval', array($__templater->func('property', array('uix_stickySectionLinkHeight', ), false), ), false));
				$__finalCompiled .= '
			';
			} else {
				$__finalCompiled .= '
	...
	if (((!$__vars['uix_subNavContentStatic'])) OR $__vars['uix_subNavContentStatic']) {
		$__finalCompiled .= '	
		';
		$__vars['uix_stickyTotal'] = ((($__templater->func('uix_intval', array($__vars['uix_stickyStaffBarHeight'], ), false) + $__templater->func('uix_intval', array($__vars['uix_stickyNavHeightTotal'], ), false)) + $__templater->func('uix_intval', array($__templater->func('property', array('elementSpacer', ), false), ), false)) + $__templater->func('uix_intval', array($__vars['uix_stickyTabsHeight'], ), false));
		$__finalCompiled .= '
		.uix_mainTabBar {top: ' . ($__templater->func('uix_intval', array($__vars['uix_stickyStaffBarHeight'], ), false) + $__templater->func('uix_intval', array($__vars['uix_stickyNavHeightTotal'], ), false)) . 'px !important;}
		...
		if ($__vars['uix_responsiveStaffBar'] AND (!$__vars['uix_alwaysStaffBar'])) {
			...
			@media(max-width: ' . $__templater->func('property', array('uix_staffBarBreakpoint', ), true) . ') {
				';
			$__vars['uix_stickyTotal'] = (($__templater->func('uix_intval', array($__vars['uix_stickyNavHeightTotal'], ), false) + $__templater->func('uix_intval', array($__templater->func('property', array('elementSpacer', ), false), ), false)) + $__templater->func('uix_intval', array($__vars['uix_stickyTabsHeight'], ), false));
			$__finalCompiled .= '
		...
		$__finalCompiled .= '
				...
				';
		$__vars['uix_stickyTotal'] = ((($__templater->func('uix_intval', array($__vars['uix_stickyStaffBarHeight'], ), false) + $__templater->func('uix_intval', array($__vars['uix_stickyNavPrimary'], ), false)) + $__templater->func('uix_intval', array($__templater->func('property', array('elementSpacer', ), false), ), false)) + $__templater->func('uix_intval', array($__vars['uix_stickyTabsHeight'], ), false));
		$__finalCompiled .= '

				.uix_mainTabBar {top: ' . ($__templater->func('uix_intval', array($__vars['uix_stickyStaffBarHeight'], ), false) + $__templater->func('uix_intval', array($__vars['uix_stickyNavPrimary'], ), false)) . 'px !important;}
				.uix_stickyBodyElement:not(.offCanvasMenu) {
					top: ' . $__templater->escape($__vars['uix_stickyTotal']) . 'px !important;
					min-height: calc(100vh - ' . $__templater->escape($__vars['uix_stickyTotal']) . 'px) !important;
				}
		...
		if ($__vars['uix_responsiveStaffBar'] AND (!$__vars['uix_alwaysStaffBar'])) {
			$__finalCompiled .= '
					@media(max-width: ' . $__templater->func('property', array('uix_staffBarBreakpoint', ), true) . ') {
						';
			$__vars['uix_stickyTotal'] = (($__templater->func('uix_intval', array($__vars['uix_stickyNavPrimary'], ), false) + $__templater->func('uix_intval', array($__templater->func('property', array('elementSpacer', ), false), ), false)) + $__templater->func('uix_intval', array($__vars['uix_stickyTabsHeight'], ), false));
			$__finalCompiled .= '
