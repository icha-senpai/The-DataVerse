<?php
// FROM HASH: 9d7d36a59cef7141e97e92a430ad744c
return array(
...
';
	...
	array(
		...
		'data-hide' => 'true',
		'label' => 'Send a direct message to ' . $__templater->escape($__vars['user']['username']) . '',
		'_type' => 'option',
	)), array(
	)) . '
		...
		'value' => '1',
		'label' => '
						' . 'Allow ' . $__templater->escape($__vars['user']['username']) . ' to invite others to this direct message' . '
					',
		'_type' => 'option',
	),
	array(
