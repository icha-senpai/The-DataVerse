<?php
// FROM HASH: 53af71f19f28e59c59e6b7d083ac7632
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="sidePanel__tabPanels">
		...
		<div data-content="navigation" class="is-active sidePanel__tabPanel js-navigationTabPanel">
			' . $__templater->callMacro(null, 'PAGE_CONTAINER::canvasNavPanel', array(
	...
	if ($__vars['xf']['visitor']['user_id'] AND (($__templater->func('property', array('uix_visitorTabsMobile', ), false) == 'canvas'))) {
		...
		<div data-content="inbox" class="sidePanel__tabPanel js-convoTabPanel">
				...
				<div class="menu-footer">
					<a href="' . $__templater->func('link', array('direct-messages/add', ), true) . '" class="u-pullRight">' . 'Send direct message' . '</a>
					<a href="' . $__templater->func('link', array('direct-messages', ), true) . '">' . 'Show all' . $__vars['xf']['language']['ellipsis'] . '</a>
				</div>
		</div>
