<?php
// FROM HASH: fec355ebbf1cfb7aa79094b2f0356913
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	array(
		...
		'_type' => 'option',
				...
				' . $__templater->callMacro(null, 'filter_macros::find_new_filter_footer', array(), $__vars) . '
			', array(
	...
	if ($__vars['findNew']['result_count']) {
		...
		if ($__templater->isTraversable($__vars['threads'])) {
			foreach ($__vars['threads'] AS $__vars['thread']) {
				...
				' . $__templater->callMacro(null, 'thread_list_macros::item', array(
