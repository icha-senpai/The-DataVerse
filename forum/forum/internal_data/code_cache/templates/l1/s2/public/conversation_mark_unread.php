<?php
// FROM HASH: 5d3db802d54aaf81271bd718ac299f58
return array(
...
';
	...
	if ($__vars['isUnread']) {
		$__compilerTemp1 .= '
					' . 'Please confirm that you wish to mark the following direct message read' . $__vars['xf']['language']['label_separator'] . '
				';
	} else {
		$__compilerTemp1 .= '
					' . 'Please confirm that you wish to mark the following direct message unread' . $__vars['xf']['language']['label_separator'] . '
				';
	}
...
', array(
		'action' => $__templater->func('link', array('direct-messages/mark-unread', $__vars['userConv'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
