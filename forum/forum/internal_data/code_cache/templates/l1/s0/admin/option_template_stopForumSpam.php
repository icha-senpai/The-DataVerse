...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	array(
		...
		'hint' => 'If selected, the user\'s email address will be converted to an MD5 hash before submission. This reduces the number of checks which are possible, including blacklist checks.<br>
<strong>Note:</strong> The unhashed email will be submitted when reporting <em>new</em> spammers, regardless of this option.',
		'_type' => 'option',
	)))),
		'_type' => 'option',
	),
	array(
		...
		'title' => 'Please enter a valid API key',
			...
			<p class="formRow-explain">' . 'If you have an API key from StopForumSpam, you may have spammer activity on your site automatically reported back to StopForumSpam in order to improve the database for other users. This option will cause users who are banned via the spam cleaner to be reported.<br>
<strong>Note:</strong> The unhashed email will be submitted when reporting <em>new</em> spammers.' . '</p>
		'),
		'_type' => 'option',
	)), array(
