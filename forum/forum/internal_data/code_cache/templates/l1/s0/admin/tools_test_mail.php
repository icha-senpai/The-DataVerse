<?php
// FROM HASH: 8f52ffb3b49ba5f6fba5a942e34ed821
return array(
...
';
	if ($__vars['result']) {
		$__finalCompiled .= '
	';
		if (!$__templater->test($__vars['result']['sent'], 'empty', array())) {
			$__finalCompiled .= '
		<div class="blockMessage blockMessage--success">
			' . 'The email was sent successfully with no errors.' . '
			';
			if ($__vars['transportClass'] == 'Symfony\\Component\\Mailer\\Transport\\SendmailTransport') {
				$__finalCompiled .= '
