<?php
// FROM HASH: 3e0256052a7243f28074c93ffa55d560
return array(
...
' . $__templater->callMacro(null, 'public:prefix_macros::row', array(
		'includeAny' => true,
...
' . $__templater->formCheckBoxRow(array(
		'name' => 'criteria[featured]',
		'value' => $__vars['criteria']['featured'],
	), array(array(
		'value' => '0',
		'label' => 'Not featured',
		'_type' => 'option',
