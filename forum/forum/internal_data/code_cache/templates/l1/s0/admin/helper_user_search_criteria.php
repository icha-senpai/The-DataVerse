<?php
// FROM HASH: d73d3a31ca842df3dbae5ce22fa22abf
return array(
...
';
	$__compilerTemp5 = $__templater->mergeChoiceOptions(array(), $__vars['connectedAccProviders']);
	$__finalCompiled .= $__templater->formCheckBoxRow(array(
		'name' => 'criteria[connected_account]',
		'value' => $__vars['criteria']['connected_account'],
		'listclass' => 'listColumns',
		'readonly' => $__vars['readOnly'],
...
';
	...
	$__compilerTemp6 .= '
		';
	$__compilerTemp7 = $__templater->method($__templater->method($__vars['xf']['app']['em'], 'getRepository', array('XF:UserField', )), 'getDisplayGroups', array());
	if ($__templater->isTraversable($__compilerTemp7)) {
		foreach ($__compilerTemp7 AS $__vars['fieldGroup'] => $__vars['phrase']) {
			$__compilerTemp6 .= '
			';
