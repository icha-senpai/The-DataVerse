<?php
// FROM HASH: 92b159804f979d3959d2640940373ec4
return array(
...
';
	...
	<div class="block-container">
		...
		'label' => 'Phrase text',
		'explain' => 'You may use HTML here, but ideally markup should be made in templates rather than phrases.<br>
<br>
You may use <code>&#123;icon::name&#125;</code> to display an icon in the default variant, or <code>&#123;icon:variant::name&#125;</code> to display an icon in a specific variant. For example, <code>&#123;icon::alien&#125;</code> or <code>&#123;icon:fas::alien&#125;</code>.',
	)) . '
