...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
		...
		if ($__vars['property']['has_variations']) {
			...
			if ($__vars['enableVariations']) {
					...
					<ul class="listPlain inputGroup-container">
						<li>
							<div class="inputGroup inputGroup--grow">
								';
				$__compilerTemp6 = $__templater->method($__vars['property'], 'getVariations', array());
				if ($__templater->isTraversable($__compilerTemp6)) {
					foreach ($__compilerTemp6 AS $__vars['variation']) {
						$__compilerTemp5 .= '
									';
						...
						$__compilerTemp5 .= $__templater->formRadio(array(
				...
				$__compilerTemp5 .= '
					';
				$__compilerTemp8 = $__templater->mergeChoiceOptions(array(), $__vars['valueOptions']);
				$__compilerTemp5 .= $__templater->formRadio(array(
					...
					';
				$__compilerTemp9 = $__templater->method($__vars['property'], 'getVariations', array(false, ));
				if ($__templater->isTraversable($__compilerTemp9)) {
					foreach ($__compilerTemp9 AS $__vars['variation']) {
						$__compilerTemp5 .= '
	...
	';
		...
		';
		$__compilerTemp11 = $__templater->mergeChoiceOptions(array(), $__vars['valueOptions']);
		...
		if ($__vars['property']['has_variations']) {
			...
			if ($__vars['enableVariations']) {
				$__compilerTemp12 .= '
					<ul class="listPlain inputGroup-container">
						<li>
							<div class="inputGroup inputGroup--grow">
								';
				$__compilerTemp13 = $__templater->method($__vars['property'], 'getVariations', array());
				...
				$__compilerTemp12 .= '
					...
					';
				$__compilerTemp14 = $__templater->method($__vars['property'], 'getVariations', array(false, ));
				if ($__templater->isTraversable($__compilerTemp14)) {
					foreach ($__compilerTemp14 AS $__vars['variation']) {
						$__compilerTemp12 .= '
						' . $__templater->formHiddenVal($__vars['formBaseKey'] . '[' . $__vars['variation'] . ']', $__templater->method($__vars['property'], 'getVariationValue', array($__vars['variation'], )), array(
						)) . '
					';
		...
		if ($__vars['property']['has_variations']) {
			...
			if ($__vars['enableVariations']) {
				$__compilerTemp15 .= '
					<ul class="listPlain inputGroup-container">
						<li>
							<div class="inputGroup inputGroup--grow">
								';
				$__compilerTemp16 = $__templater->method($__vars['property'], 'getVariations', array());
				...
				$__compilerTemp15 .= '
					...
					';
				$__compilerTemp17 = $__templater->method($__vars['property'], 'getVariations', array(false, ));
				if ($__templater->isTraversable($__compilerTemp17)) {
					foreach ($__compilerTemp17 AS $__vars['variation']) {
						$__compilerTemp15 .= '
						' . $__templater->formHiddenVal($__vars['formBaseKey'] . '[' . $__vars['variation'] . ']', $__templater->method($__vars['property'], 'getVariationValue', array($__vars['variation'], )), array(
						)) . '
					';
		...
		if ($__vars['property']['has_variations']) {
			...
			if ($__vars['enableVariations']) {
				$__compilerTemp18 .= '
					<ul class="listPlain inputGroup-container">
						<li>
							<div class="inputGroup inputGroup--grow">
								';
				$__compilerTemp19 = $__templater->method($__vars['property'], 'getVariations', array());
				...
				$__compilerTemp18 .= '
					...
					';
				$__compilerTemp20 = $__templater->method($__vars['property'], 'getVariations', array(false, ));
				if ($__templater->isTraversable($__compilerTemp20)) {
					foreach ($__compilerTemp20 AS $__vars['variation']) {
						$__compilerTemp18 .= '
						' . $__templater->formHiddenVal($__vars['formBaseKey'] . '[' . $__vars['variation'] . ']', $__templater->method($__vars['property'], 'getVariationValue', array($__vars['variation'], )), array(
						)) . '
					';
		...
		if ($__vars['property']['has_variations']) {
			...
			if ($__vars['enableVariations']) {
				$__compilerTemp21 .= '
					<ul class="listPlain inputGroup-container">
						<li>
							<div class="inputGroup inputGroup--grow">
								';
				$__compilerTemp22 = $__templater->method($__vars['property'], 'getVariations', array());
				...
				$__compilerTemp21 .= '
					...
					';
				$__compilerTemp23 = $__templater->method($__vars['property'], 'getVariations', array(false, ));
				if ($__templater->isTraversable($__compilerTemp23)) {
					foreach ($__compilerTemp23 AS $__vars['variation']) {
						$__compilerTemp21 .= '
						' . $__templater->formHiddenVal($__vars['formBaseKey'] . '[' . $__vars['variation'] . ']', $__templater->method($__vars['property'], 'getVariationValue', array($__vars['variation'], )), array(
						)) . '
					';
