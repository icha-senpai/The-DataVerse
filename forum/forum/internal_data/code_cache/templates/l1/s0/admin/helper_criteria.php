<?php
// FROM HASH: 0d8327297612e3e8eeb17e204e33694d
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	array(
		...
		'name' => 'user_criteria[user_id][rule]',
		'value' => 'user_id',
		'selected' => $__vars['criteria']['user_id'],
		'label' => 'User ID matches expression' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formTextBox(array(
		'name' => 'user_criteria[user_id][data][expression]',
		'value' => $__vars['criteria']['user_id']['expression'],
		'placeholder' => '2n+1',
	))),
		'afterhint' => 'Use this criteria to segment your users according to their numeric user ID. This can be useful for things like A-B testing, where half of your users match the criteria and half do not. Use the <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/:nth-child" target="_blank">syntax for CSS :nth-child</a> for the expression, for example: <code>2n</code> for even numbers and <code>2n+1</code> for odd numbers.',
		'_type' => 'option',
	)), array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	array(
		...
		'_dependent' => array($__templater->callMacro(null, 'helper_callback_fields::callback_fields', array(
