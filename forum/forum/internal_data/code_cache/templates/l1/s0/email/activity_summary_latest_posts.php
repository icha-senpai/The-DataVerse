<?php
// FROM HASH: 611a06db73f9aeb6cf6dc065633011e6
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if (!$__templater->test($__vars['posts'], 'empty', array())) {
		$__finalCompiled .= '
	' . $__templater->callMacro(null, 'activity_summary_macros::outer_header', array(
			'title' => $__vars['title'],
		), $__vars) . '
	...
	';
		...
		' . $__templater->callMacro(null, 'activity_summary_macros::block', array(
