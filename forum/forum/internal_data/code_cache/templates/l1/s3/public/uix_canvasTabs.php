<?php
// FROM HASH: a997fafb08be03e4453c3d62a58807e2
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<ul class="sidePanel__tabs">
		...
		<li>
			<a data-attr="alerts" data-xf-click="toggle" data-target=".js-alertTabPanel .uix_canvasPanelBody" data-badge="' . $__templater->filter($__vars['xf']['visitor']['alerts_unviewed'], array(array('number', array()),), true) . '" class="sidePanel__tab js-alertTab js-badge--alerts badgeContainer' . ($__vars['xf']['visitor']['alerts_unread'] ? ' badgeContainer--highlighted' : '') . '">
