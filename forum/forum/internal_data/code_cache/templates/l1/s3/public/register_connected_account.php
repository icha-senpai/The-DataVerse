<?php
// FROM HASH: 5189cce34674cb5dd683b47c82a7bddd
return array(
		...
		<ul class="tabPanes">
			<li class="is-active"
				...
				<div class="block-body">
					...
					' . $__templater->callMacro(null, 'register_macros::tos_row', array(), $__vars) . '
				</div>
				' . $__templater->callMacro(null, 'register_macros::submit_row', array(), $__vars) . '
