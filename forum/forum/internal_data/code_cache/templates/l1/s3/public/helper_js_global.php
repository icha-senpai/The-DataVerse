...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->func('is_addon_active', array('ThemeHouse/UIX', ), false) AND ($__templater->func('is_addon_active', array('ThemeHouse/UIX', ), false) >= 2000490)) {
		$__finalCompiled .= '
		';
		$__vars['cssUrls'] = $__templater->func('array_merge', array($__vars['cssUrls'], $__templater->func('uix_extra_css_urls', array($__vars['cssUrls'], ), false), ), false);
		$__finalCompiled .= '
	';
	}
	$__finalCompiled .= '
	...
	if ($__templater->func('property', array('uix_iconFontFamily', ), false) != 'fontawesome') {
		$__finalCompiled .= '
		<link rel="preload" href="' . $__templater->func('base_url', array($__templater->func('property', array('uix_imagePath', ), false), ), true) . '/fonts/icons/material-icons/fonts/materialdesignicons-webfont.woff2?v=6.9.96" as="font" type="font/woff2" crossorigin="anonymous" />
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
	';
	if ($__templater->func('property', array('uix_backstretch', ), false) OR $__templater->func('property', array('uix_parallax', ), false)) {
		$__finalCompiled .= '
