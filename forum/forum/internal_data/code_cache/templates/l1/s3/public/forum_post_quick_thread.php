<?php
// FROM HASH: 04d373324d7cfef50389ca19069f4214
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['attachmentData']) {
		$__compilerTemp7 .= '
							' . $__templater->callMacro(null, 'helper_attach_upload::upload_link_from_data', array(
	...
	<div class="js-quickThreadFields" data-xf-init="attachment-manager">
		...
		<div class="formButtonGroup">
			<div class="formButtonGroup-primary">
				' . $__templater->button('
					' . ($__templater->escape($__templater->method($__vars['forum']['TypeHandler'], 'getTypeActionPhrase', array('submit', ))) ?: 'Post thread') . '
				', array(
		'type' => 'submit',
