 ...
 * @property-read mixed $api_key_snippet
 *
 * RELATIONS
...
class ApiKey extends Entity
{
	use TokenScopeTrait
	{
		hasScope as protected hasScopeInternal;
	}
	...
	public function hasScope($scope): bool
	{
		...
		return $this->hasScopeInternal($scope);
	}
	...
	protected function _preSave()
	{
		...
		if ($this->isChanged('api_key'))
		{
			$this->api_key_hash = $this->repository(ApiRepository::class)->getApiKeyHash($this->api_key);
		}
