 ...
 *
 * RELATIONS
 * @property-read User|null $ProfileUser
...
class ProfilePost extends Entity implements RenderableContentInterface, LinkableInterface, ViewableInterface, ContainableInterface, DatableInterface
{
	...
	{
		$this->repository(ProfilePostRepository::class)->addCommentsToProfilePosts([$this->profile_post_id => $this]);
	...
	{
		$this->latest_comment_ids = $this->repository(ProfilePostRepository::class)->getLatestCommentCache($this);
	}
	...
	{
		$comment = $this->_em->create(ProfilePostComment::class);
