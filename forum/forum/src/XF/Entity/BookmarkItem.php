 ...
 * @property-read mixed $content_title
 * @property-read mixed $content_link
 * @property-read mixed $content_user
 * @property-read mixed $edit_link
 * @property-read mixed $delete_link
 * @property-read mixed $has_custom_icon
 * @property-read mixed $label_ids
 *
 * RELATIONS
 * @property-read User|null $User
 */
class BookmarkItem extends Entity implements ViewableInterface
{
