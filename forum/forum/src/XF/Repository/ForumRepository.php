...
class ForumRepository extends Repository
{
	public function getViewableForums(array $where = [], $with = null)
	{
		...
		$forumFinder = $this->finder(ForumFinder::class)
	...
	public function markForumReadByVisitor(Forum $forum, $newRead = null)
	{
		$userId = \XF::visitor()->user_id;
		return $this->markForumReadByUser($forum, $userId, $newRead);
	}

	public function markForumReadIfPossible(Forum $forum, $newRead = null)
	{
		$userId = \XF::visitor()->user_id;
		if (!$userId)
		{
