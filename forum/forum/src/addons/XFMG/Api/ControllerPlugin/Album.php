...
{
	public function applyAlbumListFilters(\XFMG\Finder\Album $albumFinder, ?Category $category = null)
	{
		$filters = [];
	...
	public function applyAlbumListSort(\XFMG\Finder\Album $albumFinder, ?Category $category = null)
	{
