...
{
	public function applyMediaListFilters(\XFMG\Finder\MediaItem $mediaFinder, ?Category $category = null)
	{
		$filters = [];
	...
	public function applyMediaListSort(\XFMG\Finder\MediaItem $mediaFinder, ?Category $category = null)
	{
