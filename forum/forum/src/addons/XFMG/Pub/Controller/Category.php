...
class Category extends AbstractController
{
	public function actionIndex(ParameterBag $params)
	{
		...
		if ($category->category_type == 'container')
		{
			...
			/** @var ArrayCollection $descendents */
			...
			else if ($categoryParams['primaryType'] == 'media')
			{
				...
				if ($this->responseType == 'rss')
				{
					...
					$feedLink = $this->buildLink('canonical:media/categories/index.rss', $category);
	...
	public static function getActivityDetails(array $activities)
	{
		return self::getActivityDetailsForContent(
			$activities,
			\XF::phrase('xfmg_viewing_media_category'),
			'category_id',
			function (array $ids)
			{
