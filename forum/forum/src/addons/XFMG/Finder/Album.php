...
/**
 * @method AbstractCollection<\XFMG\Entity\Album> fetch(?int $limit = null, ?int $offset = null)
 * @method AbstractCollection<\XFMG\Entity\Album> fetchDeferred(?int $limit = null, ?int $offset = null)
 * @method \XFMG\Entity\Album|null fetchOne(?int $offset = null)
 * @extends Finder<\XFMG\Entity\Album>
 */
