...
/**
 * @method AbstractCollection<\XFMG\Entity\Comment> fetch(?int $limit = null, ?int $offset = null)
 * @method AbstractCollection<\XFMG\Entity\Comment> fetchDeferred(?int $limit = null, ?int $offset = null)
 * @method \XFMG\Entity\Comment|null fetchOne(?int $offset = null)
 * @extends Finder<\XFMG\Entity\Comment>
 */
class Comment extends Finder
{
	public function forContent(Entity $content, array $limits = [])
	{
	...
	public function applyVisibilityChecksInContent(Entity $content, $allowOwnPending = true)
	{
	...
	public function whereContainerVisible(?Category $withinCategory = null)
	{
