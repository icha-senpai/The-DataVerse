 ...
 * @property-read \XF\Mvc\Entity\AbstractCollection<\XFMG\Entity\MediaWatch> $Watch
 * @property-read DeletionLog|null $DeletionLog
 * @property-read User|null $User
 * @property-read \XF\Mvc\Entity\AbstractCollection<\XFMG\Entity\MediaUserView> $Viewed
 ...
 * @property-read \XF\Mvc\Entity\AbstractCollection<\XFMG\Entity\MediaCommentRead> $CommentRead
	...
	public function getStructuredData()
	{
		...
		switch ($this->media_type)
		{
			case 'image':
				...
				$encodingFormat = $this->Attachment->extension;
				break;
		...
		$mainEntity = [
			...
			'contentSize' => $this->Attachment->file_size,
