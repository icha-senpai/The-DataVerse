...
class MirrorCreator extends AbstractService
{
	...
	public function __construct(App $app, Attachment $baseAttachment)
	{
	...
	protected function setupMediaItem(Attachment $baseAttachment): MediaItem
	{
	...
	protected function checkTranscodingRequired(): bool
	{
		...
		{
			$tempPath = File::copyAbstractedPathToTempFile($attachmentData->getAbstractedDataPath());
