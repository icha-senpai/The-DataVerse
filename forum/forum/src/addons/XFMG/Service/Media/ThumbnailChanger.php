...
class ThumbnailChanger extends AbstractService
{
	...
	public function setThumbnailFromUpload(Upload $upload)
	{
		$upload->requireImage();
	...
	public function updateThumbnail()
	{
		...
		$posterSuccess = $generator->getTempPosterFromImage(
			$this->fileName,
			$mediaItem->getAbstractedPosterPath()
		);
		...
		File::copyFileToAbstractedPath($this->fileName, $abstractedOriginalPath);
