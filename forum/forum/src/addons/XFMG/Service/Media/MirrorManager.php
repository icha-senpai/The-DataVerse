...
{
	public function attachmentInserted(Attachment $attachment, FileWrapper $file)
	{
	 ...
	 */
	protected function setupMirrorCreator(Attachment $attachment, ?Category $category = null)
	{
		if (!$this->canCreateMirror($attachment))
		{
			return null;
		...
		/** @var MirrorCreator $mirrorCreator */
	...
	/**
	 * @param Attachment $attachment
	 * @param Category $newCategory Returns the new category (always returned if an attachment is returned)
	 *
