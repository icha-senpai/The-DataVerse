...
class TemplaterSetup
{
	...
	public function fnAllowedMedia(Templater $templater, &$escape, $type)
	{
		$options = \XF::options();
	...
	public function fnWatermark(Templater $templater, &$escape, $type)
	{
		$options = \XF::options();
	...
	public function fnThumbnail(Templater $templater, &$escape, Entity $entity, $additionalClasses = '', $inline = false, $forceType = null)
	{
		if (!($entity instanceof Album) && !($entity instanceof MediaItem))
		{
	...
	protected function getTransparentThumbUri(Templater $templater)
	{
