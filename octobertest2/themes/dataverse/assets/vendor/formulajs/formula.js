        ...
        return /******/ (function (modules) {
            ...
            /******/ [
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    exports.CEILING = exports.ISOCEILING = set(
                        mathTrig.CEILING.MATH,
                        mathTrig.CEILING
                    );
                    ...
                    exports.CONFIDENCE = set(
                        statistical.CONFIDENCE.NORM,
                    ...
                    exports.QUARTILE = set(
                        statistical.QUARTILE.INC,
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    exports.ACOSH = function (number) {
                        ...
                        return Math.log(
                            number + Math.sqrt(number * number - 1)
                        );
                    };
                    ...
                    exports.BASE = function (number, radix, min_length) {
                        ...
                        return (
                            new Array(
                                Math.max(min_length + 1 - result.length, 0)
                            ).join("0") + result
                        );
                    };
                    ...
                    exports.CEILING = function (number, significance, mode) {
                        ...
                        var precision = -Math.floor(
                            Math.log(significance) / Math.log(10)
                        );
                        if (number >= 0) {
                            return exports.ROUND(
                    ...
                    exports.FLOOR.MATH = function (number, significance, mode) {
                        significance =
                            significance === undefined ? 1 : significance;
                    ...
                    exports.GCD = function () {
                        var range = utils.parseNumberArray(
                            utils.flatten(arguments)
                        );
                    ...
                    exports.MULTINOMIAL = function () {
                        var args = utils.parseNumberArray(
                            utils.flatten(arguments)
                        );
                    ...
                    exports.RANDBETWEEN = function (bottom, top) {
                        ...
                        return (
                            bottom +
                            Math.ceil((top - bottom + 1) * Math.random()) -
                            1
                        );
                    };
                    ...
                    exports.ROMAN = function (number) {
                        ...
                        return (
                            new Array(+digits.join("") + 1).join("M") + roman
                        );
                    };
                    ...
                    exports.ROUNDDOWN = function (number, digits) {
                        ...
                        return (
                            (sign *
                                Math.floor(
                                    Math.abs(number) * Math.pow(10, digits)
                                )) /
                            Math.pow(10, digits)
                        );
                    };
                    ...
                    exports.SUMPRODUCT = function () {
                        ...
                        for (var i = 0; i < arguments[0].length; i++) {
                            if (!(arguments[0][i] instanceof Array)) {
                                ...
                                for (
                                    var j = 0;
                                    j < arguments[0][i].length;
                                    j++
                                ) {
                                    product = 1;
                                    for (k = 1; k < arrays; k++) {
                                        _ij = utils.parseNumber(
                                            arguments[k - 1][i][j]
                                        );
                    ...
                    exports.SUMSQ = function () {
                        var numbers = utils.parseNumberArray(
                            utils.flatten(arguments)
                        );
                        ...
                        for (var i = 0; i < length; i++) {
                            result += information.ISNUMBER(numbers[i])
                                ? numbers[i] * numbers[i]
                                : 0;
                        }
                        return result;
                    ...
                    exports.SUMX2MY2 = function (array_x, array_y) {
                        array_x = utils.parseNumberArray(
                            utils.flatten(array_x)
                        );
                        array_y = utils.parseNumberArray(
                            utils.flatten(array_y)
                        );
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    exports.numbers = function () {
                        var possibleNumbers = this.flatten.apply(
                            null,
                            arguments
                        );
                    ...
                    exports.parseDate = function (date) {
                        if (!isNaN(date)) {
                            ...
                            if (d <= 60) {
                                return new Date(
                                    d1900.getTime() + (d - 1) * 86400000
                                );
                            }
                            return new Date(
                                d1900.getTime() + (d - 2) * 86400000
                            );
                        }
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    exports.BETA.INV = function (
                        ...
                        return (
                            jStat.beta.inv(probability, alpha, beta) * (B - A) +
                            A
                        );
                    };
                    ...
                    exports.BINOM.DIST.RANGE = function (
                        ...
                        successes2 =
                            successes2 === undefined ? successes : successes2;
                    ...
                    exports.BINOM.INV = function (trials, probability, alpha) {
                        ...
                        while (x <= trials) {
                            if (
                                jStat.binomial.cdf(x, trials, probability) >=
                                alpha
                            ) {
                                return x;
                            }
                        ...
                        for (i = 0; i < args.length; i += 2) {
                            ...
                            for (var j = 0; j < range.length; j++) {
                                if (typeof range[j] !== "string") {
                                    ...
                                    results[j] =
                                        results[j] &&
                                        eval('"' + range[j] + '"' + criteria); // jshint ignore:line
                                }
                            }
                        }
                        var result = 0;
                    ...
                    exports.COUNTUNIQUE = function () {
                        return misc.UNIQUE.apply(null, utils.flatten(arguments))
                            .length;
                    };
                    ...
                    exports.F.TEST = function (array1, array2) {
                        ...
                        var sum1 =
                            sumOfSquares(array1, x1) / (array1.length - 1);
                        var sum2 =
                            sumOfSquares(array2, x2) / (array2.length - 1);
                    ...
                    exports.LOGEST = function (data_y, data_x) {
                        ...
                        result[0] =
                            Math.round(Math.exp(result[0]) * 1000000) / 1000000;
                        result[1] =
                            Math.round(Math.exp(result[1]) * 1000000) / 1000000;
                        return result;
                    };
                    ...
                    exports.MAX = function () {
                        ...
                        return range.length === 0
                            ? 0
                            : Math.max.apply(Math, range);
                    };

                    exports.MAXA = function () {
                        var range = utils.arrayValuesToNumbers(
                            utils.flatten(arguments)
                        );
                        return range.length === 0
                            ? 0
                    ...
                    exports.PERCENTRANK.EXC = function (
                        array,
                        x,
                        significance
                    ) {
                        significance =
                            significance === undefined ? 3 : significance;
                        array = utils.parseNumberArray(utils.flatten(array));
                        x = utils.parseNumber(x);
                        significance = utils.parseNumber(significance);
                    ...
                    exports.PERCENTRANK.INC = function (
                        array,
                        x,
                        significance
                    ) {
                    ...
                    exports.PERMUT = function (number, number_chosen) {
                        ...
                        return (
                            mathTrig.FACT(number) /
                            mathTrig.FACT(number - number_chosen)
                        );
                    };
                    ...
                    exports.PROB = function (range, probability, lower, upper) {
                        ...
                        range = utils.parseNumberArray(utils.flatten(range));
                        probability = utils.parseNumberArray(
                            utils.flatten(probability)
                        );
                        lower = utils.parseNumber(lower);
                        upper = utils.parseNumber(upper);
                        if (
                            utils.anyIsError(range, probability, lower, upper)
                        ) {
                            return error.value;
                        }
                    ...
                    exports.SKEW = function () {
                        ...
                        return (
                            ...
                            ((n - 1) *
                                (n - 2) *
                                Math.pow(jStat.stdev(range, true), 3))
                        );
                    };
                    ...
                    exports.T.INV["2T"] = function (probability, df) {
                        ...
                        return Math.abs(
                            jStat.studentt.inv(probability / 2, df)
                        );
                    };
                    ...
                    exports.T.TEST = function (data_x, data_y) {
                        ...
                        var t =
                            ...
                            Math.sqrt(
                                s_x / data_x.length + s_y / data_y.length
                            );

                        return exports.T.DIST["2T"](
                            t,
                            data_x.length + data_y.length - 2
                        );
                    };
                    ...
                    exports.TREND = function (data_y, data_x, new_data_x) {
                        data_y = utils.parseNumberArray(utils.flatten(data_y));
                        data_x = utils.parseNumberArray(utils.flatten(data_x));
                        new_data_x = utils.parseNumberArray(
                            utils.flatten(new_data_x)
                        );
                    ...
                    exports.TRIMMEAN = function (range, percent) {
                        ...
                        var trim =
                            mathTrig.FLOOR(range.length * percent, 2) / 2;
                        return jStat.mean(
                            utils.initial(
                                utils.rest(
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    exports.NUMBERVALUE = function (
                        ...
                        decimal_separator =
                            typeof decimal_separator === "undefined"
                                ? "."
                                : decimal_separator;
                        group_separator =
                            typeof group_separator === "undefined"
                                ? ","
                                : group_separator;
                        return Number(
                            text
                        ...
                        try {
                            ...
                            for (var i = 0; i < path.length; ++i) {
                                ...
                                if (step[step.length - 1] === "]") {
                                    ...
                                    result =
                                        result[step.substring(0, opening)][
                                            index
                                        ];
                                } else {
                                    result = result[step];
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    exports.BIN2HEX = function (number, places) {
                        ...
                        if (
                            ...
                            return (
                                1099511627264 +
                                parseInt(stringified.substring(1), 2)
                            ).toString(16);
                        }
                        ...
                        if (places === undefined) {
                            ...
                            return places >= result.length
                                ? text.REPT("0", places - result.length) +
                                      result
                                : error.num;
                        }
                    };
                    ...
                    exports.CONVERT = function (number, from_unit, to_unit) {
                        ...
                        if (from === null) {
                            ...
                            var from_unit_prefix =
                                unit_prefixes[from_unit.substring(0, 1)];
                        ...
                        // Lookup to prefix
                        if (to === null) {
                            var to_binary_prefix =
                                binary_prefixes[to_unit.substring(0, 2)];
                            var to_unit_prefix =
                                unit_prefixes[to_unit.substring(0, 1)];
                            ...
                            if (to_binary_prefix) {
                                ...
                                base_to_unit = to_unit.substring(
                                    to_unit_prefix[2].length
                                );
                            }
                    ...
                    exports.ERF = function (lower_bound, upper_bound) {
                        // Set number2 to zero if undefined
                        upper_bound =
                            upper_bound === undefined ? 0 : upper_bound;
                    ...
                    exports.HEX2BIN = function (number, places) {
                        ...
                        if (negative) {
                            return (
                                ...
                                text.REPT(
                                    "0",
                                    9 - (512 + decimal).toString(2).length
                                ) +
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    var besselj = (function () {
                        ...
                        var b0_a1b = [
                            1.0, -0.1098628627e-2, 0.2734510407e-4,
                        ...
                        var b1_a1b = [
                            1.0, 0.183105e-2, -0.3516396496e-4, 0.2457520174e-5,
                            -0.240337019e-6,
                        ].reverse();
                        var b1_a2b = [
                        ...
                        return function besselj(x, n) {
                            ...
                            if (M.abs(x) > n) {
                                ...
                                m =
                                    2 *
                                    M.floor((n + M.floor(M.sqrt(40 * n))) / 2);
                                jsum = 0;
                                bjp = ret = sum = 0.0;
                                bj = 1.0;
                                for (j = m; j > 0; j--) {
                    ...
                    var bessely = (function () {
                        ...
                        var b0_a2a = [
                            40076544269.0, 745249964.8, 7189466.438, 47447.2647,
                            226.1030244, 1.0,
                        ].reverse();
                        var b0_a1b = [
                            1.0, -0.1098628627e-2, 0.2734510407e-4,
                        ...
                        function bessel0(x) {
                            ...
                            if (x < 8) {
                                ...
                                a =
                                    M.sqrt(W / x) *
                                    (M.sin(xx) * a1 + (M.cos(xx) * a2 * 8) / x);
                            }
                            return a;
                        }

                        var b1_a1a = [
                            -0.4900604943e13, 0.127527439e13, -0.5153438139e11,
                            0.7349264551e9, -0.4237922726e7, 0.8511937935e4,
                        ].reverse();
                        var b1_a2a = [
                            0.249958057e14, 0.4244419664e12, 0.3733650367e10,
                            0.2245904002e8, 0.102042605e6, 0.3549632885e3, 1,
                        ].reverse();
                        var b1_a1b = [
                            1.0, 0.183105e-2, -0.3516396496e-4, 0.2457520174e-5,
                            -0.240337019e-6,
                    ...
                    var besseli = (function () {
                        ...
                        var b0_b = [
                            0.39894228, 0.1328592e-1, 0.225319e-2, -0.157565e-2,
                        ...
                        function bessel0(x) {
                            ...
                            return (
                                (M.exp(M.abs(x)) / M.sqrt(M.abs(x))) *
                                _horner(b0_b, 3.75 / M.abs(x))
                            );
                        }
                        ...
                        var b1_b = [
                            0.39894228, -0.3988024e-1, -0.362018e-2,
                        ...
                        function bessel1(x) {
                            if (x < 3.75)
                                return (
                                    x * _horner(b1_a, (x * x) / (3.75 * 3.75))
                                );
                            return (
                                (((x < 0 ? -1 : 1) * M.exp(M.abs(x))) /
                                    M.sqrt(M.abs(x))) *
                    ...
                    var besselk = (function () {
                        var b0_a = [
                            -0.57721566, 0.4227842, 0.23069756, 0.348859e-1,
                            0.262698e-2, 0.1075e-3, 0.74e-5,
                        ].reverse();
                        var b0_b = [
                            1.25331414, -0.7832358e-1, 0.2189568e-1,
                            -0.1062446e-1, 0.587872e-2, -0.25154e-2, 0.53208e-3,
                        ].reverse();
                        function bessel0(x) {
                            if (x <= 2)
                                return (
                                    -M.log(x / 2) * besseli(x, 0) +
                                    _horner(b0_a, (x * x) / 4)
                                );
                            return (
                                (M.exp(-x) / M.sqrt(x)) * _horner(b0_b, 2 / x)
                            );
                        }
                        ...
                        var b1_b = [
                            1.25331414, 0.23498619, -0.365562e-1, 0.1504268e-1,
                            -0.780353e-2, 0.325614e-2, -0.68245e-3,
                        ].reverse();
                        function bessel1(x) {
                            if (x <= 2)
                                return (
                                    M.log(x / 2) * besseli(x, 1) +
                                    (1 / x) * _horner(b1_a, (x * x) / 4)
                                );
                            return (
                                (M.exp(-x) / M.sqrt(x)) * _horner(b1_b, 2 / x)
                            );
                        }
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    exports.INTERVAL = function (second) {
                        ...
                        return (
                            "P" + year + month + day + "T" + hour + min + sec
                        );
                    };
                    ...
                    exports.NETWORKDAYS = function (
                        start_date,
                        end_date,
                        holidays
                    ) {
                        return this.NETWORKDAYS.INTL(
                            start_date,
                            end_date,
                            1,
                            holidays
                    ...
                    exports.NETWORKDAYS.INTL = function (
                        ...
                        var days =
                            (end_date - start_date) / (1000 * 60 * 60 * 24) + 1;
                        var total = days;
                        var day = start_date;
                        for (i = 0; i < days; i++) {
                            var d =
                    ...
                    exports.WEEKNUM = function (serial_number, return_type) {
                        ...
                        jan -=
                            Math.abs(jan.getDay() - week_start) *
                            24 *
                            60 *
                            60 *
                            1000;
                    ...
                    exports.YEARFRAC = function (start_date, end_date, basis) {
                        ...
                        switch (basis) {
                            ...
                            case 1:
                                ...
                                return (
                                    daysBetween(start_date, end_date) / average
                                );
                            case 2:
                                // Actual/360
                                ...
                                for (var j = 0; j < criterias.length; ++j) {
                                    ...
                                    for (var p = 1; p < criteria.length; ++p) {
                                        currentCriteriaResult =
                                            currentCriteriaResult ||
                                            eval(database[k][l] + criteria[p]); // jshint ignore:line
                                    }
                                }
                                if (hasMatchingCriteria) {
                                    matches[l] =
                                        matches[l] && currentCriteriaResult;
                                }
                            }
                        }
                        ...
                        if (arguments.length > 0) {
                            ...
                            if (switchCount) {
                                for (
                                    ...
                                    if (
                                        targetValue === arguments[index * 2 + 1]
                                    ) {
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    exports.ACCRINT = function (
                        ...
                        return (
                            par *
                            rate *
                            dateTime.YEARFRAC(issue, settlement, basis)
                        );
                    };
                    ...
                    exports.CUMIPMT = function (
                        ...
                        for (var i = start; i <= end; i++) {
                            if (type === 1) {
                                interest +=
                                    exports.FV(rate, i - 2, payment, value, 1) -
                                    payment;
                            } else {
                                interest += exports.FV(
                                    rate,
                    ...
                    exports.CUMPRINC = function (
                        ...
                        for (var i = start; i <= end; i++) {
                            if (type > 0) {
                                ...
                                principal +=
                                    payment -
                                    exports.FV(rate, i - 1, payment, value, 0) *
                                        rate;
                            }
                        }
                    ...
                    exports.DB = function (cost, salvage, life, period, month) {
                        ...
                        month = utils.parseNumber(month);
                        if (
                            utils.anyIsError(cost, salvage, life, period, month)
                        ) {
                            return error.value;
                        }
                        ...
                        var rate = (
                            1 - Math.pow(salvage / cost, 1 / life)
                        ).toFixed(3);
                    ...
                    exports.DOLLARDE = function (dollar, fraction) {
                        ...
                        result +=
                            ((dollar % 1) *
                                Math.pow(
                                    10,
                                    Math.ceil(Math.log(fraction) / Math.LN10)
                                )) /
                            fraction;
                    ...
                    exports.FVSCHEDULE = function (principal, schedule) {
                        ...
                        schedule = utils.parseNumberArray(
                            utils.flatten(schedule)
                        );
                    ...
                    exports.IRR = function (values, guess) {
                        ...
                        var irrResult = function (values, dates, rate) {
                            ...
                            for (var i = 1; i < values.length; i++) {
                                result +=
                                    values[i] /
                                    Math.pow(r, (dates[i] - dates[0]) / 365);
                            }
                            return result;
                        };
                        ...
                        var irrResultDeriv = function (values, dates, rate) {
                            ...
                            for (var i = 1; i < values.length; i++) {
                                ...
                                result -=
                                    (frac * values[i]) / Math.pow(r, frac + 1);
                            }
                            return result;
                        };
                        ...
                        do {
                            ...
                            newRate =
                                resultRate -
                                resultValue /
                                    irrResultDeriv(values, dates, resultRate);
                    ...
                    exports.MIRR = function (
                        ...
                        var den =
                            exports.NPV(finance_rate, payments) *
                            (1 + finance_rate);
                    ...
                    exports.PDURATION = function (rate, present, future) {
                        ...
                        // Return number of periods
                        return (
                            (Math.log(future) - Math.log(present)) /
                            Math.log(1 + rate)
                        );
                    };

                    exports.PMT = function (
                        rate,
                        periods,
                        present,
                        future,
                        ...
                        while (iter < iterMax && !close) {
                            ...
                            var f2 =
                                ...
                                (payment * (t1 - 1) * (rate * type + 1)) /
                                    Math.pow(rate, 2);
                            var f3 =
                                (periods * payment * t2 * (rate * type + 1)) /
                                    rate +
                    ...
                    exports.TBILLYIELD = function (
                        ...
                        return (
                            ((100 - price) * 360) /
                            (price *
                                dateTime.DAYS360(settlement, maturity, false))
                        );
                    };
                        ...
                        var irrResult = function (values, dates, rate) {
                            ...
                            for (var i = 1; i < values.length; i++) {
                                result +=
                                    ...
                                    Math.pow(
                                        r,
                                        dateTime.DAYS(dates[i], dates[0]) / 365
                                    );
                            }
                            return result;
                        };
