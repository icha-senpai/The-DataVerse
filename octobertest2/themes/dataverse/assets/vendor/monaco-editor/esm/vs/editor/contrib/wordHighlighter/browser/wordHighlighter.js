...
let WordHighlighter = (WordHighlighter_1 = class WordHighlighter {
    ...
    _removeSingleDecorations() {
        ...
        const currentDecorationIDs = WordHighlighter_1.storedDecorations.get(
    ...
    _removeAllDecorations() {
        ...
        for (const editor of currentEditors) {
            ...
            const currentDecorationIDs =
                WordHighlighter_1.storedDecorations.get(editor.getModel().uri);
            if (!currentDecorationIDs) {
                continue;
            }
            ...
            if (
                !(editorHighlighterContrib === null ||
                editorHighlighterContrib === void 0
                    ? void 0
                    : editorHighlighterContrib.wordHighlighter)
            ) {
                continue;
            }
            if (
        ...
        if (this.editor.hasWidgetFocus()) {
            if (
                ((_a = this.editor.getModel()) === null || _a === void 0
                    ? void 0
                    : _a.uri.scheme) !== Schemas.vscodeNotebookCell &&
                ((_c =
                    (_b = WordHighlighter_1.query) === null || _b === void 0
                        ? void 0
                        : _b.modelInfo) === null || _c === void 0
                    ? void 0
                    : _c.model.uri.scheme) !== Schemas.vscodeNotebookCell
            ) {
                ...
                if (
                    (_d = WordHighlighter_1.query) === null || _d === void 0
                        ? void 0
                        : _d.modelInfo
                ) {
    ...
    _run() {
        ...
        if (workerRequestIsValid) {
            ...
            const sendWord =
                (!WordHighlighter_1.query.modelInfo &&
                    WordHighlighter_1.query.word) ||
                ((_a = WordHighlighter_1.query.modelInfo) === null ||
                _a === void 0
                    ? void 0
                    : _a.model.uri) !== this.model.uri
                    ? true
                    : false;
            if (
                !WordHighlighter_1.query.modelInfo ||
                ...
                this.workerRequest = this.computeWithModel(
                    ...
                    sendWord ? WordHighlighter_1.query.word : null,
                    otherModelsToHighlight
                );
            } else {
                // use stored query model + selection
                this.workerRequest = this.computeWithModel(
                    WordHighlighter_1.query.modelInfo.model,
                    WordHighlighter_1.query.modelInfo.selection,
                    WordHighlighter_1.query.word,
                    otherModelsToHighlight
                );
            }
            (_b = this.workerRequest) === null || _b === void 0
                ? void 0
                : _b.result.then((data) => {
    ...
    computeWithModel(model, selection, word, otherModels) {
        if (!otherModels.length) {
            return computeOccurencesAtPosition(
                ...
                selection,
                word,
                this.editor.getOption(129 /* EditorOption.wordSeparators */)
            );
        } else {
        ...
        for (const editor of currentEditors) {
            ...
            if (uri && this.workerRequestValue.has(uri)) {
                const oldDecorationIDs =
                    WordHighlighter_1.storedDecorations.get(uri);
                ...
                editor.changeDecorations((changeAccessor) => {
                    newDecorationIDs = changeAccessor.deltaDecorations(
                        oldDecorationIDs !== null && oldDecorationIDs !== void 0
                            ? oldDecorationIDs
                            : [],
                        newDecorations
                    );
                });
                WordHighlighter_1.storedDecorations =
                    WordHighlighter_1.storedDecorations.set(
                        uri,
                        newDecorationIDs
                    );
                if (newDecorations.length > 0) {
                    (_b = editorHighlighterContrib.wordHighlighter) === null ||
                    _b === void 0
                        ? void 0
                        : _b.decorations.set(newDecorations);
                    (_c = editorHighlighterContrib.wordHighlighter) === null ||
                    _c === void 0
                        ? void 0
                        : _c._hasWordHighlights.set(true);
                }
            }
        }
    }
...
let WordHighlighterContribution =
    (WordHighlighterContribution_1 = class WordHighlighterContribution extends (
        Disposable
    ) {
        static get(editor) {
        ...
        saveViewState() {
            if (
                this._wordHighlighter &&
                this._wordHighlighter.hasDecorations()
            ) {
                return true;
            }
            return false;
        ...
        moveNext() {
            var _a;
            (_a = this._wordHighlighter) === null || _a === void 0
                ? void 0
                : _a.moveNext();
        }
        moveBack() {
