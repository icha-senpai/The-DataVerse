...
let HelpQuickAccessProvider =
    (HelpQuickAccessProvider_1 = class HelpQuickAccessProvider {
        ...
        provide(picker) {
                ...
                picker.onDidChangeValue((value) => {
                    const providerDescriptor =
                        this.registry.getQuickAccessProvider(
                            value.substr(
                                HelpQuickAccessProvider_1.PREFIX.length
                            )
                        );
                    if (
                        providerDescriptor &&
                        ...
                        providerDescriptor.prefix !==
                            HelpQuickAccessProvider_1.PREFIX
                    ) {
            ...
            picker.items = this.getQuickAccessProviders().filter(
                (p) => p.prefix !== HelpQuickAccessProvider_1.PREFIX
            );
            return disposables;
        }
