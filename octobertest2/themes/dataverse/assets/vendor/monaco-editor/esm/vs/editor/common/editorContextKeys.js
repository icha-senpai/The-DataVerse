...
(function (EditorContextKeys) {
    EditorContextKeys.editorSimpleInput = new RawContextKey(
        "editorSimpleInput",
        false,
        true
    );
    ...
    EditorContextKeys.isEmbeddedDiffEditor = new RawContextKey(
    ...
    EditorContextKeys.inMultiDiffEditor = new RawContextKey(
        "inMultiDiffEditor",
        false,
        nls.localize(
            "inMultiDiffEditor",
    ...
    EditorContextKeys.multiDiffEditorAllCollapsed = new RawContextKey(
    ...
    EditorContextKeys.hasChanges = new RawContextKey(
    ...
    EditorContextKeys.comparingMovedCode = new RawContextKey(
        "comparingMovedCode",
        false,
        nls.localize(
            "comparingMovedCode",
    ...
    EditorContextKeys.accessibleDiffViewerVisible = new RawContextKey(
    ...
    EditorContextKeys.isInWalkThroughSnippet = new RawContextKey(
        "isInEmbeddedEditor",
        false,
        true
    );
    ...
    EditorContextKeys.notInCompositeEditor =
        EditorContextKeys.inCompositeEditor.toNegated();
    // -- mode context keys
