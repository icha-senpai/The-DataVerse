...
class ViewItem {
    ...
    setVisible(visible, size) {
        ...
        try {
            (_b = (_a = this.view).setVisible) === null || _b === void 0
                ? void 0
                : _b.call(_a, visible);
        } catch (e) {
    ...
    get proportionalLayout() {
        var _a;
        return (_a = this.view.proportionalLayout) !== null && _a !== void 0
            ? _a
            : true;
    }
    get snap() {
...
export class SplitView extends Disposable {
    ...
    constructor(container, options = {}) {
        ...
        this.orientation =
            (_a = options.orientation) !== null && _a !== void 0
                ? _a
                : 0 /* Orientation.VERTICAL */;
        this.inverseAltBehavior =
            (_b = options.inverseAltBehavior) !== null && _b !== void 0
                ? _b
                : false;
        this.proportionalLayout =
            (_c = options.proportionalLayout) !== null && _c !== void 0
                ? _c
                : true;
        ...
        this.scrollableElement = this._register(
            new SmoothScrollableElement(
                this.viewContainer,
                {
                    vertical:
                        this.orientation === 0 /* Orientation.VERTICAL */
                            ? (_d = options.scrollbarVisibility) !== null &&
                              _d !== void 0
                                ? _d
                    ...
                    horizontal:
                        this.orientation === 1 /* Orientation.HORIZONTAL */
                            ? (_e = options.scrollbarVisibility) !== null &&
                              _e !== void 0
                                ? _e
                                : 1 /* ScrollbarVisibility.Auto */
                            : 2 /* ScrollbarVisibility.Hidden */,
    ...
    layout(size, layoutContext) {
        ...
        if (!this.proportions) {
            ...
            const highPriorityIndexes = indexes.filter(
                (i) =>
                    this.viewItems[i].priority === 2 /* LayoutPriority.High */
            );
            this.resize(
    ...
    resizeView(index, size) {
        ...
        try {
            ...
            const lowPriorityIndexes = [
                ...indexes.filter(
                    (i) =>
                        this.viewItems[i].priority ===
                        1 /* LayoutPriority.Low */
                ),
                index,
            ];
            const highPriorityIndexes = indexes.filter(
    ...
    dispose() {
        var _a;
        (_a = this.sashDragState) === null || _a === void 0
            ? void 0
            : _a.disposable.dispose();
