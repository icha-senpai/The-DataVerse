        ...
        this.position = derived(this, (reader) => {
            ...
            const position = new Position(
                ...
                Math.min(
                    firstColumn,
                    (_c =
                        (_b = this.sessionPosition) === null || _b === void 0
                            ? void 0
                            : _b.column) !== null && _c !== void 0
                        ? _c
                ...
                const contentWidget = store.add(
                    this.instantiationService.createInstance(
                        ...
                        model.selectedInlineCompletion.map(
                            (v) => /** @description commands */ {
                                var _a;
                                /** @description commands */ return (_a =
                                    v === null || v === void 0
                                        ? void 0
                                        : v.inlineCompletion.source
...
let InlineSuggestionHintsContentWidget =
    (InlineSuggestionHintsContentWidget_1 = class InlineSuggestionHintsContentWidget extends (
        Disposable
    ) {
                ...
                instantiationService.createInstance(
                    ...
                    MenuId.InlineSuggestionToolbar,
                    {
                        ...
                        actionViewItemProvider: (action, options) => {
                            ...
                            if (
                                action === this.availableSuggestionCountAction
                            ) {
...
let CustomizedMenuWorkbenchToolBar = class CustomizedMenuWorkbenchToolBar extends WorkbenchToolBar {
    ...
    updateToolbar() {
        ...
        createAndFillInActionBarActions(
            this.menu,
            (_a = this.options2) === null || _a === void 0
                ? void 0
                : _a.menuOptions,
            { primary, secondary },
            (_c =
                (_b = this.options2) === null || _b === void 0
                    ? void 0
                    : _b.toolbarOptions) === null || _c === void 0
                ? void 0
                : _c.primaryGroup,
            (_e =
                (_d = this.options2) === null || _d === void 0
                    ? void 0
                    : _d.toolbarOptions) === null || _e === void 0
                ? void 0
                : _e.shouldInlineSubmenu,
            (_g =
                (_f = this.options2) === null || _f === void 0
                    ? void 0
                    : _f.toolbarOptions) === null || _g === void 0
                ? void 0
