...
let SnippetController2 = (SnippetController2_1 = class SnippetController2 {
    ...
    constructor(
        ...
        this._inSnippet =
            SnippetController2_1.InSnippetMode.bindTo(contextKeyService);
        this._hasNextTabstop =
            SnippetController2_1.HasNextTabstop.bindTo(contextKeyService);
        this._hasPrevTabstop =
            SnippetController2_1.HasPrevTabstop.bindTo(contextKeyService);
    }
    dispose() {
        var _a;
    ...
    _doInsert(template, opts) {
        ...
        if (
            ...
            const disable = () => {
                registration === null || registration === void 0
                    ? void 0
    ...
    _handleChoice() {
        ...
        if (!activeChoice || !this._choiceCompletions) {
            (_a = this._choiceCompletions) === null || _a === void 0
                ? void 0
                : _a.disable();
            this._currentChoice = undefined;
            return;
