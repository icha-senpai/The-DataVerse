...
export class EditorCommand extends Command {
    ...
    static runEditorCommand(accessor, args, precondition, runner) {
        ...
        return editor.invokeWithinContext((editorAccessor) => {
            ...
            if (
                !kbService.contextMatchesRules(
                    precondition !== null && precondition !== void 0
                        ? precondition
                        : undefined
                )
            ) {
...
export class EditorAction extends EditorCommand {
    ...
    reportTelemetry(accessor, editor) {
        accessor
            ...
            .publicLog2("editorActionInvoked", {
                name: this.label,
                id: this.id,
            });
    }
    ...
    run(accessor, ...args) {
        ...
        return editor.invokeWithinContext((editorAccessor) => {
            ...
            const enabled = kbService.contextMatchesRules(
                (_a = this.desc.precondition) !== null && _a !== void 0
                    ? _a
                    : undefined
            );
            if (!enabled) {
                logService.debug(
                    ...
                    this.desc.id,
                    (_b = this.desc.precondition) === null || _b === void 0
                        ? void 0
                        : _b.serialize()
                );
                return;
