...
export class Menu extends ActionBar {
    constructor(container, actions, options, menuStyles) {
        ...
        super(menuElement, {
            ...
            triggerKeys: {
                keys: [
                    3 /* KeyCode.Enter */,
                    ...(isMacintosh || isLinux ? [10 /* KeyCode.Space */] : []),
                ],
                keyDown: true,
            },
        });
            ...
            this._register(
                addDisposableListener(menuElement, EventType.KEY_DOWN, (e) => {
                    ...
                    if (
                        ...
                        event.equals(11 /* KeyCode.PageUp */)
                    ) {
        ...
        actions = actions.filter((a, idx) => {
            var _a;
            if (
                (_a = options.submenuIds) === null || _a === void 0
                    ? void 0
                    : _a.has(a.id)
            ) {
    ...
    styleScrollElement(scrollElement, style) {
        var _a, _b;
        const fgColor =
            (_a = style.foregroundColor) !== null && _a !== void 0 ? _a : "";
        const bgColor =
            (_b = style.backgroundColor) !== null && _b !== void 0 ? _b : "";
        ...
        if (this.options.label) {
            ...
            if (label) {
                ...
                if (matches) {
                    ...
                    const replaceDoubleEscapes = (str) =>
                        str.replace(/&amp;&amp;/g, "&amp;");
                    if (escMatch) {
                        this.label.append(
                            strings.ltrim(
    ...
    applyStyle() {
        ...
        if (this.item) {
            this.item.style.color =
                fgColor !== null && fgColor !== void 0 ? fgColor : "";
...
class SubmenuMenuActionViewItem extends BaseMenuActionViewItem {
    ...
    applyStyle() {
        ...
        if (this.submenuIndicator) {
            this.submenuIndicator.style.color =
                fgColor !== null && fgColor !== void 0 ? fgColor : "";
        }
    }
    dispose() {
