    ...
    constructor(
        ...
        this._viewItems = derivedWithStore(this, (reader, store) => {
            ...
            return items.map((d) => {
                ...
                const data =
                    (_a = this._lastDocStates) === null || _a === void 0
                        ? void 0
                        : _a[item.getKey()];
                if (data) {
                    transaction((tx) => {
        ...
        this._totalHeight = this._viewItems.map(this, (items, reader) =>
            items.reduce(
                (r, i) =>
                    r + i.contentHeight.read(reader) + this._spaceBetweenPx,
                0
            )
        );
        this.activeDiffItem = derived(this, (reader) =>
            this._viewItems.read(reader).find((i) => {
                var _a;
                return (_a = i.template.read(reader)) === null || _a === void 0
                    ? void 0
                    : _a.isFocused.read(reader);
            })
        );
        this.lastActiveDiffItem = derivedObservableWithCache(
            (reader, lastValue) => {
                var _a;
                return (_a = this.activeDiffItem.read(reader)) !== null &&
                    _a !== void 0
                    ? _a
                    : lastValue;
            }
        ...
        this._register(
            autorun((reader) => {
                ...
                transaction((tx) => {
                    var _a;
                    (_a = this._viewModel.read(reader)) === null ||
                    _a === void 0
                        ? void 0
                        : _a.activeDiffItem.set(
                              lastActiveDiffItem === null ||
                                  lastActiveDiffItem === void 0
                                  ? void 0
                                  : lastActiveDiffItem.viewModel,
                              tx
                          );
                });
            })
...
MultiDiffEditorWidgetImpl = __decorate(
    [__param(4, IContextKeyService), __param(5, IInstantiationService)],
...
class VirtualizedViewItem extends Disposable {
    constructor(viewModel, _objectPool, _scrollLeft) {
        ...
        this._templateRef = this._register(
            disposableObservableValue(this, undefined)
        );
        this.contentHeight = derived(this, (reader) => {
            var _a, _b, _c;
            return (_c =
                (_b =
                    (_a = this._templateRef.read(reader)) === null ||
                    _a === void 0
                        ? void 0
                        : _a.object.contentHeight) === null || _b === void 0
                    ? void 0
                    : _b.read(reader)) !== null && _c !== void 0
                ? _c
        ...
        this.maxScroll = derived(this, (reader) => {
            var _a, _b;
            return (_b =
                (_a = this._templateRef.read(reader)) === null || _a === void 0
                    ? void 0
                    : _a.object.maxScroll.read(reader)) !== null &&
                _b !== void 0
                ? _b
                : { maxScroll: 0, scrollWidth: 0 };
        });
        this.template = derived(this, (reader) => {
            var _a;
            return (_a = this._templateRef.read(reader)) === null ||
                _a === void 0
                ? void 0
                : _a.object;
        });
        ...
        this._register(
            autorun((reader) => {
                ...
                (_a = this._templateRef.read(reader)) === null || _a === void 0
                    ? void 0
                    : _a.object.setScrollLeft(scrollLeft);
            })
        );
        this._register(
            autorun((reader) => {
    ...
    toString() {
        var _a;
        return `VirtualViewItem(${
            (_a = this.viewModel.entry.value.modified) === null || _a === void 0
                ? void 0
                : _a.uri.toString()
        })`;
    }
    ...
    setViewState(viewState, tx) {
        ...
        const selections =
            (_a = viewState.selections) === null || _a === void 0
                ? void 0
                : _a.map(Selection.liftSelection);
        ...
        this.viewModel.lastTemplateData.set(
            {
                ...
                selections:
                    (_a = ref.object.editor.getSelections()) !== null &&
                    _a !== void 0
                        ? _a
                        : undefined,
            },
