...
let InlineCompletionsSource = class InlineCompletionsSource extends Disposable {
    constructor(
        ...
        this.inlineCompletions = disposableObservableValue(
            "inlineCompletions",
            undefined
        );
    ...
    fetch(position, context, activeInlineCompletion) {
        ...
        if (
            (_a = this._updateOperation.value) === null || _a === void 0
                ? void 0
                : _a.request.satisfies(request)
        ) {
            return this._updateOperation.value.promise;
        } else if (
            (_b = target.get()) === null || _b === void 0
                ? void 0
                : _b.request.satisfies(request)
        ) {
...
export class InlineCompletionWithUpdatedRange {
    get forwardStable() {
        ...
        return (_a =
            this.inlineCompletion.source.inlineCompletions
                .enableForwardStability) !== null && _a !== void 0
            ? _a
            : false;
    }
    constructor(inlineCompletion, decorationId, rangeVersion, initialRange) {
        ...
        this._isValid = true;
        this._updatedRange =
            initialRange !== null && initialRange !== void 0
                ? initialRange
