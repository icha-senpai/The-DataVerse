...
let InlineCompletionsHoverParticipant = class InlineCompletionsHoverParticipant {
    ...
    computeSync(anchor, lineDecorations) {
        if (
            this._editor.getOption(62 /* EditorOption.inlineSuggest */)
                .showToolbar !== "onHover"
        ) {
            return [];
        }
            ...
            model.selectedInlineCompletion.map(
                (v) => /** @description commands */ {
                    ...
                    /** @description commands */ return (_a =
                        v === null || v === void 0
                            ? void 0
                            : v.inlineCompletion.source.inlineCompletions
                                  .commands) !== null && _a !== void 0
                        ? _a
                        : [];
                }
            )
    ...
    renderScreenReaderText(context, part, disposableStore) {
        ...
        disposableStore.add(
            autorun((reader) => {
                ...
                const ghostText =
                    (_a = part.controller.model.read(reader)) === null ||
                    _a === void 0
                        ? void 0
