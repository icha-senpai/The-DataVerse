...
let DiffEditorItemTemplate = class DiffEditorItemTemplate extends Disposable {
    constructor(
        ...
        this._collapsed = derived(this, (reader) => {
            var _a;
            return (_a = this._viewModel.read(reader)) === null || _a === void 0
                ? void 0
                : _a.collapsed.read(reader);
        });
        ...
        this._resourceLabel = this._workbenchUIElementFactory
            .createResourceLabel
            ? this._register(
            ...
            : undefined;
        this._resourceLabel2 = this._workbenchUIElementFactory
            .createResourceLabel
            ? this._register(
                  this._workbenchUIElementFactory.createResourceLabel(
        ...
        this._register(
            btn.onDidClick(() => {
                var _a;
                (_a = this._viewModel.get()) === null || _a === void 0
                    ? void 0
                    : _a.collapsed.set(!this._collapsed.get(), undefined);
            })
        );
        this._register(
            autorun((reader) => {
                ...
                MenuId.MultiDiffEditorFileToolbar,
                {
                    actionRunner: this._register(
                        new ActionRunnerWithContext(() => {
                            var _a;
                            return (_a = this._viewModel.get()) === null ||
                                _a === void 0
                                ? void 0
                                : _a.modifiedUri;
                        })
    ...
    setData(data) {
            ...
            this._dataStore.add(
                value.onOptionsDidChange(() => {
                    ...
                    this.editor.updateOptions(
                        updateOptions(
                            (_a = value.options) !== null && _a !== void 0
                                ? _a
                                : {}
                        )
                    );
        ...
        globalTransaction((tx) => {
            var _a, _b, _c, _d;
            (_a = this._resourceLabel) === null || _a === void 0
                ? void 0
                : _a.setUri(
                      (_b = data.viewModel.modifiedUri) !== null &&
                          _b !== void 0
                          ? _b
                          : data.viewModel.originalUri,
                      {
                          strikethrough:
                              data.viewModel.modifiedUri === undefined,
                      }
                  );
            let isRenamed = false;
            let isDeleted = false;
            ...
            (_c = this._resourceLabel2) === null || _c === void 0
                ? void 0
                : _c.setUri(
            ...
            this.editor.updateOptions(
                updateOptions(
                    (_d = value.options) !== null && _d !== void 0 ? _d : {}
                )
            );
        });
    }
