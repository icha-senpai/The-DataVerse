...
export class ViewModelLinesFromProjectedModel {
    ...
    getHiddenAreas() {
        return this.hiddenAreasDecorationIds.map((decId) =>
            this.model.getDecorationRange(decId)
        );
    }
    ...
    getViewLinesIndentGuides(viewStartLineNumber, viewEndLineNumber) {
        ...
        for (let i = 0, len = result.length; i < len; i++) {
            ...
            if (option === 2 /* IndentGuideRepeatOption.BlockAll */) {
                ...
                option === 1 /* IndentGuideRepeatOption.BlockSubsequent */
            ) {
                blockAtIndex = 1;
            } else {
                blockAtIndex = count;
