...
export class MultiDiffEditorViewModel extends Disposable {
    ...
    constructor(model, _instantiationService) {
        ...
        this._documents = observableFromEvent(
...
let DocumentDiffItemViewModel = class DocumentDiffItemViewModel extends Disposable {
    get originalUri() {
        var _a;
        return (_a = this.entry.value.original) === null || _a === void 0
            ? void 0
            : _a.uri;
    }
    get modifiedUri() {
        var _a;
        return (_a = this.entry.value.modified) === null || _a === void 0
            ? void 0
            : _a.uri;
    }
    constructor(entry, _instantiationService, _modelService) {
        ...
        const originalTextModel =
            (_a = this.entry.value.original) !== null && _a !== void 0
                ? _a
                : this._register(this._modelService.createModel("", null));
        const modifiedTextModel =
            (_b = this.entry.value.modified) !== null && _b !== void 0
                ? _b
                : this._register(this._modelService.createModel("", null));
    ...
    getKey() {
        ...
        return JSON.stringify([
            (_a = this.originalUri) === null || _a === void 0
                ? void 0
                : _a.toString(),
            (_b = this.modifiedUri) === null || _b === void 0
                ? void 0
                : _b.toString(),
        ]);
    }
...
DocumentDiffItemViewModel = __decorate(
    [__param(1, IInstantiationService), __param(2, IModelService)],
    DocumentDiffItemViewModel
);
