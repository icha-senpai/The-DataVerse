...
export class StickyScrollWidget extends Disposable {
    ...
    _renderChildNode(index, line, foldingModel, layoutInfo) {
        ...
        if (
            ...
            (lineNumberOption.renderType ===
                3 /* RenderLineNumbersType.Interval */ &&
                line % 10 === 0)
        ) {
    ...
    _updateTopAndZIndexOfStickyLine(stickyLine) {
        ...
        const lastLineTop = `${
            ...
            this._lastLineRelativePosition +
            ((
                (_a = stickyLine.foldingIcon) === null || _a === void 0
                    ? void 0
                    : _a.isCollapsed
            )
                ? 1
    ...
    getLineNumberFromChildDomNode(domNode) {
        var _a, _b;
        return (_b =
            (_a = this._getRenderedStickyLineFromChildDomNode(domNode)) ===
                null || _a === void 0
                ? void 0
                : _a.lineNumber) !== null && _b !== void 0
            ? _b
            : null;
    }
