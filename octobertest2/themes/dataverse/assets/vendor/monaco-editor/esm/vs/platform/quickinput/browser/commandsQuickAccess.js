...
let AbstractCommandsQuickAccessProvider =
    (AbstractCommandsQuickAccessProvider_1 = class AbstractCommandsQuickAccessProvider extends (
        ...
        async _getPicks(filter, _disposables, token, runOptions) {
            ...
            const runTfidf = createSingleCallFunction(() => {
                ...
                return normalizeTfIdfScores(result)
                    .filter(
                        (score) =>
                            score.score >
                            AbstractCommandsQuickAccessProvider_1.TFIDF_THRESHOLD
                    )
                    .slice(
                        0,
                        AbstractCommandsQuickAccessProvider_1.TFIDF_MAX_RESULTS
                    );
            });
            // Filter
            ...
            for (const commandPick of allCommandPicks) {
                const labelHighlights =
                    (_a = AbstractCommandsQuickAccessProvider_1.WORD_FILTER(
                        filter,
                        commandPick.label
                    )) !== null && _a !== void 0
                        ? _a
                ...
                const aliasHighlights = commandPick.commandAlias
                    ? (_b = AbstractCommandsQuickAccessProvider_1.WORD_FILTER(
                          filter,
            ...
            filteredCommandPicks.sort((commandPickA, commandPickB) => {
                ...
                if (commandPickA.tfIdfScore && commandPickB.tfIdfScore) {
                    if (commandPickA.tfIdfScore === commandPickB.tfIdfScore) {
                        return commandPickA.label.localeCompare(
                            commandPickB.label
                        ); // prefer lexicographically smaller command
                    }
                ...
                if (this.options.suggestedCommandIds) {
                    const commandASuggestion =
                        this.options.suggestedCommandIds.has(
                            commandPickA.commandId
                        );
                    const commandBSuggestion =
                        this.options.suggestedCommandIds.has(
                            commandPickB.commandId
                        );
            ...
            for (let i = 0; i < filteredCommandPicks.length; i++) {
                ...
                if (
                    ...
                    commandPick.tfIdfScore === undefined &&
                    !this.commandsHistory.peek(commandPick.commandId) &&
                    ((_c = this.options.suggestedCommandIds) === null ||
                    _c === void 0
                        ? void 0
                        : _c.has(commandPick.commandId))
                ) {
                    commandPicks.push({
                        type: "separator",
                ...
                if (
                    ...
                    commandPick.tfIdfScore === undefined &&
                    !this.commandsHistory.peek(commandPick.commandId) &&
                    !((_d = this.options.suggestedCommandIds) === null ||
                    _d === void 0
                        ? void 0
                        : _d.has(commandPick.commandId))
                ) {
                    commandPicks.push({
                        type: "separator",
            ...
            return {
                ...
                additionalPicks: (async () => {
                    ...
                    const commandPicks = additionalCommandPicks.map(
                        (commandPick) =>
                    ...
                    if (
                        addSuggestedSeparator &&
                        ((_a = commandPicks[0]) === null || _a === void 0
                            ? void 0
                            : _a.type) !== "separator"
                    ) {
                ...
                accept: async () => {
                    ...
                    this.telemetryService.publicLog2(
                        "workbenchActionExecuted",
                        {
                            ...
                            from:
                                (_a =
                                    runOptions === null || runOptions === void 0
                                        ? void 0
                                        : runOptions.from) !== null &&
                                _a !== void 0
                                    ? _a
                                    : "quick open",
                        }
                    ...
                    try {
                        (
                            (_b = commandPick.args) === null || _b === void 0
                                ? void 0
                                : _b.length
                        )
...
AbstractCommandsQuickAccessProvider = AbstractCommandsQuickAccessProvider_1 =
    __decorate(
        [
...
let CommandsHistory = (CommandsHistory_1 = class CommandsHistory extends (
    Disposable
) {
    ...
    updateConfiguration(e) {
        ...
        this.configuredCommandsHistoryLength =
            CommandsHistory_1.getConfiguredCommandHistoryLength(
                this.configurationService
            );
        if (
            CommandsHistory_1.cache &&
            CommandsHistory_1.cache.limit !==
                this.configuredCommandsHistoryLength
        ) {
            CommandsHistory_1.cache.limit =
                this.configuredCommandsHistoryLength;
    ...
    load() {
        ...
        const cache = (CommandsHistory_1.cache = new LRUCache(
            this.configuredCommandsHistoryLength,
            1
        ));
        if (serializedCache) {
        ...
        CommandsHistory_1.counter = this.storageService.getNumber(
    ...
    peek(commandId) {
        var _a;
        return (_a = CommandsHistory_1.cache) === null || _a === void 0
            ? void 0
            : _a.peek(commandId);
    }
    saveState() {
        ...
        CommandsHistory_1.cache.forEach((value, key) =>
    ...
    static getConfiguredCommandHistoryLength(configurationService) {
        ...
        const configuredCommandHistoryLength =
            (_b =
                (_a = config.workbench) === null || _a === void 0
                    ? void 0
                    : _a.commandPalette) === null || _b === void 0
                ? void 0
                : _b.history;
