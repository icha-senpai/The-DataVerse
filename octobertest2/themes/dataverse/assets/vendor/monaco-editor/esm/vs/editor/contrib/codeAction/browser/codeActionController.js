...
let CodeActionController =
    (CodeActionController_1 = class CodeActionController extends Disposable {
        static get(editor) {
        ...
        constructor(
            ...
            this._register(
                this._model.onDidChangeState((newState) =>
        ...
        async update(newState) {
            ...
            if (newState.type !== 1 /* CodeActionsState.Type.Triggered */) {
                (_a = this._lightBulbWidget.rawValue) === null || _a === void 0
                    ? void 0
                    : _a.hide();
                return;
            }
            ...
            if (
                newState.trigger.type === 1 /* CodeActionTriggerType.Invoke */
            ) {
                if (
                    (_c = newState.trigger.filter) === null || _c === void 0
                        ? void 0
                        : _c.include
                ) {
                    ...
                    if (validActionToApply) {
                        try {
                            (_d = this._lightBulbWidget.value) === null ||
                            _d === void 0
                                ? void 0
                                : _d.hide();
                            await this._applyCodeAction(
                    ...
                    if (newState.trigger.context) {
                        ...
                        if (invalidAction && invalidAction.action.disabled) {
                            (_e = MessageController.get(this._editor)) ===
                                null || _e === void 0
                                ? void 0
                                : _e.showMessage(
                ...
                const includeDisabledActions = !!((_f =
                    newState.trigger.filter) === null || _f === void 0
                    ? void 0
                    : _f.include);
                if (newState.trigger.context) {
                    if (
                        ...
                        (_g = MessageController.get(this._editor)) === null ||
                        _g === void 0
                            ? void 0
                            : _g.showMessage(
                ...
                this._activeCodeActions.value = actions;
                this.showCodeActionList(
                    actions,
                    this.toCoords(newState.position),
                    { includeDisabledActions, fromLightbulb: false }
                );
            } else {
        ...
        async showCodeActionList(actions, at, options) {
            ...
            const delegate = {
                ...
                onHide: () => {
                    var _a;
                    (_a = this._editor) === null || _a === void 0
                        ? void 0
                        : _a.focus();
                    currentDecorations.clear();
                },
                onHover: async (action, token) => {
                    ...
                    return {
                        canPreview: !!((_a = action.action.edit) === null ||
                        _a === void 0
                            ? void 0
                            : _a.edits.length),
                    };
                    ...
                    if (action && action.action) {
                        ...
                        if (ranges && ranges.length > 0) {
                            ...
                            if (
                                ...
                                const selectionText =
                                    (_b =
                                        (_a = this._editor.getModel()) ===
                                            null || _a === void 0
                                            ? void 0
                                            : _a.getWordAtPosition({
                                                  lineNumber:
                                                      diagnostic.startLineNumber,
        ...
        toCoords(position) {
            ...
            const cursorCoords =
                this._editor.getScrolledVisiblePosition(position);
            const editorCoords = getDomNodePagePosition(
        ...
        _getActionBarActions(actions, at, options) {
            ...
            const resultActions = actions.documentation.map((command) => {
                ...
                return {
                    ...
                    label: command.title,
                    tooltip:
                        (_a = command.tooltip) !== null && _a !== void 0
                            ? _a
                            : "",
                    class: undefined,
                    enabled: true,
