...
let DiffEditorViewModel = class DiffEditorViewModel extends Disposable {
    ...
    constructor(model, _options, _diffProviderFactoryService) {
        ...
        this.unchangedRegions = derived(this, (r) => {
            ...
            if (this._options.hideUnchangedRegions.read(r)) {
                return (_b =
                    (_a = this._unchangedRegions.read(r)) === null ||
                    _a === void 0
                        ? void 0
                        : _a.regions) !== null && _b !== void 0
                    ? _b
                    : [];
            } else {
                // Reset state
                transaction((tx) => {
                    var _a;
                    for (const r of ((_a = this._unchangedRegions.get()) ===
                        null || _a === void 0
                        ? void 0
                        : _a.regions) || []) {
                        r.collapseAll(tx);
        ...
        this.activeMovedText = derived(this, (r) => {
            var _a, _b;
            return (_b =
                (_a = this.movedTextToCompare.read(r)) !== null && _a !== void 0
                    ? _a
                    : this._hoveredMovedText.read(r)) !== null && _b !== void 0
                ? _b
        ...
        const updateUnchangedRegions = (result, tx, reader) => {
            ...
            const originalDecorationIds = model.original.deltaDecorations(
                (lastUnchangedRegions === null ||
                lastUnchangedRegions === void 0
                    ? void 0
                    : lastUnchangedRegions.originalDecorationIds) || [],
    ...
    ensureModifiedLineIsVisible(lineNumber, preference, tx) {
        var _a, _b;
        if (
            ((_a = this.diff.get()) === null || _a === void 0
                ? void 0
                : _a.mappings.length) === 0
        ) {
            return;
        }
        const unchangedRegions =
            ((_b = this._unchangedRegions.get()) === null || _b === void 0
                ? void 0
                : _b.regions) || [];
    ...
    restoreSerializedState(state) {
        var _a;
        const ranges =
            (_a = state.collapsedRegions) === null || _a === void 0
                ? void 0
                : _a.map((r) => LineRange.deserialize(r.range));
        const regions = this._unchangedRegions.get();
        if (!regions || !ranges) {
            return;
        }
...
export class UnchangedRegion {
    ...
    showModifiedLine(lineNumber, preference, tx) {
        ...
        const bottom =
            ...
            lineNumber;
        if (
            (preference === 0 /* RevealPreference.FromCloserSide */ &&
                top < bottom) ||
