...
} from "../markdownRenderer/browser/markdownRenderer.js";
...
let HoverWidget = class HoverWidget extends Widget {
    ...
    get anchor() {
        return this._hoverPosition === 2 /* HoverPosition.BELOW */
            ? 0 /* AnchorPosition.BELOW */
            : 1 /* AnchorPosition.ABOVE */;
    }
    get x() {
        return this._x;
    }
    ...
    constructor(
        ...
        this._hoverPointer = (
            (_a = options.appearance) === null || _a === void 0
                ? void 0
                : _a.showPointer
        )
        ...
        if (
            (_b = options.appearance) === null || _b === void 0
                ? void 0
                : _b.compact
        ) {
        ...
        if (
            (_c = options.appearance) === null || _c === void 0
                ? void 0
                : _c.skipFadeInAnimation
        ) {
        ...
        if (
            (_d = options.position) === null || _d === void 0
                ? void 0
                : _d.forcePosition
        ) {
        ...
        this._hoverPosition =
            (_f =
                (_e = options.position) === null || _e === void 0
                    ? void 0
                    : _e.hoverPosition) !== null && _f !== void 0
                ? _f
        ...
        if (options.actions && options.actions.length > 0) {
            ...
            if (
                ((_g = options.persistence) === null || _g === void 0
                    ? void 0
                    : _g.hideOnHover) === undefined
            ) {
        ...
        if (
            hideOnHover &&
            ((_h = options.appearance) === null || _h === void 0
                ? void 0
                : _h.showHoverHint)
        ) {
            const statusBarElement = $("div.hover-row.status-bar");
    ...
    render(container) {
        ...
        const accessibleViewHint =
            ...
            getHoverAccessibleViewHint(
                ...
                (_a = this._keybindingService.lookupKeybinding(
        ...
        if (this._hoverPointer) {
            switch (this._hoverPosition) {
                case 1 /* HoverPosition.RIGHT */:
                    ...
                    this._hoverContainer.style.paddingLeft = `${
                        3 /* Constants.PointerSize */
                    }px`;
                    this._hoverContainer.style.marginLeft = `${
                        -3 /* Constants.PointerSize */
                    }px`;
                    break;
                case 0 /* HoverPosition.LEFT */:
                    ...
                    this._hoverContainer.style.marginRight = `${
                        -3 /* Constants.PointerSize */
                    }px`;
                    break;
                case 2 /* HoverPosition.BELOW */:
                    ...
                    this._hoverContainer.style.paddingTop = `${
                        3 /* Constants.PointerSize */
                    }px`;
                    this._hoverContainer.style.marginTop = `${
                        -3 /* Constants.PointerSize */
                    }px`;
                    break;
                case 3 /* HoverPosition.ABOVE */:
                    targetRect.top -= 3 /* Constants.PointerSize */;
                    targetRect.bottom -= 3 /* Constants.PointerSize */;
                    this._hoverContainer.style.paddingBottom = `${
                        3 /* Constants.PointerSize */
                    }px`;
                    this._hoverContainer.style.marginBottom = `${
                        -3 /* Constants.PointerSize */
                    }px`;
                    break;
            }
        ...
        if (this._target.x !== undefined) {
            ...
            if (
                ...
                this._x = Math.max(
                    this._targetDocumentElement.clientWidth -
                        hoverWidth -
                        2 /* Constants.HoverWindowEdgeMargin */,
    ...
    adjustHorizontalHoverPosition(target) {
        ...
        if (this._forcePosition) {
            const padding =
                (this._hoverPointer ? 3 /* Constants.PointerSize */ : 0) +
                2; /* Constants.HoverBorderWidth */
        ...
        switch (this._hoverPosition) {
            ...
            case 2 /* HoverPosition.BELOW */: {
                ...
                let pointerLeftPosition =
                    Math.round(hoverWidth / 2) - 3; /* Constants.PointerSize */
