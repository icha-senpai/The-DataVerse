...
const $ = dom.$;
let ContentHoverController =
    (ContentHoverController_1 = class ContentHoverController extends (
        Disposable
    ) {
        constructor(_editor, _instantiationService, _keybindingService) {
            ...
            this._participants.sort(
                (p1, p2) => p1.hoverOrdinal - p2.hoverOrdinal
            );
        ...
        _renderMessages(anchor, messages) {
            const { showAtPosition, showAtSecondaryPosition, highlightRange } =
                ContentHoverController_1.computeHoverRanges(
                    this._editor,
                    anchor.range,
                    messages
                );
                    ...
                    highlightDecoration.set([
                        {
                            ...
                            options:
                                ContentHoverController_1._DECORATION_OPTIONS,
                        },
                    ]);
                    disposables.add(
                        toDisposable(() => {
...
let ContentHoverWidget =
    (ContentHoverWidget_1 = class ContentHoverWidget extends (
        ResizableContentWidget
    ) {
        get isColorPickerVisible() {
            var _a;
            return Boolean(
                (_a = this._visibleData) === null || _a === void 0
                    ? void 0
                    : _a.colorPicker
            );
        }
        get isVisibleFromKeyboard() {
            ...
            return (
                ((_a = this._visibleData) === null || _a === void 0
                    ? void 0
                    : _a.source) === 1 /* HoverStartSource.Keyboard */
            );
        }
        get isVisible() {
            var _a;
            return (_a = this._hoverVisibleKey.get()) !== null && _a !== void 0
                ? _a
                : false;
        }
        get isFocused() {
            var _a;
            return (_a = this._hoverFocusedKey.get()) !== null && _a !== void 0
                ? _a
                : false;
        }
        constructor(
            ...
            const minimumHeight =
                editor.getOption(66 /* EditorOption.lineHeight */) + 8;
        ...
        _setContentsDomNodeDimensions(width, height) {
            ...
            return ContentHoverWidget_1._applyDimensions(
                contentsDomNode,
                width,
                height
            );
        ...
        _setHoverWidgetMaxDimensions(width, height) {
            ContentHoverWidget_1._applyMaxDimensions(
        ...
        _hasHorizontalScrollbar() {
            const scrollDimensions =
                this._hover.scrollbar.getScrollDimensions();
        ...
        _updateResizableNodeMaxDimensions() {
            ...
            const maxRenderingWidth =
                (_a = this._findMaximumRenderingWidth()) !== null &&
                _a !== void 0
                    ? _a
                    : Infinity;
            const maxRenderingHeight =
                (_b = this._findMaximumRenderingHeight()) !== null &&
                _b !== void 0
                    ? _b
                    : Infinity;
        ...
        _resize(size) {
            var _a, _b;
            ContentHoverWidget_1._lastDimensions = new dom.Dimension(
                size.width,
                size.height
            );
        ...
        _updateMaxDimensions() {
            const height = Math.max(
                ...
                250,
                ContentHoverWidget_1._lastDimensions.height
            );
            const width = Math.max(
                this._editor.getLayoutInfo().width * 0.66,
                500,
                ContentHoverWidget_1._lastDimensions.width
            );
        ...
        getPosition() {
            ...
            return {
                ...
                positionAffinity: this._visibleData.isBeforeContent
                    ...
                    : undefined,
                preference: [
                    (_a = this._positionPreference) !== null && _a !== void 0
                        ? _a
                        : 1 /* ContentWidgetPositionPreference.ABOVE */,
                ],
            };
        ...
        showAt(node, hoverData) {
            ...
            this._positionPreference =
                (_a = this._findPositionPreference(
                    widgetHeight,
                    widgetPosition
                )) !== null && _a !== void 0
                    ? _a
            ...
            (_b = hoverData.colorPicker) === null || _b === void 0
                ? void 0
                : _b.layout();
            ...
            const accessibleViewHint =
                ...
                getHoverAccessibleViewHint(
                    ...
                    (_d =
                        (_c = this._keybindingService.lookupKeybinding(
                            "editor.action.accessibleView"
                        )) === null || _c === void 0
                            ? void 0
                            : _c.getAriaLabel()) !== null && _d !== void 0
                        ? _d
                        : ""
                );
        ...
        _adjustHoverHeightForScrollbar(height) {
            ...
            const contentsDomNode = this._hover.contentsDomNode;
            const maxRenderingHeight =
                (_a = this._findMaximumRenderingHeight()) !== null &&
                _a !== void 0
                    ? _a
                    : Infinity;
        ...
        scrollUp() {
            const scrollTop =
                this._hover.scrollbar.getScrollPosition().scrollTop;
        ...
        scrollLeft() {
            const scrollLeft =
                this._hover.scrollbar.getScrollPosition().scrollLeft;
            this._hover.scrollbar.setScrollPosition({
        ...
        pageUp() {
            const scrollTop =
                this._hover.scrollbar.getScrollPosition().scrollTop;
            const scrollHeight =
                this._hover.scrollbar.getScrollDimensions().height;
            this._hover.scrollbar.setScrollPosition({
        ...
        goToBottom() {
            this._hover.scrollbar.setScrollPosition({
                scrollTop:
                    this._hover.scrollbar.getScrollDimensions().scrollHeight,
            });
        }
    });
