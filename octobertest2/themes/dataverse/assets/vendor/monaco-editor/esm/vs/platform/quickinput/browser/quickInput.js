            ...
            const concreteToggles =
                (_b =
                    (_a = this.toggles) === null || _a === void 0
                        ? void 0
                        : _a.filter((opts) => opts instanceof Toggle)) !==
                    null && _b !== void 0
                    ? _b
                    : [];
...
export class QuickPick extends QuickInput {
    constructor() {
        ...
        this.onDidTriggerSeparatorButton =
            this.onDidTriggerSeparatorButtonEmitter.event;
    }
    get quickNavigate() {
        ...
        if (!this.visible) {
            ...
            this.visibleDisposables.add(
                this.ui.list.onButtonTriggered((event) =>
                    this.onDidTriggerItemButtonEmitter.fire(event)
                )
            );
            this.visibleDisposables.add(
    ...
    update() {
        ...
        if (this.ui.list.ariaLabel !== ariaLabel) {
            this.ui.list.ariaLabel =
                ariaLabel !== null && ariaLabel !== void 0 ? ariaLabel : null;
        }
...
QuickPick.DEFAULT_ARIA_LABEL = localize(
    ...
    showHover(options, focus) {
        ...
        const showHoverHint =
            (options.content instanceof HTMLElement
                ? (_a = options.content.textContent) !== null && _a !== void 0
                    ? _a
                    : ""
