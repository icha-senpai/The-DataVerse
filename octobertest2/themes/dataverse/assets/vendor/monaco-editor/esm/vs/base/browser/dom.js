...
export const {
    ...
    return {
        ...
        getWindow(e) {
            ...
            if (
                (_a =
                    candidateNode === null || candidateNode === void 0
                        ? void 0
                        : candidateNode.ownerDocument) === null || _a === void 0
                    ? void 0
                    : _a.defaultView
            ) {
            ...
            if (
                candidateEvent === null || candidateEvent === void 0
                    ? void 0
                    : candidateEvent.view
            ) {
...
export const addStandardDisposableListener =
...
export const addStandardDisposableGenericMouseDownListener =
    function addStandardDisposableListener(node, handler, useCapture) {
...
export class WindowIntervalTimer extends IntervalTimer {
    ...
    cancelAndSet(runner, interval, targetWindow) {
        return super.cancelAndSet(
            runner,
            interval,
            targetWindow !== null && targetWindow !== void 0
                ? targetWindow
                : this.defaultTarget
        );
    }
...
(function () {
    ...
    const animationFrameRunner = (targetWindowId) => {
        ...
        const currentQueue =
            (_a = NEXT_QUEUE.get(targetWindowId)) !== null && _a !== void 0
                ? _a
                : [];
...
export function getClientArea(element, fallback) {
    ...
    if (
        platform.isIOS &&
        (elWindow === null || elWindow === void 0
            ? void 0
            : elWindow.visualViewport)
    ) {
...
export function isAncestor(testChild, testAncestor) {
    return Boolean(
        testAncestor === null || testAncestor === void 0
            ? void 0
            : testAncestor.contains(testChild)
    );
}
...
export function getShadowRoot(domNode) {
    ...
    while (domNode.parentNode) {
        if (
            domNode ===
            ((_a = domNode.ownerDocument) === null || _a === void 0
                ? void 0
                : _a.body)
        ) {
            // reached the body
...
export function getActiveDocument() {
    ...
    return (_a = documents.find((doc) => doc.hasFocus())) !== null &&
        _a !== void 0
        ? _a
        : mainWindow.document;
}
...
export function getActiveWindow() {
    ...
    return (_b =
        (_a = document.defaultView) === null || _a === void 0
            ? void 0
...
export function createStyleSheet(
    container = mainWindow.document.head,
    beforeAppend,
    disposableStore
) {
    ...
    style.type = "text/css";
    style.media = "screen";
    beforeAppend === null || beforeAppend === void 0
        ? void 0
        : beforeAppend(style);
    ...
    if (container === mainWindow.document.head) {
        ...
        for (const { window: targetWindow, disposables } of getWindows()) {
            ...
            disposableStore === null || disposableStore === void 0
                ? void 0
...
function cloneGlobalStyleSheet(
    ...
    for (const rule of getDynamicStyleSheetRules(globalStylesheet)) {
        (_a = clone.sheet) === null || _a === void 0
            ? void 0
            : _a.insertRule(
                  rule.cssText,
                  (_b = clone.sheet) === null || _b === void 0
                      ? void 0
                      : _b.cssRules.length
              );
    }
            ...
            disposables.add(
                toDisposable(() => {
                    ...
                    if (resolvedMutationObserverPerOptions.users === 0) {
                        onDidMutate.dispose();
                        observer.disconnect();
                        mutationObserversPerTarget === null ||
                        mutationObserversPerTarget === void 0
                            ? void 0
                        ...
                        if (
                            ...
                            mutationObserversPerTarget === void 0
                                ? void 0
                                : mutationObserversPerTarget.size) === 0
                        ) {
...
function getDynamicStyleSheetRules(style) {
    var _a, _b;
    if (
        (_a = style === null || style === void 0 ? void 0 : style.sheet) ===
            null || _a === void 0
            ? void 0
            : _a.rules
    ) {
    ...
    if (
        (_b = style === null || style === void 0 ? void 0 : style.sheet) ===
            null || _b === void 0
            ? void 0
            : _b.cssRules
    ) {
...
export function createCSSRule(
    ...
    (_a = style.sheet) === null || _a === void 0
        ? void 0
        : _a.insertRule(`${selector} {${cssText}}`, 0);
    // Apply rule also to all cloned global stylesheets
    for (const clonedGlobalStylesheet of (_b = globalStylesheets.get(style)) !==
        null && _b !== void 0
        ? _b
        : []) {
    ...
    registerListeners() {
        if (this.callbacks.onDragStart) {
            this._register(
                addDisposableListener(
                    ...
                    (e) => {
                        var _a, _b;
                        (_b = (_a = this.callbacks).onDragStart) === null ||
                        _b === void 0
                            ? void 0
                            : _b.call(_a, e);
                    }
        ...
        if (this.callbacks.onDrag) {
            this._register(
                addDisposableListener(this.element, EventType.DRAG, (e) => {
                    var _a, _b;
                    (_b = (_a = this.callbacks).onDrag) === null ||
                    _b === void 0
                        ? void 0
                        : _b.call(_a, e);
                })
        ...
        this._register(
            addDisposableListener(this.element, EventType.DRAG_ENTER, (e) => {
                ...
                (_b = (_a = this.callbacks).onDragEnter) === null ||
                _b === void 0
                    ? void 0
                    : _b.call(_a, e);
            })
        ...
        this._register(
            addDisposableListener(this.element, EventType.DRAG_OVER, (e) => {
                ...
                (_b = (_a = this.callbacks).onDragOver) === null ||
                _b === void 0
                    ? void 0
        ...
        this._register(
            addDisposableListener(this.element, EventType.DRAG_LEAVE, (e) => {
                ...
                if (this.counter === 0) {
                    this.dragStartTime = 0;
                    (_b = (_a = this.callbacks).onDragLeave) === null ||
                    _b === void 0
                        ? void 0
                        : _b.call(_a, e);
                }
        ...
        this._register(
            addDisposableListener(this.element, EventType.DRAG_END, (e) => {
                ...
                this.counter = 0;
                this.dragStartTime = 0;
                (_b = (_a = this.callbacks).onDragEnd) === null || _b === void 0
                    ? void 0
                    : _b.call(_a, e);
            })
        );
        this._register(
            addDisposableListener(this.element, EventType.DROP, (e) => {
                ...
                this.counter = 0;
                this.dragStartTime = 0;
                (_b = (_a = this.callbacks).onDrop) === null || _b === void 0
                    ? void 0
                    : _b.call(_a, e);
            })
        );
