    ...
    (function () {
                ...
                if (s.node === node && !s.inverted) {
                    ...
                    if (
                        ...
                        var propertyNameCompletionItem = function (
                            ...
                            if (
                                schemaPropertyNames_1.suggestSortText !== void 0
                            ) {
                                proposal.sortText =
                                ...
                                if (
                                    ...
                                    i <
                                        schemaPropertyNames_1
                                            .markdownEnumDescriptions.length
                                ) {
            ...
            if (Array.isArray(schema.defaultSnippets)) {
                schema.defaultSnippets.forEach(function (s) {
                    ...
                    collector.add({
                        ...
                        label,
                        documentation:
                            _this.fromMarkup(s.markdownDescription) ||
                            s.description,
                        insertText,
                        insertTextFormat: InsertTextFormat.Snippet,
                        filterText,
        ...
        JSONCompletion2.prototype.getInsertTextForGuessedValue = function (
            ...
            switch (typeof value) {
                ...
                case "boolean":
                    return (
                        "${1:" + JSON.stringify(value) + "}" + separatorAfter
                    );
            }
            return this.getInsertTextForValue(value, separatorAfter);
        };
            ...
            447: (t2, e2, r2) => {
                ...
                var l = "",
                    ...
                    y = (function (t3) {
                        function e3() {
                            var e4 =
                                (null !== t3 && t3.apply(this, arguments)) ||
                                this;
                            return (
                                (e4._formatted = null), (e4._fsPath = null), e4
                            );
                        }
                        return (
                            h(e3, t3),
                ...
                function b(t3, e3) {
                    ...
                    return (
                        -1 !== n2 &&
                            (r3 += encodeURIComponent(t3.substring(n2))),
                        void 0 !== r3 ? r3 : t3
                    );
                }
                function C(t3) {
    ...
    return {
        ...
        format: function (d, r, o) {
            ...
            var options = {
                ...
                insertSpaces:
                    (o === null || o === void 0 ? void 0 : o.insertSpaces) ===
                    true,
                insertFinalNewline:
                    (o === null || o === void 0
                        ? void 0
