...
export const ISymbolNavigationService = createDecorator(
...
let SymbolNavigationService = class SymbolNavigationService {
    ...
    reset() {
        ...
        (_a = this._currentState) === null || _a === void 0
            ? void 0
            : _a.dispose();
        (_b = this._currentMessage) === null || _b === void 0
            ? void 0
            : _b.dispose();
        this._currentModel = undefined;
        this._currentIdx = -1;
    ...
    _showMessage() {
        var _a;
        (_a = this._currentMessage) === null || _a === void 0
            ? void 0
            : _a.dispose();
...
let EditorState = class EditorState {
    ...
    _onDidRemoveEditor(editor) {
        var _a;
        (_a = this._listener.get(editor)) === null || _a === void 0
            ? void 0
            : _a.dispose();
