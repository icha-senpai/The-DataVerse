...
export function setupNativeHover(htmlElement, tooltip) {
    if (isString(tooltip)) {
        ...
        tooltip === null || tooltip === void 0
            ? void 0
            : tooltip.markdownNotSupportedFallback
    ) {
...
class UpdatableHoverWidget {
    ...
    show(content, focus, options) {
        ...
        oldHoverWidget === null || oldHoverWidget === void 0
            ? void 0
    ...
    get isDisposed() {
        var _a;
        return (_a = this._hoverWidget) === null || _a === void 0
            ? void 0
            : _a.isDisposed;
    }
    dispose() {
        var _a, _b;
        (_a = this._hoverWidget) === null || _a === void 0
            ? void 0
            : _a.dispose();
        (_b = this._cancellationTokenSource) === null || _b === void 0
            ? void 0
            : _b.dispose(true);
        this._cancellationTokenSource = undefined;
    }
...
export function setupCustomHover(hoverDelegate, htmlElement, content, options) {
    ...
    const hideHover = (disposeWidget, disposePreparation) => {
        ...
        if (disposeWidget) {
            hoverWidget === null || hoverWidget === void 0
                ? void 0
                : hoverWidget.dispose();
    ...
    const hover = {
        ...
        update: async (newContent, hoverOptions) => {
            content = newContent;
            await (hoverWidget === null || hoverWidget === void 0
                ? void 0
