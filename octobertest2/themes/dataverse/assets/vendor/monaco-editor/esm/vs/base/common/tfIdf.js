...
function countMapFrom(values) {
    ...
    for (const value of values) {
        map.set(
            value,
            ((_a = map.get(value)) !== null && _a !== void 0 ? _a : 0) + 1
        );
    }
    return map;
}
...
export class TfIdfCalculator {
            ...
            for (const text of doc.textChunks) {
                ...
                for (const term of tf.keys()) {
                    this.chunkOccurrences.set(
                        term,
                        ((_a = this.chunkOccurrences.get(term)) !== null &&
                        _a !== void 0
                            ? _a
                            : 0) + 1
                    );
    ...
    computeIdf(term) {
        ...
        const chunkOccurrences =
            (_a = this.chunkOccurrences.get(term)) !== null && _a !== void 0
                ? _a
                : 0;
...
export function normalizeTfIdfScores(scores) {
    ...
    const max =
        (_b =
            (_a = result[0]) === null || _a === void 0 ? void 0 : _a.score) !==
            null && _b !== void 0
            ? _b
            : 0;
    if (max > 0) {
