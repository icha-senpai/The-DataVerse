...
let SuggestAlternatives = (SuggestAlternatives_1 = class SuggestAlternatives {
    constructor(_editor, contextKeyService) {
        ...
        this._ckOtherSuggestions =
            SuggestAlternatives_1.OtherSuggestions.bindTo(contextKeyService);
    }
    dispose() {
        this.reset();
    }
    ...
    _move(fwd) {
        ...
        try {
            this._ignore = true;
            this._index = SuggestAlternatives_1._moveIndex(
                fwd,
                this._model,
                this._index
            );
...
SuggestAlternatives.OtherSuggestions = new RawContextKey(
    "hasOtherSuggestions",
    false
);
