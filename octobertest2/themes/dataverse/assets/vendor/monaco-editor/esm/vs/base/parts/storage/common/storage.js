...
(function (StorageHint) {
    ...
    StorageHint[(StorageHint["STORAGE_DOES_NOT_EXIST"] = 0)] =
    ...
    onDidChangeItemsExternal(e) {
        ...
        try {
            ...
            (_a = e.changed) === null || _a === void 0
                ? void 0
                : _a.forEach((value, key) => this.acceptExternal(key, value));
            (_b = e.deleted) === null || _b === void 0
                ? void 0
                : _b.forEach((key) => this.acceptExternal(key, undefined));
        } finally {
        ...
        return this.database.updateItems(updateRequest).finally(() => {
            ...
            if (!this.hasPending) {
                while (this.whenFlushedCallbacks.length) {
                    (_a = this.whenFlushedCallbacks.pop()) === null ||
                    _a === void 0
                        ? void 0
                        : _a();
                }
