...
let QuickAccessController = class QuickAccessController extends Disposable {
    ...
    doShowOrPick(value, pick, options) {
        ...
        if (
            ...
            picker.itemActivation =
                (_a =
                    options === null || options === void 0
                        ? void 0
                        : options.itemActivation) !== null && _a !== void 0
                    ? _a
        ...
        if (pick) {
            return pickPromise === null || pickPromise === void 0
                ? void 0
                : pickPromise.p;
        }
    }
        ...
        // Otherwise: select the value up until the prefix
            ...
            valueSelection = [
                (_a =
                    descriptor === null || descriptor === void 0
                        ? void 0
                        : descriptor.prefix.length) !== null && _a !== void 0
                    ? _a
                    : 0,
                picker.value.length,
            ];
