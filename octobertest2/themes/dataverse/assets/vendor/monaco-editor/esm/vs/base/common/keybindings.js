...
export function createSimpleKeybinding(keybinding, OS) {
    const ctrlCmd =
        keybinding & 2048 /* BinaryKeybindingsMask.CtrlCmd */ ? true : false;
    const winCtrl =
        keybinding & 256 /* BinaryKeybindingsMask.WinCtrl */ ? true : false;
    const ctrlKey =
        OS === 2 /* OperatingSystem.Macintosh */ ? winCtrl : ctrlCmd;
    const shiftKey =
        keybinding & 1024 /* BinaryKeybindingsMask.Shift */ ? true : false;
    const altKey =
        keybinding & 512 /* BinaryKeybindingsMask.Alt */ ? true : false;
    const metaKey =
        OS === 2 /* OperatingSystem.Macintosh */ ? ctrlCmd : winCtrl;
