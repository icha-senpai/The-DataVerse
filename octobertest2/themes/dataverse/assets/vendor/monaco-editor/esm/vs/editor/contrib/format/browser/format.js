...
export async function formatDocumentRangesWithProvider(
    ...
    const computeEdits = async (range) => {
        ...
        logService.trace(
            ...
            (_a = provider.extensionId) === null || _a === void 0
                ? void 0
                : _a.value,
            range
        );
        ...
        logService.trace(
            ...
            (_b = provider.extensionId) === null || _b === void 0
                ? void 0
                : _b.value,
            result
        );
