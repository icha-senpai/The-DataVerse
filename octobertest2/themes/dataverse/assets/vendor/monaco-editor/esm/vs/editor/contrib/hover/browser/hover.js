...
const _sticky = false;
let HoverController = (HoverController_1 = class HoverController extends (
    Disposable
) {
    constructor(
        _editor,
    ...
    _hookListeners() {
        ...
        if (hoverOpts.enabled) {
            this._listenersStore.add(
                this._editor.onMouseDown((e) => this._onEditorMouseDown(e))
            );
            this._listenersStore.add(
                this._editor.onMouseUp(() => this._onEditorMouseUp())
            );
            this._listenersStore.add(
                this._editor.onMouseMove((e) => this._onEditorMouseMove(e))
            );
            this._listenersStore.add(
    ...
    _onEditorMouseLeave(mouseEvent) {
        ...
        if (
            ((_a = this._contentWidget) === null || _a === void 0
                ? void 0
                : _a.widget.isResizing) ||
            ((_b = this._contentWidget) === null || _b === void 0
                ? void 0
                : _b.containsNode(targetElement))
        ) {
    ...
    _isMouseOverWidget(mouseEvent) {
        ...
        if (
            ...
            ((_a = this._contentWidget) === null || _a === void 0
                ? void 0
                : _a.containsNode(
                      (_b = mouseEvent.event.browserEvent.view) === null ||
                          _b === void 0
                          ? void 0
                          : _b.document.activeElement
                  )) &&
            !((_d =
                (_c = mouseEvent.event.browserEvent.view) === null ||
                _c === void 0
                    ? void 0
        ...
        if (
            ...
            target.type === 9 /* MouseTargetType.CONTENT_WIDGET */ &&
            target.detail === ContentHoverWidget.ID &&
            ((_e = this._contentWidget) === null || _e === void 0
                ? void 0
                : _e.isColorPickerVisible)
        ) {
    ...
    _onEditorMouseMove(mouseEvent) {
        ...
        if (
            sticky &&
            ((_c = this._contentWidget) === null || _c === void 0
                ? void 0
                : _c.isVisibleFromKeyboard)
        ) {
        ...
        if (
            ((_d = this._contentWidget) === null || _d === void 0
                ? void 0
                : _d.isVisible) &&
            sticky &&
            hidingDelay > 0
    ...
    _reactToEditorMouseMove(mouseEvent) {
        ...
        const target = mouseEvent.target;
        const mouseOnDecorator =
            (_a = target.element) === null || _a === void 0
                ? void 0
                : _a.classList.contains("colorpicker-color-decoration");
        ...
        if (contentWidget.showsOrWillShow(mouseEvent)) {
            (_b = this._glyphWidget) === null || _b === void 0
                ? void 0
                : _b.hide();
            return;
        }
    ...
    dispose() {
        ...
        (_a = this._glyphWidget) === null || _a === void 0
            ? void 0
            : _a.dispose();
        (_b = this._contentWidget) === null || _b === void 0
            ? void 0
