...
export class ViewOverlayWidgets extends ViewPart {
    constructor(context, viewDomNode) {
        ...
        PartFingerprints.write(
            this._domNode,
            4 /* PartFingerprint.OverlayWidgets */
        );
        ...
        PartFingerprints.write(
            ...
            5 /* PartFingerprint.OverflowingOverlayWidgets */
        );
    ...
    _updateMaxMinWidth() {
        ...
        for (let i = 0, len = keys.length; i < len; i++) {
            ...
            const widgetMinWidthInPx =
                (_b = (_a = widget.widget).getMinContentWidthInPx) === null ||
                _b === void 0
                    ? void 0
                    : _b.call(_a);
    ...
    _renderWidget(widgetData) {
        ...
        if (
            ...
            0 /* OverlayWidgetPositionPreference.TOP_RIGHT_CORNER */
        ) {
            domNode.setTop(0);
            domNode.setRight(
            ...
            widgetData.preference ===
            2 /* OverlayWidgetPositionPreference.TOP_CENTER */
        ) {
            domNode.setTop(0);
