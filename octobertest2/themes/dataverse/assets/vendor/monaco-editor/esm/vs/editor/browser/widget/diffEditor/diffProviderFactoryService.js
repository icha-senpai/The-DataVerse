...
export const IDiffProviderFactoryService = createDecorator(
...
let WorkerBasedDocumentDiffProvider =
    (WorkerBasedDocumentDiffProvider_1 = class WorkerBasedDocumentDiffProvider {
        ...
        dispose() {
            var _a;
            (_a = this.diffAlgorithmOnDidChangeSubscription) === null ||
            _a === void 0
                ? void 0
                : _a.dispose();
        }
        async computeDiff(original, modified, options, cancellationToken) {
            ...
            this.telemetryService.publicLog2("diffEditor.computeDiff", {
                ...
                timedOut:
                    (_a =
                        result === null || result === void 0
                            ? void 0
                            : result.quitEarly) !== null && _a !== void 0
                        ? _a
                        : true,
                detectedMoves: options.computeMoves
                    ? (_b =
                          result === null || result === void 0
                              ? void 0
                              : result.moves.length) !== null && _b !== void 0
                        ? _b
                        : 0
                    : -1,
            });
            ...
            if (WorkerBasedDocumentDiffProvider_1.diffCache.size > 10) {
                WorkerBasedDocumentDiffProvider_1.diffCache.delete(
                    WorkerBasedDocumentDiffProvider_1.diffCache.keys().next()
                        .value
                );
            }
...
WorkerBasedDocumentDiffProvider = WorkerBasedDocumentDiffProvider_1 =
    __decorate(
