...
export class ListView {
    ...
    constructor(
        ...
        this.onDidChangeContentHeight = Event.latch(
        ...
        this.rangeMap = new RangeMap(
            (_a = options.paddingTop) !== null && _a !== void 0 ? _a : 0
        );
        ...
        this._horizontalScrolling =
            (_b = options.horizontalScrolling) !== null && _b !== void 0
                ? _b
        ...
        const transformOptimization =
            (_c = options.transformOptimization) !== null && _c !== void 0
                ? _c
        ...
        this.scrollable = this.disposables.add(
            new Scrollable({
                ...
                smoothScrollDuration: (
                    (_d = options.smoothScrolling) !== null && _d !== void 0
                        ? _d
                        : false
                )
                    ? 125
            ...
            new SmoothScrollableElement(
                this.rowsContainer,
                {
                    alwaysConsumeMouseWheel:
                        (_e = options.alwaysConsumeMouseWheel) !== null &&
                        _e !== void 0
                            ? _e
                            : DefaultOptions.alwaysConsumeMouseWheel,
                    horizontal: 1 /* ScrollbarVisibility.Auto */,
                    vertical:
                        (_f = options.verticalScrollMode) !== null &&
                        _f !== void 0
                            ? _f
                            : DefaultOptions.verticalScrollMode,
                    useShadows:
                        (_g = options.useShadows) !== null && _g !== void 0
                            ? _g
        ...
        this.setRowLineHeight =
            (_h = options.setRowLineHeight) !== null && _h !== void 0
                ? _h
                : DefaultOptions.setRowLineHeight;
        this.setRowHeight =
            (_j = options.setRowHeight) !== null && _j !== void 0
                ? _j
                : DefaultOptions.setRowHeight;
        this.supportDynamicHeights =
            (_k = options.supportDynamicHeights) !== null && _k !== void 0
                ? _k
                : DefaultOptions.supportDynamicHeights;
        this.dnd =
            (_l = options.dnd) !== null && _l !== void 0
                ? _l
                : this.disposables.add(DefaultOptions.dnd);
        this.layout(
            (_m = options.initialSize) === null || _m === void 0
                ? void 0
                : _m.height,
            (_o = options.initialSize) === null || _o === void 0
                ? void 0
                : _o.width
        );
    }
    updateOptions(options) {
        ...
        if (options.scrollByPage !== undefined) {
            scrollableOptions = {
                ...(scrollableOptions !== null && scrollableOptions !== void 0
                    ? scrollableOptions
                    : {}),
                scrollByPage: options.scrollByPage,
            };
    ...
    _splice(start, deleteCount, elements = []) {
        ...
        for (const range of insertRanges) {
            for (let i = range.start; i < range.end; i++) {
                ...
                const row =
                    rows === null || rows === void 0 ? void 0 : rows.pop();
    ...
    onDragOver(event) {
        ...
        event.browserEvent.dataTransfer.dropEffect =
            ...
            ((_a = result.effect) === null || _a === void 0
                ? void 0
                : _a.type) === 0 /* ListDragOverEffectType.Copy */
                ? "copy"
                : "move";
        let feedback;
        ...
        if (feedback[0] === -1) {
            ...
            for (const index of feedback) {
                ...
                (_b = item.row) === null || _b === void 0
                    ? void 0
                    : _b.domNode.classList.add(dragOverEffectPosition);
            }
            this.currentDragFeedbackDisposable = toDisposable(() => {
                var _a;
                for (const index of feedback) {
                    ...
                    (_a = item.row) === null || _a === void 0
                        ? void 0
                        : _a.domNode.classList.remove(dragOverEffectPosition);
                }
            });
        }
        return true;
    ...
    probeDynamicHeight(index) {
        ...
        (_c = (_b = this.virtualDelegate).setDynamicHeight) === null ||
        _c === void 0
            ? void 0
    ...
    dispose() {
        ...
        (_b = this.dragOverAnimationDisposable) === null || _b === void 0
            ? void 0
            : _b.dispose();
