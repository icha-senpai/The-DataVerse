...
class CompressibleRenderer {
    ...
    disposeElement(node, index, templateData, height) {
        ...
        if (templateData.compressedTreeNode) {
            (_b = (_a = this.renderer).disposeCompressedElements) === null ||
            _b === void 0
                ? void 0
                : _b.call(
                      _a,
...
__decorate(
    [memoize],
    CompressibleRenderer.prototype,
...
class CompressibleStickyScrollDelegate {
    ...
    compressStickyNodes(stickyNodes) {
        ...
        for (const stickyNode of stickyNodes) {
            const compressedNode = this.modelProvider().getCompressedTreeNode(
