...
export class ModeToggle extends Toggle {
    constructor(opts) {
        ...
        super({
            ...
            isChecked:
                (_a = opts.isChecked) !== null && _a !== void 0 ? _a : false,
...
class FindController {
    ...
    constructor(tree, model, view, filter, contextViewProvider, options = {}) {
        ...
        this.disposables = new DisposableStore();
        this._mode =
            (_a = tree.options.defaultFindMode) !== null && _a !== void 0
                ? _a
                : TreeFindMode.Highlight;
        this._matchType =
    ...
    render() {
        ...
        if (this.pattern && noMatches) {
            if (
                (_a = this.tree.options.showNotFoundMessage) !== null &&
                _a !== void 0
                    ? _a
                    : true
            ) {
...
class StickyScrollController extends Disposable {
    constructor(tree, model, view, renderers, treeDelegate, options = {}) {
        ...
        this.stickyScrollDelegate =
            (_a = options.stickyScrollDelegate) !== null && _a !== void 0
                ? _a
                : new DefaultStickyScrollDelegate();
...
class StickyScrollWidget {
    ...
    setState(state) {
        ...
        if (
            ...
            this._previousElements[
                this._previousState.count - 1
            ].style.top = `${lastStickyNode.position}px`;
        }
    ...
    setAccessibilityAttributes(
        ...
        if (this.accessibilityProvider.getPosInSet) {
            container.setAttribute(
                "aria-posinset",
                String(
                    this.accessibilityProvider.getPosInSet(element, stickyIndex)
                )
            );
        }
        if (this.accessibilityProvider.getRole) {
            container.setAttribute(
                "role",
                (_a = this.accessibilityProvider.getRole(element)) !== null &&
                    _a !== void 0
                    ? _a
                    : "treeitem"
            );
...
class Trait {
    ...
    set(nodes, browserEvent) {
        if (
            !(browserEvent === null || browserEvent === void 0
                ? void 0
                : browserEvent.__forceEvent) &&
...
class TreeNodeListMouseController extends MouseController {
    ...
    handleStickyScrollMouseEvent(e, node) {
        if (
            isMonacoCustomToggle(e.browserEvent.target) ||
...
export class AbstractTree {
    ...
    get findMode() {
        var _a, _b;
        return (_b =
            (_a = this.findController) === null || _a === void 0
                ? void 0
                : _a.mode) !== null && _b !== void 0
            ? _b
            : TreeFindMode.Highlight;
    }
    ...
    constructor(_user, container, delegate, renderers, _options = {}) {
        ...
        if (_options.keyboardSupport !== false) {
            const onKeyDown = Event.chain(this.view.onKeyDown, ($) =>
                $.filter((e) => !isInputElement(e.target)).map(
        ...
        if (
            ((_a = _options.findWidgetEnabled) !== null && _a !== void 0
                ? _a
                : true) &&
            _options.keyboardNavigationLabelProvider &&
    ...
    updateOptions(optionsUpdate = {}) {
        ...
        (_a = this.findController) === null || _a === void 0
            ? void 0
            : _a.updateOptions(optionsUpdate);
    ...
    updateStickyScroll(optionsUpdate) {
        ...
        (_a = this.stickyScrollController) === null || _a === void 0
            ? void 0
            : _a.updateOptions(optionsUpdate);
    }
    // Widget
    ...
    style(styles) {
        ...
        const focusAndSelectionOutline = asCssValueWithDefault(
            ...
            asCssValueWithDefault(
                ...
                (_a = styles.listFocusOutline) !== null && _a !== void 0
                    ? _a
                    : ""
            )
        );
