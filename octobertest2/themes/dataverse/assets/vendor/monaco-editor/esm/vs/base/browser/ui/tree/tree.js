...
(function (ObjectTreeElementCollapseState) {
    ObjectTreeElementCollapseState[
        (ObjectTreeElementCollapseState["Expanded"] = 0)
    ] = "Expanded";
    ObjectTreeElementCollapseState[
        (ObjectTreeElementCollapseState["Collapsed"] = 1)
    ] = "Collapsed";
    /**
     * If the element is already in the tree, preserve its current state. Else, expand it.
     */
    ObjectTreeElementCollapseState[
        (ObjectTreeElementCollapseState["PreserveOrExpanded"] = 2)
    ] = "PreserveOrExpanded";
    /**
     * If the element is already in the tree, preserve its current state. Else, collapse it.
     */
    ObjectTreeElementCollapseState[
        (ObjectTreeElementCollapseState["PreserveOrCollapsed"] = 3)
    ] = "PreserveOrCollapsed";
