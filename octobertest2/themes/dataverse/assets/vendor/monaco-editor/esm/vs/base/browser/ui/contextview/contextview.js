...
export class ContextView extends Disposable {
    constructor(container, domPosition) {
        ...
        this._register(
            toDisposable(() =>
                this.setContainer(null, 1 /* ContextViewDOMPosition.ABSOLUTE */)
            )
        );
    }
    setContainer(container, domPosition) {
        ...
        if (this.container) {
            ...
            if (this.shadowRoot) {
                ...
                this.shadowRoot = null;
                (_a = this.shadowRootHostElement) === null || _a === void 0
                    ? void 0
                    : _a.remove();
                this.shadowRootHostElement = null;
            } else {
    ...
    show(delegate) {
        ...
        this.doLayout();
        // Focus
        (_b = (_a = this.delegate).focus) === null || _b === void 0
            ? void 0
            : _b.call(_a);
    }
    getViewElement() {
    ...
    doLayout() {
        ...
        const anchorPosition =
            this.delegate.anchorPosition || 0; /* AnchorPosition.BELOW */
        const anchorAlignment =
            this.delegate.anchorAlignment || 0; /* AnchorAlignment.LEFT */
        const anchorAxisAlignment =
            this.delegate.anchorAxisAlignment ||
            0; /* AnchorAxisAlignment.VERTICAL */
        let top;
        let left;
        ...
        this.view.classList.add(
            anchorPosition === 0 /* AnchorPosition.BELOW */ ? "bottom" : "top"
        );
        this.view.classList.add(
            anchorAlignment === 0 /* AnchorAlignment.LEFT */ ? "left" : "right"
        );
    ...
    hide(data) {
        ...
        this.delegate = null;
        if (
            delegate === null || delegate === void 0 ? void 0 : delegate.onHide
        ) {
