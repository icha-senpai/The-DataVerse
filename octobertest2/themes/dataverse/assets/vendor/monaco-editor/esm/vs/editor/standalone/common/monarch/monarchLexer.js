...
MonarchStackElementFactory._INSTANCE = new MonarchStackElementFactory(
    CACHE_STACK_DEPTH
);
...
MonarchLineStateFactory._INSTANCE = new MonarchLineStateFactory(
    CACHE_STACK_DEPTH
);
...
let MonarchTokenizer = (MonarchTokenizer_1 = class MonarchTokenizer extends (
    Disposable
) {
    constructor(
        languageService,
