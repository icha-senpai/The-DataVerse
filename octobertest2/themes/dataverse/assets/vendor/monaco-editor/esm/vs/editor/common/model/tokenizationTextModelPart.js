...
class GrammarTokens extends Disposable {
    ...
    constructor(_languageIdCodec, _textModel, getLanguageId, attachedViews) {
        ...
        this._debugBackgroundTokenizer = this._register(
            new MutableDisposable()
        );
        this._backgroundTokenizationState = 1 /* BackgroundTokenizationState.InProgress */;
        this._onDidChangeBackgroundTokenizationState = this._register(
            new Emitter()
        );
                ...
                setEndState: (lineNumber, state) => {
                    ...
                    if (
                        ...
                        (_a = this._tokenizer) === null || _a === void 0
                            ? void 0
                            : _a.store.setEndState(lineNumber, state);
                    }
                },
            };
            if (
                ...
                this._debugBackgroundTokenizer.value =
                    tokenizationSupport.createBackgroundTokenizer(
                        this._textModel,
                        {
                            setTokens: (tokens) => {
                                var _a;
                                (_a = this._debugBackgroundTokens) === null ||
                                _a === void 0
                                    ? void 0
                                    : _a.setMultilineTokens(
                                          tokens,
                                          this._textModel
                                      );
                            },
                            ...
                            setEndState: (lineNumber, state) => {
                                var _a;
                                (_a = this._debugBackgroundStates) === null ||
                                _a === void 0
                                    ? void 0
    ...
    handleDidChangeAttached() {
        var _a;
        (_a = this._defaultBackgroundTokenizer) === null || _a === void 0
            ? void 0
            : _a.handleChanges();
    }
    handleDidChangeContent(e) {
    ...
    refreshRange(startLineNumber, endLineNumber) {
        ...
        (_b = this._defaultBackgroundTokenizer) === null || _b === void 0
            ? void 0
            : _b.checkFinished();
    }
    forceTokenization(lineNumber) {
        ...
        if (
            ...
            if (
                ...
                if (
                    ...
                    ((_a = this._debugBackgroundTokenizer.value) === null ||
                    _a === void 0
                        ? void 0
