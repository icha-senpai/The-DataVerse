...
let TextModel = (TextModel_1 = class TextModel extends Disposable {
    ...
    onDidChangeContent(listener) {
        return this._eventEmitter.slowEvent((e) =>
    ...
    constructor(
        ...
        this._languageSelectionListener = this._register(
        ...
        this._options = TextModel_1.resolveOptions(
            this._buffer,
            creationOptions
        );
        const languageId =
        ...
        if (creationOptions.largeFileOptimizations) {
            ...
            this._isTooLargeForHeapOperation =
                bufferTextLength >
                TextModel_1.LARGE_FILE_HEAP_OPERATION_THRESHOLD;
        } else {
            this._isTooLargeForTokenization = false;
            this._isTooLargeForHeapOperation = false;
        }
        this._isTooLargeForSyncing =
            bufferTextLength > TextModel_1._MODEL_SYNC_LIMIT;
        this._versionId = 1;
    ...
    setEOL(eol) {
        this._assertNotDisposed();
        const newEOL =
            eol === 1 /* model.EndOfLineSequence.CRLF */ ? "\r\n" : "\n";
    ...
    getValueInRange(
        rawRange,
        eol = 0 /* model.EndOfLinePreference.TextDefined */
    ) {
        this._assertNotDisposed();
    ...
    _isValidPosition(lineNumber, column, validationType) {
        ...
        if (
            validationType === 1 /* StringOffsetValidationType.SurrogatePairs */
        ) {
    ...
    findMatches(
        ...
        if (rawSearchScope !== null) {
            ...
            if (
                rawSearchScope.every((searchScope) =>
                    Range.isIRange(searchScope)
                )
            ) {
                searchRanges = rawSearchScope.map((searchScope) =>
...
export class ModelDecorationOptions {
    ...
    constructor(options) {
        ...
        this.blockDoesNotCollapse =
            (_a = options.blockDoesNotCollapse) !== null && _a !== void 0
                ? _a
                : null;
        this.blockIsAfterEnd =
            (_b = options.blockIsAfterEnd) !== null && _b !== void 0
                ? _b
                : null;
        this.blockPadding =
            (_c = options.blockPadding) !== null && _c !== void 0 ? _c : null;
        this.stickiness =
            options.stickiness ||
            0 /* model.TrackedRangeStickiness.AlwaysGrowsWhenTypingAtEdges */;
        this.zIndex = options.zIndex || 0;
        this.className = options.className
            ? cleanClassName(options.className)
            : null;
        this.shouldFillLineOnLineBreak =
            (_d = options.shouldFillLineOnLineBreak) !== null && _d !== void 0
                ? _d
                : null;
        ...
        this.hideInCommentTokens =
            (_e = options.hideInCommentTokens) !== null && _e !== void 0
                ? _e
                : false;
        this.hideInStringTokens =
            (_f = options.hideInStringTokens) !== null && _f !== void 0
                ? _f
                : false;
    }
}
...
class DidChangeDecorationsEmitter extends Disposable {
    ...
    endDeferredEmit() {
        ...
        if (this._deferredCnt === 0) {
            ...
            (_a = this._affectedInjectedTextLines) === null || _a === void 0
                ? void 0
                : _a.clear();
            this._affectedInjectedTextLines = null;
        }
    ...
    checkAffectedAndFire(options) {
        ...
        this._affectsMinimap ||
            (this._affectsMinimap = !!((_a = options.minimap) === null ||
            _a === void 0
                ? void 0
                : _a.position));
        this._affectsOverviewRuler ||
            (this._affectsOverviewRuler = !!((_b = options.overviewRuler) ===
                null || _b === void 0
                ? void 0
                : _b.color));
        this._affectsGlyphMargin ||
            (this._affectsGlyphMargin = !!options.glyphMarginClassName);
        this._affectsLineNumber ||
