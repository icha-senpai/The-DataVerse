...
export const SUPPORTED_CODE_ACTIONS = new RawContextKey(
    "supportedCodeAction",
    ""
);
...
export class CodeActionModel extends Disposable {
    ...
    _update() {
        ...
        if (
            ...
            const supportedActions = this._registry
                ...
                .flatMap((provider) => {
                    var _a;
                    return (_a = provider.providedCodeActionKinds) !== null &&
                        _a !== void 0
                        ? _a
                        : [];
                });
                    ...
                    const actions = createCancelablePromise(async (token) => {
                        ...
                        if (
                            ...
                            trigger.trigger.type ===
                                1 /* CodeActionTriggerType.Invoke */ &&
                            (trigger.trigger.triggerAction ===
                                CodeActionTriggerSource.QuickFix ||
                                ((_b =
                                    (_a = trigger.trigger.filter) === null ||
                                    _a === void 0
                                        ? void 0
                                        : _a.include) === null || _b === void 0
                                    ? void 0
                                    : _b.contains(CodeActionKind.QuickFix)))
                        ) {
                            ...
                            const foundQuickfix =
                                (_c = codeActionSet.validActions) === null ||
                                _c === void 0
                                    ? void 0
                                    : _c.some((action) =>
                                          action.action.kind
    ...
    trigger(trigger) {
        var _a;
        (_a = this._codeActionOracle.value) === null || _a === void 0
            ? void 0
            : _a.trigger(trigger);
    }
