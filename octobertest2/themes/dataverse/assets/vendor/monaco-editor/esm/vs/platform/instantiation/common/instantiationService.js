...
export class InstantiationService {
    constructor(
        ...
        this._globalGraph = _enableTracing
            ? (_a =
                  _parent === null || _parent === void 0
                      ? void 0
                      : _parent._globalGraph) !== null && _a !== void 0
                ? _a
                : new Graph((e) => e)
            : undefined;
    }
...
export class Trace {
    ...
    static traceCreation(_enableTracing, ctor) {
        return !_enableTracing
            ? Trace._None
            : new Trace(1 /* TraceType.Creation */, ctor.name);
    }
    ...
    stop() {
        ...
        const lines = [
            `${this.type === 1 /* TraceType.Creation */ ? "CREATE" : "CALL"} ${
                this.name
            }`,
            `${printChild(1, this)}`,
