...
let SnippetSession = (SnippetSession_1 = class SnippetSession {
    ...
    static createEditsAndSnippetsFromSelections(
        ...
        const firstBeforeText = model.getValueInRange(
            SnippetSession_1.adjustSelection(
                model,
                editor.getSelection(),
                overwriteBefore,
                0
        ...
        for (const { selection, idx } of indexedSelections) {
            ...
            let extensionBefore = SnippetSession_1.adjustSelection(
                model,
                selection,
                overwriteBefore,
                0
            );
            let extensionAfter = SnippetSession_1.adjustSelection(
                model,
                selection,
                0,
                overwriteAfter
    ...
    static createEditsAndSnippetsFromEdits(
        ...
        const resolver = new CompositeSnippetVariableResolver([
            ...
            new ClipboardBasedVariableResolver(
                ...
                editor.getOption(78 /* EditorOption.multiCursorPaste */) ===
                    "spread"
            ),
            new SelectionBasedVariableResolver(
                model,
