        ...
        if (this._matchOne(2 /* TokenType.Neg */)) {
            ...
            switch (peek.type) {
                ...
                case 0 /* TokenType.LParen */: {
                    ...
                    this._consume(
                        1 /* TokenType.RParen */,
                        errorClosingParenthesis
                    );
                    return expr === null || expr === void 0
                        ? void 0
                        : expr.negate();
                }
                        ...
                        case 19 /* TokenType.Error */: {
                            ...
                            for (let i = 0; i < expr.lexeme.length; i++) {
                                if (
                                    ...
                                    40 /* CharCode.OpenParen */
                                ) {
                                    parenBalance++;
                                } else if (
                                    expr.lexeme.charCodeAt(i) ===
                                    41 /* CharCode.CloseParen */
                                ) {
                                    parenBalance--;
                                }
                            }
            ...
            while (result.length > 1) {
                ...
                for (const left of getTerminals(LEFT)) {
                    for (const right of getTerminals(RIGHT)) {
                        all.push(
                            ContextKeyAndExpr.create([left, right], null, false)
                        );
                    }
                }
...
export function implies(p, q) {
    if (
        p.type === 0 /* ContextKeyExprType.False */ ||
        q.type === 1 /* ContextKeyExprType.True */
    ) {
