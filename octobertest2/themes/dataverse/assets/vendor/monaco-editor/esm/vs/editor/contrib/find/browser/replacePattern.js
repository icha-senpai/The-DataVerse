...
export function parseReplaceString(replaceString) {
    ...
    for (let i = 0, len = replaceString.length; i < len; i++) {
        ...
        if (chCode === 36 /* CharCode.DollarSign */) {
            ...
            if (
                nextChCode === 48 /* CharCode.Digit0 */ ||
                nextChCode === 38 /* CharCode.Ampersand */
            ) {
                // $& and $0 => inserts the matched substring.
                result.emitUnchanged(i - 1);
            ...
            if (
                49 /* CharCode.Digit1 */ <= nextChCode &&
                nextChCode <= 57 /* CharCode.Digit9 */
            ) {
                // $n
                ...
                if (i + 1 < len) {
                    ...
                    if (
                        ...
                        matchIndex =
                            matchIndex * 10 +
                            (nextNextChCode - 48) /* CharCode.Digit0 */;
