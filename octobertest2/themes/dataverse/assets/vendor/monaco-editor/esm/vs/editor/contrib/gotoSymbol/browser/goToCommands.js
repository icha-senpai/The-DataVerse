                ...
                async (references) => {
                    ...
                    if (referenceCount === 0) {
                        ...
                        if (!this.configuration.muteMessage) {
                            ...
                            (_j = MessageController.get(editor)) === null ||
                            _j === void 0
                                ? void 0
                                : _j.showMessage(
...
export class DefinitionAction extends SymbolNavigationAction {
    ...
    _getAlternativeCommand(editor) {
        return editor.getOption(58 /* EditorOption.gotoLocation */)
...
class GenericGoToLocationAction extends SymbolNavigationAction {
    ...
    _getGoToPreference(editor) {
        var _j;
        return (_j = this._gotoMultipleBehaviour) !== null && _j !== void 0
            ? _j
            : editor.getOption(58 /* EditorOption.gotoLocation */)
                  .multipleReferences;
    }
