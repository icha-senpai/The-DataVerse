...
export class SelectBoxList extends Disposable {
    ...
    styleSelectElement() {
        var _a, _b, _c;
        const background =
            (_a = this.styles.selectBackground) !== null && _a !== void 0
                ? _a
                : "";
        const foreground =
            (_b = this.styles.selectForeground) !== null && _b !== void 0
                ? _b
                : "";
        const border =
    ...
    styleList() {
        ...
        const optionsBorder =
            (_b = this.styles.focusBorder) !== null && _b !== void 0 ? _b : "";
    ...
    createSelectList(parent) {
        ...
        this._register(
            Event.chain(onSelectDropDownKeyDown, ($) =>
                $.filter((e) => e.keyCode === 13 /* KeyCode.End */)
            )(this.onEnd, this)
        );
        this._register(
            Event.chain(onSelectDropDownKeyDown, ($) =>
                $.filter(
                    (e) =>
                        (e.keyCode >= 21 /* KeyCode.Digit0 */ &&
                            e.keyCode <= 56) /* KeyCode.KeyZ */ ||
                        (e.keyCode >= 85 /* KeyCode.Semicolon */ &&
                            e.keyCode <= 113) /* KeyCode.NumpadDivide */
                )
    ...
    updateDetail(selectedIndex) {
        ...
        const description =
            (_a =
                option === null || option === void 0
                    ? void 0
                    : option.description) !== null && _a !== void 0
                ? _a
                : "";
        const descriptionIsMarkdown =
            (_b =
                option === null || option === void 0
                    ? void 0
                    : option.descriptionIsMarkdown) !== null && _b !== void 0
                ? _b
                : false;
        if (description) {
