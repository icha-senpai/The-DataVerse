...
export class QuickInputController extends Disposable {
    ...
    getUI(showInActiveContainer) {
        ...
        const checkAll = dom.append(
            headerContainer,
            $("input.quick-input-check-all")
        );
        ...
        this._register(
            list.onDidChangeFocus(() => {
                ...
                inputBox.setAttribute(
                    ...
                    (_a = list.getActiveDescendant()) !== null && _a !== void 0
                        ? _a
                        : ""
                );
            })
        ...
        return new Promise((doResolve, reject) => {
            ...
            const disposables = [
                ...
                input.onDidTriggerSeparatorButton((event) => {
                    var _a;
                    return (_a = options.onDidTriggerSeparatorButton) ===
                        null || _a === void 0
                        ? void 0
    ...
    show(controller) {
        ...
        oldController === null || oldController === void 0
            ? void 0
    ...
    hide(reason) {
        ...
        const container =
            (_a = this.ui) === null || _a === void 0 ? void 0 : _a.container;
        const focusChanged =
        ...
        if (!focusChanged) {
            ...
            while (currentElement && !currentElement.offsetParent) {
                currentElement =
                    (_b = currentElement.parentElement) !== null &&
                    _b !== void 0
                        ? _b
                        : undefined;
            }
    ...
    updateStyles() {
        if (this.ui) {
            ...
            this.ui.titleBar.style.backgroundColor =
                quickInputTitleBackground !== null &&
