...
function canShowQuickSuggest(editor, contextKeyService, configurationService) {
    ...
    return !editor.getOption(62 /* EditorOption.inlineSuggest */)
        .suppressSuggestions;
}
...
let SuggestModel = (SuggestModel_1 = class SuggestModel {
        ...
        const checkTriggerCharacter = (text) => {
            ...
            if (supports) {
                ...
                this.trigger({
                    ...
                    clipboardText:
                        (_a = this._completionModel) === null || _a === void 0
                            ? void 0
                            : _a.clipboardText,
                    completionOptions: {
    ...
    cancel(retrigger = false) {
        ...
        if (this._triggerState !== undefined) {
            ...
            (_a = this._requestToken) === null || _a === void 0
                ? void 0
                : _a.cancel();
    ...
    _doTriggerQuickSuggest() {
        ...
        if (
            QuickSuggestionsOptions.isAllOff(
                this._editor.getOption(88 /* EditorOption.quickSuggestions */)
            )
        ) {
            // not enabled
            return;
        ...
        if (
            this._editor.getOption(117 /* EditorOption.suggest */)
                .snippetsPreventQuickSuggestions &&
            ((_a = SnippetController2.get(this._editor)) === null ||
            _a === void 0
                ? void 0
                : _a.isInSnippet())
        ) {
    ...
    trigger(options) {
        ...
        const completionOptions = new CompletionOptions(
            snippetSortOrder,
            (_d =
                (_c = options.completionOptions) === null || _c === void 0
                    ? void 0
                    : _c.kindFilter) !== null && _d !== void 0
                ? _d
                : itemKindFilter,
            (_e = options.completionOptions) === null || _e === void 0
                ? void 0
                : _e.providerFilter,
            (_f = options.completionOptions) === null || _f === void 0
                ? void 0
                : _f.providerItemsToReuse,
            showDeprecated
        );
