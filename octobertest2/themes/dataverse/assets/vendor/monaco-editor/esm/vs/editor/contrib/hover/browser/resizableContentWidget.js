...
export class ResizableContentWidget extends Disposable {
    ...
    get position() {
        var _a;
        return (
            (_a = this._contentPosition) === null || _a === void 0
                ? void 0
                : _a.position
        )
    ...
    _findPositionPreference(widgetHeight, showAtPosition) {
        ...
        const maxHeightBelow = Math.min(
            (_a = this._availableVerticalSpaceBelow(showAtPosition)) !== null &&
                _a !== void 0
                ? _a
                : Infinity,
            widgetHeight
        ...
        const maxHeightAbove = Math.min(
            (_b = this._availableVerticalSpaceAbove(showAtPosition)) !== null &&
                _b !== void 0
                ? _b
                : Infinity,
            widgetHeight
