...
export class IndentGuidesOverlay extends DynamicViewOverlay {
    ...
    onCursorStateChanged(e) {
        ...
        if (
            !((_a = this._primaryPosition) === null || _a === void 0
                ? void 0
                : _a.equals(newPosition))
        ) {
    ...
    prepareRender(ctx) {
        ...
        for (
            ...
            const leftOffset =
                (_b =
                    (_a = ctx.visibleRangeForPosition(
    ...
    const colorValues = colors
        .map((c) => {
            ...
            const effectiveGuideColor = transparentToUndefined(
                (_a = transparentToUndefined(guideColor)) !== null &&
                    _a !== void 0
                    ? _a
            ...
            const effectiveGuideColorActive = transparentToUndefined(
                (_b = transparentToUndefined(guideColorActive)) !== null &&
                    _b !== void 0
                    ? _b
                    : bracketColor
            );
