        ...
        for (const item of Iterable.concat(first, second)) {
            ...
            result.push(
                new SuggestInlineCompletion(
                    range,
                    insertText,
                    (_a = item.filterTextLow) !== null && _a !== void 0
                        ? _a
                        : item.labelLow,
...
let SuggestInlineCompletions = class SuggestInlineCompletions extends Disposable {
        ...
        if (
            ...
            const completions = await provideSuggestionItems(
                ...
                new CompletionOptions(
                    ...
                    triggerCharacterInfo === null ||
                    triggerCharacterInfo === void 0
                        ? void 0
            ...
            const completionModel = new CompletionModel(
                ...
                WordDistance.None,
                editor.getOption(117 /* EditorOption.suggest */),
                editor.getOption(111 /* EditorOption.snippetSuggestions */),
    ...
    _getTriggerCharacterInfo(model, position) {
        ...
        for (const provider of this._languageFeatureService.completionProvider.all(
            ...
            if (
                (_a = provider.triggerCharacters) === null || _a === void 0
                    ? void 0
                    : _a.includes(ch)
            ) {
