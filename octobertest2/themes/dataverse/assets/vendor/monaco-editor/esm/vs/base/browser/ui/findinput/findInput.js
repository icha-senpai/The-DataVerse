...
export class FindInput extends Widget {
    constructor(parent, contextViewProvider, options) {
        ...
        this.additionalTogglesDisposables = this._register(
    ...
    enable() {
        ...
        (_c = this.caseSensitive) === null || _c === void 0
            ? void 0
            : _c.enable();
    ...
    disable() {
        ...
        (_b = this.wholeWords) === null || _b === void 0
            ? void 0
            : _b.disable();
        (_c = this.caseSensitive) === null || _c === void 0
            ? void 0
    ...
    setAdditionalToggles(toggles) {
        ...
        for (const toggle of toggles !== null && toggles !== void 0
            ? toggles
            : []) {
    ...
    updateInputBoxPadding(controlsHidden = false) {
        ...
        if (controlsHidden) {
            ...
            this.inputBox.paddingRight =
                ((_b =
                    (_a = this.caseSensitive) === null || _a === void 0
                        ? void 0
                        : _a.width()) !== null && _b !== void 0
                    ? _b
                    : 0) +
                ((_d =
                    (_c = this.wholeWords) === null || _c === void 0
                        ? void 0
                        : _c.width()) !== null && _d !== void 0
                    ? _d
                    : 0) +
                ((_f =
                    (_e = this.regex) === null || _e === void 0
                        ? void 0
    ...
    getWholeWords() {
        var _a, _b;
        return (_b =
            (_a = this.wholeWords) === null || _a === void 0
                ? void 0
                : _a.checked) !== null && _b !== void 0
            ? _b
            : false;
