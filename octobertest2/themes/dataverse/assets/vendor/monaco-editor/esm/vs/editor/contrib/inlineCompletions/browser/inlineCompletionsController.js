...
} from "./inlineCompletionsHintsWidget.js";
import {
    InlineCompletionsModel,
    VersionIdChangeReason,
} from "./inlineCompletionsModel.js";
...
let InlineCompletionsController =
    (InlineCompletionsController_1 = class InlineCompletionsController extends (
        Disposable
    ) {
        static get(editor) {
        ...
        constructor(
            ...
            this.model = disposableObservableValue(
                    ...
                    () => {
                        ...
                        return (_b =
                            (_a = this.model.get()) === null || _a === void 0
                                ? void 0
                                : _a.selectedInlineCompletion.get()) === null ||
                            _b === void 0
                            ? void 0
            ...
            this._enabled = observableFromEvent(
                ...
                () =>
                    this.editor.getOption(62 /* EditorOption.inlineSuggest */)
                        .enabled
            );
            ...
            this._ghostTextWidget = this._register(
                this._instantiationService.createInstance(
                    GhostTextWidget,
                    this.editor,
                    {
                        ghostText: this.model.map((v, reader) =>
                            /** ghostText */ v === null || v === void 0
                                ? void 0
                                : v.ghostText.read(reader)
                        ),
                        minReservedLineCount: constObservable(0),
                        targetTextModel: this.model.map((v) =>
                            v === null || v === void 0 ? void 0 : v.textModel
                        ),
                    }
                )
            );
            ...
            this._isReadonly = observableFromEvent(
                this.editor.onDidChangeConfiguration,
                () => this.editor.getOption(90 /* EditorOption.readOnly */)
            );
            this._textModel = observableFromEvent(
                this.editor.onDidChangeModel,
                () => this.editor.getModel()
            );
            this._textModelIfWritable = derived((reader) =>
	...
	font-family: ${fontFamily};
            ...
            this._register(
                this.editor.onDidBlurEditorWidget(() => {
                    ...
                    if (
                        ...
                        editor.getOption(62 /* EditorOption.inlineSuggest */)
                            .keepOnBlur
                    ) {
                        return;
                    }
            ...
            this._register(
                autorun((reader) => {
                    ...
                    const state =
                        (_a = this.model.read(reader)) === null || _a === void 0
                            ? void 0
                            : _a.state.read(reader);
                    if (
        ...
        updateObservables(tx, changeReason) {
            ...
            this._textModelVersionId.set(
                (_a =
                    newModel === null || newModel === void 0
                        ? void 0
                        : newModel.getVersionId()) !== null && _a !== void 0
                    ? _a
                    : -1,
                tx,
                changeReason
            ...
            this._cursorPosition.set(
                (_b = this.editor.getPosition()) !== null && _b !== void 0
                    ? _b
                    : new Position(1, 1),
                tx
            );
