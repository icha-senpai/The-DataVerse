...
export class ActionBar extends Disposable {
    constructor(container, options = {}) {
        ...
        this._context =
            (_a = options.context) !== null && _a !== void 0 ? _a : null;
        this._orientation =
            ...
            keyDown:
                (_d =
                    (_c = this.options.triggerKeys) === null || _c === void 0
                        ? void 0
                        : _c.keyDown) !== null && _d !== void 0
                    ? _d
                    : false,
            keys:
                (_f =
                    (_e = this.options.triggerKeys) === null || _e === void 0
                        ? void 0
                        : _e.keys) !== null && _f !== void 0
                    ? _f
    ...
    updateFocusedItem() {
        ...
        for (let i = 0; i < this.actionsList.children.length; i++) {
            ...
            if (DOM.isAncestor(DOM.getActiveElement(), elem)) {
                this.focusedItem = i;
                (_b =
                    (_a = this.viewItems[this.focusedItem]) === null ||
                    _a === void 0
                        ? void 0
                        : _a.showHover) === null || _b === void 0
                    ? void 0
                    : _b.call(_a);
                break;
            }
    ...
    getAction(indexOrElement) {
        ...
        if (typeof indexOrElement === "number") {
            return (_a = this.viewItems[indexOrElement]) === null ||
                _a === void 0
                ? void 0
                : _a.action;
        }
    ...
    updateFocus(fromRight, preventScroll, forceFocus = false) {
        ...
        if (
            ...
            (_a = this.viewItems[this.previouslyFocusedItem]) === null ||
            _a === void 0
                ? void 0
                : _a.blur();
        }
        ...
        if (actionViewItem) {
            ...
            if (focusItem) {
                (_b = actionViewItem.showHover) === null || _b === void 0
                    ? void 0
                    : _b.call(actionViewItem);
            }
        }
    }
    doTrigger(event) {
