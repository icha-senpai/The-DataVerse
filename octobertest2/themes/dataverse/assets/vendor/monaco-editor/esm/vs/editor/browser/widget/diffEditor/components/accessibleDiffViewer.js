...
let ViewModel = class ViewModel extends Disposable {
    constructor(_diffs, _editors, _setVisible, canClose, _audioCueService) {
        ...
        this.currentGroup = this._currentGroupIdx.map(
        ...
        this.currentElement = this._currentElementIdx.map((idx, r) => {
            var _a;
            return (_a = this.currentGroup.read(r)) === null || _a === void 0
                ? void 0
                : _a.lines[idx];
        });
        this._register(
        ...
        this._register(
            autorun((reader) => {
                ...
                if (
                    (currentViewItem === null || currentViewItem === void 0
                        ? void 0
                        : currentViewItem.type) === LineType.Deleted
                ) {
                    ...
                    (currentViewItem === null || currentViewItem === void 0
                        ? void 0
                        : currentViewItem.type) === LineType.Added
                ) {
                    this._audioCueService.playAudioCue(
        ...
        this._register(
            autorun((reader) => {
                ...
                if (
                    ...
                    const lineNumber =
                        (_a = currentViewItem.modifiedLineNumber) !== null &&
                        _a !== void 0
                            ? _a
...
let View = class View extends Disposable {
        ...
        this._register(
            addStandardDisposableListener(this.domNode, "keydown", (e) => {
                ...
                if (
                    ...
                    e.equals(
                        2048 /* KeyMod.CtrlCmd */ | 9 /* KeyCode.Escape */
                    ) ||
    ...
    _render(store) {
        ...
        applyFontInfo(
            container,
            modifiedOptions.get(50 /* EditorOption.fontInfo */)
        );
        ...
        for (const viewItem of (group === null || group === void 0
            ? void 0
            : group.lines) || []) {
            if (!group) {
                break;
    ...
    _getLineHtml(model, options, tabSize, lineNumber, languageIdCodec) {
        ...
        const r = renderViewLine2(
            new RenderLineInput(
                ...
                options.get(116 /* EditorOption.stopRenderingLineAfter */),
                options.get(98 /* EditorOption.renderWhitespace */),
                options.get(93 /* EditorOption.renderControlCharacters */),
                options.get(51 /* EditorOption.fontLigatures */) !==
