...
export class ViewContentWidgets extends ViewPart {
    constructor(context, viewDomNode) {
        ...
        PartFingerprints.write(
            this.domNode,
            1 /* PartFingerprint.ContentWidgets */
        );
...
class Widget {
    ...
    _layoutHorizontalSegmentInPage(windowSize, domNodePosition, left, width) {
        ...
        const elWindow = elDocument.defaultView;
        let absoluteLeft =
            domNodePosition.left +
            left -
            ((_a =
                elWindow === null || elWindow === void 0
                    ? void 0
                    : elWindow.scrollX) !== null && _a !== void 0
                ? _a
                : 0);
    ...
    _layoutBoxInPage(anchor, width, height, ctx) {
        ...
        const absoluteAboveTop =
            ...
            ((_a =
                elWindow === null || elWindow === void 0
                    ? void 0
                    : elWindow.scrollY) !== null && _a !== void 0
                ? _a
                : 0);
        const absoluteBelowTop =
            ...
            ((_b =
                elWindow === null || elWindow === void 0
                    ? void 0
                    : elWindow.scrollY) !== null && _b !== void 0
                ? _b
                : 0);
    ...
    _getAnchorsCoordinates(ctx) {
        ...
        const secondaryViewPosition =
            ((_a = this._secondaryAnchor.viewPosition) === null || _a === void 0
                ? void 0
                : _a.lineNumber) ===
            ((_b = this._primaryAnchor.viewPosition) === null || _b === void 0
                ? void 0
                : _b.lineNumber)
        ...
        for (let pass = 1; pass <= 2; pass++) {
            for (const pref of this._preference) {
                ...
                if (pref === 1 /* ContentWidgetPositionPreference.ABOVE */) {
                    ...
                    pref === 2 /* ContentWidgetPositionPreference.BELOW */
                ) {
                    if (!placement) {
                        // Widget outside of viewport
                        return null;
