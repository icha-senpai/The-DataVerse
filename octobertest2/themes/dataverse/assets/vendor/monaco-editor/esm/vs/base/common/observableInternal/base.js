...
export class TransactionImpl {
    constructor(_fn, _getDebugName) {
        ...
        (_a = getLogger()) === null || _a === void 0
            ? void 0
            : _a.handleBeginTransaction(this);
    }
    getDebugName() {
...
export function getDebugName(self, debugNameFn, fn, owner) {
    ...
    if (dbgName) {
        let count =
            (_a = countPerName.get(dbgName)) !== null && _a !== void 0 ? _a : 0;
        count++;
...
function formatOwner(owner) {
    ...
    let count =
        (_a = countPerClassName.get(className)) !== null && _a !== void 0
            ? _a
            : 0;
    count++;
...
export class ObservableValue extends BaseObservable {
    ...
    set(value, tx, change) {
        ...
        try {
            ...
            (_a = getLogger()) === null || _a === void 0
                ? void 0
                : _a.handleObservableChanged(this, {
                      oldValue,
                      newValue: value,
                      change,
                      didChange: true,
