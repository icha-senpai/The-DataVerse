...
export class BracketPairsTextModelPart extends Disposable {
    ...
    constructor(textModel, languageConfigurationService) {
        ...
        this._register(
            this.languageConfigurationService.onDidChange((e) => {
                ...
                if (
                    !e.languageId ||
                    ((_a = this.bracketPairsTree.value) === null ||
                    _a === void 0
                        ? void 0
    ...
    getBracketPairsInRange(range) {
        ...
        return (
            ((_a = this.bracketPairsTree.value) === null || _a === void 0
                ? void 0
                : _a.object.getBracketPairsInRange(range, false)) ||
    ...
    getBracketPairsInRangeWithMinIndentation(range) {
        ...
        return (
            ((_a = this.bracketPairsTree.value) === null || _a === void 0
                ? void 0
                : _a.object.getBracketPairsInRange(range, true)) ||
            CallbackIterable.empty
        );
    }
    getBracketsInRange(range, onlyColorizedBrackets = false) {
        ...
        return (
            ((_a = this.bracketPairsTree.value) === null || _a === void 0
                ? void 0
                : _a.object.getBracketsInRange(range, onlyColorizedBrackets)) ||
            CallbackIterable.empty
        );
    }
    ...
    _establishBracketSearchOffsets(
        position,
        lineTokens,
        modeBrackets,
        tokenIndex
