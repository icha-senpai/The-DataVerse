...
export const CONTEXT_FIND_WIDGET_VISIBLE = new RawContextKey(
    "findWidgetVisible",
    false
);
...
export const CONTEXT_FIND_INPUT_FOCUSED = new RawContextKey(
    "findInputFocussed",
    false
);
export const CONTEXT_REPLACE_INPUT_FOCUSED = new RawContextKey(
...
export class FindModelBoundToEditorModel {
    ...
    research(moveCursor, newFindScope) {
        ...
        if (
            moveCursor &&
            this._editor.getOption(41 /* EditorOption.find */).cursorMoveOnType
        ) {
