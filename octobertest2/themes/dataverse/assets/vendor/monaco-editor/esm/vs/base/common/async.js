...
export class Delayer {
    ...
    trigger(task, delay = this.defaultDelay) {
        ...
        const fn = () => {
            var _a;
            this.deferred = null;
            (_a = this.doResolve) === null || _a === void 0
                ? void 0
                : _a.call(this, null);
        };
        this.deferred =
    ...
    isTriggered() {
        var _a;
        return !!((_a = this.deferred) === null || _a === void 0
            ? void 0
            : _a.isTriggered());
    }
    cancel() {
...
export class IntervalTimer {
    ...
    cancel() {
        var _a;
        (_a = this.disposable) === null || _a === void 0
            ? void 0
            : _a.dispose();
        this.disposable = undefined;
    }
...
export class DeferredPromise {
    get isRejected() {
        var _a;
        return (
            ((_a = this.outcome) === null || _a === void 0
                ? void 0
                : _a.outcome) === 1 /* DeferredOutcome.Rejected */
        );
    }
    get isSettled() {
        return !!this.outcome;
        ...
        return {
            next: async () => {
                do {
                    if (
                        this._state ===
                        2 /* AsyncIterableSourceState.DoneError */
                    ) {
                        throw this._error;
                    }
