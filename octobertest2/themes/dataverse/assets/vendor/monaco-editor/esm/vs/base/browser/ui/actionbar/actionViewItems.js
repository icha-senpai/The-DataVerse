...
export class BaseActionViewItem extends Disposable {
    ...
    updateTooltip() {
        ...
        const title =
            (_a = this.getTooltip()) !== null && _a !== void 0 ? _a : "";
...
export class ActionViewItem extends BaseActionViewItem {
    ...
    updateClass() {
        ...
        if (this.options.icon) {
            ...
            (_a = this.label) === null || _a === void 0
                ? void 0
                : _a.classList.remove("codicon");
        }
    }
    updateEnabled() {
        var _a, _b;
