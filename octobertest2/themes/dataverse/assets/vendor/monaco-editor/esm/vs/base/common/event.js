...
export class Emitter {
    constructor(options) {
        ...
        this._leakageMon =
            ...
            ((_a = this._options) === null || _a === void 0
                ? void 0
                : _a.leakWarningThreshold)
                ? new LeakageMonitor(
                      (_c =
                          (_b = this._options) === null || _b === void 0
                              ? void 0
                              : _b.leakWarningThreshold) !== null &&
                      _c !== void 0
                          ? _c
                ...
                if (_enableDisposeWithListenerWarning) {
                    ...
                    queueMicrotask(() => {
                        forEachListener(listeners, (l) => {
                            var _a;
                            return (_a = l.stack) === null || _a === void 0
                                ? void 0
                                : _a.print();
                        });
                    });
            ...
            : (this._event = (callback, thisArgs, disposables) => {
                  ...
                  if (!this._listeners) {
                      (_b =
                          (_a = this._options) === null || _a === void 0
                              ? void 0
                              : _a.onWillAddFirstListener) === null ||
                      _b === void 0
                          ? void 0
                          : _b.call(_a, this);
                      ...
                      (_d =
                          (_c = this._options) === null || _c === void 0
                              ? void 0
                              : _c.onDidAddFirstListener) === null ||
                      _d === void 0
                          ? void 0
                          : _d.call(_c, this);
                  } else if (this._listeners instanceof UniqueContainer) {
                      (_e = this._deliveryQueue) !== null && _e !== void 0
                          ? _e
                          : (this._deliveryQueue =
    ...
    _removeListener(listener) {
        ...
        if (this._size === 1) {
            ...
            (_d =
                (_c = this._options) === null || _c === void 0
                    ? void 0
                    : _c.onDidRemoveLastListener) === null || _d === void 0
                ? void 0
                : _d.call(_c, this);
            this._size = 0;
            return;
    ...
    _deliver(listener, value) {
        ...
        const errorHandler =
            ((_a = this._options) === null || _a === void 0
                ? void 0
                : _a.onListenerError) || onUnexpectedError;
        if (!errorHandler) {
    ...
    fire(event) {
        ...
        (_c = this._perfMon) === null || _c === void 0
            ? void 0
            : _c.start(this._size);
        if (!this._listeners) {
            // no-op
