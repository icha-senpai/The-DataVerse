...
let SmartSelectController =
    (SmartSelectController_1 = class SmartSelectController {
        static get(editor) {
        ...
        dispose() {
            var _a;
            (_a = this._selectionListener) === null || _a === void 0
                ? void 0
                : _a.dispose();
        }
        async run(forward) {
            ...
            if (!this._state) {
                await provideSelectionRanges(
                    ...
                    this._editor.getOption(112 /* EditorOption.smartSelect */),
                    ...
                    this._selectionListener =
                        this._editor.onDidChangeCursorPosition(() => {
                            ...
                            if (!this._ignoreSelection) {
                                (_a = this._selectionListener) === null ||
                                _a === void 0
                                    ? void 0
                                    : _a.dispose();
