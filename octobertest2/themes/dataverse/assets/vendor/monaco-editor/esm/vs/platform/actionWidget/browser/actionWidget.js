...
let ActionWidgetService = class ActionWidgetService extends Disposable {
        ...
        this._contextViewService.showContextView(
            {
                ...
                render: (container) => {
                    ...
                    return this._renderWidget(
                        container,
                        list,
                        actionBarActions !== null && actionBarActions !== void 0
                            ? actionBarActions
                            : []
                    );
                },
    ...
    acceptSelected(preview) {
        var _a;
        (_a = this._list.value) === null || _a === void 0
            ? void 0
            : _a.acceptSelected(preview);
    }
    focusPrevious() {
        var _a, _b;
        (_b =
            (_a = this._list) === null || _a === void 0 ? void 0 : _a.value) ===
            null || _b === void 0
            ? void 0
            : _b.focusPrevious();
    }
