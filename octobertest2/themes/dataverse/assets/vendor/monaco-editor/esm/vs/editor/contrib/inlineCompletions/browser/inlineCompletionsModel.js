...
(function (VersionIdChangeReason) {
    ...
    VersionIdChangeReason[(VersionIdChangeReason["AcceptWord"] = 2)] =
        "AcceptWord";
...
let InlineCompletionsModel = class InlineCompletionsModel extends Disposable {
    ...
    constructor(
        ...
        this._fetchInlineCompletions = derivedHandleChanges(
            ...
            (reader, changeSummary) => {
                ...
                const itemToPreserveCandidate =
                    this.selectedInlineCompletion.get();
                const itemToPreserve =
                    changeSummary.preserveCurrentCompletion ||
                    (itemToPreserveCandidate === null ||
                    itemToPreserveCandidate === void 0
                        ? void 0
                ...
                if (suggestWidgetInlineCompletions && !suggestItem) {
                    const inlineCompletions =
                        this._source.inlineCompletions.get();
                    transaction((tx) => {
        ...
        this.state = derivedOpts(
            ...
            (reader) => {
                ...
                if (suggestItem) {
                    ...
                    const augmentedCompletion =
                        this._computeAugmentedCompletion(
                            suggestCompletion,
                            reader
                        );
                    ...
                    const edit =
                        (_a =
                            augmentedCompletion === null ||
                            augmentedCompletion === void 0
                                ? void 0
                                : augmentedCompletion.edit) !== null &&
                        _a !== void 0
                            ? _a
                            : suggestCompletion;
        ...
        this._register(
            autorun((reader) => {
                ...
                if (
                    (completion === null || completion === void 0
                        ? void 0
                        : completion.semanticId) !==
                    ...
                    if (completion) {
                        ...
                        const src = i.source;
                        (_b = (_a = src.provider).handleItemDidShow) === null ||
                        _b === void 0
                            ? void 0
                            : _b.call(
                                  _a,
    ...
    async accept(editor) {
        ...
        if (completion.snippetInfo) {
            ...
            (_a = SnippetController2.get(editor)) === null || _a === void 0
                ? void 0
                : _a.insert(completion.snippetInfo.snippet, {
    ...
    handleSuggestAccepted(item) {
        ...
        (_b = (_a = inlineCompletion.source.provider).handlePartialAccept) ===
            null || _b === void 0
            ? void 0
            : _b.call(
                  _a,
