...
export class InputBox extends Widget {
    constructor(container, contextViewProvider, options) {
        ...
        this.tooltip =
            (_a = this.options.tooltip) !== null && _a !== void 0
                ? _a
                : this.placeholder || "";
    ...
    validate() {
        ...
        return errorMsg === null || errorMsg === void 0
            ? void 0
            : errorMsg.type;
    }
    stylesForType(type) {
        ...
        this.contextViewProvider.showContextView({
            ...
            render: (container) => {
                ...
                spanElement.style.backgroundColor =
                    (_a = styles.background) !== null && _a !== void 0
                        ? _a
                        : "";
                spanElement.style.color =
                    (_b = styles.foreground) !== null && _b !== void 0
                        ? _b
                        : "";
    ...
    applyStyles() {
        ...
        const styles = this.options.inputBoxStyles;
        const background =
            (_a = styles.inputBackground) !== null && _a !== void 0 ? _a : "";
        const foreground =
            (_b = styles.inputForeground) !== null && _b !== void 0 ? _b : "";
        const border =
            (_c = styles.inputBorder) !== null && _c !== void 0 ? _c : "";
