...
(function (CoreNavigationCommands) {
    class BaseMoveToCommand extends CoreEditorCommand {
        ...
        runCoreEditorCommand(viewModel, args) {
            ...
            if (
                cursorStateChanged &&
                args.revealType !== 2 /* NavigationCommandRevealType.None */
            ) {
    ...
    CoreNavigationCommands.CursorMove = registerEditorCommand(
        new CursorMoveImpl()
    );
    class CursorMoveBasedCommand extends CoreEditorCommand {
        ...
        runCoreEditorCommand(viewModel, dynamicArgs) {
            ...
            if (
                this._staticArgs.value === -1 /* Constants.PAGE_SIZE_MARKER */
            ) {
    ...
    class EditorScrollImpl extends CoreEditorCommand {
        ...
        _computeDesiredScrollTop(viewModel, args) {
            ...
            const deltaLines =
                (args.direction === 1 /* EditorScroll_.Direction.Up */
                    ? -1
                    : 1) * noOfLines;
            return (
        ...
        _computeDesiredScrollLeft(viewModel, args) {
            const deltaColumns =
                (args.direction === 4 /* EditorScroll_.Direction.Left */
                    ? -1
                    : 1) * args.value;
            return (
    ...
    CoreNavigationCommands.EditorScroll = registerEditorCommand(
    ...
    CoreNavigationCommands.ScrollLineUp = registerEditorCommand(
        new (class extends CoreEditorCommand {
            ...
            runCoreEditorCommand(viewModel, args) {
                CoreNavigationCommands.EditorScroll.runCoreEditorCommand(
                    viewModel,
                    {
            ...
            constructor() {
                super({
                    ...
                    kbOpts: {
                        ...
                        win: {
                            primary:
                                512 /* KeyMod.Alt */ | 11 /* KeyCode.PageUp */,
                        },
                        linux: {
                            primary:
                                512 /* KeyMod.Alt */ | 11 /* KeyCode.PageUp */,
    ...
    CoreNavigationCommands.RemoveSecondaryCursors = registerEditorCommand(
        new (class extends CoreEditorCommand {
            ...
            runCoreEditorCommand(viewModel, args) {
                ...
                viewModel.revealPrimaryCursor(args.source, true);
                status(
                    nls.localize("removedCursor", "Removed secondary cursors")
                );
            }
        })()
    );
    ...
    CoreNavigationCommands.SelectAll =
        new (class extends EditorOrNativeTextInputCommand {
            constructor() {
        ...
        new (class extends CoreEditingCommand {
            ...
            runCoreEditingCommand(editor, viewModel, args) {
                ...
                viewModel.setPrevEditOperationType(
                    2 /* EditOperationType.DeletingLeft */
                );
            }
        })()
    );
    CoreEditingCommands.DeleteRight = registerEditorCommand(
        new (class extends CoreEditingCommand {
            ...
            runCoreEditingCommand(editor, viewModel, args) {
                ...
                editor.executeCommands(this.id, commands);
                viewModel.setPrevEditOperationType(
                    3 /* EditOperationType.DeletingRight */
                );
            }
        })()
    );
    CoreEditingCommands.Undo =
        new (class extends EditorOrNativeTextInputCommand {
            constructor() {
                super(UndoCommand);
            }
            ...
            runEditorCommand(accessor, editor, args) {
                if (
                    !editor.hasModel() ||
                    editor.getOption(90 /* EditorOption.readOnly */) === true
                ) {
                    return;
                }
...
registerOverwritableCommand(
    "replacePreviousChar" /* Handler.ReplacePreviousChar */
);
