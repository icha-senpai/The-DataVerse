...
let SuggestDetailsWidget = class SuggestDetailsWidget {
    ...
    _configureFont() {
        ...
        const fontSize =
            options.get(118 /* EditorOption.suggestFontSize */) ||
            fontInfo.fontSize;
        const lineHeight =
            options.get(119 /* EditorOption.suggestLineHeight */) ||
            fontInfo.lineHeight;
    ...
    getLayoutInfo() {
        const lineHeight =
            this._editor.getOption(119 /* EditorOption.suggestLineHeight */) ||
            this._editor.getOption(50 /* EditorOption.fontInfo */).lineHeight;
    ...
    renderItem(item, explainMode) {
        ...
        if (explainMode) {
            ...
            md += `prefix: ${
                (_a = item.word) !== null && _a !== void 0 ? _a : "(no prefix)"
            }\n`;
            md += `word: ${
            ...
            md += `commit_chars: ${
                (_b = item.completion.commitCharacters) === null ||
                _b === void 0
                    ? void 0
                    : _b.join("")
            }\n`;
        ...
        this._disposables.add(
            this.widget.onDidChangeContents(() => {
                ...
                if (this._anchorBox) {
                    this._placeAtAnchor(
                        this._anchorBox,
                        (_a = this._userSize) !== null && _a !== void 0
                            ? _a
                            : this.widget.size,
