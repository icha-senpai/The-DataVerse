...
export const RawWorkbenchListFocusContextKey = new RawContextKey(
    "listFocus",
    true
);
export const WorkbenchTreeStickyScrollFocused = new RawContextKey(
...
export const WorkbenchListHasSelectionOrFocus = new RawContextKey(
    "listHasSelectionOrFocus",
    false
);
export const WorkbenchListDoubleSelection = new RawContextKey(
    "listDoubleSelection",
    false
);
export const WorkbenchListMultiSelection = new RawContextKey(
    "listMultiSelection",
    false
);
export const WorkbenchListSelectionNavigation = new RawContextKey(
    "listSelectionNavigation",
    false
);
export const WorkbenchListSupportsFind = new RawContextKey(
    "listSupportsFind",
    true
);
export const WorkbenchTreeElementCanCollapse = new RawContextKey(
    "treeElementCanCollapse",
    false
);
export const WorkbenchTreeElementHasParent = new RawContextKey(
    "treeElementHasParent",
    false
);
export const WorkbenchTreeElementCanExpand = new RawContextKey(
    "treeElementCanExpand",
    false
);
export const WorkbenchTreeElementHasChild = new RawContextKey(
    "treeElementHasChild",
    false
);
...
class ResourceNavigator extends Disposable {
    constructor(widget, options) {
        ...
        this._register(
            this.widget.onPointer((e) =>
                this.onPointer(e.element, e.browserEvent)
            )
        );
        this._register(
            this.widget.onMouseDblClick((e) =>
        ...
        if (
            typeof (options === null || options === void 0
                ? void 0
                : options.openOnSingleClick) !== "boolean" &&
            ...
            this.openOnSingleClick =
                (_a =
                    options === null || options === void 0
                        ? void 0
                        : options.openOnSingleClick) !== null && _a !== void 0
                    ? _a
                    : true;
        }
    }
...
class TreeResourceNavigator extends ResourceNavigator {
    ...
    getSelectedElement() {
        var _a;
        return (_a = this.widget.getSelection()[0]) !== null && _a !== void 0
            ? _a
            : undefined;
    }
}
    ...
    return {
        ...
        options: {
            ...
            expandOnlyOnTwistieClick:
                (_a = options.expandOnlyOnTwistieClick) !== null &&
                _a !== void 0
                    ? _a
...
let WorkbenchTreeInternals = class WorkbenchTreeInternals {
    ...
    constructor(
        ...
        this.listSupportFindWidget.set(
            (_a = options.findWidgetEnabled) !== null && _a !== void 0
                ? _a
                : true
        );
