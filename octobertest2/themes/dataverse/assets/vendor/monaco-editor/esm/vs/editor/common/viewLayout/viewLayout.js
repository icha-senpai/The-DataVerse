...
export class ViewLayout extends Disposable {
    constructor(configuration, lineCount, scheduleAtNextAnimationFrame) {
        ...
        this._linesLayout = new LinesLayout(
            lineCount,
            options.get(66 /* EditorOption.lineHeight */),
            padding.top,
            padding.bottom
        );
    ...
    _getContentHeight(width, height, contentWidth) {
        ...
        if (options.get(104 /* EditorOption.scrollBeyondLastLine */)) {
            result += Math.max(
                ...
                height -
                    options.get(66 /* EditorOption.lineHeight */) -
                    options.get(83 /* EditorOption.padding */).bottom
            );
        } else if (
            !options.get(102 /* EditorOption.scrollbar */)
    ...
    _computeContentWidth() {
        ...
        if (wrappingInfo.isViewportWrapping) {
            ...
            const extraHorizontalSpace =
                options.get(103 /* EditorOption.scrollBeyondLastColumn */) *
                fontInfo.typicalHalfwidthCharacterWidth;
