...
export function derivedOpts(options, computeFn) {
    ...
    return new Derived(
        ...
        (_a = options.equalityComparer) !== null && _a !== void 0
            ? _a
            : defaultEqualityComparer
    );
}
...
export function derivedWithStore(computeFnOrOwner, computeFnOrUndefined) {
    ...
    return new Derived(
        ...
        () => {
            var _a;
            return (_a = getFunctionName(computeFn)) !== null && _a !== void 0
                ? _a
                : "(anonymous)";
        },
        (r) => {
...
export class Derived extends BaseObservable {
    ...
    constructor(
        ...
        this.changeSummary =
            (_a = this.createChangeSummary) === null || _a === void 0
                ? void 0
                : _a.call(this);
        (_b = getLogger()) === null || _b === void 0
            ? void 0
            : _b.handleDerivedCreated(this);
    }
    onLastObserverRemoved() {
        ...
        (_a = this._handleLastObserverRemoved) === null || _a === void 0
            ? void 0
            : _a.call(this);
    }
    get() {
        ...
        if (this.observers.size === 0) {
            ...
            do {
                ...
                if (
                    this.state ===
                    1 /* DerivedState.dependenciesMightHaveChanged */
                ) {
                    for (const d of this.dependencies) {
    ...
    _recomputeIfNeeded() {
        ...
        (_b = getLogger()) === null || _b === void 0
            ? void 0
            : _b.handleDerivedRecomputed(this, {
                  oldValue,
                  newValue: this.value,
                  change: undefined,
                  didChange,
