...
let HoverService = class HoverService {
    ...
    showHover(options, focus, skipLastFocusedUpdate) {
        ...
        if (
            this._currentHover &&
            ((_b =
                (_a = this._currentHoverOptions) === null || _a === void 0
                    ? void 0
                    : _a.persistence) === null || _b === void 0
                ? void 0
                : _b.sticky)
        ) {
            return undefined;
        ...
        if (
            (_c = options.persistence) === null || _c === void 0
                ? void 0
                : _c.sticky
        ) {
            hover.isLocked = true;
        ...
        hover.onDispose(() => {
            ...
            const hoverWasFocused =
                ((_a = this._currentHover) === null || _a === void 0
                    ? void 0
                    : _a.domNode) &&
                isAncestorOfActiveElement(this._currentHover.domNode);
            if (hoverWasFocused) {
                // Required to handle cases such as closing the hover with the escape key
                (_b = this._lastFocusedElementBeforeOpen) === null ||
                _b === void 0
                    ? void 0
                    : _b.focus();
            }
        ...
        if (
            (_d = options.persistence) === null || _d === void 0
                ? void 0
                : _d.sticky
        ) {
    ...
    _keyDown(e, hover, hideOnKeyDown) {
        ...
        if (
            ...
            this.hideHover();
            (_b = this._lastFocusedElementBeforeOpen) === null || _b === void 0
                ? void 0
                : _b.focus();
        }
    }
    _keyUp(e, hover) {
        ...
        if (e.key === "Alt") {
            ...
            if (!hover.isMouseIn) {
                this.hideHover();
                (_a = this._lastFocusedElementBeforeOpen) === null ||
                _a === void 0
                    ? void 0
                    : _a.focus();
            }
