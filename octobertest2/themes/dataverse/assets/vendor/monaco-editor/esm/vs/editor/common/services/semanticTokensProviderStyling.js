            ...
            if (tokenType) {
                ...
                if (typeof tokenStyle === "undefined") {
                    ...
                    if (typeof tokenStyle.italic !== "undefined") {
                        ...
                        metadata |=
                            italicBit |
                            1 /* MetadataConsts.SEMANTIC_USE_ITALIC */;
                    }
                    if (typeof tokenStyle.bold !== "undefined") {
                        const boldBit =
                            ...
                            11; /* MetadataConsts.FONT_STYLE_OFFSET */
                        metadata |=
                            boldBit | 2 /* MetadataConsts.SEMANTIC_USE_BOLD */;
                    }
                    if (typeof tokenStyle.underline !== "undefined") {
                        ...
                        metadata |=
                            underlineBit |
                            4 /* MetadataConsts.SEMANTIC_USE_UNDERLINE */;
                    }
                    if (typeof tokenStyle.strikethrough !== "undefined") {
                        const strikethroughBit =
                            (tokenStyle.strikethrough
                                ? 8 /* FontStyle.Strikethrough */
                                : 0) <<
                            11; /* MetadataConsts.FONT_STYLE_OFFSET */
                        metadata |=
                            strikethroughBit |
                            8 /* MetadataConsts.SEMANTIC_USE_STRIKETHROUGH */;
                    }
    ...
    while (tokenIndex < tokenCount) {
        ...
        while (tokenIndex < tokenEndIndex) {
            ...
            if (endCharacter <= startCharacter) {
                ...
                if (
                    metadata !==
                    2147483647 /* SemanticTokensProviderStylingConstants.NO_STYLING */
                ) {
                    if (areaLine === 0) {
                        areaLine = lineNumber;
                    }
