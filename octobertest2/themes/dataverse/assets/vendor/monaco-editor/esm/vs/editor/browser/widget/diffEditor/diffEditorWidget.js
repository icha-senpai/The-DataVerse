...
let DiffEditorWidget = class DiffEditorWidget extends DelegatingEditor {
    ...
    constructor(
        ...
        this._accessibleDiffViewerShouldBeVisible = observableValue(
            this,
            false
        );
        ...
        this._layoutInfo = derived(this, (reader) => {
            ...
            const sashLeft =
                (_a = this._sash.read(reader)) === null || _a === void 0
                    ? void 0
                    : _a.sashLeft.read(reader);
            const originalWidth =
                sashLeft !== null && sashLeft !== void 0
                    ? sashLeft
                    : Math.max(
                          5,
            ...
            const modifiedWidth =
                ...
                originalWidth -
                ((_c =
                    (_b = this._overviewRulerPart.read(reader)) === null ||
                    _b === void 0
                        ? void 0
            ...
            const movedBlocksLinesWidth =
                (_e =
                    (_d = this._movedBlocksLinesPart.read(reader)) === null ||
                    _d === void 0
                        ? void 0
                        : _d.width.read(reader)) !== null && _e !== void 0
                    ? _e
                    : 0;
        ...
        this._diffValue = this._diffModel.map((m, r) =>
            m === null || m === void 0 ? void 0 : m.diff.read(r)
        );
        ...
        this._rootSizeObserver.setAutomaticLayout(
            (_a = options.automaticLayout) !== null && _a !== void 0
                ? _a
                : false
        );
        ...
        this._register(
            bindContextKey(
                ...
                (reader) => {
                    var _a;
                    return !!((_a = this._diffModel.read(reader)) === null ||
                    _a === void 0
                        ? void 0
                        : _a.movedTextToCompare.read(reader));
                }
            )
        );
        this._register(
            ...
            bindContextKey(
                ...
                (reader) => {
                    ...
                    return (
                        ((_c =
                            (_b =
                                (_a = this._diffModel.read(reader)) === null ||
                                _a === void 0
                                    ? void 0
                                    : _a.diff.read(reader)) === null ||
                            _b === void 0
                                ? void 0
                                : _b.mappings.length) !== null && _c !== void 0
                            ? _c
                            : 0) > 0
                    );
                }
            ...
            this._instantiationService.createInstance(
                ...
                this._diffModel.map((m, r) => {
                    ...
                    return (_a =
                        m === null || m === void 0
                            ? void 0
                            : m.diff.read(r)) === null || _a === void 0
                        ? void 0
                        : _a.mappings.map((m) => m.lineRangeMapping);
                }),
                this._editors
            )
        ).recomputeInitiallyAndOnChange(this._store);
        const visibility = this._accessibleDiffViewerVisible.map((v) =>
            v ? "hidden" : "visible"
        );
        ...
        this._register(
            applyStyle(this.elements.overlay, {
                ...
                visibility: derived((reader) => /** @description visibility */ {
                    var _a, _b;
                    return this._options.hideUnchangedRegions.read(reader) &&
                        ((_b =
                            (_a = this._diffModel.read(reader)) === null ||
                            _a === void 0
                                ? void 0
        ...
        this._register(
            Event.runAndSubscribe(
                ...
                (e) => {
                    var _a, _b;
                    if (
                        (e === null || e === void 0 ? void 0 : e.reason) ===
                        3 /* CursorChangeReason.Explicit */
                    ) {
                        const diff =
                            (_b =
                                (_a = this._diffModel.get()) === null ||
                                _a === void 0
                                    ? void 0
                                    : _a.diff.get()) === null || _b === void 0
                                ? void 0
                                : _b.mappings.find((m) =>
                        ...
                        if (
                            diff === null || diff === void 0
                                ? void 0
                                : diff.lineRangeMapping.modified.isEmpty
                        ) {
                            ...
                            diff === null || diff === void 0
                                ? void 0
                                : diff.lineRangeMapping.original.isEmpty
                        ) {
                            this._audioCueService.playAudioCue(
        ...
        this._register(
            toDisposable(() => {
                ...
                if (this._shouldDisposeDiffModel) {
                    (_a = this._diffModel.get()) === null || _a === void 0
                        ? void 0
                        : _a.dispose();
                }
            })
    ...
    restoreViewState(s) {
        ...
        if (s && s.original && s.modified) {
            ...
            if (diffEditorState.modelState) {
                (_a = this._diffModel.get()) === null || _a === void 0
                    ? void 0
                    : _a.restoreSerializedState(diffEditorState.modelState);
            }
        }
    }
    handleInitialized() {
    ...
    setModel(model, tx) {
        ...
        if (
            this._diffModel.get() !==
            (vm === null || vm === void 0 ? void 0 : vm.model)
        ) {
            subtransaction(tx, (tx) => {
                ...
                this._shouldDisposeDiffModel =
                    (_a =
                        vm === null || vm === void 0
                            ? void 0
                            : vm.shouldDispose) !== null && _a !== void 0
                        ? _a
                        : false;
                this._diffModel.set(
                    vm === null || vm === void 0 ? void 0 : vm.model,
                ...
                if (shouldDispose) {
                    prevValue === null || prevValue === void 0
                        ? void 0
                        : prevValue.dispose();
                }
            });
    ...
    revealFirstDiff() {
        ...
        this.waitForDiff().then(() => {
            var _a;
            const diffs =
                (_a = diffModel.diff.get()) === null || _a === void 0
                    ? void 0
                    : _a.mappings;
            if (!diffs || diffs.length === 0) {
                return;
