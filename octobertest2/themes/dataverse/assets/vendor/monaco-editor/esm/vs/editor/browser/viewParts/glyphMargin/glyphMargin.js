...
export class GlyphMarginWidgets extends ViewPart {
    ...
    removeWidget(widget) {
        ...
        if (this._widgets[widgetId]) {
            ...
            (_a = domNode.parentNode) === null || _a === void 0
                ? void 0
                : _a.removeChild(domNode);
            this.setShouldRender();
        }
    }
    ...
    _collectDecorationBasedGlyphRenderRequest(ctx, requests) {
        ...
        for (const d of decorations) {
            ...
            const lane =
                (_b =
                    (_a = d.options.glyphMargin) === null || _a === void 0
                        ? void 0
                        : _a.position) !== null && _b !== void 0
                    ? _b
                    : GlyphMarginLane.Center;
            const zIndex =
                (_c = d.options.zIndex) !== null && _c !== void 0 ? _c : 0;
            for (
                ...
                if (a.laneIndex === b.laneIndex) {
                    if (a.zIndex === b.zIndex) {
                        if (b.type === a.type) {
                            if (
                                a.type ===
                                    0 /* GlyphRenderRequestType.Decoration */ &&
                                b.type ===
                                    0 /* GlyphRenderRequestType.Decoration */
                            ) {
                                return a.className < b.className ? -1 : 1;
