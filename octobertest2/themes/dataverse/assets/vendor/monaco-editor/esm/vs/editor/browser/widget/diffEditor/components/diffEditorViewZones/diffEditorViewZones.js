    ...
    constructor(
        ...
        this._register(
            this._editors.original.onDidChangeConfiguration((args) => {
                if (
                    args.hasChanged(144 /* EditorOption.wrappingInfo */) ||
                    args.hasChanged(66 /* EditorOption.lineHeight */)
                ) {
                    updateImmediately.schedule();
                }
            })
        ...
        const originalModelTokenizationCompleted = this._diffModel
            ...
            .map((m, reader) =>
                m === null || m === void 0 ? void 0 : m.read(reader)
            );
        const alignments = derived((reader) => {
            /** @description alignments */
            const diffModel = this._diffModel.read(reader);
            const diff =
                diffModel === null || diffModel === void 0
                    ? void 0
                    : diffModel.diff.read(reader);
            if (!diffModel || !diff) {
                return null;
            }
            state.read(reader);
        ...
        const alignmentsSyncedMovedText = derived((reader) => {
            ...
            const syncedMovedText =
                (_a = this._diffModel.read(reader)) === null || _a === void 0
                    ? void 0
        ...
        this.viewZones = derivedWithStore(this, (reader, store) => {
            ...
            const deletedCodeLineBreaksComputer = !renderSideBySide
                ? (_a = this._editors.modified._getViewModel()) === null ||
                  _a === void 0
                    ? void 0
                    : _a.createLineBreaksComputer()
                : undefined;
                ...
                for (const a of alignmentsVal) {
                    if (a.diff) {
                        for (
                            ...
                            deletedCodeLineBreaksComputer === null ||
                            deletedCodeLineBreaksComputer === void 0
                                ? void 0
            ...
            const lineBreakData =
                (_b =
                    ...
                    deletedCodeLineBreaksComputer === void 0
                        ? void 0
                        : deletedCodeLineBreaksComputer.finalize()) !== null &&
                _b !== void 0
                    ? _b
                    : [];
            ...
            const syncedMovedText =
                (_c = this._diffModel.read(reader)) === null || _c === void 0
                    ? void 0
                    : _c.movedTextToCompare.read(reader);
            const mightContainNonBasicASCII =
                (_e =
                    (_d = this._editors.original.getModel()) === null ||
                    _d === void 0
                        ? void 0
                        : _d.mightContainNonBasicASCII()) !== null &&
                _e !== void 0
                    ? _e
                    : false;
            const mightContainRTL =
                (_g =
                    (_f = this._editors.original.getModel()) === null ||
                    _f === void 0
                        ? void 0
                        : _f.mightContainRTL()) !== null && _g !== void 0
                    ? _g
                    : false;
            ...
            for (const a of alignmentsVal) {
                if (a.diff && !renderSideBySide) {
                    ...
                    if (delta > 0) {
                        if (
                            syncedMovedText === null ||
                            syncedMovedText === void 0
                                ? void 0
            ...
            for (const a of (_h = alignmentsSyncedMovedText.read(reader)) !==
                null && _h !== void 0
                ? _h
                : []) {
                if (
                    !(syncedMovedText === null || syncedMovedText === void 0
                        ? void 0
...
DiffEditorViewZones = __decorate(
    [__param(8, IClipboardService), __param(9, IContextMenuService)],
    DiffEditorViewZones
);
...
function computeRangeAlignment(
    ...
    function handleAlignmentsOutsideOfDiffs(
        untilOriginalLineNumberExclusive,
        untilModifiedLineNumberExclusive
    ) {
        while (true) {
    ...
    for (const m of diffs) {
        ...
        function emitAlignment(
            ...
            const originalAdditionalHeight =
                (_b =
                    (_a = originalLineHeightOverrides.takeWhile(
                        (v) => v.lineNumber < origLineNumberExclusive
                    )) === null || _a === void 0
                        ? void 0
                        : _a.reduce((p, c) => p + c.heightInPx, 0)) !== null &&
                _b !== void 0
                    ? _b
                    : 0;
            const modifiedAdditionalHeight =
                (_d =
                    (_c = modifiedLineHeightOverrides.takeWhile(
                        (v) => v.lineNumber < modLineNumberExclusive
                    )) === null || _c === void 0
                        ? void 0
                        : _c.reduce((p, c) => p + c.heightInPx, 0)) !== null &&
                _d !== void 0
                    ? _d
                    : 0;
            result.push({
...
function getAdditionalLineHeights(editor, viewZonesToIgnore) {
    ...
    const hasWrapping =
        editor.getOption(144 /* EditorOption.wrappingInfo */).wrappingColumn !==
        -1;
