...
let AbstractGotoSymbolQuickAccessProvider =
    (AbstractGotoSymbolQuickAccessProvider_1 = class AbstractGotoSymbolQuickAccessProvider extends (
        ...
        provideLabelPick(picker, label) {
            picker.items = [
                { label, index: 0, kind: 14 /* SymbolKind.String */ },
            ];
        ...
        async waitForLanguageSymbolRegistry(model, disposables) {
            ...
            disposables.add(
                toDisposable(() =>
                    symbolProviderRegistryPromise.complete(false)
                )
            );
        ...
        doProvideWithEditorSymbols(context, model, picker, token) {
            ...
            const updatePickerItems = async (positionToEnclose) => {
                ...
                try {
                    const query = prepareQuery(
                        picker.value
                            .substr(
                                AbstractGotoSymbolQuickAccessProvider_1.PREFIX
                                    .length
                            )
                            .trim()
                    );
            ...
            updatePickerItems(
                (_a = editor.getSelection()) === null || _a === void 0
                    ? void 0
                    : _a.getPosition()
            );
        ...
        async doGetSymbolPicks(symbolsPromise, query, options, token) {
            ...
            const filterBySymbolKind =
                query.original.indexOf(
                    AbstractGotoSymbolQuickAccessProvider_1.SCOPE_PREFIX
                ) === 0;
            ...
            const openSideBySideDirection =
                (_b =
                    (_a = this.options) === null || _a === void 0
                        ? void 0
                        : _a.openSideBySideDirection) === null || _b === void 0
                    ? void 0
                    : _b.call(_a);
            ...
            for (let index = 0; index < symbols.length; index++) {
                ...
                const deprecated =
                    symbol.tags &&
                    symbol.tags.indexOf(1 /* SymbolTag.Deprecated */) >= 0;
...
AbstractGotoSymbolQuickAccessProvider =
    AbstractGotoSymbolQuickAccessProvider_1 = __decorate(
        [
