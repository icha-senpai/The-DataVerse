...
export class InlayHintItem {
    ...
    async _doResolve(token) {
        ...
        try {
            ...
            this.hint.tooltip =
                (_a =
                    newHint === null || newHint === void 0
                        ? void 0
                        : newHint.tooltip) !== null && _a !== void 0
                    ? _a
                    : this.hint.tooltip;
            this.hint.label =
                (_b =
            ...
            this.hint.textEdits =
                (_c =
                    newHint === null || newHint === void 0
                        ? void 0
                        : newHint.textEdits) !== null && _c !== void 0
                    ? _c
                    : this.hint.textEdits;
...
InlayHintsFragments._emptyInlayHintList = Object.freeze({
    dispose() {},
    hints: [],
});
