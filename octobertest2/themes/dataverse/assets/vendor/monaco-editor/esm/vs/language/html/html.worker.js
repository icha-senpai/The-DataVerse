                    ...
                    if (a.name.toLowerCase() === attribute) {
                        ...
                        if (a.valueSet) {
                            if (_this._valueSetMap[a.valueSet]) {
                                _this._valueSetMap[a.valueSet].forEach(
                                    function (v) {
                                        values.push(v);
                                    }
                                );
                ...
                return __generator2(this, function (_a2) {
                    switch (_a2.label) {
                        ...
                        case 1:
                            ...
                            return [
                                4,
                                participant.computeCompletions(
                                    document,
                                    documentContext
                                ),
                            ];
                        case 2:
                            ...
                            return [
                                2,
                                {
                                    isIncomplete:
                                        result.isIncomplete ||
                                        pathCompletionResult.isIncomplete,
                                    items: pathCompletionResult.items.concat(
                                        result.items
                                    ),
                                },
                            ];
        ...
        HTMLCompletion2.prototype._doComplete = function (
                ...
                while (curr) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            var insertText =
                                startIndent + "</" + tag + closeTag;
                            item.textEdit = TextEdit.replace(
                                getReplaceRange(
                                    afterOpenBracket2 - 1 - endIndent.length
                                ),
                                insertText
                            );
                    ...
                    var defaultValue =
                        (_a2 =
                            settings === null || settings === void 0
                                ? void 0
                                : settings.attributeDefaultValue) !== null &&
                        _a2 !== void 0
                            ? _a2
                            : "doublequotes";
            ...
            function collectAttributeValueSuggestions(valueStart, valueEnd) {
                ...
                if (completionParticipants.length > 0) {
                    ...
                    for (
                        var _i = 0,
                            completionParticipants_1 = completionParticipants;
            ...
            function collectInsideContent() {
                for (
                    var _i = 0,
                        completionParticipants_2 = completionParticipants;
        ...
        HTMLHover2.prototype.doHover = function (
            ...
            function getAttrHover(currTag, currAttr, range) {
                var _loop_2 = function (provider2) {
                    var hover = null;
                    provider2
                        .provideAttributes(currTag)
                        .forEach(function (attr2) {
            ...
            if (node.endTagStart && offset >= node.endTagStart) {
                var tagRange_1 = getTagNameRange2(
                    TokenType.EndTag,
                    node.endTagStart
                );
                if (tagRange_1) {
            ...
            var attrRange = getTagNameRange2(
        ...
        HTMLHover2.prototype.doesSupportMarkdown = function () {
            ...
            if (!isDefined(this.supportsMarkdown)) {
                ...
                var contentFormat =
                    (_c =
                        (_b =
                            (_a2 = this.lsOptions.clientCapabilities) ===
                                null || _a2 === void 0
                                ? void 0
    ...
    var __webpack_modules__ = [
        ...
        function (module, __unused_webpack_exports, __webpack_require__2) {
            ...
            var TemplatablePattern =
                __webpack_require__2(14).TemplatablePattern;
            var Pattern = __webpack_require__2(12).Pattern;
            var TOKEN = {
...
function findLinkedEditingRanges(document, position, htmlDocument) {
    ...
    if (
        ...
        (node.start + "<".length <= offset &&
            offset <= node.start + "<".length + tagLength) || // Within closing tag, compute open tag
        (node.endTagStart + "</".length <= offset &&
