...
export const pasteWidgetVisibleCtx = new RawContextKey(
    "pasteWidgetVisible",
    false,
    localize("pasteWidgetVisible", "Whether the paste widget is showing")
);
const vscodeClipboardMime = "application/vnd.code.copyMetadata";
let CopyPasteController =
    (CopyPasteController_1 = class CopyPasteController extends Disposable {
        static get(editor) {
        ...
        constructor(
            ...
            this._register(
                addDisposableListener(container, "copy", (e) =>
                    this.handleCopy(e)
                )
            );
            this._register(
                addDisposableListener(container, "cut", (e) =>
                    this.handleCopy(e)
                )
            );
            this._register(
        ...
        isPasteAsEnabled() {
            return (
                this._editor.getOption(84 /* EditorOption.pasteAs */).enabled &&
        ...
        handleCopy(e) {
            ...
            const providerCopyMimeTypes = providers.flatMap((x) => {
                var _a;
                return (_a = x.copyMimeTypes) !== null && _a !== void 0
                    ? _a
                    : [];
            });
            ...
            (_b = this._currentCopyOperation) === null || _b === void 0
                ? void 0
                : _b.dataTransferPromise.cancel();
        ...
        async handlePaste(e) {
            ...
            (_a = MessageController.get(this._editor)) === null || _a === void 0
                ? void 0
                : _a.closeMessage();
            (_b = this._currentPasteOperation) === null || _b === void 0
                ? void 0
                : _b.cancel();
            ...
            const allPotentialMimeTypes = [
                ...
                ...((_c =
                    metadata === null || metadata === void 0
                        ? void 0
                        : metadata.providerCopyMimeTypes) !== null &&
                _c !== void 0
                    ? _c
                    : []),
            ...
            const allProviders =
                this._languageFeaturesService.documentPasteEditProvider
                    ...
                    .filter((provider) => {
                        var _a, _b;
                        if (
                            (_a = this._pasteAsActionContext) === null ||
                            _a === void 0
                                ? void 0
                                : _a.preferredId
                        ) {
                        ...
                        return (_b = provider.pasteMimeTypes) === null ||
                            _b === void 0
                            ? void 0
                            : _b.some((type) =>
            ...
            if (!allProviders.length) {
                if (
                    (_d = this._pasteAsActionContext) === null || _d === void 0
                        ? void 0
                        : _d.preferredId
                ) {
                    this.showPasteAsNoEditMessage(
                        selections,
                        (_e = this._pasteAsActionContext) === null ||
                            _e === void 0
                            ? void 0
                            : _e.preferredId
                    );
            ...
            const p = createCancelablePromise(async (token) => {
                ...
                try {
                    ...
                    if (providerEdits.length) {
                        const canShowWidget =
                            editor.getOption(84 /* EditorOption.pasteAs */)
        ...
        fetchCopyMetadata(e) {
            ...
            const [_, metadata] = ClipboardEventUtils.getTextData(
                e.clipboardData
            );
            if (metadata) {
                return {
                    defaultPastePayload: {
                        mode: metadata.mode,
                        multicursorText:
                            (_a = metadata.multicursorText) !== null &&
                            _a !== void 0
                                ? _a
                                : null,
        ...
        async mergeInDataFromCopy(dataTransfer, metadata, token) {
            ...
            if (
                (metadata === null || metadata === void 0
                    ? void 0
                    : metadata.id) &&
                ((_a = this._currentCopyOperation) === null || _a === void 0
                    ? void 0
                    : _a.handle) === metadata.id
            ) {
                const toMergeDataTransfer = await this._currentCopyOperation
                    .dataTransferPromise;
            ...
            const results = await raceCancellation(
                Promise.all(
                    providers.map(async (provider) => {
                        ...
                        try {
                            const edit = await ((_a =
                                provider.provideDocumentPasteEdits) === null ||
                            _a === void 0
                                ? void 0
                                : _a.call(
                                      provider,
            ...
            const payload = {
                ...
                pasteOnNewLine:
                    (_b =
                        metadata === null || metadata === void 0
                            ? void 0
                            : metadata.defaultPastePayload.pasteOnNewLine) !==
                        null && _b !== void 0
                        ? _b
                        : false,
                multicursorText:
                    (_c =
                        metadata === null || metadata === void 0
                            ? void 0
                            : metadata.defaultPastePayload.multicursorText) !==
                        null && _c !== void 0
                        ? _c
                        : null,
                mode: null,
...
function isSupportedPasteProvider(provider, dataTransfer) {
    var _a;
    return Boolean(
        (_a = provider.pasteMimeTypes) === null || _a === void 0
            ? void 0
            : _a.some((type) => dataTransfer.matches(type))
    );
}
