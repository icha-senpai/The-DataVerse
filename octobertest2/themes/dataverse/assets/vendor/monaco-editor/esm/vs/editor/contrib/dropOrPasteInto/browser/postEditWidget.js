...
let PostEditWidget = (PostEditWidget_1 = class PostEditWidget extends (
    Disposable
) {
    constructor(
        typeId,
...
let PostEditWidgetManager = class PostEditWidgetManager extends Disposable {
    ...
    async applyEditAndShowIfNeeded(ranges, edits, canShowWidget, token) {
        ...
        if (
            ...
            this.show(
                editRange !== null && editRange !== void 0
                    ? editRange
                    : primaryRange,
                edits,
                async (newEditIndex) => {
    ...
    tryShowSelector() {
        var _a;
        (_a = this._currentWidget.value) === null || _a === void 0
            ? void 0
            : _a.showSelector();
    }
};
PostEditWidgetManager = __decorate(
    [__param(4, IInstantiationService), __param(5, IBulkEditService)],
