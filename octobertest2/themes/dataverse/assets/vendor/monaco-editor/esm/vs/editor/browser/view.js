...
let View = class View extends ViewEventHandler {
    constructor(
        ...
        PartFingerprints.write(
            ...
            3 /* PartFingerprint.OverflowGuard */
        );
    ...
    _computeGlyphMarginLanes() {
        ...
        glyphs = glyphs.concat(
            model.getAllMarginDecorations().map((decoration) => {
                ...
                const lane =
                    (_b =
                        (_a = decoration.options.glyphMargin) === null ||
                        _a === void 0
                            ? void 0
                ...
                return {
                    ...
                    lane,
                    persist:
                        (_c = decoration.options.glyphMargin) === null ||
                        _c === void 0
                            ? void 0
                            : _c.persistLane,
                };
    ...
    _getEditorClassName() {
        ...
        return (
            this._context.configuration.options.get(
                140 /* EditorOption.editorClassName */
            ) +
            " " +
    ...
    layoutContentWidget(widgetData) {
        ...
        this._contentWidgets.setWidgetPosition(
            widgetData.widget,
            (_b =
                (_a = widgetData.position) === null || _a === void 0
                    ? void 0
                    : _a.position) !== null && _b !== void 0
                ? _b
                : null,
            (_d =
                (_c = widgetData.position) === null || _c === void 0
                    ? void 0
                    : _c.secondaryPosition) !== null && _d !== void 0
                ? _d
                : null,
            (_f =
                (_e = widgetData.position) === null || _e === void 0
                    ? void 0
                    : _e.preference) !== null && _f !== void 0
                ? _f
                : null,
            (_h =
                (_g = widgetData.position) === null || _g === void 0
                    ? void 0
                    : _g.positionAffinity) !== null && _h !== void 0
                ? _h
                : null
        );
        this._scheduleRender();
