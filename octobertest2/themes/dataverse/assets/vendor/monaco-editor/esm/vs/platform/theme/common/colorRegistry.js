...
export function executeTransform(transform, theme) {
    ...
    switch (transform.op) {
        case 0 /* ColorTransformType.Darken */:
            return (_a = resolveColorValue(transform.value, theme)) === null ||
                _a === void 0
                ? void 0
                : _a.darken(transform.factor);
        case 1 /* ColorTransformType.Lighten */:
            return (_b = resolveColorValue(transform.value, theme)) === null ||
                _b === void 0
                ? void 0
                : _b.lighten(transform.factor);
        case 2 /* ColorTransformType.Transparent */:
            return (_c = resolveColorValue(transform.value, theme)) === null ||
                _c === void 0
                ? void 0
        ...
        case 3 /* ColorTransformType.Opaque */: {
            ...
            return (_d = resolveColorValue(transform.value, theme)) === null ||
                _d === void 0
                ? void 0
