...
function createLineBreaks(
    ...
    const trustedhtml =
        (_a =
            ttPolicy === null || ttPolicy === void 0
                ? void 0
                : ttPolicy.createHTML(html)) !== null && _a !== void 0
            ? _a
            : html;
...
function renderLine(
    ...
    let nextCharCode =
        0 < len ? lineContent.charCodeAt(0) : 0 /* CharCode.Null */;
    sb.appendString("<span>");
    for (let charIndex = 0; charIndex < len; charIndex++) {
        if (
            charIndex !== 0 &&
            charIndex % 16384 /* Constants.SPAN_MODULO_LIMIT */ === 0
        ) {
...
function readClientRect(range, spans, startOffset, endOffset) {
    range.setStart(
        spans[(startOffset / 16384) /* Constants.SPAN_MODULO_LIMIT */ | 0]
            .firstChild,
        startOffset % 16384 /* Constants.SPAN_MODULO_LIMIT */
    );
    range.setEnd(
        spans[(endOffset / 16384) /* Constants.SPAN_MODULO_LIMIT */ | 0]
            .firstChild,
