...
(function (TypeNavigationControllerState) {
    TypeNavigationControllerState[(TypeNavigationControllerState["Idle"] = 0)] =
        "Idle";
    TypeNavigationControllerState[
        (TypeNavigationControllerState["Typing"] = 1)
    ] = "Typing";
...
export const DefaultKeyboardNavigationDelegate = new (class {
    mightProducePrintableCharacter(event) {
        ...
        return (
            (event.keyCode >= 31 /* KeyCode.KeyA */ &&
                event.keyCode <= 56) /* KeyCode.KeyZ */ ||
            (event.keyCode >= 21 /* KeyCode.Digit0 */ &&
                event.keyCode <= 30) /* KeyCode.Digit9 */ ||
            (event.keyCode >= 98 /* KeyCode.Numpad0 */ &&
                event.keyCode <= 107) /* KeyCode.Numpad9 */ ||
            (event.keyCode >= 85 /* KeyCode.Semicolon */ &&
                event.keyCode <= 95) /* KeyCode.Quote */
        );
    }
})();
class TypeNavigationController {
    ...
    updateOptions(options) {
        var _a, _b;
        if (
            (_a = options.typeNavigationEnabled) !== null && _a !== void 0
                ? _a
                : true
        ) {
            this.enable();
    ...
    onClear() {
        ...
        if (focus.length > 0 && focus[0] === this.previouslyFocused) {
            ...
            const ariaLabel =
                (_a = this.list.options.accessibilityProvider) === null ||
                _a === void 0
                    ? void 0
...
export class DefaultStyleController {
    ...
    style(styles) {
        ...
        const inactiveFocusAndSelectionOutline = asCssValueWithDefault(
            styles.listSelectionOutline,
            (_b = styles.listInactiveFocusOutline) !== null && _b !== void 0
                ? _b
                : ""
        );
    ...
    constructor(
        ...
        const role =
            ...
            this._options.accessibilityProvider.getWidgetRole
                ? (_a = this._options.accessibilityProvider) === null ||
                  _a === void 0
                    ? void 0
                    : _a.getWidgetRole()
                : "list";
        ...
        if (this.accessibilityProvider) {
            ...
            (_c = (_b = this.accessibilityProvider)
                .onDidChangeActiveDescendant) === null || _c === void 0
                ? void 0
                : _c.call(
                      _b,
        ...
        if (_options.keyboardNavigationLabelProvider) {
            ...
            this.typeNavigationController = new TypeNavigationController(
                ...
                (_d = _options.keyboardNavigationEventFilter) !== null &&
                _d !== void 0
                    ? _d
                    : () => true,
                delegate
