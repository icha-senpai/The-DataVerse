...
let StandaloneColorPickerParticipant = class StandaloneColorPickerParticipant {
    ...
    async createColorHover(
        ...
        const colorInfo =
            foundColorInfo !== null && foundColorInfo !== void 0
                ? foundColorInfo
                : defaultColorInfo;
        const colorProvider =
...
function renderHoverParts(
    ...
    const widget = disposables.add(
        new ColorPickerWidget(
            context.fragment,
            model,
            editor.getOption(141 /* EditorOption.pixelRatio */),
            themeService,
...
function _updateEditorModel(editor, range, model) {
    ...
    const textEdits = [];
    const edit =
        (_a = model.presentation.textEdit) !== null && _a !== void 0
            ? _a
            : {
                  range,
    ...
    const trackedRange = editor
        ...
        ._setTrackedRange(
            null,
            replaceRange,
            3 /* TrackedRangeStickiness.GrowsOnlyWhenTypingAfter */
        );
    editor.executeEdits("colorpicker", textEdits);
    editor.pushUndoStop();
    return (_b = editor.getModel()._getTrackedRange(trackedRange)) !== null &&
        _b !== void 0
        ? _b
        : replaceRange;
}
