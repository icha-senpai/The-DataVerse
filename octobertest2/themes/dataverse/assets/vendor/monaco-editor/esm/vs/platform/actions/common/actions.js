...
MenuId.EditorTabsBarShowTabsSubmenu = new MenuId(
    "EditorTabsBarShowTabsSubmenu"
);
MenuId.EditorTabsBarShowTabsZenModeSubmenu = new MenuId(
    "EditorTabsBarShowTabsZenModeSubmenu"
);
MenuId.EditorActionsPositionSubmenu = new MenuId(
...
MenuId.SCMIncomingChangesAllChangesContext = new MenuId(
    "SCMIncomingChangesAllChangesContext"
);
MenuId.SCMIncomingChangesHistoryItemContext = new MenuId(
    "SCMIncomingChangesHistoryItemContext"
);
MenuId.SCMOutgoingChangesAllChangesContext = new MenuId(
    "SCMOutgoingChangesAllChangesContext"
);
MenuId.SCMOutgoingChangesHistoryItemContext = new MenuId(
...
MenuId.StatusBarWindowIndicatorMenu = new MenuId(
    "StatusBarWindowIndicatorMenu"
);
MenuId.StatusBarRemoteIndicatorMenu = new MenuId(
...
MenuId.CommentThreadAdditionalActions = new MenuId(
...
MenuId.NotebookDiffCellMetadataTitle = new MenuId(
    "NotebookDiffCellMetadataTitle"
);
MenuId.NotebookDiffCellOutputsTitle = new MenuId(
    "NotebookDiffCellOutputsTitle"
);
MenuId.NotebookOutputToolbar = new MenuId("NotebookOutputToolbar");
MenuId.NotebookEditorLayoutConfigure = new MenuId(
...
MenuId.TerminalEditorInstanceContext = new MenuId(
