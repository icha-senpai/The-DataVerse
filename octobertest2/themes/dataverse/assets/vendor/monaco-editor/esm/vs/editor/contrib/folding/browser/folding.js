...
let FoldingController = (FoldingController_1 = class FoldingController extends (
    Disposable
) {
    static get(editor) {
    ...
    static getFoldingRangeProviders(languageFeaturesService, model) {
        ...
        return (_b =
            (_a = FoldingController_1._foldingRangeSelector) === null ||
            _a === void 0
                ? void 0
                : _a.call(
                      FoldingController_1,
    ...
    constructor(
        ...
        this._useFoldingProviders =
            options.get(44 /* EditorOption.foldingStrategy */) !==
            "indentation";
        ...
        this._register(
            this.editor.onDidChangeConfiguration((e) => {
                ...
                if (
                    ...
                    e.hasChanged(45 /* EditorOption.foldingHighlight */)
                ) {
                    const options = this.editor.getOptions();
                    this.foldingDecorationProvider.showFoldingControls =
                        options.get(109 /* EditorOption.showFoldingControls */);
                    this.foldingDecorationProvider.showFoldingHighlights =
                        options.get(45 /* EditorOption.foldingHighlight */);
                ...
                if (e.hasChanged(44 /* EditorOption.foldingStrategy */)) {
                    this._useFoldingProviders =
                        this.editor
                            .getOptions()
                            .get(44 /* EditorOption.foldingStrategy */) !==
                        "indentation";
                ...
                if (
                    ...
                    this._unfoldOnClickAfterEndOfLine = this.editor
                        .getOptions()
                        .get(48 /* EditorOption.unfoldOnClickAfterEndOfLine */);
                }
                if (
                    e.hasChanged(46 /* EditorOption.foldingImportsByDefault */)
                ) {
                    this._foldingImportsByDefault = this.editor
                        .getOptions()
                        .get(46 /* EditorOption.foldingImportsByDefault */);
                }
            })
        );
        this.onModelChanged();
    ...
    onModelChanged() {
        ...
        this.localToDispose.add({
            dispose: () => {
                ...
                (_a = this.updateScheduler) === null || _a === void 0
                    ? void 0
                    : _a.cancel();
                this.updateScheduler = null;
                this.foldingModel = null;
                ...
                this.hiddenRangeModel = null;
                this.cursorChangedScheduler = null;
                (_b = this.rangeProvider) === null || _b === void 0
                    ? void 0
                    : _b.dispose();
                this.rangeProvider = null;
            },
    ...
    onFoldingStrategyChanged() {
        var _a;
        (_a = this.rangeProvider) === null || _a === void 0
            ? void 0
            : _a.dispose();
        this.rangeProvider = null;
        this.triggerFoldingModelChanged();
    ...
    getRangeProvider(editorModel) {
        ...
        if (this._useFoldingProviders && this.foldingModel) {
            const selectedProviders =
                FoldingController_1.getFoldingRangeProviders(
...
export class RangesLimitReporter {
    ...
    get limit() {
        return this.editor
            .getOptions()
            .get(47 /* EditorOption.foldingMaximumRegions */);
    }
