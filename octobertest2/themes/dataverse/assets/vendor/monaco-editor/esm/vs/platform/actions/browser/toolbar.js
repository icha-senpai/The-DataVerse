    ...
    constructor(
        ...
        super(container, _contextMenuService, {
            ...
            getKeyBinding: (action) => {
                var _a;
                return (_a = keybindingService.lookupKeybinding(action.id)) !==
                    null && _a !== void 0
                    ? _a
                    : undefined;
            },
            ...
            skipTelemetry:
                typeof (_options === null || _options === void 0
                    ? void 0
                    : _options.telemetrySource) === "string",
        });
    ...
    setActions(_primary, _secondary = [], menuIds) {
        ...
        if (
            ((_a = this._options) === null || _a === void 0
                ? void 0
                : _a.hiddenItemStrategy) !== -1 /* HiddenItemStrategy.NoHide */
        ) {
        ...
        if (
            ((_c = this._options) === null || _c === void 0
                ? void 0
                : _c.overflowBehavior) !== undefined
        ) {
            const exemptedIds = intersection(
                new Set(this._options.overflowBehavior.exempted),
                Iterable.map(primary, (a) =>
                    a === null || a === void 0 ? void 0 : a.id
                )
            );
            const maxItems =
                ...
                addDisposableListener(this.getElement(), "contextmenu", (e) => {
                    ...
                    this._contextMenuService.showContextMenu({
                        ...
                        menuActionOptions: {
                            ...
                            ...((_d = this._options) === null || _d === void 0
                                ? void 0
                                : _d.menuOptions),
                        },
                        skipTelemetry:
                            typeof ((_e = this._options) === null ||
                            _e === void 0
                                ? void 0
                                : _e.telemetrySource) === "string",
        ...
        const updateToolbar = () => {
            ...
            createAndFillInActionBarActions(
                ...
                (_a =
                    options === null || options === void 0
                        ? void 0
                        : options.toolbarOptions) === null || _a === void 0
                    ? void 0
                    : _a.primaryGroup,
                (_b =
                    options === null || options === void 0
                        ? void 0
                        : options.toolbarOptions) === null || _b === void 0
                    ? void 0
                    : _b.shouldInlineSubmenu,
                (_c =
                    options === null || options === void 0
                        ? void 0
                        : options.toolbarOptions) === null || _c === void 0
                    ? void 0
                    : _c.useSeparatorsInPrimaryActions
            );
