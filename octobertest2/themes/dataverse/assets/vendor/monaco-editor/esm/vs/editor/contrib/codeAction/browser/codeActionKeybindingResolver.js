...
let CodeActionKeybindingResolver =
    (CodeActionKeybindingResolver_1 = class CodeActionKeybindingResolver {
        ...
        getResolver() {
            ...
            const allCodeActionBindings = new Lazy(() =>
                this.keybindingService
                    ...
                    .filter(
                        (item) =>
                            CodeActionKeybindingResolver_1.codeActionCommands.indexOf(
                                item.command
                            ) >= 0
                    )
