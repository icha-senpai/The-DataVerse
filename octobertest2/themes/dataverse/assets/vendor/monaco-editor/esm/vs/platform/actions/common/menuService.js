...
MenuService = __decorate(
    [__param(0, ICommandService), __param(1, IStorageService)],
    MenuService
);
export { MenuService };
let PersistedMenuHideState =
    (PersistedMenuHideState_1 = class PersistedMenuHideState {
                ...
                _storageService.onDidChangeValue(
                    ...
                    if (!this._ignoreChangeEvent) {
                        try {
                            ...
                            console.log(
                                "FAILED to read storage after UPDATE",
                                err
                            );
                        }
                    }
        ...
        _isHiddenByDefault(menu, commandId) {
            var _a;
            return (_a = this._hiddenByDefaultCache.get(
                `${menu.id}/${commandId}`
            )) !== null && _a !== void 0
                ? _a
                : false;
        ...
        isHidden(menu, commandId) {
            ...
            const state =
                (_b =
                    (_a = this._data[menu.id]) === null || _a === void 0
                        ? void 0
                        : _a.includes(commandId)) !== null && _b !== void 0
                    ? _b
                    : false;
        ...
        if (isIMenuItem(item)) {
            ...
            if (item.command.toggled) {
                const toggledExpression =
                    item.command.toggled.condition || item.command.toggled;
                MenuInfo_1._fillInKbExprKeys(
                    toggledExpression,
