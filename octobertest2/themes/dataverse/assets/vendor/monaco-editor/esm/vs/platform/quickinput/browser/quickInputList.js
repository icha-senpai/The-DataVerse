...
class ListElement {
    constructor(
        ...
        if (mainItem.type === "separator") {
            ...
            this._labelHighlights =
                (_a = this.item.highlights) === null || _a === void 0
                    ? void 0
                    : _a.label;
            this._descriptionHighlights =
                (_b = this.item.highlights) === null || _b === void 0
                    ? void 0
                    : _b.description;
            this._detailHighlights =
                (_c = this.item.highlights) === null || _c === void 0
                    ? void 0
                    : _c.detail;
        ...
        this._init = new Lazy(() => {
            var _a;
            const saneLabel =
                (_a = mainItem.label) !== null && _a !== void 0 ? _a : "";
...
class ListElementRenderer {
    ...
    renderElement(element, index, data) {
        ...
        element.element =
            (_a = data.entry) !== null && _a !== void 0 ? _a : undefined;
        ...
        const { labelHighlights, descriptionHighlights, detailHighlights } =
            element;
        if (
            (_b = element.item) === null || _b === void 0 ? void 0 : _b.iconPath
        ) {
            const icon = isDark(this.themeService.getColorTheme().type)
                ? element.item.iconPath.dark
                : (_c = element.item.iconPath.light) !== null && _c !== void 0
                ? _c
                : element.item.iconPath.dark;
            ...
            data.icon.className = (
                (_d = element.item) === null || _d === void 0
                    ? void 0
                    : _d.iconClass
            )
        ...
        const options = {
            ...
            descriptionTitle: element.saneTooltip
                ? undefined
...
(function (QuickInputListFocus) {
    ...
    QuickInputListFocus[(QuickInputListFocus["PreviousPage"] = 7)] =
        "PreviousPage";
...
export class QuickInputList {
    constructor(parent, id, options, themeService) {
        ...
        this.onChangedAllVisibleChecked =
        ...
        this.onSeparatorButtonTriggered =
            this._onSeparatorButtonTriggered.event;
        ...
        this.list = options.createList(
            ...
            this.container,
            delegate,
            [new ListElementRenderer(themeService, options.hoverDelegate)],
            {
                identityProvider: {
                    getId: (element) => {
                        ...
                        return (_h =
                            (_f =
                                (_d =
                                    (_b =
                                        (_a = element.item) === null ||
                                        _a === void 0
                                            ? void 0
                                            : _a.id) !== null && _b !== void 0
                                        ? _b
                                        : (_c = element.item) === null ||
                                          _c === void 0
                                        ? void 0
                                        : _c.label) !== null && _d !== void 0
                                    ? _d
                                    : (_e = element.separator) === null ||
                                      _e === void 0
                                    ? void 0
                                    : _e.id) !== null && _f !== void 0
                                ? _f
                                : (_g = element.separator) === null ||
                                  _g === void 0
                                ? void 0
                                : _g.label) !== null && _h !== void 0
                            ? _h
                            : "";
                    },
                },
    ...
    setElements(inputElements) {
        ...
        const fireSeparatorButtonTriggered = (event) =>
        ...
        this.elements = inputElements.reduce((result, item, index) => {
            ...
            elementsToIndexes.set(
                (_a = element.item) !== null && _a !== void 0
                    ? _a
                    : element.separator,
                resultIndex
            );
    ...
    showHover(element) {
        ...
        if (this._lastHover && !this._lastHover.isDisposed) {
            (_b = (_a = this.options.hoverDelegate).onDidHideHover) === null ||
            _b === void 0
                ? void 0
                : _b.call(_a);
            (_c = this._lastHover) === null || _c === void 0
                ? void 0
                : _c.dispose();
        }
...
class QuickInputAccessibilityProvider {
    ...
    getAriaLabel(element) {
        var _a;
        return (
            (_a = element.separator) === null || _a === void 0
                ? void 0
                : _a.label
        )
