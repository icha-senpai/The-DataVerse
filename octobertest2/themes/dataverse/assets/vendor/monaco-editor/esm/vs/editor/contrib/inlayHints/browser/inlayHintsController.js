...
// --- controller
let InlayHintsController =
    (InlayHintsController_1 = class InlayHintsController {
        static get(editor) {
            var _a;
            return (_a = editor.getContribution(InlayHintsController_1.ID)) !==
                null && _a !== void 0
                ? _a
                : undefined;
        }
        constructor(
            ...
            this._disposables.add(
                _editor.onDidChangeModel(() => this._update())
            );
            this._disposables.add(
        ...
        _getInlayHintLabelPart(e) {
            ...
            const options =
                (_a = e.target.detail.injectedText) === null || _a === void 0
                    ? void 0
                    : _a.options;
            if (
                ...
                (options === null || options === void 0
                    ? void 0
                    : options.attachedData) instanceof
        ...
        async _invokeCommand(command, item) {
            ...
            try {
                await this._commandService.executeCommand(
                    command.id,
                    ...((_a = command.arguments) !== null && _a !== void 0
                        ? _a
                        : [])
                );
            } catch (err) {
        ...
        _updateHintsDecorators(ranges, items) {
            ...
            for (const item of items) {
                ...
                if (
                    ...
                    InlayHintsController_1._MAX_LABEL_LEN
                ) {
                    continue;
                }
                ...
                for (let i = 0; i < parts.length; i++) {
                    ...
                    if (
                        ...
                        ((_a = this._activeInlayHintPart) === null ||
                        _a === void 0
                            ? void 0
                            : _a.part.item) === item &&
                ...
                if (
                    newDecorationsData.length >
                    InlayHintsController_1._MAX_DECORATORS
                ) {
                    break;
                }
            }
            ...
            for (const [id, metadata] of this._decorationsMetadata) {
                const range =
                    (_b = this._editor.getModel()) === null || _b === void 0
                        ? void 0
                        : _b.getDecorationRange(id);
        ...
        _fillInColors(props, hint) {
            if (hint.kind === languages.InlayHintKind.Parameter) {
                ...
                props.color = themeColorFromId(
                    colors.editorInlayHintForeground
                );
            }
        }
        _getLayoutInfo() {
