        ...
        for (const { overrides, source } of configurationDefaults) {
            for (const key in overrides) {
                ...
                if (OVERRIDE_PROPERTY_REGEX.test(key)) {
                    ...
                    const valuesSources =
                        (_a =
                            configurationDefaultOverride === null ||
                            configurationDefaultOverride === void 0
                                ? void 0
            ...
            for (const key in properties) {
                ...
                if (OVERRIDE_PROPERTY_REGEX.test(key)) {
                    ...
                    property.restricted = types.isUndefinedOrNull(
                        ...
                        ? !!(restrictedProperties === null ||
                          restrictedProperties === void 0
                              ? void 0
                ...
                if (
                    ...
                    if (
                        (_a = properties[key].policy) === null || _a === void 0
                            ? void 0
                            : _a.name
                    ) {
...
export function validateProperty(property, schema) {
    ...
    if (
        ...
        configurationRegistry
            .getPolicyConfigurations()
            .get(
                (_b = schema.policy) === null || _b === void 0
                    ? void 0
                    : _b.name
            ) !== undefined
    ) {
        return nls.localize(
            ...
            configurationRegistry
                .getPolicyConfigurations()
                .get(
                    (_d = schema.policy) === null || _d === void 0
                        ? void 0
                        : _d.name
                )
        );
