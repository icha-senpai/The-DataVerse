...
let CodeLensContribution = class CodeLensContribution {
    ...
    dispose() {
        ...
        (_a = this._currentCodeLensModel) === null || _a === void 0
            ? void 0
            : _a.dispose();
    }
    _getLayoutInfo() {
        const lineHeightFactor = Math.max(
            ...
            this._editor.getOption(66 /* EditorOption.lineHeight */) /
                this._editor.getOption(52 /* EditorOption.fontSize */)
        );
        ...
        if (!fontSize || fontSize < 5) {
            fontSize =
                (this._editor.getOption(52 /* EditorOption.fontSize */) * 0.9) |
                0;
        }
        return {
            fontSize,
    ...
    _localDispose() {
        var _a, _b, _c;
        (_a = this._getCodeLensModelPromise) === null || _a === void 0
            ? void 0
            : _a.cancel();
        this._getCodeLensModelPromise = undefined;
        (_b = this._resolveCodeLensesPromise) === null || _b === void 0
            ? void 0
            : _b.cancel();
        this._resolveCodeLensesPromise = undefined;
        this._localToDispose.clear();
        this._oldCodeLensModels.clear();
        (_c = this._currentCodeLensModel) === null || _c === void 0
            ? void 0
            : _c.dispose();
    }
    _onModelChange() {
        ...
        if (
            !this._editor.getOption(17 /* EditorOption.codeLens */) ||
        ...
        this._localToDispose.add(
            this._editor.onDidChangeModelContent(() => {
                ...
                (_a = this._resolveCodeLensesPromise) === null || _a === void 0
                    ? void 0
                    : _a.cancel();
                this._resolveCodeLensesPromise = undefined;
            })
    ...
    async getModel() {
        ...
        return !((_a = this._currentCodeLensModel) === null || _a === void 0
            ? void 0
            : _a.isDisposed)
            ...
            if (model.isDisposed) {
                ...
                const newLens =
                    newModel === null || newModel === void 0
                        ? void 0
                        : newModel.lenses.find((lens) => {
                              var _a;
                              return (
                                  lens.symbol.range.startLineNumber ===
                                      lineNumber &&
                                  ((_a = lens.symbol.command) === null ||
                                  _a === void 0
                                      ? void 0
                                      : _a.title) === command.title
                              );
                          });
