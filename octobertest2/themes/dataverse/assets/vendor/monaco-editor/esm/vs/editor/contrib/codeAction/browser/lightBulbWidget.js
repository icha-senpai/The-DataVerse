...
let LightBulbWidget = (LightBulbWidget_1 = class LightBulbWidget extends (
    Disposable
) {
    ...
    update(actions, trigger, atPosition) {
        ...
        const fontInfo = this._editor
            .getOptions()
            .get(50 /* EditorOption.fontInfo */);
...
LightBulbWidget = LightBulbWidget_1 = __decorate(
    [__param(1, IKeybindingService), __param(2, ICommandService)],
    LightBulbWidget
);
