...
let CommonFindController =
    (CommonFindController_1 = class CommonFindController extends Disposable {
        get editor() {
            return this._editor;
        }
        static get(editor) {
        ...
        isFindInputFocused() {
            return !!CONTEXT_FIND_INPUT_FOCUSED.getValue(
        ...
        async _start(opts, newState) {
            ...
            if (opts.updateSearchScope) {
                ...
                if (
                    currentSelections.some((selection) => !selection.isEmpty())
                ) {
        ...
        replaceAll() {
            ...
            if (this._model) {
                if (
                    (_a = this._editor.getModel()) === null || _a === void 0
                        ? void 0
                        : _a.isTooLargeForHeapOperation()
                ) {
        ...
        async getGlobalBufferTerm() {
            if (
                this._editor.getOption(41 /* EditorOption.find */)
                    .globalFindClipboard &&
    ...
    async _start(opts, newState) {
        ...
        if (this._widget) {
            if (
                ...
                opts.shouldFocus === 1 /* FindStartFocusAction.FocusFindInput */
            ) {
...
StartFindAction.addImplementation(0, (accessor, editor, args) => {
    ...
    return controller.start({
        ...
        seedSearchStringFromSelection:
            editor.getOption(41 /* EditorOption.find */)
            ...
            kbOpts: [
                {
                    ...
                    mac: {
                        primary:
                            2048 /* KeyMod.CtrlCmd */ | 37 /* KeyCode.KeyG */,
...
StartFindReplaceAction.addImplementation(0, (accessor, editor, args) => {
    if (
        !editor.hasModel() ||
        editor.getOption(90 /* EditorOption.readOnly */)
    ) {
        return false;
    }
    const controller = CommonFindController.get(editor);
