...
export class CursorMoveCommands {
    ...
    static moveTo(
        ...
        if (inSelectionMode) {
            if (
                cursor.modelState.selectionStartKind ===
    ...
    static _moveToViewFirstNonWhitespaceColumn(
        viewModel,
        cursors,
        inSelectionMode
    ) {
    ...
    static _moveToViewLastNonWhitespaceColumn(
        viewModel,
        cursors,
        inSelectionMode
    ) {
