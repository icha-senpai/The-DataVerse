...
export function createCombinedWorkspaceEdit(uri, ranges, edit) {
    ...
    if (
        ...
        return {
            edits:
                (_b =
                    (_a = edit.additionalEdit) === null || _a === void 0
                        ? void 0
                        : _a.edits) !== null && _b !== void 0
                    ? _b
                    : [],
        };
    }
    return {
        edits: [
            ...
            ...((_d =
                (_c = edit.additionalEdit) === null || _c === void 0
                    ? void 0
                    : _c.edits) !== null && _d !== void 0
                ? _d
                : []),
        ],
    };
...
export function sortEditsByYieldTo(edits) {
    ...
    for (const edit of edits) {
        for (const yTo of (_a = edit.yieldTo) !== null && _a !== void 0
            ? _a
            : []) {
