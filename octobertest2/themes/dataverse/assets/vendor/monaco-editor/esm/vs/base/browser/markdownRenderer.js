    ...
    if (codeBlocks.length > 0) {
        Promise.all(codeBlocks).then((tuples) => {
            ...
            const placeholderElements =
                element.querySelectorAll(`div[data-code]`);
            for (const placeholderElement of placeholderElements) {
                const renderedElement = renderedElements.get(
                    (_a = placeholderElement.dataset["code"]) !== null &&
                        _a !== void 0
                        ? _a
                        : ""
                );
            ...
            (_b = options.asyncRenderCallback) === null || _b === void 0
                ? void 0
                : _b.call(options);
        });
        ...
        for (const placeholderElement of placeholderElements) {
            const renderedElement = renderedElements.get(
                (_b = placeholderElement.dataset["code"]) !== null &&
                    _b !== void 0
                    ? _b
                    : ""
            );
...
function sanitizeRenderedMarkdown(options, renderedMarkdown) {
    ...
    dompurify.addHook("uponSanitizeAttribute", (element, e) => {
        ...
        if (e.attrName === "style" || e.attrName === "class") {
            ...
            ((_a = element.attributes.getNamedItem("type")) === null ||
            _a === void 0
                ? void 0
                : _a.value) === "checkbox"
        ) {
...
export function renderMarkdownAsPlaintext(markdown) {
    ...
    const html = marked
        ...
        .replace(/&(#\d+|[a-zA-Z]+);/g, (m) => {
            var _a;
            return (_a = unescapeInfo.get(m)) !== null && _a !== void 0
                ? _a
                : m;
        });
    ...
    for (let i = 0; i < token.tokens.length; i++) {
        ...
        if (subtoken.type === "text") {
            ...
            if (lastLine.includes("`")) {
                ...
                if (
                    ((_a = nextTwoSubTokens[0]) === null || _a === void 0
                        ? void 0
                        : _a.type) === "link" &&
                    ((_b = nextTwoSubTokens[1]) === null || _b === void 0
                        ? void 0
                        : _b.type) === "text" &&
