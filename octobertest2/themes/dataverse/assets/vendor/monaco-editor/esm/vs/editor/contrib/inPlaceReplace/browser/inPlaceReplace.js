...
let InPlaceReplaceController =
    (InPlaceReplaceController_1 = class InPlaceReplaceController {
        static get(editor) {
        ...
        run(source, up) {
            ...
            (_a = this.currentRequest) === null || _a === void 0
                ? void 0
                : _a.cancel();
            ...
            this.currentRequest = createCancelablePromise((token) =>
                this.editorWorkerService.navigateValueSet(
                    modelURI,
                    selection,
                    up
                )
            ...
            return this.currentRequest
                .then((result) => {
                    ...
                    highlightRange = {
                        ...
                        endColumn:
                            highlightRange.startColumn + result.value.length,
                    };
                    if (diff > 1) {
                    ...
                    (_a = this.decorationRemover) === null || _a === void 0
                        ? void 0
                        : _a.cancel();
