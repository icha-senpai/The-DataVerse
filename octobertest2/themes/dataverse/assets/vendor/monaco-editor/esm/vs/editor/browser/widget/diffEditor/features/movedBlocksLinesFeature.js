...
export class MovedBlocksLinesFeature extends Disposable {
    constructor(
        ...
        this._state = derivedWithStore(this, (reader, store) => {
            ...
            const moves =
                (_a =
                    model === null || model === void 0
                        ? void 0
                        : model.diff.read(reader)) === null || _a === void 0
                    ? void 0
                    : _a.movedTexts;
            ...
            const lineAreaWidth =
                (layout.getTrackCount() - 1) * 10 + padding * 2;
            const width =
                lineAreaLeft +
                lineAreaWidth +
                (infoMod.contentLeft -
            ...
            for (const line of lines) {
                ...
                path.setAttribute(
                    ...
                    `M ${0} ${line.from} L ${verticalY} ${
                        line.from
                    } L ${verticalY} ${line.to} L ${right - arrowWidth} ${
                        line.to
                    }`
                );
                ...
                arrowRight.setAttribute(
                    "points",
                    `${right - arrowWidth},${
                        line.to - arrowHeight / 2
                    } ${right},${line.to} ${right - arrowWidth},${
                        line.to + arrowHeight / 2
                    }`
                );
