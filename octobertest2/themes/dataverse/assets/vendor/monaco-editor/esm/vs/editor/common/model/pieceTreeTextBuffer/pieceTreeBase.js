...
export function createLineStartsFast(str, readonly = true) {
    ...
    for (let i = 0, len = str.length; i < len; i++) {
        ...
        if (chr === 13 /* CharCode.CarriageReturn */) {
            if (
                i + 1 < len &&
                str.charCodeAt(i + 1) === 10 /* CharCode.LineFeed */
            ) {
                // \r\n... case
                r[rLength++] = i + 2;
                i++; // skip \n
...
export class PieceTreeBase {
    ...
    getLinesContent() {
        ...
        this.iterate(this.root, (node) => {
            ...
            if (danglingCR) {
                if (
                    buffer.charCodeAt(pieceStartOffset) ===
                    10 /* CharCode.LineFeed */
                ) {
    ...
    createNewPieces(text) {
        ...
        if (
            ...
            this._buffers[0].lineStarts = this._buffers[0].lineStarts.concat(
                lineStarts.slice(1)
            );
