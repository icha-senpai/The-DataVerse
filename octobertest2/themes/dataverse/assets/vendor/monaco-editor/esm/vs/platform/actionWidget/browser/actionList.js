...
class HeaderRenderer {
    ...
    renderElement(element, _index, templateData) {
        ...
        templateData.text.textContent =
            (_b =
                (_a = element.group) === null || _a === void 0
                    ? void 0
...
let ActionList = class ActionList extends Disposable {
                ...
                ],
                {
                    ...
                    accessibilityProvider: {
                        getAriaLabel: (element) => {
                            if (
                                element.kind ===
                                "action" /* ActionListItemKind.Action */
                            ) {
                        ...
                        getRole: (e) =>
                            e.kind === "action" /* ActionListItemKind.Action */
                                ? "option"
                                : "separator",
    ...
    onFocus() {
        ...
        const focusIndex = focused[0];
        const element = this._list.element(focusIndex);
        (_b = (_a = this._delegate).onFocus) === null || _b === void 0
            ? void 0
            : _b.call(_a, element.item);
    }
    async onListHover(e) {
