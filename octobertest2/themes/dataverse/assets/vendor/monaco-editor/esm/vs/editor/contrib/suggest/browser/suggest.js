...
export async function provideSuggestionItems(
    ...
    const onCompletionList = (provider, container, sw) => {
        ...
        for (const suggestion of container.suggestions) {
            if (!options.kindFilter.has(suggestion.kind)) {
                ...
                if (
                    ...
                    ((_a =
                        suggestion === null || suggestion === void 0
                            ? void 0
                            : suggestion.tags) === null || _a === void 0
                        ? void 0
                        : _a.includes(
                              1 /* languages.CompletionItemTag.Deprecated */
                          ))
                ) {
                    continue;
                }
        ...
        durations.push({
            providerName:
                (_b = provider._debugDisplayName) !== null && _b !== void 0
                    ? _b
                    : "unknown_provider",
            elapsedProvider:
                (_c = container.duration) !== null && _c !== void 0 ? _c : -1,
    ...
    const snippetCompletions = (async () => {
        if (
            ...
            options.kindFilter.has(
                27 /* languages.CompletionItemKind.Snippet */
            )
        ) {
            return;
        }
...
function snippetUpComparator(a, b) {
    if (a.completion.kind !== b.completion.kind) {
        if (
            a.completion.kind === 27 /* languages.CompletionItemKind.Snippet */
        ) {
            return -1;
        } else if (
            b.completion.kind === 27 /* languages.CompletionItemKind.Snippet */
        ) {
            return 1;
        }
    }
    ...
    async (accessor, ...args) => {
        ...
        try {
            ...
            const completions = await provideSuggestionItems(
                ...
                {
                    triggerCharacter:
                        triggerCharacter !== null && triggerCharacter !== void 0
                            ? triggerCharacter
                            : undefined,
            ...
            for (const item of completions.items) {
                if (
                    resolving.length <
                    (maxItemsToResolve !== null && maxItemsToResolve !== void 0
                        ? maxItemsToResolve
                        : 0)
                ) {
...
export function showSimpleSuggestions(editor, provider) {
    var _a;
    (_a = editor.getContribution("editor.contrib.suggestController")) ===
        null || _a === void 0
        ? void 0
