...
export class KeybindingLabel {
    ...
    render() {
        ...
        if (this.keybinding) {
            ...
            const title = (
                (_a = this.options.disableTitle) !== null && _a !== void 0
                    ? _a
                    : false
            )
                ? undefined
    ...
    renderChord(parent, chord, match) {
        ...
        if (chord.ctrlKey) {
            this.renderKey(
                ...
                Boolean(
                    match === null || match === void 0 ? void 0 : match.ctrlKey
                ),
        ...
        if (chord.shiftKey) {
            this.renderKey(
                ...
                Boolean(
                    match === null || match === void 0 ? void 0 : match.shiftKey
                ),
                modifierLabels.separator
            );
        }
        if (chord.altKey) {
            this.renderKey(
                ...
                Boolean(
                    match === null || match === void 0 ? void 0 : match.altKey
                ),
                modifierLabels.separator
            );
        }
        if (chord.metaKey) {
            this.renderKey(
                ...
                Boolean(
                    match === null || match === void 0 ? void 0 : match.metaKey
                ),
                modifierLabels.separator
            );
        }
        ...
        if (keyLabel) {
            this.renderKey(
                ...
                keyLabel,
                Boolean(
                    match === null || match === void 0 ? void 0 : match.keyCode
                ),
                ""
            );
        }
