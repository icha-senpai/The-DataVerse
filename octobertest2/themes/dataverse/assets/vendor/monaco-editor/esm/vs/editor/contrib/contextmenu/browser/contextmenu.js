...
let ContextMenuController =
    (ContextMenuController_1 = class ContextMenuController {
        static get(editor) {
        ...
        constructor(
            ...
            this._editor = editor;
            this._toDispose.add(
                this._editor.onContextMenu((e) => this._onContextMenu(e))
            );
            this._toDispose.add(
        ...
        _onContextMenu(e) {
            ...
            if (!this._editor.getOption(24 /* EditorOption.contextmenu */)) {
                ...
                if (
                    ...
                    !this._editor
                        .getSelection()
                        .containsPosition(e.target.position)
                ) {
        ...
        _doShowContextMenu(actions, event = null) {
            ...
            const useShadowDOM =
                this._editor.getOption(126 /* EditorOption.useShadowDOM */) &&
            ...
            this._contextMenuService.showContextMenu({
                ...
                getActionViewItem: (action) => {
                    ...
                    if (
                        typeof customActionViewItem.getActionViewItem ===
                        "function"
                    ) {
