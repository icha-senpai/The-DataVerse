...
let CodeEditorWidget = (CodeEditorWidget_1 = class CodeEditorWidget extends (
    Disposable
) {
    //#endregion
    get isSimpleWidget() {
    ...
    constructor(
        ...
        this._onWillChangeModel = this._register(
            new Emitter({ deliveryQueue: this._deliveryQueue })
        );
        this.onWillChangeModel = this._onWillChangeModel.event;
        this._onDidChangeModel = this._register(
            new Emitter({ deliveryQueue: this._deliveryQueue })
        );
        ...
        this._onDidLayoutChange = this._register(
            new Emitter({ deliveryQueue: this._deliveryQueue })
        );
        ...
        this._onDidScrollChange = this._register(
            new Emitter({ deliveryQueue: this._deliveryQueue })
        );
        ...
        for (const action of EditorExtensionsRegistry.getEditorActions()) {
            ...
            const internalAction = new InternalEditorAction(
                ...
                action.alias,
                action.metadata,
                (_a = action.precondition) !== null && _a !== void 0
                    ? _a
                    : undefined,
                (args) => {
        ...
        const e = {
            oldModelUrl:
                ((_a = this._modelData) === null || _a === void 0
                    ...
                    : _a.model.uri) || null,
            newModelUrl:
                (model === null || model === void 0 ? void 0 : model.uri) ||
                null,
        };
    ...
    getTopForLineNumber(lineNumber, includeViewZones = false) {
        ...
        return CodeEditorWidget_1._getVerticalOffsetForPosition(
            this._modelData,
            lineNumber,
            1,
            includeViewZones
    ...
    getBottomForLineNumber(lineNumber, includeViewZones = false) {
        ...
        return CodeEditorWidget_1._getVerticalOffsetAfterPosition(
            this._modelData,
            lineNumber,
            1,
            includeViewZones
    ...
    revealRangeNearTopIfOutsideViewport(
        ...
        this._revealRange(
            range,
            6 /* VerticalRevealType.NearTopIfOutsideViewport */,
            true,
            scrollType
        );
    }
    ...
    setScrollLeft(
        newScrollLeft,
        scrollType = 1 /* editorCommon.ScrollType.Immediate */
    ) {
        if (!this._modelData) {
            return;
        }
    ...
    handleInitialized() {
        var _a;
        (_a = this._getViewModel()) === null || _a === void 0
            ? void 0
            : _a.visibleLinesStabilized();
    }
    getContribution(id) {
    ...
    applyFontInfo(target) {
        applyFontInfo(
            target,
            this._configuration.options.get(50 /* EditorOption.fontInfo */)
        );
    }
        ...
        if (this.isSimpleWidget) {
            ...
            commandDelegate = {
                paste: (text, pasteOnNewLine, multicursorText, mode) => {
                    ...
                    this._commandService.executeCommand(
                        "paste" /* editorCommon.Handler.Paste */,
                        payload
                    );
                },
                type: (text) => {
                    const payload = { text };
                    this._commandService.executeCommand(
                        "type" /* editorCommon.Handler.Type */,
                        payload
                    );
                },
                compositionType: (
...
CodeEditorWidget.dropIntoEditorDecorationOptions =
...
export class BooleanEventEmitter extends Disposable {
    ...
    setValue(_value) {
        const value = _value
            ? 2 /* BooleanEventValue.True */
            : 1 /* BooleanEventValue.False */;
