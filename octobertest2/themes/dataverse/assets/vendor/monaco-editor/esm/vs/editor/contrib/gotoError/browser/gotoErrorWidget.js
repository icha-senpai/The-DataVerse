...
class MessageWidget {
    ...
    update(marker) {
        ...
        let sourceAndCodeLength =
            ((source === null || source === void 0 ? void 0 : source.length) ||
                0) + "()".length;
        if (code) {
        ...
        if (isNonEmptyArray(relatedInformation)) {
            ...
            relatedInformationNode.style.paddingTop = `${Math.floor(
                this._editor.getOption(66 /* EditorOption.lineHeight */) * 0.66
            )}px`;
            this._lines += 1;
...
let MarkerNavigationWidget =
    (MarkerNavigationWidget_1 = class MarkerNavigationWidget extends (
        PeekViewWidget
    ) {
        constructor(
            editor,
            ...
            this.onDidSelectRelatedInformation =
        ...
        _applyStyles() {
            if (this._parentContainer) {
                this._parentContainer.style.backgroundColor = this
                    ._backgroundColor
        ...
        _fillHead(container) {
            ...
            const menu = this._menuService.createMenu(
                MarkerNavigationWidget_1.TitleMenu,
