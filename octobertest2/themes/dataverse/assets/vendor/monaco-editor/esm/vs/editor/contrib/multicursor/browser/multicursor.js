...
export class MultiCursorSession {
    ...
    constructor(
        ...
        this.isDisconnectedFromFindController =
            isDisconnectedFromFindController;
    ...
    selectAll(searchScope) {
        ...
        return editorModel.findMatches(
            ...
            this.matchCase,
            this.wholeWord
                ? this._editor.getOption(129 /* EditorOption.wordSeparators */)
                : null,
            false,
            1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */
        );
...
let SelectionHighlighter =
    (SelectionHighlighter_1 = class SelectionHighlighter extends Disposable {
        ...
        _update() {
            this._setState(
                SelectionHighlighter_1._createState(
                    this.state,
                    this._isEnabled,
                    this.editor
                )
        ...
        static _createState(oldState, isEnabled, editor) {
            ...
            if (!r) {
                ...
                if (allSelections.length > 1) {
                    const findState = findController.getState();
                    const matchCase = findState.matchCase;
                    const selectionsContainSameText =
                        modelRangesContainSameText(
                            editor.getModel(),
                            allSelections,
                            matchCase
                        );
            ...
            return new SelectionHighlighterState(
                ...
                r.matchCase,
                r.wholeWord
                    ? editor.getOption(129 /* EditorOption.wordSeparators */)
                    : null,
                oldState
            );
        }
