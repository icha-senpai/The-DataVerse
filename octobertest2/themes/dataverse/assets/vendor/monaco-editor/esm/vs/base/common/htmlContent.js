...
export class MarkdownString {
    constructor(value = "", isTrustedOrOptions = false) {
        ...
        if (typeof isTrustedOrOptions === "boolean") {
            ...
            this.isTrusted =
                (_a = isTrustedOrOptions.isTrusted) !== null && _a !== void 0
                    ? _a
                    : undefined;
            this.supportThemeIcons =
                (_b = isTrustedOrOptions.supportThemeIcons) !== null &&
                _b !== void 0
                    ? _b
                    : false;
            this.supportHtml =
                (_c = isTrustedOrOptions.supportHtml) !== null && _c !== void 0
                    ? _c
                    : false;
        }
    }
    appendText(
        value,
        newlineStyle = 0 /* MarkdownStringTextNewlineStyle.Paragraph */
    ) {
...
export function appendEscapedMarkdownCodeBlockFence(code, langId) {
    ...
    const longestFenceLength =
        (_b =
            (_a = code.match(/^`+/gm)) === null || _a === void 0
                ? void 0
                : _a.reduce((a, b) => (a.length > b.length ? a : b)).length) !==
            null && _b !== void 0
            ? _b
            : 0;
