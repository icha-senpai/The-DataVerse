...
export class PickerQuickAccessProvider extends Disposable {
    ...
    provide(picker, token, runOptions) {
        ...
        picker.canAcceptInBackground = !!((_a = this.options) === null ||
        _a === void 0
            ? void 0
        ...
        disposables.add(
            picker.onDidTriggerItemButton(async ({ button, item }) => {
                ...
                if (typeof item.trigger === "function") {
                    const buttonIndex =
                        (_b =
                            (_a = item.buttons) === null || _a === void 0
                                ? void 0
                                : _a.indexOf(button)) !== null && _b !== void 0
                            ? _b
                            : -1;
                    if (buttonIndex >= 0) {
