...
export const ILanguageFeatureDebounceService = createDecorator(
...
let LanguageFeatureDebounceService = class LanguageFeatureDebounceService {
    ...
    for(feature, name, config) {
        ...
        const min =
            (_a =
                config === null || config === void 0 ? void 0 : config.min) !==
                null && _a !== void 0
                ? _a
                : 50;
        const max =
            (_b =
                config === null || config === void 0 ? void 0 : config.max) !==
                null && _b !== void 0
                ? _b
                : min ** 2;
        const extra =
            (_c =
                config === null || config === void 0 ? void 0 : config.key) !==
                null && _c !== void 0
                ? _c
                : undefined;
...
LanguageFeatureDebounceService = __decorate(
    [__param(0, ILogService), __param(1, IEnvironmentService)],
