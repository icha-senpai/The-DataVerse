 ...
 */
let HideUnchangedRegionsFeature =
    (HideUnchangedRegionsFeature_1 = class HideUnchangedRegionsFeature extends (
        Disposable
    ) {
        ...
        constructor(_editors, _diffModel, _options, _instantiationService) {
            ...
            this._modifiedOutlineSource = derivedDisposable(this, (reader) => {
                ...
                const factory =
                    HideUnchangedRegionsFeature_1._breadcrumbsSourceFactory.read(
                        reader
                    );
                return !m || !factory
                    ? undefined
                            ...
                            for (const s of this._editors.original.getSelections() ||
                                ...
                                m === null || m === void 0
                                    ...
                                    : m.ensureOriginalLineIsVisible(
                                          ...
                                          0 /* RevealPreference.FromCloserSide */,
                                          tx
                                      );
                                m === null || m === void 0
                                    ? void 0
            ...
            const unchangedRegions = this._diffModel.map((m, reader) => {
                ...
                const regions =
                    (_a =
                        m === null || m === void 0
                            ? void 0
                            : m.unchangedRegions.read(reader)) !== null &&
                    _a !== void 0
                        ? _a
                        : [];
                if (
                    ...
                    regions[0].lineCount ===
                        ((_b = this._editors.modifiedModel.read(reader)) ===
                            null || _b === void 0
                            ? void 0
                            : _b.getLineCount())
                ) {
            ...
            this._register(
                applyObservableDecorations(
                    ...
                    derived(this, (reader) => {
                        ...
                        const curUnchangedRegions =
                            unchangedRegions.read(reader);
                ...
                this._editors.modified.onMouseUp((event) => {
                    ...
                    if (
                        ...
                        ((_a = event.target.element) === null || _a === void 0
                            ? void 0
                            : _a.className.includes("fold-unchanged"))
                    ) {
