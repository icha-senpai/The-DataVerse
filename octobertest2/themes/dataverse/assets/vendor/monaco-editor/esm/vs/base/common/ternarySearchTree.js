...
export class UriIterator {
    ...
    cmp(a) {
        if (this._states[this._stateIdx] === 1 /* UriIteratorState.Scheme */) {
            ...
            this._states[this._stateIdx] === 2 /* UriIteratorState.Authority */
        ) {
            ...
            this._states[this._stateIdx] === 4 /* UriIteratorState.Query */
        ) {
            return compare(a, this._value.query);
        } else if (
            this._states[this._stateIdx] === 5 /* UriIteratorState.Fragment */
        ) {
...
class TernarySearchTreeNode {
    ...
    get heightLeft() {
        var _a, _b;
        return (_b =
            (_a = this.left) === null || _a === void 0 ? void 0 : _a.height) !==
            null && _b !== void 0
            ? _b
            : 0;
    }
...
export class TernarySearchTree {
    ...
    get(key) {
        var _a;
        return (_a = this._getNode(key)) === null || _a === void 0
            ? void 0
            : _a.value;
    }
    _getNode(key) {
