...
let ReferencesController =
    (ReferencesController_1 = class ReferencesController {
        static get(editor) {
        ...
        dispose() {
            ...
            (_a = this._widget) === null || _a === void 0
                ? void 0
                : _a.dispose();
            (_b = this._model) === null || _b === void 0
                ? void 0
                : _b.dispose();
                ...
                .openCodeEditor(
                    {
                        ...
                        options: {
                            selection: range,
                            selectionSource:
                                "code.jump" /* TextEditorSelectionSource.JUMP */,
                            pinned,
                        },
                    },
                    this._editor
                ...
                .then(
                    (openedEditor) => {
                        ...
                        if (this._editor === openedEditor) {
                            ...
                            const other =
                                ReferencesController_1.get(openedEditor);
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    handler(accessor) {
        ...
        const focus =
            (_a = listService.lastFocusedList) === null || _a === void 0
                ? void 0
                : _a.getFocus();
