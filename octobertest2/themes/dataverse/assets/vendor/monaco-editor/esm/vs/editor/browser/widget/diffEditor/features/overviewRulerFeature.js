...
let OverviewRulerFeature =
    (OverviewRulerFeature_1 = class OverviewRulerFeature extends Disposable {
        constructor(
            _editors,
            _rootElement,
            _diffModel,
            ...
            const diffOverviewRoot = h("div.diffOverview", {
                style: {
                    ...
                    top: "0px",
                    width:
                        OverviewRulerFeature_1.ENTIRE_DIFF_OVERVIEW_WIDTH +
                        "px",
                },
            }).root;
            this._register(
                ...
                autorunWithStore((reader, store) => {
                    ...
                    store.add(
                        autorun((reader) => {
                            ...
                            originalOverviewRuler === null ||
                            originalOverviewRuler === void 0
                                ? void 0
                                : originalOverviewRuler.setZones(originalZones);
                            modifiedOverviewRuler === null ||
                            modifiedOverviewRuler === void 0
                                ? void 0
                        ...
                        autorun((reader) => {
                            ...
                            if (layoutInfo) {
                                const freeSpace =
                                    OverviewRulerFeature_1.ENTIRE_DIFF_OVERVIEW_WIDTH -
                                    2 *
                                        OverviewRulerFeature_1.ONE_OVERVIEW_WIDTH;
                                ...
                                const scrollTop =
                                    this._editors.modifiedScrollTop.read(
                                        reader
                                    );
                                const scrollHeight =
                                    this._editors.modifiedScrollHeight.read(
                                        reader
                                    );
                                const scrollBarOptions =
                                    this._editors.modified.getOption(
                                        102 /* EditorOption.scrollbar */
                                    );
...
OverviewRulerFeature.ENTIRE_DIFF_OVERVIEW_WIDTH =
    OverviewRulerFeature_1.ONE_OVERVIEW_WIDTH * 2;
