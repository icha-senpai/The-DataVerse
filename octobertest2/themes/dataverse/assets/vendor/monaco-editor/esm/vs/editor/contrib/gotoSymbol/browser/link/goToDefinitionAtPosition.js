...
let GotoDefinitionAtPositionEditorContribution =
    (GotoDefinitionAtPositionEditorContribution_1 = class GotoDefinitionAtPositionEditorContribution {
        constructor(
            editor,
                ...
                linkGesture.onMouseMoveOrRelevantKeyDown(
                    ([mouseEvent, keyboardEvent]) => {
                        this.startFindDefinitionFromMouse(
                            mouseEvent,
                            keyboardEvent !== null && keyboardEvent !== void 0
                                ? keyboardEvent
                                : undefined
                        );
                    }
        ...
        static get(editor) {
            return editor.getContribution(
                GotoDefinitionAtPositionEditorContribution_1.ID
            );
        }
        ...
        startFindDefinitionFromMouse(mouseEvent, withKey) {
            ...
            if (
                mouseEvent.target.type ===
                    9 /* MouseTargetType.CONTENT_WIDGET */ &&
            ...
            if (
                ...
                !this.isEnabled(mouseEvent, withKey)
            ) {
                this.currentWordAtPosition = null;
                this.removeLinkDecorations();
                return;
        ...
        getPreviewValue(textEditorModel, startLineNumber, result) {
            ...
            if (
                ...
                GotoDefinitionAtPositionEditorContribution_1.MAX_SOURCE_PREVIEW_LINES
            ) {
        ...
        isEnabled(mouseEvent, withKey) {
            ...
            return (
                ...
                !(
                    ((_a = mouseEvent.target.detail.injectedText) === null ||
                    _a === void 0
                        ? void 0
                        : _a.options) instanceof
