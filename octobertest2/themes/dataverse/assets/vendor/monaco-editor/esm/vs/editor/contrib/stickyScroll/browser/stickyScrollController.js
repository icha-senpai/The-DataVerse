...
let StickyScrollController =
    (StickyScrollController_1 = class StickyScrollController extends (
        Disposable
    ) {
        constructor(
            _editor,
        ...
        _disposeFocusStickyScrollStore() {
            ...
            (_a = this._focusDisposableStore) === null || _a === void 0
                ? void 0
                : _a.dispose();
            this._focused = false;
            this._positionRevealed = false;
        ...
        _registerMouseListeners() {
            ...
            const getMouseEventTarget = (mouseEvent) => {
                ...
                if (
                    mouseEvent.target.type !==
                        12 /* MouseTargetType.OVERLAY_WIDGET */ ||
                    mouseEvent.target.detail !==
                        this._stickyScrollWidget.getId()
                ) {
                ...
                if (
                    !mouseTargetElement ||
                    mouseTargetElement.innerText !==
                        mouseTargetElement.innerHTML
                ) {
            ...
            const stickyScrollWidgetDomNode =
        ...
        _toggleFoldingRegionForLine(line) {
            ...
            const stickyLine =
                this._stickyScrollWidget.getRenderedStickyLine(line);
            const foldingIcon =
                stickyLine === null || stickyLine === void 0
                    ? void 0
                    : stickyLine.foldingIcon;
            if (!foldingIcon) {
                return;
            }
            ...
            const scrollTop =
                (foldingIcon.isCollapsed
                    ? this._editor.getTopForLineNumber(
                          foldingIcon.foldingEndLine
                      )
                    : this._editor.getTopForLineNumber(
                          foldingIcon.foldingStartLine
                      )) -
                this._editor.getOption(66 /* EditorOption.lineHeight */) *
                    stickyLine.index +
                1;
        ...
        _readConfiguration() {
            ...
            if (
                lineNumberOption.renderType ===
                2 /* RenderLineNumbersType.Relative */
            ) {
                this._sessionStore.add(
        ...
        _needsUpdate(event) {
            const stickyLineNumbers =
                this._stickyScrollWidget.getCurrentLines();
        ...
        async _renderStickyScroll(rebuildFromLine) {
            ...
            if (
                ...
                this._foldingModel =
                    (_b = await ((_a = FoldingController.get(this._editor)) ===
                        null || _a === void 0
                        ? void 0
                    ...
                    if (this._focusedStickyElementIndex === -1) {
                        ...
                        if (this._stickyScrollWidget.lineNumberCount === 0) {
                            ...
                            if (!previousFocusedLineNumberExists) {
                                this._focusedStickyElementIndex =
                                    this._stickyScrollWidget.lineNumberCount -
                                    1;
                            }
                            this._stickyScrollWidget.focusLineWithIndex(
                                this._focusedStickyElementIndex
        ...
        findScrollWidgetState() {
            ...
            const maxNumberStickyLines = Math.min(
                ...
                this._editor.getOption(114 /* EditorOption.stickyScroll */)
                    .maxLineCount
            );
                ...
                for (const range of candidateRanges) {
                    ...
                    if (end - start > 0) {
                        ...
                        const bottomOfBeginningLine =
                            this._editor.getBottomForLineNumber(start) -
                            scrollTop;
                        const topOfEndLine =
                            this._editor.getTopForLineNumber(end) - scrollTop;
                        const bottomOfEndLine =
                            this._editor.getBottomForLineNumber(end) -
                            scrollTop;
                        if (
