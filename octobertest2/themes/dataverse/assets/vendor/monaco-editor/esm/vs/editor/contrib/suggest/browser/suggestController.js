...
let SuggestController = (SuggestController_1 = class SuggestController {
    ...
    constructor(
        ...
        ctxInsertMode.set(
            editor.getOption(117 /* EditorOption.suggest */).insertMode
        );
        this._toDispose.add(
    ...
    _insertSuggestion(event, flags) {
            ...
            tasks.push(
                item
                    ...
                    .then(() => {
                        ...
                        if (
                            didType ||
                            !((oldFlags & 2) /* InsertFlags.NoAfterUndoStop */)
                        ) {
                            this.editor.pushUndoStop();
                        }
                        return true;
        ...
        snippetController.insert(insertText, {
            ...
            adjustWhitespace: !(
                (
                    item.completion.insertTextRules & 1
    ...
    _reportSuggestionAcceptedTelemetry(
        ...
        this._telemetryService.publicLog2("suggest.acceptedSuggestion", {
            extensionId:
                (_b =
                    (_a = item.extensionId) === null || _a === void 0
                        ? void 0
                        : _a.value) !== null && _b !== void 0
                    ? _b
                    : "unknown",
            providerId:
                (_c = item.provider._debugDisplayName) !== null && _c !== void 0
                    ? _c
                    : "unknown",
    ...
    getOverwriteInfo(item, toggleMode) {
        ...
        let replace =
            this.editor.getOption(117 /* EditorOption.suggest */).insertMode ===
            "replace";
        if (toggleMode) {
            replace = !replace;
        }
        ...
        const makesTextEdit = (item) => {
            if (
                item.completion.insertTextRules &
                    4 /* CompletionItemInsertTextRule.InsertAsSnippet */ ||
                item.completion.additionalTextEdits
            ) {
