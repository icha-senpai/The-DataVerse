...
let ParameterHintsWidget =
    (ParameterHintsWidget_1 = class ParameterHintsWidget extends Disposable {
        constructor(
            editor,
            model,
            contextKeyService,
        ...
        show() {
            ...
            setTimeout(() => {
                ...
                (_a = this.domNodes) === null || _a === void 0
                    ? void 0
                    : _a.element.classList.add("visible");
            }, 100);
            this.editor.layoutContentWidget(this);
        }
        hide() {
        ...
        render(hints) {
            ...
            const activeParameterIndex =
                (_a = signature.activeParameter) !== null && _a !== void 0
                    ? _a
            ...
            if (activeParameter) {
                ...
                if (this.announcedLabel !== labelToAnnounce) {
                    aria.alert(
                        nls.localize("hint", "{0}, hint", labelToAnnounce)
                    );
        ...
        updateMaxHeight() {
            ...
            const height = Math.max(
                this.editor.getLayoutInfo().height / 4,
                250
            );
            const maxHeight = `${height}px`;
            this.domNodes.element.style.maxHeight = maxHeight;
            const wrapper =
                this.domNodes.element.getElementsByClassName("phwrapper");
            if (wrapper.length) {
