...
const ctrlKeyMod = platform.isMacintosh
    ? 256 /* KeyMod.WinCtrl */
    : 2048 /* KeyMod.CtrlCmd */;
...
export class FindWidget extends Widget {
    constructor(
        ...
        if (
            this._codeEditor.getOption(41 /* EditorOption.find */)
                .addExtraSpaceOnTop
        ) {
    ...
    _buildDomNode() {
        ...
        this._replaceBtn = this._register(
            new SimpleButton({
                ...
                onKeyDown: (e) => {
                    if (
                        e.equals(1024 /* KeyMod.Shift */ | 2 /* KeyCode.Tab */)
                    ) {
                        this._closeBtn.focus();
                        e.preventDefault();
                    }
    ...
    updateAccessibilitySupport() {
        ...
        this._findInput.setFocusInputOnOptionClick(
            value !== 2 /* AccessibilitySupport.Enabled */
        );
    }
}
...
export class SimpleButton extends Widget {
    constructor(opts) {
        ...
        this.onkeydown(this._domNode, (e) => {
            ...
            (_b = (_a = this._opts).onKeyDown) === null || _b === void 0
                ? void 0
                : _b.call(_a, e);
        });
    }
