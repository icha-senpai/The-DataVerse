...
import {
    ...
    TextAreaInput,
    TextAreaWrapper,
} from "./textAreaInput.js";
import {
    PagedScreenReaderStrategy,
    TextAreaState,
    _debugComposition,
} from "./textAreaState.js";
...
let TextAreaHandler = class TextAreaHandler extends ViewPart {
    constructor(
        ...
        this.textArea.setAttribute(
            "aria-required",
            options.get(5 /* EditorOption.ariaRequired */) ? "true" : "false"
        );
        this.textArea.setAttribute(
            "tabindex",
            String(options.get(123 /* EditorOption.tabIndex */))
        );
        ...
        this.textArea.setAttribute(
            "aria-autocomplete",
            options.get(90 /* EditorOption.readOnly */) ? "none" : "both"
        );
    ...
    _getWordBeforePosition(position) {
        ...
        while (column > 1) {
            ...
            const charClass = wordSeparators.get(charCode);
            if (
                charClass !== 0 /* WordCharacterClass.Regular */ ||
                distance > 50
            ) {
    ...
    onConfigurationChanged(e) {
        ...
        if (
            e.hasChanged(34 /* EditorOption.domReadOnly */) ||
    ...
    _ensureReadOnlyAttribute() {
        ...
        const useReadOnly =
            !IME.enabled ||
            (options.get(34 /* EditorOption.domReadOnly */) &&
                options.get(90 /* EditorOption.readOnly */));
        if (useReadOnly) {
    ...
    prepareRender(ctx) {
        ...
        (_a = this._visibleTextArea) === null || _a === void 0
            ? void 0
            : _a.prepareRender(ctx);
    }
    render(ctx) {
    ...
    _render() {
        ...
        if (
            ...
            const lineCount =
                (_a =
                    this._textAreaInput.textAreaState
                        .newlineCountBeforeSelection) !== null && _a !== void 0
                    ? _a
                    : this._newlinecount(
                          this.textArea.domNode.value.substr(
                              0,
...
TextAreaHandler = __decorate(
    [__param(3, IKeybindingService), __param(4, IInstantiationService)],
    TextAreaHandler
);
