...
let StandaloneColorPickerController =
    (StandaloneColorPickerController_1 = class StandaloneColorPickerController extends (
        Disposable
    ) {
        constructor(
            _editor,
        ...
        showOrFocus() {
            ...
            if (!this._standaloneColorPickerVisible.get()) {
                this._standaloneColorPickerWidget =
                    new StandaloneColorPickerWidget(
                        this._editor,
                        this._standaloneColorPickerVisible,
                        this._standaloneColorPickerFocused,
                ...
                (_a = this._standaloneColorPickerWidget) === null ||
                _a === void 0
                    ? void 0
                    : _a.focus();
            }
        ...
        hide() {
            ...
            (_a = this._standaloneColorPickerWidget) === null || _a === void 0
                ? void 0
                : _a.hide();
            this._editor.focus();
        }
...
let StandaloneColorPickerWidget =
    (StandaloneColorPickerWidget_1 = class StandaloneColorPickerWidget extends (
        Disposable
    ) {
        constructor(
            _editor,
            ...
            this._position =
                (_a = this._editor._getViewModel()) === null || _a === void 0
                    ? void 0
                    : _a.getPrimaryCursorState().modelState.position;
            ...
            this._register(
                this._editor.onMouseMove((e) => {
                    var _a;
                    const classList =
                        (_a = e.target.element) === null || _a === void 0
                            ? void 0
                            : _a.classList;
                    if (
                        classList &&
        ...
        _render(colorHover, foundInEditor) {
            ...
            this._register(
                this._standaloneColorPickerParticipant.renderHoverParts(
                    context,
                    [colorHover]
                )
            );
