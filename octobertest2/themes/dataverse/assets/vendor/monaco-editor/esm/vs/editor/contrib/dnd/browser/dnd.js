...
export class DragAndDropController extends Disposable {
    constructor(editor) {
        ...
        this._register(
            this._editor.onMouseDrag((e) => this._onEditorMouseDrag(e))
        );
        this._register(
            this._editor.onMouseDrop((e) => this._onEditorMouseDrop(e))
        );
        this._register(
    ...
    onEditorKeyDown(e) {
        if (
            !this._editor.getOption(35 /* EditorOption.dragAndDrop */) ||
