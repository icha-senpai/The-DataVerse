...
let LinkedEditingContribution =
    (LinkedEditingContribution_1 = class LinkedEditingContribution extends (
        Disposable
    ) {
        static get(editor) {
        ...
        constructor(
            ...
            this._register(
                this._editor.onDidChangeConfiguration((e) => {
                    if (
                        e.hasChanged(69 /* EditorOption.linkedEditing */) ||
                        e.hasChanged(92 /* EditorOption.renameOnType */)
                    ) {
        ...
        reinitialize(forceRefresh) {
            ...
            const isEnabled =
                model !== null &&
                (this._editor.getOption(69 /* EditorOption.linkedEditing */) ||
        ...
        _syncRanges(token) {
            ...
            const edits = [];
            for (
                let i = 1, len = this._currentDecorations.length;
                i < len;
                i++
            ) {
    ...
    return first(
        ...
        (result) =>
            ...
            arrays.isNonEmptyArray(
                result === null || result === void 0 ? void 0 : result.ranges
            )
    );
}
