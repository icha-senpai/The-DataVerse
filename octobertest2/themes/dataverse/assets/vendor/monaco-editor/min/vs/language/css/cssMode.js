    ...
    var moduleExports = (() => {
                ...
                if ((t && typeof t == "object") || typeof t == "function")
                    for (let e of on(t))
                        !an.call(n, e) &&
                            ...
                            Y(n, e, {
                                get: () => t[e],
                                enumerable: !(r = rn(t, e)) || r.enumerable,
                            });
                return n;
            },
            ...
            function i(r) {
                ...
                return (
                    ...
                    (v.is(e.originSelectionRange) ||
                        a.undefined(e.originSelectionRange))
                );
            }
            n.is = i;
        })(Te || (Te = {}));
        ...
        (function (n) {
            ...
            function i(r) {
                ...
                return (
                    ...
                    a.uinteger(e.startLine) &&
                    (a.undefined(e.startCharacter) ||
                        a.uinteger(e.startCharacter)) &&
                    (a.undefined(e.endCharacter) ||
        ...
        (function (n) {
            ...
            function e(o) {
                var s = o;
                return (
                    a.objectLiteral(s) && a.string(s.newText) && v.is(s.range)
                );
            }
            n.is = e;
        })(C || (C = {}));
        ...
        (function (n) {
            ...
            function e(o) {
                var s = o;
                return (
                    C.is(s) && (R.is(s.annotationId) || y.is(s.annotationId))
                );
            }
            n.is = e;
        })(I || (I = {}));
        ...
        (function (n) {
            ...
            function i(r) {
                ...
                return (
                    a.defined(e) &&
                    a.uinteger(e.tabSize) &&
                    a.boolean(e.insertSpaces)
                );
            }
            n.is = i;
        })(Xe || (Xe = {}));
                ...
                this._disposables.push(d.editor.onDidCreateModel(e)),
                    ...
                    this._disposables.push({
                        dispose: () => {
                            ...
                            for (let s in this._listener)
                                this._listener[s].dispose();
                        },
                    }),
                        ...
                        .then((o) => {
                            if (o)
                                return o.map((s) => {
                                    ...
                                    return (
                                        s.textEdit &&
                                            (u.textEdit = W(s.textEdit)),
                                        s.additionalTextEdits &&
                                            (u.additionalTextEdits =
                                                s.additionalTextEdits.map(W)),
                                        u
                                    );
                                });
                        });
        ...
        function Rn(n) {
            ...
            function o() {
                ...
                nn(i),
                    ...
                    u.hovers &&
                        i.push(d.languages.registerHoverProvider(s, new U(e))),
                    ...
                    u.definitions &&
                        i.push(
                            d.languages.registerDefinitionProvider(s, new O(e))
                        ),
                    u.references &&
                        i.push(
                            d.languages.registerReferenceProvider(s, new N(e))
                        ),
                    u.documentSymbols &&
                        i.push(
                    ...
                    u.rename &&
                        i.push(d.languages.registerRenameProvider(s, new V(e))),
                    u.colors &&
                        i.push(d.languages.registerColorProvider(s, new $(e))),
                    u.foldingRanges &&
                        i.push(
