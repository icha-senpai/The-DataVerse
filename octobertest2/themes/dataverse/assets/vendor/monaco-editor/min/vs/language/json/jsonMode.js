    ...
    var moduleExports = (() => {
                ...
                if ((t && typeof t == "object") || typeof t == "function")
                    for (let n of xn(t))
                        !_n.call(e, n) &&
                            ...
                            ie(e, n, {
                                get: () => t[n],
                                enumerable: !(r = In(t, n)) || r.enumerable,
                            });
                return e;
            },
        ...
        (function (e) {
            ...
            function i(r) {
                ...
                return (
                    ...
                    (y.is(n.originSelectionRange) ||
                        s.undefined(n.originSelectionRange))
                );
            }
            e.is = i;
        })(Oe || (Oe = {}));
        ...
        (function (e) {
            function t(r, n, a, o, u) {
                ...
                return (
                    s.defined(a) && (l.startCharacter = a),
                    s.defined(o) && (l.endCharacter = o),
            ...
            function i(r) {
                ...
                return (
                    ...
                    s.uinteger(n.startLine) &&
                    (s.undefined(n.startCharacter) ||
                        s.uinteger(n.startCharacter)) &&
                    (s.undefined(n.endCharacter) ||
                        s.uinteger(n.endCharacter)) &&
            ...
            function i(r) {
                ...
                return (
                    ...
                    (s.undefined(a.relatedInformation) ||
                        s.typedArray(a.relatedInformation, me.is))
                );
            }
            e.is = i;
        })(se || (se = {}));
        ...
        (function (e) {
            ...
            function n(a) {
                var o = a;
                return (
                    s.objectLiteral(o) && s.string(o.newText) && y.is(o.range)
                );
            }
            e.is = n;
        })(A || (A = {}));
        ...
        (function (e) {
            ...
            function n(a) {
                var o = a;
                return (
                    A.is(o) && (N.is(o.annotationId) || T.is(o.annotationId))
                );
            }
            e.is = n;
        })(P || (P = {}));
        ...
        (function (e) {
            ...
            function i(r) {
                ...
                return (
                    s.defined(n) &&
                    s.uinteger(n.tabSize) &&
                    s.boolean(n.insertSpaces)
                );
            }
            e.is = i;
        })(an || (an = {}));
...
` &&
        ...
        (function (e) {
            ...
            function h(g) {
                return (
                    t.call(g) === "[object Number]" && 0 <= g && g <= 2147483647
                );
            }
            e.uinteger = h;
            function p(g) {
            ...
            _doValidate(t, i) {
                this._worker(t)
                    ...
                    .then((r) => {
                        ...
                        a &&
                            a.getLanguageId() === i &&
                            c.editor.setModelMarkers(a, i, n);
                    })
                    .then(void 0, (r) => {
                        console.error(r);
                    });
...
` +
            ...
            for (let i in e.changes) {
                ...
                for (let n of e.changes[i])
                    t.push({
                        resource: r,
                        versionId: void 0,
                        textEdit: { range: b(n.range), text: n.newText },
                    });
            }
            return { edits: t };
        }
                        ...
                        .then((a) => {
                            if (a)
                                return a.map((o) => {
                                    ...
                                    return (
                                        o.textEdit &&
                                            (u.textEdit = j(o.textEdit)),
                                        o.additionalTextEdits &&
                                            (u.additionalTextEdits =
                                                o.additionalTextEdits.map(j)),
                                        u
                                    );
                                });
                        });
        ...
        function de(e, t) {
            ...
            function _() {
                ...
                if (
                    r < e.length &&
                    (e.charCodeAt(r) === 69 || e.charCodeAt(r) === 101)
                )
                    if (
                        (r++,
        ...
        function gr(e) {
            ...
            function n() {
                ...
                Tn(i),
                    ...
                    u.hovers &&
                        i.push(c.languages.registerHoverProvider(o, new Y(x))),
                    u.documentSymbols &&
                        i.push(
                    ...
                    u.tokens &&
                        i.push(c.languages.setTokensProvider(o, yn(!0))),
                    u.colors &&
                        i.push(c.languages.registerColorProvider(o, new Z(x))),
                    u.foldingRanges &&
                        i.push(
            ...
            return (
                e.onDidChange((o) => {
                    o.modeConfiguration !== a &&
                        ((a = o.modeConfiguration), n());
                }),
                t.push(kn(i)),
                kn(t)
            );
