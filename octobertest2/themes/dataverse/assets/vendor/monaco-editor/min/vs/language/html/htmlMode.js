    ...
    var moduleExports = (() => {
                ...
                if ((t && typeof t == "object") || typeof t == "function")
                    for (let e of sn(t))
                        !un.call(n, e) &&
                            ...
                            Q(n, e, {
                                get: () => t[e],
                                enumerable: !(r = on(t, e)) || r.enumerable,
                            });
                return n;
            },
        ...
        (function (n) {
            ...
            function e(o) {
                var s = o;
                return (
                    _.is(s) && (R.is(s.annotationId) || T.is(s.annotationId))
                );
            }
            n.is = e;
        })(I || (I = {}));
                        ...
                        .then((o) => {
                            if (o)
                                return o.map((s) => {
                                    ...
                                    return (
                                        s.textEdit &&
                                            (u.textEdit = D(s.textEdit)),
                                        s.additionalTextEdits &&
                                            (u.additionalTextEdits =
                                                s.additionalTextEdits.map(D)),
                                        u
                                    );
                                });
                        });
        ...
        function Wn(n) {
            ...
            function o() {
                ...
                tn(i),
                    ...
                    u.hovers &&
                        i.push(d.languages.registerHoverProvider(s, new L(e))),
                    ...
                    u.links &&
                        i.push(d.languages.registerLinkProvider(s, new A(e))),
                    u.documentSymbols &&
                        i.push(
                    ...
                    u.rename &&
                        i.push(d.languages.registerRenameProvider(s, new F(e))),
                    u.foldingRanges &&
                        i.push(
