    ...
    var moduleExports = (() => {
        ...
        (function (t) {
            ...
            function o(n) {
                ...
                return (
                    ...
                    (P.is(e.originSelectionRange) ||
                        _.undefined(e.originSelectionRange))
                );
            }
            t.is = o;
        })(Tt || (Tt = {}));
        ...
        (function (t) {
            ...
            function o(n) {
                ...
                return (
                    ...
                    _.uinteger(e.startLine) &&
                    (_.undefined(e.startCharacter) ||
                        _.uinteger(e.startCharacter)) &&
                    (_.undefined(e.endCharacter) ||
        ...
        (function (t) {
            ...
            function e(a) {
                var c = a;
                return (
                    _.objectLiteral(c) && _.string(c.newText) && P.is(c.range)
                );
            }
            t.is = e;
        })(Y || (Y = {}));
        ...
        (function (t) {
            ...
            function e(a) {
                var c = a;
                return (
                    Y.is(c) && (be.is(c.annotationId) || Z.is(c.annotationId))
                );
            }
            t.is = e;
        })(ce || (ce = {}));
            ...
            xt = (function () {
                ...
                return (
                    ...
                    (t.prototype.manage = function (i, o) {
                        ...
                        if (o === void 0)
                            throw new Error(
                                "No annotation provided for id " + n
                            );
                        ...
                        i !== void 0
                            ? ((this._workspaceEdit = i),
                              i.documentChanges
                                  ...
                                  : i.changes &&
                                    Object.keys(i.changes).forEach(function (
                                        n
                                    ) {
        ...
        (function (t) {
            ...
            function o(n) {
                ...
                return (
                    _.defined(e) &&
                    _.typedArray(e.diagnostics, Ae.is) &&
        ...
        (function (t) {
            ...
            function o(n) {
                ...
                return (
                    _.defined(e) &&
                    _.uinteger(e.tabSize) &&
                    _.boolean(e.insertSpaces)
                );
            }
            t.is = o;
        })(lt || (lt = {}));
...
` &&
        ...
        (function (t) {
            ...
            function s(g) {
                return (
                    i.call(g) === "[object Number]" && 0 <= g && g <= 2147483647
                );
            }
            t.uinteger = s;
            function u(g) {
        ...
        function Pt(t) {
            ...
            return i.line > o.line ||
                (i.line === o.line && i.character > o.character)
                ? { start: o, end: i }
                : t;
        }
        function In(t) {
            ...
            Un = (function () {
                ...
                return (
                    ...
                    (t.prototype.advanceIfChars = function (i) {
                        var o;
                        if (this.position + i.length > this.source.length)
                            return !1;
                        for (o = 0; o < i.length; o++)
                            if (
                                this.source.charCodeAt(this.position + o) !==
                                i[o]
                            )
                                return !1;
                    ...
                    (t.prototype.advanceIfRegExp = function (i) {
                        ...
                        return n
                            ? ((this.position =
                                  this.position + n.index + n[0].length),
                              n[0])
                            : "";
                    }),
                    ...
                    (t.prototype.advanceUntilChar = function (i) {
                        for (; this.position < this.source.length; ) {
                            if (this.source.charCodeAt(this.position) === i)
                                return !0;
                            this.advance(1);
                        }
                        return !1;
                    ...
                    (t.prototype.advanceUntilChars = function (i) {
                        for (
                            ;
                            this.position + i.length <= this.source.length;
                ...
                switch (a) {
                    ...
                    case W.WithinContent:
                        if (e.advanceIfChar(qe)) {
                            if (!e.eos() && e.peekChar() === Ot) {
                                if (e.advanceIfChars([Ot, ke, ke]))
                                    return (
                                        (a = W.WithinComment),
                                        m(w, S.StartCommentTag)
                                    );
                                if (e.advanceIfRegExp(/^!doctype/i))
                                    return (
                                        (a = W.WithinDoctype),
                                        m(w, S.StartDoctypeTag)
                                    );
                            }
                            return e.advanceIfChar(ht)
                                ? ((a = W.AfterOpeningEndTag),
                                  m(w, S.EndTagOpen))
                                : ((a = W.AfterOpeningStartTag),
                                  m(w, S.StartTagOpen));
                        }
                    ...
                    case W.AfterAttributeName:
                        return e.skipWhitespace()
                            ? ((s = !0), m(w, S.Whitespace))
                            : e.advanceIfChar(Wn)
                            ? ((a = W.BeforeAttributeValue),
                              m(w, S.DelimiterAssign))
                            : ((a = W.WithinTag), E());
                    ...
                    case W.WithinScriptContent:
                        for (var f = 1; !e.eos(); ) {
                            var p = e.advanceIfRegExp(
                                /<!--|-->|<\/?script\s*\/?>?/i
                            );
                            if (p.length === 0)
                                return e.goToEnd(), m(w, S.Script);
                            if (p === "<!--") f === 1 && (f = 2);
                            else if (p === "-->") f = 1;
                            else if (p[1] !== "/") f === 2 && (f = 3);
                            else if (f === 3) f = 2;
        ...
        function je(t) {
            for (
                ...
                switch (l) {
                    ...
                    case S.EndTag:
                        ...
                        break;
                    case S.EndTagClose:
                        for (var s = n; !s.isSameTag(a) && s.parent; )
                            s = s.parent;
                        if (s.parent) {
                            for (; n !== s; )
                                (n.end = e), (n.closed = !1), (n = n.parent);
                            (n.closed = !0),
                                (n.endTagStart = e),
                                (n.end = i.getTokenEnd()),
                                (n = n.parent);
            ...
            for (; n.parent; )
                (n.end = t.length), (n.closed = !1), (n = n.parent);
            return {
                roots: o.children,
                            ...
                            l.forEach(function (r) {
                                r.name.toLowerCase() === o &&
                                    ...
                                    r.valueSet &&
                                        ...
                                        n._valueSetMap[r.valueSet].forEach(
                                            function (s) {
                                                e.push(s);
                                            }
                                        ));
            ...
            Yt = (function () {
                ...
                return (
                    (t.prototype.onHtmlAttributeValue = function (i) {
                        ri(i.tag, i.attribute) &&
                            this.atributeCompletions.push(i);
                    }),
                    ...
                    (t.prototype.providePathSuggestions = function (
                        i,
                        o,
                        n,
                        e
...
\r`.indexOf(L) >= 0
                        ...
                        function J(x, D) {
                            ...
                            if (
                                !$t(
                                    s,
                                    D,
                                    W.AfterAttributeName,
                                    S.DelimiterAssign
                                )
                            ) {
                                var K =
                                    (L = e?.attributeDefaultValue) !== null &&
                                    L !== void 0
                                        ? L
                                        : "doublequotes";
                                K === "empty"
                            ...
                            return (
                                ...
                                l.forEach(function (ue) {
                                    ue.provideAttributes(g).forEach(function (
                                        te
                                    ) {
                                        if (!oe[te.name]) {
                                            oe[te.name] = !0;
                        ...
                        function p(x, D) {
                            ...
                            return (
                                l.forEach(function (An) {
                                    An.provideValues(g, y).forEach(function (
                                        ze
                                    ) {
                                        var _t = q
                                            ? '"' + ze.name + '"'
                    ...
                    (t.prototype.doQuoteComplete = function (i, o, n, e) {
                        ...
                        if (c <= 0) return null;
                        var l =
                            (a = e?.attributeDefaultValue) !== null &&
                            a !== void 0
                                ? a
                                : "doublequotes";
                    ...
                    (t.prototype.doesSupportMarkdown = function () {
                        ...
                        if (!Se(this.supportsMarkdown)) {
                            if (!Se(this.lsOptions.clientCapabilities))
                                return (
                                    (this.supportsMarkdown = !0),
                            ...
                            var e =
                                (n =
                                    ...
                                    o === void 0
                                        ? void 0
                                        : o.completionItem) === null ||
                                n === void 0
                                    ? void 0
                                    : n.documentationFormat;
                            this.supportsMarkdown =
                                Array.isArray(e) &&
                                e.indexOf(ee.Markdown) !== -1;
                        }
        ...
        function $t(t, i, o, n) {
            for (var e = $(t, i, o), a = e.scan(); a === S.Whitespace; )
                a = e.scan();
            return a === n;
        }
        function pi(t, i, o) {
                ...
                return (
                        ...
                        function h(U, H, z) {
                            for (
                                var I = function (C) {
                                        var x = null;
                                        if (
                                            (C.provideTags().forEach(function (
                                                D
                                            ) {
                                                if (
                                                    D.name.toLowerCase() ===
                    ...
                    (t.prototype.convertContents = function (i) {
                        if (!this.doesSupportMarkdown()) {
                            ...
                            if ("kind" in i)
                                return { kind: "plaintext", value: i.value };
                            if (Array.isArray(i))
                                i.map(function (o) {
                                ...
                                if (this._should_wrap()) {
                                    ...
                                    return (
                                        ...
                                        (this.__character_count =
                                            this.__wrap_point_character_count),
                                        r.__items[0] === " " &&
                                            (r.__items.splice(0, 1),
                                            (r.__character_count -= 1)),
                                        !0
                                    );
                                }
                                return !1;
...
` && (u = u.replace(/[\n]/g, r)),
                            ...
                            (l.prototype.set_indent = function (r, s) {
                                return (
                                    ...
                                    this.__lines.length > 1
                                        ? (this.current_line.set_indent(r, s),
                                          !0)
                                        : (this.current_line.set_indent(), !1)
                                );
                            }),
                            (l.prototype.add_raw_token = function (r) {
                                for (var s = 0; s < r.newlines; s++)
                                    this.__add_outputline();
                                this.current_line.set_indent(-1),
                            ...
                            (l.prototype.__add_space_before_token =
                                function () {
                            ...
                            (l.prototype.ensure_empty_line_above = function (
                                r,
                                s
                            ) {
                                for (
                                    var u = this.__lines.length - 2;
                                    u >= 0;
...
You passed in: '` +
                            ...
                            (a.prototype._get_selection_list = function (
                                r,
                                s,
                                u
                            ) {
...
You passed in: '` +
                    ...
                    function (e) {
                        ...
                        (c.prototype.restart = function () {
                            ...
                            (c.prototype.read = function (l, r, s) {
                                ...
                                return (
                                    l &&
                                        ((h = this.match(l)), h && (u += h[0])),
                                    r &&
                                        (h || !l) &&
                                        (u += this.readUntil(r, s)),
                                    u
                                );
                            }),
                    ...
                    function (e) {
                        ...
                        (a.prototype.get_directives = function (c) {
                            if (!c.match(this.__directives_block_pattern))
                                return null;
                            var l = {};
                            this.__directive_pattern.lastIndex = 0;
                            for (var r = this.__directive_pattern.exec(c); r; )
                                (l[r[1]] = r[2]),
                                    (r = this.__directive_pattern.exec(c));
                            return l;
                        }),
                            (a.prototype.readIgnored = function (c) {
                                return c.readUntilAfter(
                                    this.__directives_end_ignore_pattern
                                );
                            }),
...
` &&
                            ...
                            (w.prototype.foundNestedPseudoClass = function () {
                                for (
                                    var M = 0, B = 1, G = this._input.peek(B);
                                    G;
...
You passed in: '` +
                    ...
                    function (e, a, c) {
                        var l = c(8).InputScanner,
                            ...
                            d = function (g, y) {
                                (this._input = new l(g)),
                                    ...
                                    (this.__tokens = null),
                                    (this._patterns = {}),
                                    (this._patterns.whitespace = new u(
                                        this._input
                                    ));
                            };
                        (d.prototype.tokenize = function () {
                            ...
                            for (
                                ...
                                for (
                                    g = this._get_next_token(y, m);
                                    this._is_comment(g);

                                )
                                    E.add(g), (g = this._get_next_token(y, m));
                                E.isEmpty() ||
                                    ((g.comments_before = E), (E = new s())),
                                    (g.parent = m),
                                    this._is_opening(g)
                                        ? (A.push(m), (m = g))
                                        : m &&
                    ...
                    function (e, a, c) {
                        ...
                        (r.prototype = new l()),
                            (r.prototype.__set_whitespace_patterns = function (
                                s,
                                u
                            ) {
                                (s += "\\t "),
                            ...
                            (r.prototype.matching = function (s, u) {
                                var h = this._create();
                                return (
                                    h.__set_whitespace_patterns(s, u),
                                    h._update(),
                                    h
                                );
                            }),
                        ...
                        (s.prototype = new l()),
                            ...
                            (s.prototype.__set_templated_pattern = function () {
                                ...
                                this._disabled.php ||
                                    ...
                                    this._until_pattern &&
                                        u.push(this._until_pattern.source),
                                    (this.__template_pattern =
                                        this._input.get_regexp(
                                            "(?:" + u.join("|") + ")"
                                        ));
                    ...
                    function (e, a, c) {
                        ...
                        (g.prototype.current_line_has_match = function (f) {
                            ...
                            (g.prototype.set_space_before_token = function (
                                f,
                                p
                            ) {
                            ...
                            (g.prototype.print_preserved_newlines = function (
                                f
                            ) {
                                var p = 0;
                                f.type !== u.TEXT &&
                            ...
                            (g.prototype.get_full_indent = function (f) {
                                return (
                                    ...
                                    f < 1
                                        ? ""
                                        : this._output.get_indent_string(f)
                                );
                            });
                        var y = function (f) {
                                for (
...
`
                            ...
                            for (var z = null, I = H.next(); I.type !== u.EOF; )
                                I.type === u.TAG_OPEN || I.type === u.COMMENT
                                    ? ((z = this._handle_tag_open(U, I, R, N)),
                                      (R = z))
                                    : I.type === u.ATTRIBUTE ||
                                      I.type === u.EQUALS ||
                                      I.type === u.VALUE ||
                            ...
                            (M.prototype._handle_tag_close = function (
                                f,
                                p,
                                b
                            ) {
                            ...
                            (M.prototype._handle_inside_tag = function (
                                f,
                                p,
                                b,
                                N
                            ...
                            (M.prototype._print_custom_beatifier_text =
                                function (f, p, b) {
                                    var N = this;
                                    if (p.text !== "") {
                                        var R = p.text,
...
` +
                            ...
                            (M.prototype._handle_tag_open = function (
                                f,
                                p,
                                b,
                                N
                        ...
                        (M.prototype._get_tag_open_token = function (f) {
                            ...
                            (M.prototype._set_tag_position = function (
                                f,
                                p,
                                b,
                                N,
                                ...
                                if (
                                    ...
                                    A(
                                        ...
                                        (f.print_newline(!1),
                                        f._output.just_added_blankline() ||
                                            f.print_newline(!0)),
                                    b.is_empty_element)
                                ) {
                                    if (
...
`) === -1) ||
                                    ...
                                    (H =
                                        b.start_tag_token &&
                                        b.start_tag_token.multiline_content),
                                        (H =
                                            H ||
                                            (!b.is_inline_element &&
                                                !(
                            ...
                            (M.prototype._calcluate_parent_multiline =
                                function (f, p) {
                                    p.parent &&
                    ...
                    function (e, a, c) {
                        var l = c(9).Tokenizer,
                            ...
                            y = function (m, A) {
                                ...
                                var E = new u(this._input).read_options(
                                        this._options
                                    ),
                                    w = new h(this._input);
                                if (
                        ...
                        (y.prototype = new l()),
                            ...
                            (y.prototype._get_next_token = function (m, A) {
                                ...
                                return w === null
                                    ...
                                    : ((E =
                                          E ||
                                          this._read_open_handlebars(w, A)),
                                      (E = E || this._read_attribute(w, m, A)),
                                      (E = E || this._read_close(w, A)),
                                      (E =
                                          E || this._read_raw_content(w, m, A)),
                            ...
                            (y.prototype._read_open_handlebars = function (
                                m,
                                A
                            ) {
                                var E = null,
                            ...
                            (y.prototype._is_content_unformatted = function (
                                m
                            ) {
                                return (
                                    this._options.void_elements.indexOf(m) ===
                                        -1 &&
                                    (this._options.content_unformatted.indexOf(
                                        m
                                    ) !== -1 ||
                                        this._options.unformatted.indexOf(m) !==
                                            -1)
                                );
                            }),
                            (y.prototype._read_raw_content = function (
                                m,
                                A,
                                E
                            ) {
...
`.indexOf(t.charAt(i)) !== -1
            ...
            var t = {
                    470: (n) => {
                        ...
                        var c = {
                            ...
                            isAbsolute: function (l) {
                                return (
                                    e(l), l.length > 0 && l.charCodeAt(0) === 47
                                );
                            },
                            join: function () {
                            ...
                            relative: function (l, r) {
                                ...
                                for (
                                    ...
                                    if (A === y) {
                                        if (g > y) {
                                            if (r.charCodeAt(d + A) === 47)
                                                return r.slice(d + A + 1);
                    ...
                    447: (n, e, a) => {
                        ...
                        function J(T, v) {
                            ...
                            return (
                                C !== -1 &&
                                    (k += encodeURIComponent(T.substring(C))),
                                k !== void 0 ? k : T
                            );
                        }
                        function f(T) {
                                ...
                                if (k || arguments.length === 2)
                                    for (var C, x = 0, D = v.length; x < D; x++)
                                        (!C && x in v) ||
                                            ...
                                            (C[x] = v[x]));
                                return T.concat(
                                    C || Array.prototype.slice.call(v)
                                );
                            },
                            F = z.posix || z;
                        (function (T) {
                            (T.joinPath = function (v) {
                                for (
                                    ...
                                    k[C - 1] = arguments[C];
                                return v.with({
                                    path: F.join.apply(F, I([v.path], k, !1)),
                                });
                            }),
                                (T.resolvePath = function (v) {
                                    ...
                                    var x = v.path || "/";
                                    return v.with({
                                        path: F.resolve.apply(F, I([x], k, !1)),
                                    });
                                }),
                    ...
                    case S.AttributeValue:
                        if (a === "src" || a === "href") {
                            ...
                            c &&
                                typeof l > "u" &&
                                ((l = ft(u)),
                                l && i && (l = i.resolveReference(l, t.uri))),
                                (c = !1),
                                (a = void 0);
                        } else if (a === "id") {
        ...
        function mn(t, i, o) {
            ...
            var a = [],
                ...
                l =
                    typeof e.endTagStart == "number" &&
                    pn(S.EndTag, t, e.endTagStart);
            return (
                ((c && dn(c, i)) || (l && dn(l, i))) &&
        ...
        function hn(t, i) {
            return (
                t.line < i.line ||
                (t.line === i.line && t.character <= i.character)
            );
        }
        function dn(t, i) {
        ...
        function vn(t, i, o) {
            ...
            if (
                e.endTagStart + 2 <= n &&
                n <= e.endTagStart + 2 + e.tag.length
            ) {
        ...
        function gt(t, i, o) {
            ...
            return e.endTagStart &&
                ...
                ? [
                      P.create(
                          t.positionAt(e.start + 1),
                          t.positionAt(e.start + 1 + a)
                      ),
                      P.create(
        ...
        function xi(t, i) {
            ...
            for (
                ...
                if (!o) (o = r), c(l, 0);
                    ...
                    if (r.endLine <= o.endLine)
                        n.push(o), (o = r), c(l, n.length);
        ...
        function Di(t, i) {
            ...
            if (
                (a.unshift([e.start, e.end]), e.start < n && n < e.startTagEnd)
            ) {
                a.unshift([e.start + 1, e.startTagEnd - 1]);
                var r = _n(t, e, n);
                return (a = r.concat(a)), a;
        ...
        var Je = class {
            constructor(i, o) {
                ...
                let n = this._languageSettings.data,
                    ...
                    a = [];
                if (n?.dataProviders)
                    for (let c in n.dataProviders)
                        a.push(Sn(c, n.dataProviders[c]));
