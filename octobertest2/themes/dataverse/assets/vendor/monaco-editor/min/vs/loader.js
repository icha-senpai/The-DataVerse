...
(function (u) {
    ...
    class m {
        ...
        record(r, c) {
            this._events.push(
                new y(r, c, u.Utilities.getHighPerformanceTimestamp())
            );
        }
        getEvents() {
            return this._events;
    ...
    class m {
        static validateConfigurationOptions(r) {
            ...
            if (
                ...
                r.baseUrl.length > 0 &&
                    (u.Utilities.endsWith(r.baseUrl, "/") ||
                        (r.baseUrl += "/")),
                ...
                u.Utilities.forEachProperty(r, (t, e) => {
                    ...
                    typeof a.ignoreDuplicateModules < "u"
                        ? (a.ignoreDuplicateModules =
                              a.ignoreDuplicateModules.concat(e))
    ...
    class p {
        ...
        _createIgnoreDuplicateModulesMap() {
            ...
            for (let r = 0; r < this.options.ignoreDuplicateModules.length; r++)
                this.ignoreDuplicateModulesMap[
                    this.options.ignoreDuplicateModules[r]
                ] = !0;
        }
        _createSortedPathsRules() {
            (this.sortedPathsRules = []),
                ...
                this.sortedPathsRules.sort(
                    (r, c) => c.from.length - r.from.length
                );
        }
        cloneAndMerge(r) {
            return new p(
                this._env,
                m.mergeConfigurationOptions(r, this.options)
            );
        }
        getOptionsLiteral() {
            return this.options;
        ...
        _applyPaths(r) {
            ...
            for (let a = 0, t = this.sortedPathsRules.length; a < t; a++)
                if (
                    ((c = this.sortedPathsRules[a]),
                    u.Utilities.startsWith(r, c.from))
                ) {
                    let e = [];
        ...
        load(e, i, s, n) {
            if (/^node\|/.test(i)) {
                let l = e.getConfig().getOptionsLiteral(),
                    d = c(
                        e.getRecorder(),
                        l.nodeRequire || u.global.nodeRequire
                    ),
                    o = i.split("|"),
                    _ = null;
                try {
...
//# sourceURL=${i}`),
    ...
    class r {
        ...
        load(e, i, s, n) {
            ...
            if (/^node\|/.test(i)) {
                ...
                const f = this._path.normalize(i),
                    ...
                    v = !!l.nodeCachedData,
                    E = v
                        ? this._getCachedDataPath(l.nodeCachedData, i)
                        : void 0;
        ...
        _getElectronRendererScriptPathOrUri(e) {
            ...
            let i = e.match(/^([a-z])\:(.*)/i);
            return i
                ? `file:///${(i[1].toUpperCase() + ":" + i[2]).replace(
                      /\\/g,
                      "/"
                  )}`
                : `file://${e}`;
        ...
        _createAndWriteCachedData(e, i, s, n) {
            let l = Math.ceil(
                    n.getConfig().getOptionsLiteral().nodeCachedData
                        .writeDelay *
                        (1 + Math.random())
                ),
                d = -1,
...
(function (u) {
    ...
    class c {
        ...
        static _findRelevantLocationInStack(t, e) {
            ...
            throw new Error(
                "Could not correlate define call site for needle " + t
            );
        }
        getBuildInfo() {
            ...
            for (let i = 0, s = this._modules2.length; i < s; i++) {
                ...
                t[e++] = {
                    ...
                    path: l,
                    defineLocation:
                        l && d ? c._findRelevantLocationInStack(l, d) : null,
                    dependencies: o,
                    shim: null,
                    exports: n.exports,
                };
        ...
        _normalizeDependency(t, e) {
            ...
            return new h(
                this._moduleIdProvider.getModuleId(e.resolveModule(t))
            );
        }
        ...
        _onLoadError(t, e) {
            ...
            let s = [];
            for (
                let d = 0, o = this._moduleIdProvider.getMaxModuleId();
                d < o;
                d++
            )
                s[d] = !1;
        ...
        _hasDependencyPath(t, e) {
            ...
            let s = [];
            for (
                let l = 0, d = this._moduleIdProvider.getMaxModuleId();
                l < d;
                l++
            )
                s[l] = !1;
        ...
        _createRequire(t) {
            ...
            return (
                (e.toUrl = (i) =>
                    this._config.requireToUrl(t.resolveModule(i))),
...
`)
                    ...
                    if (
                        ...
                        let o = this._inversePluginDependencies2.get(
                            n.pluginId
                        );
                        o ||
                            ((o = []),
                ...
                for (let o = 0, _ = i.length; o < _; o++) {
                    ...
                    if (f === h.MODULE) {
                        s[o] = {
                            id: t.strId,
                            config: () =>
                                this._config.getConfigForModule(t.strId),
                        };
                        continue;
                    }
                    if (f === h.REQUIRE) {
            ...
            if (((this._inverseDependencies2[t.id] = null), l))
                for (let o = 0, _ = l.length; o < _; o++) {
                    ...
                    g.unresolvedDependenciesCount--,
                        g.unresolvedDependenciesCount === 0 &&
                            this._onModuleComplete(g);
                }
...
(function (u) {
    ...
    function c() {
        ...
        y.isNode &&
        !y.isElectronRenderer &&
        !y.isElectronNodeIntegrationWebWorker
            ? (module.exports = r)
            : (y.isElectronRenderer || (u.global.define = p),
              (u.global.require = r));
    }
    (u.init = c),
