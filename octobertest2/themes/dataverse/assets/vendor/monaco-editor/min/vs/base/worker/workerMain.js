 ...
 *-----------------------------------------------------------*/ (function () {
        ...
        class n {
            ...
            _detect() {
                this._detected ||
                    ...
                    (this._isWebWorker =
                        typeof q.global.importScripts == "function"),
    ...
    (function (q) {
        ...
        class M {
            ...
            record(d, b) {
                this._events.push(
                    new n(d, b, q.Utilities.getHighPerformanceTimestamp())
                );
            }
            getEvents() {
                return this._events;
    ...
    (function (q) {
        class n {
            ...
            static endsWith(A, i) {
                return (
                    A.length >= i.length && A.substr(A.length - i.length) === i
                );
            }
                ...
                return (
                    this.PERFORMANCE_NOW_PROBED ||
                        ...
                        (this.HAS_PERFORMANCE_NOW =
                            q.global.performance &&
                            typeof q.global.performance.now == "function")),
                    this.HAS_PERFORMANCE_NOW
                        ? q.global.performance.now()
                        : Date.now()
                );
            }
        }
    ...
    (function (q) {
        ...
        class M {
            static validateConfigurationOptions(d) {
                ...
                if (
                    ...
                    d.baseUrl.length > 0 &&
                        (q.Utilities.endsWith(d.baseUrl, "/") ||
                            (d.baseUrl += "/")),
                    typeof d.cspNonce != "string" && (d.cspNonce = ""),
                    typeof d.preferScriptTags > "u" &&
                        (d.preferScriptTags = !1),
                    d.nodeCachedData &&
                        ...
                        !d.nodeCachedData.path ||
                            typeof d.nodeCachedData.path != "string"))
                ) {
                    const p = n(
                        new Error(
                ...
                return (
                    q.Utilities.forEachProperty(d, (h, o) => {
                        ...
                        typeof p.ignoreDuplicateModules < "u"
                            ? (p.ignoreDuplicateModules =
                                  p.ignoreDuplicateModules.concat(o))
                            : h === "paths" && typeof p.paths < "u"
                            ? q.Utilities.forEachProperty(
                                  o,
                                  (L, e) => (p.paths[L] = e)
                              )
        ...
        class A {
            ...
            _createIgnoreDuplicateModulesMap() {
                ...
                for (
                    let d = 0;
                    d < this.options.ignoreDuplicateModules.length;
                    d++
                )
                    this.ignoreDuplicateModulesMap[
            ...
            _createSortedPathsRules() {
                (this.sortedPathsRules = []),
                    ...
                    this.sortedPathsRules.sort(
                        (d, b) => b.from.length - d.from.length
                    );
            }
            cloneAndMerge(d) {
                return new A(
                    this._env,
                    M.mergeConfigurationOptions(d, this.options)
                );
            }
            getOptionsLiteral() {
                return this.options;
            ...
            _applyPaths(d) {
                ...
                for (let p = 0, h = this.sortedPathsRules.length; p < h; p++)
                    if (
                        ((b = this.sortedPathsRules[p]),
                        q.Utilities.startsWith(d, b.from))
                    ) {
                        let o = [];
                        for (let L = 0, e = b.to.length; L < e; L++)
                            o.push(b.to[L] + d.substr(b.from.length));
                        return o;
                    }
                return [d];
            }
            ...
            moduleIdToPaths(d) {
                ...
                let b = d,
                    p;
                if (
                    !q.Utilities.endsWith(b, ".js") &&
                    !q.Utilities.isAbsolutePath(b)
                ) {
                    p = this._applyPaths(b);
                    for (let h = 0, o = p.length; h < o; h++)
                        (this.isBuild() && p[h] === "empty:") ||
                            (q.Utilities.isAbsolutePath(p[h]) ||
                                (p[h] = this.options.baseUrl + p[h]),
                            !q.Utilities.endsWith(p[h], ".js") &&
                                !q.Utilities.containsQueryString(p[h]) &&
                                (p[h] = p[h] + ".js"));
                } else
                    !q.Utilities.endsWith(b, ".js") &&
                        !q.Utilities.containsQueryString(b) &&
                        (b = b + ".js"),
                        (p = [b]);
            ...
            load(o, L, e, a) {
                if (/^node\|/.test(L)) {
                    let u = o.getConfig().getOptionsLiteral(),
                        c = b(
                            o.getRecorder(),
                            u.nodeRequire || q.global.nodeRequire
                        ),
                        m = L.split("|"),
                        f = null;
                    try {
        ...
        class i {
            ...
            load(o, L, e, a) {
                if (/^node\|/.test(L)) {
                    ...
                    const { trustedTypesPolicy: u } = o
                        .getConfig()
                        .getOptionsLiteral();
                    if (
                        !(
                            /^((http:)|(https:)|(file:))/.test(L) &&
                            L.substring(0, self.origin.length) !== self.origin
                        ) &&
                        this._canUseEval(o)
                    ) {
                        fetch(L)
        ...
        class d {
            ...
            _initNodeRequire(o, L) {
                ...
                u.prototype._compile = function (m, f) {
                    ...
                    return (
                        a._handleCachedData(r, y, E, !S.cachedData, L),
                        a._verifyCachedData(r, y, E, C, L),
                        v
                    );
                };
            }
            load(o, L, e, a) {
                ...
                if (/^node\|/.test(L)) {
                    ...
                    const y = this._path.normalize(L),
                        ...
                        E = !!u.nodeCachedData,
                        S = E
                            ? this._getCachedDataPath(u.nodeCachedData, L)
                            : void 0;
                    this._readSourceAndCachedData(y, S, f, (C, r, s, l) => {
                        ...
                        this._handleCachedData(v, _, S, E && !s, o),
                            this._verifyCachedData(v, _, S, l, o);
                    });
                }
            }
            ...
            _getElectronRendererScriptPathOrUri(o) {
                ...
                let L = o.match(/^([a-z])\:(.*)/i);
                return L
                    ? `file:///${(L[1].toUpperCase() + ":" + L[2]).replace(
                          /\\/g,
                          "/"
                      )}`
                    : `file://${o}`;
                ...
                o.cachedDataRejected
                    ? this._fs.unlink(e, (c) => {
                          u.getRecorder().record(62, e),
                              this._createAndWriteCachedData(o, L, e, u),
            ...
            _createAndWriteCachedData(o, L, e, a) {
                let u = Math.ceil(
                        a.getConfig().getOptionsLiteral().nodeCachedData
                            .writeDelay *
                            (1 + Math.random())
                    ),
                    c = -1,
    ...
    (function (q) {
            ...
            resolveModule(h) {
                ...
                return (
                    q.Utilities.isAbsolutePath(o) ||
                        ((q.Utilities.startsWith(o, "./") ||
                            q.Utilities.startsWith(o, "../")) &&
                            (o = n._normalizeModuleId(
                                this.fromModulePath + o
                            ))),
                    o
                );
            }
        ...
        class M {
            ...
            static _safeInvokeFunction(h, o) {
                try {
                    return {
                        returnedValue: h.apply(q.global, o),
                        producedError: null,
                    };
                } catch (L) {
                        ...
                        (a = u.producedError),
                            ...
                            !a &&
                                ...
                                (!this.exportsPassedIn ||
                                    q.Utilities.isEmpty(this.exports)) &&
        ...
        class b {
            ...
            static _findRelevantLocationInStack(h, o) {
                ...
                throw new Error(
                    "Could not correlate define call site for needle " + h
                );
            }
            getBuildInfo() {
                ...
                for (let L = 0, e = this._modules2.length; L < e; L++) {
                    ...
                    h[o++] = {
                        ...
                        defineLocation:
                            u && c
                                ? b._findRelevantLocationInStack(u, c)
                                : null,
                        dependencies: m,
                        shim: null,
                        exports: a.exports,
                ...
                return (
                    this._recorder ||
                        (this._config.shouldRecordStats()
                            ...
                            : (this._recorder =
                                  q.NullLoaderEventRecorder.INSTANCE)),
                    this._recorder
                );
            }
            getLoaderEvents() {
            ...
            defineModule(h, o, L, e, a, u = new n(h)) {
                ...
                if (this._modules2[c]) {
                    this._config.isDuplicateMessageIgnoredFor(h) ||
                        console.warn(
                            "Duplicate definition of module '" + h + "'"
                        );
                    return;
                }
            ...
            _normalizeDependency(h, o) {
                ...
                return new i(
                    this._moduleIdProvider.getModuleId(o.resolveModule(h))
                );
            }
            _normalizeDependencies(h, o) {
                ...
                for (let a = 0, u = h.length; a < u; a++)
                    L[e++] = this._normalizeDependency(h[a], o);
                return L;
            }
            ...
            _createLoadError(h, o) {
                ...
                return (
                    (a.phase = "loading"), (a.moduleId = L), (a.neededBy = e), a
                );
            }
            _onLoadError(h, o) {
                ...
                let e = [];
                for (
                    let c = 0, m = this._moduleIdProvider.getMaxModuleId();
                    c < m;
                    c++
                )
                    e[c] = !1;
            ...
            _hasDependencyPath(h, o) {
                ...
                let e = [];
                for (
                    let u = 0, c = this._moduleIdProvider.getMaxModuleId();
                    u < c;
                    u++
                )
                    e[u] = !1;
            ...
            _createRequire(h) {
                ...
                return (
                    (o.toUrl = (L) =>
                        this._config.requireToUrl(h.resolveModule(L))),
                    ...
                    for (let L = 0, e = o.length; L < e; L++) {
                        ...
                        if (this._hasDependencyPath(a.id, h.id)) {
                            ...
                            c.reverse(),
                                ...
                                console.warn(
                                    c.map((m) =>
                                        this._moduleIdProvider.getStrModuleId(m)
                                    ).join(` => 
`)
                                ),
                                h.unresolvedDependenciesCount--;
                        ...
                        if (
                            ...
                            let m = this._inversePluginDependencies2.get(
                                a.pluginId
                            );
                            m ||
                                ((m = []),
                    ...
                    for (let m = 0, f = L.length; m < f; m++) {
                        ...
                        if (y === i.MODULE) {
                            e[m] = {
                                id: h.strId,
                                config: () =>
                                    this._config.getConfigForModule(h.strId),
                            };
                            continue;
                        }
                        if (y === i.REQUIRE) {
                ...
                if (((this._inverseDependencies2[h.id] = null), u))
                    for (let m = 0, f = u.length; m < f; m++) {
                        ...
                        w.unresolvedDependenciesCount--,
                            w.unresolvedDependenciesCount === 0 &&
                                this._onModuleComplete(w);
                    }
    ...
    (function (q) {
        ...
        const A = function (p, h, o) {
            typeof p != "string" && ((o = h), (h = p), (p = null)),
                ...
                p
                    ? M.defineModule(p, h, o, null, null)
        ...
        function b() {
            ...
            !n.isElectronNodeIntegrationWebWorker
                ? (module.exports = d)
                : (n.isElectronRenderer || (q.global.define = A),
                  (q.global.require = d));
        }
        (q.init = b),
            ...
            function c(f, y) {
                ...
                return {
                    ...
                    getConfiguredDefaultLocale:
                        (w = y.getConfiguredDefaultLocale) !== null &&
                        w !== void 0
                            ? w
                            : (E) => {},
                };
            ...
            function m(f, y, w, E) {
                ...
                if (!f || f.length === 0)
                    return w({
                        ...
                        getConfiguredDefaultLocale: () => {
                            var g;
                            return (g = C.availableLanguages) === null ||
                                g === void 0
                                ? void 0
                                : g["*"];
                        },
                    });
                const r = C.availableLanguages
                        ? d(C.availableLanguages, f)
                        : null,
                    s = r === null || r === A;
                let l = ".nls";
                s || (l = l + "." + r);
                const _ = (g) => {
                    Array.isArray(g)
                        ...
                        (g.getConfiguredDefaultLocale = () => {
                            var v;
                            return (v = C.availableLanguages) === null ||
                                v === void 0
                                ? void 0
                                : v["*"];
                        }),
                ...
                typeof C.loadBundle == "function"
                    ...
                    ? (async () => {
                          ...
                          try {
                              ...
                              if (!r.includes("-"))
                                  return console.error(v), y([f + ".nls"], _);
                              try {
                                  const R = r.split("-")[0],
                                      N = await p(
                                          C.translationServiceUrl,
                                          R,
                                          f
                                      );
                                  return (
                                      ((g = C.availableLanguages) !== null &&
                                          g !== void 0) ||
        ...
        (function () {
            ...
            function d() {
                return new Promise((L, e) => {
                    if (
                        typeof globalThis.define == "function" &&
                    ...
                    if (
                        !(
                            ...
                            a.substring(0, globalThis.origin.length) !==
                                globalThis.origin
                        ) &&
                        i()
                    ) {
...
//# sourceURL=${a}`),
                    ...
                    A ? importScripts(A.createScriptURL(a)) : importScripts(a),
                        L();
                });
            }
            function b() {
        ...
        Y(X[7], J([0, 1]), function (q, n) {
            ...
            function h(k, O, I) {
                ...
                return k < z.length
                    ...
                    : k < z.length + t.length
                    ? t[0]
                    : h(k - (z.length + t.length), G, I);
            }
            n.quickSelect = h;
            function o(k, O) {
                const I = [];
                let W;
                for (const z of k.slice(0).sort(O))
                    !W || O(W[0], z) !== 0 ? ((W = [z]), I.push(W)) : W.push(z);
                return I;
            }
            n.groupBy = o;
            function* L(k, O) {
            ...
            class B {
                ...
                takeWhile(O) {
                    ...
                    const W =
                        I === this.firstIdx
                            ? null
                            : this.items.slice(this.firstIdx, I);
        ...
        Y(X[33], J([0, 1]), function (q, n) {
            ...
            class A {
                ...
                static equals(h, o) {
                    return (
                        h.r === o.r && h.g === o.g && h.b === o.b && h.a === o.a
                    );
                }
            }
            n.RGBA = A;
            class i {
                ...
                static equals(h, o) {
                    return (
                        h.h === o.h && h.s === o.s && h.l === o.l && h.a === o.a
                    );
                }
                static fromRGBA(h) {
                    const o = h.r / 255,
                ...
                static toRGBA(h) {
                    ...
                    if (L === 0) u = c = m = e;
                        ...
                        const f = e < 0.5 ? e * (1 + L) : e + L - e * L,
                            y = 2 * e - f;
                        (u = i._hue2rgb(y, f, o + 1 / 3)),
                            (c = i._hue2rgb(y, f, o)),
                            (m = i._hue2rgb(y, f, o - 1 / 3));
                    }
                    return new A(
                        Math.round(u * 255),
                        Math.round(c * 255),
            ...
            class d {
                ...
                static equals(h, o) {
                    return (
                        h.h === o.h && h.s === o.s && h.v === o.v && h.a === o.a
                    );
                }
                static fromRGBA(h) {
                    const o = h.r / 255,
            ...
            class b {
                ...
                constructor(h) {
                    if (h)
                        if (h instanceof A) this.rgba = h;
                            ...
                            (this._hsla = h), (this.rgba = i.toRGBA(h));
                        else if (h instanceof d)
                            (this._hsva = h), (this.rgba = d.toRGBA(h));
                ...
                toString() {
                    return (
                        this._toString ||
                            (this._toString = b.Format.CSS.format(this)),
                        this._toString
                    );
                }
                ...
                (function (p) {
                    ...
                    (function (o) {
                        ...
                        (function (e) {
                            ...
                            e.formatHSL = c;
                            function m(r) {
                                return `hsla(${r.hsla.h}, ${(
                                    r.hsla.s * 100
                                ).toFixed(2)}%, ${(r.hsla.l * 100).toFixed(
                                    2
                                )}%, ${r.hsla.a.toFixed(2)})`;
                            }
                            e.formatHSLA = m;
                            ...
                            function y(r) {
                                return `#${f(r.rgba.r)}${f(r.rgba.g)}${f(
                                    r.rgba.b
                                )}`;
                            }
                            e.formatHex = y;
                            function w(r, s = !1) {
                                return s && r.rgba.a === 1
                                    ...
                                    : `#${f(r.rgba.r)}${f(r.rgba.g)}${f(
                                          r.rgba.b
                                      )}${f(Math.round(r.rgba.a * 255))}`;
                            }
                            e.formatHexA = w;
                            function E(r) {
                                return r.isOpaque()
...
` +
        ...
        Y(X[12], J([0, 1, 5]), function (q, n, M) {
            ...
            function A(h, o) {
                if (!h)
                    throw new Error(
                        o ? `Assertion failed (${o})` : "Assertion Failed"
                    );
            }
            n.ok = A;
        ...
        Y(X[13], J([0, 1, 20, 21]), function (q, n, M, A) {
            ...
            if (((n.setDisposableTracker = b), i)) {
                ...
                b(
                    new (class {
                        trackDisposable(s) {
                            const l = new Error("Potentially leaked disposable")
                                .stack;
                            setTimeout(() => {
                                s[r] || console.log(l);
                            }, 3e3);
            ...
            class f {
                ...
                dispose() {
                    this._isDisposed ||
                        (h(this), (this._isDisposed = !0), this.clear());
                }
                get isDisposed() {
                ...
                deleteAndLeak(s) {
                    s &&
                        this._toDispose.has(s) &&
                        (this._toDispose.delete(s), o(s, null));
                }
            }
        ...
        Y(X[37], J([0, 1]), function (q, n) {
            ...
            class b {
                constructor(a, u) {
                    if (((this[M] = "ResourceMap"), a instanceof b))
                        (this.map = new Map(a.map)),
                            (this.toKey = u ?? b.defaultToKey);
                    else if (d(a)) {
                        (this.map = new Map()),
                            (this.toKey = u ?? b.defaultToKey);
                ...
                get(a) {
                    var u;
                    return (u = this.map.get(this.toKey(a))) === null ||
                        u === void 0
                        ? void 0
                        : u.value;
                }
            ...
            class p {
                ...
                get first() {
                    var a;
                    return (a = this._head) === null || a === void 0
                        ? void 0
                        : a.value;
                }
                get last() {
                    var a;
                    return (a = this._tail) === null || a === void 0
                        ? void 0
                        : a.value;
                }
                has(a) {
                ...
                forEach(a, u) {
                    ...
                    for (; m; ) {
                        if (
                            (u
                                ? a.bind(u)(m.value, m.key, this)
                                : a(m.value, m.key, this),
                            this._state !== c)
                        )
                            throw new Error(
            ...
            class A {
                ...
                constructor(d) {
                    (this._now =
                        M && d === !1
                            ? Date.now
                            : globalThis.performance.now.bind(
                                  globalThis.performance
                              )),
        ...
        Y(X[9], J([0, 1, 5, 20, 13, 22, 23]), function (q, n, M, A, i, d, b) {
            ...
            (function (g) {
                ...
                function T(K, j, Z) {
                    return k(
                        (Q, ee = null, ne) =>
                            K((ie) => j(ie) && Q.call(ee, ie), null, ne),
                        Z
                    );
                }
                g.filter = T;
                ...
                class me {
                    ...
                    reduce(j, Z) {
                        let Q = Z;
                        return (
                            this.steps.push((ee) => ((Q = j(Q, ee)), Q)), this
                        );
                    }
                    latch(j = (Z, Q) => Z === Q) {
                        let Z = !0,
                ...
                class Ce {
                    constructor(j, Z) {
                        ...
                        Z || v(Q),
                            (this.emitter = new y(Q)),
                            Z && Z.add(this.emitter);
                    }
                    beginUpdate(j) {
                        this._counter++;
                    }
            ...
            class L {
                ...
                start(v) {
                    (this._stopWatch = new b.StopWatch()),
                        (this.listenerCount = v);
                }
                stop() {
                    if (this._stopWatch) {
            ...
            class u {
                static create() {
                    var v;
                    return new u(
                        (v = new Error().stack) !== null && v !== void 0
                            ? v
                            : ""
                    );
                }
...
`)
                            ...
                            (this._event = (R, N, D) => {
                                ...
                                this._leakageMon &&
                                    ...
                                    this._listeners
                                        ...
                                        : ((T =
                                              (x = this._options) === null ||
                                              x === void 0
                                                  ? void 0
                                                  : x.onWillAddFirstListener) ===
                                              null ||
                                              T === void 0 ||
                                              T.call(x, this),
                                          (this._listeners = k),
                ...
                _removeListener(v) {
                    ...
                    if (F === -1)
                        throw (
                            ...
                            console.log(
                                "arr?",
                                JSON.stringify(this._listeners)
                            ),
                    ...
                    if (
                        (!(
                            ...
                            (N = this._perfMon) === null ||
                                N === void 0 ||
                                N.stop()),
                        (D = this._perfMon) === null ||
                            D === void 0 ||
                            D.start(this._size),
                        this._listeners)
                    )
                        if (this._listeners instanceof c)
                            this._deliver(this._listeners, v);
                        else {
                            const T = this._deliveryQueue;
                            T.enqueue(this, v, this._listeners.length),
                    ...
                    this.hasListeners() &&
                        ...
                        this._queuedEvents.length === 1 &&
                            queueMicrotask(() => {
                                this._mergeFn
                                    ? super.fire(
                                          this._mergeFn(this._queuedEvents)
                                      )
                                    : this._queuedEvents.forEach((R) =>
                                          super.fire(R)
                                      ),
                                    (this._queuedEvents = []);
                            }));
            ...
            class s {
                ...
                add(v) {
                    ...
                    return (0,
                    i.toDisposable)((0, A.createSingleCallFunction)(N));
                }
                onFirstListenerAdd() {
                    (this.hasListeners = !0),
                        this.events.forEach((v) => this.hook(v));
                }
                onLastListenerRemove() {
                    (this.hasListeners = !1),
                        this.events.forEach((v) => this.unhook(v));
                }
                hook(v) {
        ...
        Y(X[6], J([0, 1, 32, 36]), function (q, n, M, A) {
            ...
            function p(P, ...U) {
                return U.length === 0
                    ...
                    : P.replace(b, function (H, $) {
                          ...
                          return isNaN(te) || te < 0 || te >= U.length
                              ? H
                              : U[te];
                      });
            }
            ...
            function T(P, U) {
                ...
                const te = P.length - 1,
                    re = U.length - 1;
                for ($ = 0; $ < H; $++)
                    if (P.charCodeAt(te - $) !== U.charCodeAt(re - $)) return $;
                return H;
            }
            ...
            function ee(P, U) {
                ...
                let te = H.offset;
                return (
                    te > 0 && H.prevCodePoint() === 8205 && (te = H.offset), te
                );
            }
            function ne(P) {
            ...
            (n.AmbiguousCharacters = ie),
                ...
                (ie.cache = new M.LRUCachedFunction((P) => {
                    function U(oe) {
                        const he = new Map();
                        for (let de = 0; de < oe.length; de += 2)
                            he.set(oe[de], oe[de + 1]);
                        return he;
                    }
                    function H(oe, he) {
                        const de = new Map(oe);
            ...
            class ae {
                ...
                static getData() {
                    return (
                        this._data || (this._data = new Set(ae.getRawData())),
                        this._data
                    );
                }
            ...
            class c {
                ...
                _step() {
                    ...
                    for (let g = 0; g < 64; g += 4)
                        f.setUint32(g, y.getUint32(g, !1), !1);
        ...
        Y(X[24], J([0, 1, 34, 39]), function (q, n, M, A) {
            ...
            class o {
                ...
                _ComputeDiff(e, a, u, c, m) {
                    ...
                    return (
                        m && (y = this.PrettifyChanges(y)),
                        { quitEarly: f[0], changes: y }
                    );
                }
                ComputeDiffRecursive(e, a, u, c, m) {
                    for (
                        m[0] = !1;
                        e <= a && u <= c && this.ElementsAreEqual(e, u);

                    )
                        e++, u++;
                    for (; a >= e && c >= u && this.ElementsAreEqual(a, c); )
                        a--, c--;
                    if (e > a || u > c) {
                        let C;
                        return (
                ...
                WALKTRACE(
                    ...
                    if (((N = x.getReverseChanges()), R[0])) {
                        ...
                        if (N !== null && N.length > 0) {
                            ...
                            (O = Math.max(O, W.getOriginalEnd())),
                                (I = Math.max(I, W.getModifiedEnd()));
                        }
                ...
                ComputeRecursionPoint(e, a, u, c, m, f, y) {
                    ...
                    for (let B = 1; B <= l / 2 + 1; B++) {
                        let V = 0,
                            k = 0;
                        (S = this.ClipDiagonalBound(R - B, B, R, _)),
                            (C = this.ClipDiagonalBound(R + B, B, R, _));
                        for (let I = S; I <= C; I += 2) {
                            I === S || (I < C && g[I - 1] < g[I + 1])
                                ? (w = g[I + 1])
                                : (w = g[I - 1] + 1),
                        ...
                        if (
                            ...
                            !this.ContinueProcessingPredicate(V, O)
                        )
                            return (
                                (y[0] = !0),
                                (m[0] = V),
                        ...
                        for (let I = r; I <= s; I += 2) {
                            ...
                            for (
                                ;
                                w > e && E > u && this.ElementsAreEqual(w, E);

                            )
                                w--, E--;
                            if (
                                ((v[I] = w),
                                F && Math.abs(I - R) <= B && w <= g[I])
                            )
                                return (
                                    (m[0] = w),
                                    (f[0] = E),
                ...
                PrettifyChanges(e) {
                    for (let a = 0; a < e.length; a++) {
                        ...
                        if (
                            a < e.length - 1 &&
                            this.ChangesOverlap(e[a], e[a + 1], w)
                        ) {
                    ...
                    if (this._hasStrings)
                        for (let a = 1, u = e.length; a < u; a++) {
                            const c = e[a - 1],
                                ...
                                r = C - S;
                            if (f < 5 && E < 20 && r < 20) {
                                const s = this._findBetterContiguousSequence(
                                    y,
                                    E,
                                    S,
                                    r,
                ...
                _OriginalRegionIsBoundary(e, a) {
                    ...
                    if (a > 0) {
                        const u = e + a;
                        if (
                            this._OriginalIsBoundary(u - 1) ||
                            this._OriginalIsBoundary(u)
                        )
                            return !0;
                    }
                    return !1;
                ...
                _ModifiedRegionIsBoundary(e, a) {
                    ...
                    if (a > 0) {
                        const u = e + a;
                        if (
                            this._ModifiedIsBoundary(u - 1) ||
                            this._ModifiedIsBoundary(u)
                        )
                            return !0;
                    }
                    return !1;
                ...
                ConcatenateChanges(e, a) {
                    ...
                    if (this.ChangesOverlap(e[e.length - 1], a[0], u)) {
                        ...
                        return (
                            p.Copy(e, 0, c, 0, e.length - 1),
                            (c[e.length - 1] = u[0]),
                            p.Copy(a, 1, c, e.length, a.length - 1),
                            c
                        );
                    } else {
                        const c = new Array(e.length + a.length);
                        return (
                            p.Copy(e, 0, c, 0, e.length),
                            p.Copy(a, 0, c, e.length, a.length),
                            c
                        );
                    }
                }
                ChangesOverlap(e, a, u) {
                    if (
                        ...
                        return (
                            e.originalStart + e.originalLength >=
                                a.originalStart &&
                                (m =
                                    a.originalStart +
                                    a.originalLength -
        ...
        Y(X[25], J([0, 1]), function (q, n) {
            ...
            function m(f, y) {
                if (M(y)) {
                    if (typeof f !== y)
                        throw new Error(
                            `argument does not match constraint: typeof ${y}`
                        );
                } else if (u(y)) {
                    try {
        ...
        Y(X[40], J([0, 1, 25]), function (q, n, M) {
            ...
            function i(b, p) {
                if ((0, M.isString)(p)) {
                    ...
                    if (h === void 0)
                        throw new Error(
                            `${b} references an unknown codicon: ${p}`
                        );
                    p = h;
                }
                return (A[b] = p), { id: b };
            ...
            (n.getCodiconFontCharacters = d),
                (n.Codicon = {
                    ...
                    debugBreakpointDisabled: i(
                        "debug-breakpoint-disabled",
                        60017
                    ),
                    debugBreakpointPending: i(
                    ...
                    debugStackframeFocused: i(
                        "debug-stackframe-focused",
                        60299
                    ),
                    debugBreakpointUnsupported: i(
                    ...
                    gitPullRequestGoToChanges: i(
                        "git-pull-request-go-to-changes",
                        60427
                    ),
                    gitPullRequestNewChanges: i(
                    ...
                    treeFilterOnTypeOn: i(
                        "tree-filter-on-type-on",
                        "list-filter"
                    ),
                    treeFilterOnTypeOff: i(
                    ...
                    scrollbarButtonLeft: i(
                        "scrollbar-button-left",
                        "triangle-left"
                    ),
                    scrollbarButtonRight: i(
                        "scrollbar-button-right",
                        "triangle-right"
                    ),
                    scrollbarButtonUp: i("scrollbar-button-up", "triangle-up"),
                    scrollbarButtonDown: i(
            ...
            class A {
                constructor(b) {
                    ...
                    (this._defaultValue = p),
                        (this._asciiMap = A._createAsciiMap(p)),
                        (this._map = new Map());
                }
        ...
        Y(X[3], J([0, 1, 5]), function (q, n, M) {
            ...
            class A {
                ...
                clip(b) {
                    ...
                    return Math.max(
                        this.start,
                        Math.min(this.endExclusive - 1, b)
                    );
                }
                clipCyclic(b) {
                    if (this.isEmpty)
            ...
            class i {
                ...
                addRange(b) {
                    ...
                    for (
                        ...
                        this._sortedRanges[p].endExclusive < b.start;
                ...
                intersectsStrict(b) {
                    ...
                    return (
                        p < this._sortedRanges.length &&
                        this._sortedRanges[p].start < b.endExclusive
                    );
                }
        ...
        Y(X[4], J([0, 1]), function (q, n) {
            ...
            class M {
                ...
                with(i = this.lineNumber, d = this.column) {
                    return i === this.lineNumber && d === this.column
                        ? this
                        : new M(i, d);
                }
                delta(i = 0, d = 0) {
            ...
            class A {
                ...
                static containsPosition(d, b) {
                    return !(
                        ...
                        (b.lineNumber === d.startLineNumber &&
                            b.column < d.startColumn) ||
                        (b.lineNumber === d.endLineNumber &&
                            b.column > d.endColumn)
                    );
                }
                ...
                static plusRange(d, b) {
                    ...
                    return (
                        ...
                        b.endLineNumber > d.endLineNumber
                            ...
                            : b.endLineNumber === d.endLineNumber
                            ? ((o = b.endLineNumber),
                              (L = Math.max(b.endColumn, d.endColumn)))
        ...
        Y(X[10], J([0, 1, 5, 3, 2, 11]), function (q, n, M, A, i, d) {
            ...
            class b {
                ...
                constructor(o, L) {
                    if (o > L)
                        throw new M.BugIndicatingError(
                            `startLineNumber ${o} cannot be after endLineNumberExclusive ${L}`
                        );
                    (this.startLineNumber = o),
                        (this.endLineNumberExclusive = L);
                }
                contains(o) {
                    return (
                        this.startLineNumber <= o &&
                ...
                forEach(o) {
                    for (
                        let L = this.startLineNumber;
                        L < this.endLineNumberExclusive;
                        L++
                    )
                        o(L);
                }
            ...
            class p {
                ...
                addRange(o) {
                    ...
                    if (L === e) this._normalizedRanges.splice(L, 0, o);
                        ...
                        const a = this._normalizedRanges[L].join(
                ...
                contains(o) {
                    const L = (0, d.findLastMonotonous)(
                        this._normalizedRanges,
                ...
                subtractFrom(o) {
                    ...
                    for (let c = L; c < e; c++) {
                        ...
                        m.startLineNumber > u &&
                            a.push(new b(u, m.startLineNumber)),
                ...
                getIntersection(o) {
                    ...
                    for (
                        ...
                        const u = this._normalizedRanges[e],
                            ...
                            m = u.intersect(c);
                        m && !m.isEmpty && L.push(m),
                            u.endLineNumberExclusive < c.endLineNumberExclusive
                                ? e++
                                : a++;
                    }
                    return new p(L);
            ...
            class i extends A.Range {
                ...
                static selectionsArrEqual(b, p) {
                    ...
                    for (let h = 0, o = b.length; h < o; h++)
                        if (!this.selectionsEqual(b[h], p[h])) return !1;
                    return !0;
                }
        ...
        Y(X[42], J([0, 1, 27]), function (q, n, M) {
            "use strict";
            Object.defineProperty(n, "__esModule", { value: !0 }),
                (n.getMapForWordSeparators = n.WordCharacterClassifier =
                    void 0);
            class A extends M.CharacterClassifier {
                constructor(b) {
                    super(0);
                    for (let p = 0, h = b.length; p < h; p++)
                        this.set(b.charCodeAt(p), 2);
        ...
        Y(X[28], J([0, 1, 21, 22]), function (q, n, M, A) {
            ...
            function p(o, L, e, a, u) {
                ...
                if (y) {
                    const w = {
                        word: y[0],
                        startColumn: a + 1 + y.index,
                        endColumn: a + 1 + y.index + y[0].length,
                    };
        ...
        Y(X[8], J([0, 1, 7, 5, 3]), function (q, n, M, A, i) {
            ...
            class b {
                ...
                delta(e) {
                    return e === 0
                        ? this
                        : new b(
                              this.seq1Range.delta(e),
                              this.seq2Range.delta(e)
                          );
                }
                deltaStart(e) {
                    return e === 0
            ...
            class p {
                ...
                delta(e) {
                    return e === 0
                        ? this
                        : new p(this.offset1 + e, this.offset2 + e);
                }
                equals(e) {
                    return (
                        this.offset1 === e.offset1 && this.offset2 === e.offset2
                    );
                }
            }
            (n.OffsetPair = p),
            ...
            class o {
                constructor(e) {
                    if (
                        ...
                        throw new A.BugIndicatingError(
            ...
            class i {
                compute(o, L, e = A.InfiniteTimeout.instance) {
                    if (o.length === 0 || L.length === 0)
                        return A.DiffAlgorithmResult.trivial(o, L);
                    const a = o,
                        u = L;
                    function c(s, l) {
                        for (
                    ...
                    y.set(
                        0,
                        f.get(0) === 0 ? null : new d(null, 0, 0, f.get(0))
                    );
                    let w = 0;
                    e: for (;;) {
                        if ((m++, !e.isValid()))
                ...
                for (let E = 1; E < f.length; E++) {
                    ...
                    if (C.seq1Range.isEmpty || C.seq2Range.isEmpty) {
                        ...
                        for (
                            ...
                            s <= r &&
                            !(
                                c.getElement(C.seq1Range.start - s) !==
                                    c.getElement(
                                        C.seq1Range.endExclusive - s
                                    ) ||
                                m.getElement(C.seq2Range.start - s) !==
                                    m.getElement(C.seq2Range.endExclusive - s)
                            );
                            s++
                        );
                        if ((s--, s === r)) {
                            y[y.length - 1] = new i.SequenceDiff(
                                new A.OffsetRange(
                                    S.seq1Range.start,
                                    C.seq1Range.endExclusive - r
                                ),
                                new A.OffsetRange(
                                    S.seq2Range.start,
                                    C.seq2Range.endExclusive - r
                                )
                            );
                            continue;
                        }
                ...
                for (let y = 0; y < f.length; y++) {
                    const w = y > 0 ? f[y - 1] : void 0,
                        ...
                        C = new A.OffsetRange(
                            ...
                            S ? S.seq1Range.start - 1 : c.length
                        ),
                        r = new A.OffsetRange(
                            w ? w.seq2Range.endExclusive + 1 : 0,
                            S ? S.seq2Range.start - 1 : m.length
                        );
                    E.seq1Range.isEmpty
                        ? (f[y] = h(E, c, m, C, r))
                        : E.seq2Range.isEmpty &&
                          (f[y] = h(E.swap(), m, c, r, C).swap());
                }
                return f;
            }
            ...
            function L(c, m, f) {
                ...
                function S(r, s) {
                    ...
                    for (; y.length > 0; ) {
                        ...
                        if (
                            !(
                                D.seq1Range.intersects(l) ||
                                D.seq2Range.intersects(_)
                            )
                        )
                            break;
                        ...
                        if (
                            ...
                            (N += V.seq2Range.length),
                            (g = g.join(B)),
                            g.seq1Range.endExclusive >=
                                D.seq1Range.endExclusive)
                        )
                            y.shift();
                        else break;
                    }
                    R + N <
                        ((g.seq1Range.length + g.seq2Range.length) * 2) / 3 &&
                        w.push(g),
                ...
                for (; y.length > 0; ) {
                    ...
                    r.seq1Range.isEmpty ||
                        (S(r.getStarts(), r),
                        S(r.getEndExclusives().delta(-1), r));
                }
                return e(f, w);
            }
            ...
            function e(c, m) {
                ...
                for (; c.length > 0 || m.length > 0; ) {
                    const y = c[0],
                        w = m[0];
                    let E;
                    y && (!w || y.seq1Range.start < w.seq1Range.start)
                        ? (E = c.shift())
                        : (E = m.shift()),
                        f.length > 0 &&
                        f[f.length - 1].seq1Range.endExclusive >=
                            E.seq1Range.start
            ...
            function a(c, m, f) {
                ...
                do {
                    ...
                    for (let C = 1; C < y.length; C++) {
                        ...
                        l(s, r)
                            ? ((E = !0),
                              (S[S.length - 1] = S[S.length - 1].join(r)))
                            : S.push(r);
                    }
                    y = S;
                } while (w++ < 10 && E);
                ...
                do {
                    ...
                    for (let r = 1; r < y.length; r++) {
                        let _ = function (v, R) {
                            ...
                            if (c.countLinesIn(N) > 5 || N.length > 500)
                                return !1;
                            ...
                            return (
                                Math.pow(
                                    Math.pow(G(T * 40 + F), 1.5) +
                                        Math.pow(G(B * 40 + V), 1.5),
                                    1.5
                                ) +
                                    Math.pow(
                                        Math.pow(G(k * 40 + O), 1.5) +
                                            Math.pow(G(I * 40 + W), 1.5),
                                        1.5
                                    ) >
                                (z ** 1.5) ** 1.5 * 1.3
                            );
                        ...
                        _(l, s)
                            ? ((E = !0),
                              (C[C.length - 1] = C[C.length - 1].join(s)))
                            : C.push(s);
                    }
                    y = C;
                } while (w++ < 10 && E);
                ...
                return (
                    (0, M.forEachWithNeighbors)(y, (C, r, s) => {
                        ...
                        const g = c.extendToFullLines(r.seq1Range),
                            v = c.getText(
                                new A.OffsetRange(g.start, r.seq1Range.start)
                            );
                        ...
                        const N = i.SequenceDiff.fromOffsetPairs(
                            ...
                            D = l.intersect(N);
                        S.length > 0 &&
                        D.getStarts().equals(S[S.length - 1].getEndExclusives())
...
`);
            ...
            function A(i) {
                ...
                for (
                    ;
                    d < i.length &&
                    (i.charCodeAt(d) === 32 || i.charCodeAt(d) === 9);
        ...
        Y(X[15], J([0, 1]), function (q, n) {
            ...
            class i {
                static getKey(b) {
                    ...
                    return (
                        p === void 0 &&
                            ((p = this.chrKeys.size), this.chrKeys.set(b, p)),
                        p
                    );
                }
                constructor(b, p, h) {
                    ...
                    let o = 0;
                    for (
                        let L = b.startLineNumber - 1;
                        L < b.endLineNumberExclusive - 1;
                        L++
                    ) {
                        const e = p[L];
...
`);
                ...
                computeSimilarity(b) {
                    ...
                    for (let e = 0; e < L; e++)
                        o += Math.abs(
                            ((p = this.histogram[e]) !== null && p !== void 0
                                ? p
                                : 0) -
                                ((h = b.histogram[e]) !== null && h !== void 0
                                    ? h
                                    : 0)
                        );
            ...
            class d {
                compute(p, h, o = A.InfiniteTimeout.instance, L) {
                    if (p.length === 0 || h.length === 0)
                        return A.DiffAlgorithmResult.trivial(p, h);
                    ...
                    for (let S = 0; S < p.length; S++)
                        for (let C = 0; C < h.length; C++) {
                            ...
                            if (_ === l) {
                                const g =
                                    S > 0 && C > 0 ? u.get(S - 1, C - 1) : 0;
                                u.set(S, C, g + 1), a.set(S, C, 3);
                            } else
                                _ === r
                                    ? (u.set(S, C, 0), a.set(S, C, 1))
                                    : _ === s &&
                                      (u.set(S, C, 0), a.set(S, C, 2));
                            e.set(S, C, _);
                        }
                    const c = [];
                    let m = p.length,
                    ...
                    function y(S, C) {
                        (S + 1 !== m || C + 1 !== f) &&
                            c.push(
                                new A.SequenceDiff(
                                    new M.OffsetRange(S + 1, m),
                                    new M.OffsetRange(C + 1, f)
                                )
                            ),
                            (m = S),
                            (f = C);
                    ...
                    for (; w >= 0 && E >= 0; )
                        a.get(w, E) === 3
                            ...
                            : E--;
                    return (
                        y(-1, -1), c.reverse(), new A.DiffAlgorithmResult(c, !1)
                    );
                }
            }
            ...
            class p {
                constructor(u, c, m) {
                    ...
                    c.start > 0 &&
                        ...
                        ((c = new A.OffsetRange(c.start - 1, c.endExclusive)),
                        (f = !0)),
                        (this.lineRange = c),
                        (this.firstCharOffsetByLine[0] = 0);
                    for (
                        let y = this.lineRange.start;
                        y < this.lineRange.endExclusive;
                        y++
                    ) {
                        let w = u[y],
                            E = 0;
                        ...
                        for (let S = 0; S < w.length; S++)
                            this.elements.push(w.charCodeAt(S));
                        y < u.length - 1 &&
                            (this.elements.push(
                                `
`.charCodeAt(0)
                ...
                findWordContaining(u) {
                    ...
                    let m = u;
                    for (; m < this.elements.length && h(this.elements[m]); )
                        m++;
        ...
        Y(X[16], J([0, 1, 10]), function (q, n, M) {
            ...
            class A {
                ...
                join(p) {
                    return new A(
                        this.original.join(p.original),
                        this.modified.join(p.modified)
                    );
                }
            }
            ...
            class i extends A {
                ...
                flip() {
                    ...
                    return new i(
                        this.modified,
                        this.original,
                        (p = this.innerChanges) === null || p === void 0
                            ? void 0
                            : p.map((h) => h.flip())
                    );
                }
        ...
        Y(
            X[46],
            J([0, 1, 8, 16, 7, 11, 37, 10, 3, 30, 15, 29]),
            function (q, n, M, A, i, d, b, p, h, o, L, e) {
                "use strict";
                Object.defineProperty(n, "__esModule", { value: !0 }),
...
`).length >= 15 && u(D, (T) => T.length >= 2) >= 2
                ...
                function c(E, S, C, r) {
                    const s = [],
                        l = E.filter(
                            (v) => v.modified.isEmpty && v.original.length >= 3
                        ).map((v) => new L.LineRangeFragment(v.original, S, v)),
                        _ = new Set(
                            E.filter(
                                (v) =>
                                    v.original.isEmpty && v.modified.length >= 3
                            ).map(
                    ...
                    for (const v of l) {
                        ...
                        if (
                            (R > 0.9 &&
                                ...
                                (_.delete(N),
                                s.push(
                                    new A.LineRangeMapping(v.range, N.range)
                                ),
                                g.add(v.source),
                                g.add(N.source)),
                            !r.isValid())
                ...
                function m(E, S, C, r, s, l) {
                    ...
                    for (const x of v) {
                        ...
                        for (const k of V.ranges) {
                            ...
                            const O = k,
                                I = k.delta(-T);
                            _.push(new A.LineRangeMapping(I, O)),
                                R.addRange(O),
                                N.addRange(I);
                        }
                    }
                    ...
                    for (let x = 0; x < _.length; x++) {
                        ...
                        W > 0 &&
                            (N.addRange(
                                new p.LineRange(
                                    T.original.startLineNumber - W,
                                    T.original.startLineNumber
                                )
                            ),
                            R.addRange(
                                new p.LineRange(
                                    T.modified.startLineNumber - W,
                                    T.modified.startLineNumber
                                )
                            ));
                        let z;
                ...
                function f(E, S, C) {
                    ...
                    const s = new e.MyersDiffAlgorithm().compute(
                        new o.LinesSliceCharSequence(
                            [E],
                            new h.OffsetRange(0, 1),
                            !1
                        ),
                        new o.LinesSliceCharSequence(
                            [S],
                ...
                class f {
                    constructor() {
                        (this.dynamicProgrammingDiffing =
                            ...
                            (this.myersDiffingAlgorithm =
                                new o.MyersDiffAlgorithm());
                    }
                    computeDiff(S, C, r) {
                        if (
                            S.length <= 1 &&
                            (0, M.equals)(S, C, (z, G) => z === G)
                        )
                            return new a.LinesDiff([], [], !1);
                        if (
                            (S.length === 1 && S[0].length === 0) ||
                            (C.length === 1 && C[0].length === 0)
                        )
                            return new a.LinesDiff(
                                [
                                    new u.DetailedLineRangeMapping(
                                        new i.LineRange(1, S.length + 1),
                                        new i.LineRange(1, C.length + 1),
                                        [
                                            new u.RangeMapping(
                                                new b.Range(
                                                    1,
                        ...
                        const s =
                                r.maxComputationTimeMs === 0
                                    ...
                                    : new p.DateTimeout(r.maxComputationTimeMs),
                            l = !r.ignoreTrimWhitespace,
                            _ = new Map();
                        function g(z) {
                            let G = _.get(z);
                            return (
                                G === void 0 && ((G = _.size), _.set(z, G)), G
                            );
                        }
                        const v = S.map((z) => g(z.trim())),
                            ...
                            x = (() =>
                                N.length + D.length < 1700
                                    ...
                                    : this.myersDiffingAlgorithm.compute(
                                          N,
                                          D
                                      ))();
                        let T = x.diffs,
                        ...
                        (T = (0, e.optimizeSequenceDiffs)(N, D, T)),
                            (T = (0,
                            e.removeVeryShortMatchingLinesBetweenDiffs)(
                                N,
                                D,
                                T
                            ));
                        ...
                        return (
                            r.computeMoves &&
                                (W = this.computeMoves(I, S, C, v, R, s, l)),
                            (0, A.assertFn)(() => {
                                function z(t, se) {
                                    if (
                                        t.lineNumber < 1 ||
                                        t.lineNumber > se.length
                                    )
                                        return !1;
                                    const ce = se[t.lineNumber - 1];
                                    return !(
                                        t.column < 1 || t.column > ce.length + 1
                                    );
                                }
                                function G(t, se) {
                                    return !(
                                ...
                                for (const t of I) {
                                    ...
                                    for (const se of t.innerChanges)
                                        if (
                                            !(
                                                z(
                                                    se.modifiedRange.getStartPosition(),
                                                    C
                                                ) &&
                                                z(
                                                    se.modifiedRange.getEndPosition(),
                                                    C
                                                ) &&
                                                z(
                                                    se.originalRange.getStartPosition(),
                                                    S
                                                ) &&
                                                z(
                                                    se.originalRange.getEndPosition(),
                                                    S
                                                )
                                            )
                                        )
                                            return !1;
                                    if (!G(t.modified, C) || !G(t.original, S))
                                        return !1;
                                }
                                return !0;
                            }),
                    ...
                    computeMoves(S, C, r, s, l, _, g) {
                        return (0, L.computeMovedLines)(S, C, r, s, l, _).map(
                            (N) => {
                    ...
                    refineDiff(S, C, r, s, l) {
                        const _ = new c.LinesSliceCharSequence(
                                S,
                                r.seq1Range,
                                l
                            ),
                        ...
                        return (
                            ...
                            (R = (0, e.extendDiffsToEntireWordIfAppropriate)(
                                _,
                                g,
                                R
                            )),
                            ...
                            (R = (0,
                            e.removeVeryShortMatchingTextBetweenLongDiffs)(
                                _,
                                g,
                                R
                            )),
                ...
                function w(E, S, C) {
                    ...
                    E.modifiedRange.endColumn === 1 &&
                        ...
                        E.modifiedRange.startColumn - 1 >=
                            C[E.modifiedRange.startLineNumber - 1].length &&
                            E.originalRange.startColumn - 1 >=
                                S[E.originalRange.startLineNumber - 1].length &&
        ...
        Y(
            X[48],
            J([0, 1, 24, 31, 16, 6, 2, 12, 10]),
            function (q, n, M, A, i, d, b, p, h) {
                "use strict";
                Object.defineProperty(n, "__esModule", { value: !0 }),
                ...
                class a {
                    constructor(r) {
                        ...
                        for (let _ = 0, g = r.length; _ < g; _++)
                            (s[_] = w(r[_], 1)), (l[_] = E(r[_], 1));
                        (this.lines = r),
                            (this._startColumns = s),
                            (this._endColumns = l);
                    }
                    getElements() {
                        const r = [];
                ...
                class f {
                    ...
                    static createFromDiffResult(r, s, l, _, g, v, R) {
                        ...
                        if (
                            (s.originalLength === 0
                                ? ((N =
                                      l.getStartLineNumber(s.originalStart) -
                                      1),
                                  (D = 0))
                            ...
                            s.modifiedLength === 0
                                ? ((x =
                                      _.getStartLineNumber(s.modifiedStart) -
                                      1),
                                  (T = 0))
                            ...
                            const B = l.createCharSequence(
                                ...
                                V = _.createCharSequence(
                                    r,
                                    s.modifiedStart,
                                    s.modifiedStart + s.modifiedLength - 1
                                );
                            if (
                                B.getElements().length > 0 &&
                                V.getElements().length > 0
                            ) {
                                let k = e(B, V, g, !0).changes;
                                R && (k = m(k)), (F = []);
                                for (let O = 0, I = k.length; O < I; O++)
                                    F.push(c.createFromDiffChange(k[O], B, V));
                            }
                        }
        ...
        Y(X[50], J([0, 1, 33]), function (q, n, M) {
            ...
            function b(a, u) {
                ...
                if (c)
                    return {
                        range: a,
                        color: i(c.rgba.r, c.rgba.g, c.rgba.b, c.rgba.a),
                    };
            }
            function p(a, u, c) {
            ...
            function h(a, u, c) {
                ...
                const f = u[0].values(),
                    y = A(f),
                    w = new M.Color(
                        new M.HSLA(y[0], y[1] / 100, y[2] / 100, c ? y[3] : 1)
                    );
                return {
                    range: a,
        ...
        Y(X[51], J([0, 1, 27]), function (q, n, M) {
            ...
            class i {
                ...
                nextState(a, u) {
                    return u < 0 || u >= this._maxCharCode
                        ? 0
                        : this._states.get(a, u);
                }
            }
            n.StateMachine = i;
            let d = null;
            ...
            function h() {
                if (p === null) {
                    ...
                    const e = ` 	<>'"\u3001\u3002\uFF61\uFF64\uFF0C\uFF0E\uFF1A\uFF1B\u2018\u3008\u300C\u300E\u3014\uFF08\uFF3B\uFF5B\uFF62\uFF63\uFF5D\uFF3D\uFF09\u3015\u300F\u300D\u3009\u2019\uFF40\uFF5E\u2026`;
                    for (let u = 0; u < e.length; u++)
                        p.set(e.charCodeAt(u), 1);
                    const a = ".,;:";
                    for (let u = 0; u < a.length; u++)
                        p.set(a.charCodeAt(u), 2);
                }
                return p;
            }
            class o {
                    ...
                    for (let f = 1, y = a.getLineCount(); f <= y; f++) {
                        ...
                        for (; S < E; ) {
                            ...
                            if (s === 13) {
                                ...
                                D === 1 &&
                                    (m.push(o._createLink(c, w, f, C, S)),
                                    (R = !0));
                            } else if (s === 12) {
                                let D;
        ...
        Y(X[52], J([0, 1]), function (q, n) {
            ...
            class M {
                ...
                valueSetsReplace(i, d, b) {
                    let p = null;
                    for (let h = 0, o = i.length; p === null && h < o; h++)
                        p = this.valueSetReplace(i[h], d, b);
                    return p;
                }
        ...
        Y(X[53], J([0, 1, 14]), function (q, n, M) {
            ...
            class p {
                get originalIndentSize() {
                    return this._indentSizeIsTabSize
                        ? "tabSize"
                        : this.indentSize;
                }
                constructor(m) {
            ...
            class a {
                constructor(m, f, y) {
                    (this.reverseEdits = m),
                        (this.changes = f),
                        (this.trimAutoWhitespaceLineNumbers = y);
                }
            }
        ...
        Y(X[54], J([0, 1, 7, 26]), function (q, n, M, A) {
            ...
            class i {
                ...
                getPrefixSum(h) {
                    return h < 0
                        ? 0
                        : ((h = (0, A.toUint32)(h)), this._getPrefixSum(h));
                }
                _getPrefixSum(h) {
                    if (h <= this.prefixSumValidIndex[0])
                        return this.prefixSum[h];
                    let o = this.prefixSumValidIndex[0] + 1;
                    o === 0 && ((this.prefixSum[0] = this.values[0]), o++),
                        h >= this.values.length && (h = this.values.length - 1);
                    for (let L = o; L <= h; L++)
                        this.prefixSum[L] =
                            this.prefixSum[L - 1] + this.values[L];
                    return (
            ...
            class d {
                ...
                setValue(h, o) {
                    this._values[h] !== o &&
                        ((this._values[h] = o), this._invalidate(h));
                }
            }
            ...
            class d {
                ...
                _acceptDeleteRange(p) {
                    ...
                    this._setLineText(
                        ...
                        this._lines[p.startLineNumber - 1].substring(
                            ...
                            this._lines[p.endLineNumber - 1].substring(
                                p.endColumn - 1
                            )
                    ),
                        this._lines.splice(
                ...
                _acceptInsertText(p, h) {
                    ...
                    if (o.length === 1) {
                        this._setLineText(
                            p.lineNumber - 1,
                            this._lines[p.lineNumber - 1].substring(
                                0,
                                p.column - 1
                            ) +
                                o[0] +
                    ...
                    (o[o.length - 1] += this._lines[p.lineNumber - 1].substring(
                        p.column - 1
                    )),
                        this._setLineText(
                            p.lineNumber - 1,
                    ...
                    for (let e = 1; e < o.length; e++)
                        this._lines.splice(p.lineNumber + e - 1, 0, o[e]),
                            (L[e - 1] = o[e].length + this._eol.length);
                    this._lineStarts &&
                        this._lineStarts.insertValues(p.lineNumber, L);
                }
            }
            n.MirrorTextModel = d;
        }),
            ...
            class a {
                ...
                static _getMultilineMatchRange(w, E, S, C, r, s) {
                    let l,
                        _ = 0;
                    C
                        ? ((_ = C.findLineFeedCountBeforeOffset(r)),
                          (l = E + r + _))
                        : (l = E + r);
                    let g;
                    if (C) {
                        const D =
                            C.findLineFeedCountBeforeOffset(r + s.length) - _;
                        g = l + s.length + D;
                    } else g = l + s.length;
...
`
                ...
                static _doFindMatchesLineByLine(w, E, S, C, r) {
                    ...
                    for (
                        let g = E.startLineNumber + 1;
                        g < E.endLineNumber && l < r;
                        g++
                    )
                        l = this._findMatchesInLine(
                            S,
                    ...
                    if (l < r) {
                        const g = w
                            .getLineContent(E.endLineNumber)
...
`
                ...
                static _doFindPreviousMatchMultiline(w, E, S, C) {
                    ...
                    return E.lineNumber !== s ||
                        E.column !== w.getLineMaxColumn(s)
                    ...
                    do {
                        ...
                        if (
                            ...
                            !this._wordSeparators ||
                                m(this._wordSeparators, w, E, C, r))
                        )
                            return S;
                    } while (S);
                    return null;
                    ...
                    e: for (let v = m, R = f; v <= R; v++) {
                        ...
                        do
                            if (((s = S.next(N)), s)) {
                                ...
                                let B = (0, b.getWordAtText)(
                                    x + 1,
                                    b.DEFAULT_WORD_REGEXP,
                                    N,
                                    0
                                );
                                B && B.endColumn <= x + 1 && (B = null);
                                const V = y.shouldHighlightNonBasicASCII(
                                    F,
                                    B ? B.word : null
                                );
                                if (V !== 0) {
                    ...
                    switch (c.shouldHighlightNonBasicASCII(a, null)) {
                        ...
                        case 3: {
                            const f = a.codePointAt(0),
                                y =
                                    c.ambiguousCharacters.getPrimaryConfusable(
                                        f
                                    ),
                ...
                getCandidateCodePoints() {
                    ...
                    if (this.options.invisibleCharacters)
                        for (const u of i.InvisibleCharacters.codePoints)
                            L(String.fromCodePoint(u)) || a.add(u);
                        ...
                        for (const y of u) {
                            ...
                            (m = m || E),
                                !E &&
                                    ...
                                    !i.InvisibleCharacters.isInvisibleCharacter(
                                        w
                                    ) &&
                                    (f = !0);
                        }
...
` ||
        ...
        Y(X[58], J([0, 1]), function (q, n) {
            ...
            (function (t) {
                (t[(t.acceptSuggestionOnCommitCharacter = 0)] =
                    ...
                    (t[(t.acceptSuggestionOnEnter = 1)] =
                        "acceptSuggestionOnEnter"),
                    (t[(t.accessibilitySupport = 2)] = "accessibilitySupport"),
                    (t[(t.accessibilityPageSize = 3)] =
                    ...
                    (t[(t.bracketPairColorization = 15)] =
                    ...
                    (t[(t.foldingImportsByDefault = 46)] =
                        "foldingImportsByDefault"),
                    (t[(t.foldingMaximumRegions = 47)] =
                    ...
                    (t[(t.hideCursorInOverviewRuler = 59)] =
                    ...
                    (t[(t.scrollBeyondLastColumn = 103)] =
                        "scrollBeyondLastColumn"),
                    (t[(t.scrollBeyondLastLine = 104)] =
                        "scrollBeyondLastLine"),
                    (t[(t.scrollPredominantAxis = 105)] =
                    ...
                    (t[(t.stopRenderingLineAfter = 116)] =
                    ...
                    (t[(t.unusualLineTerminators = 125)] =
                    ...
                    (t[(t.defaultColorDecorators = 145)] =
            ...
            (function (t) {
                (t[(t.AlwaysGrowsWhenTypingAtEdges = 0)] =
                    ...
                    (t[(t.GrowsOnlyWhenTypingBefore = 2)] =
                        "GrowsOnlyWhenTypingBefore"),
                    (t[(t.GrowsOnlyWhenTypingAfter = 3)] =
                    ...
                    return (
                        ...
                        (0, A.toDisposable)(() => {
                            this._tokenizationSupports.get(p) === h &&
                                (this._tokenizationSupports.delete(p),
                                this.handleChange([p]));
                        })
                    );
                }
                ...
                registerFactory(p, h) {
                    ...
                    return (
                        ...
                        (0, A.toDisposable)(() => {
                            ...
                            !e ||
                                e !== L ||
                                (this._factories.delete(p), e.dispose());
                        })
                    );
                }
                async getOrCreate(p) {
                ...
                async _create() {
                    ...
                    (this._isResolved = !0),
                        p &&
                            !this._isDisposed &&
                            this._register(
                                this._registry.register(this._languageId, p)
                            );
                }
            }
        }),
        ...
        Y(X[17], J([0, 1, 60]), function (q, n, M) {
            ...
            const C =
                    typeof ((A = S?.versions) === null || A === void 0
                        ? void 0
                        : A.electron) == "string",
                r = C && S?.type === "renderer";
            if (typeof S == "object") {
                ...
                if (v)
                    try {
                        ...
                        (c = R.locale),
                            ...
                            (y = R._translationsConfigFile);
                    } catch {}
                h = !0;
            } else typeof navigator == "object" && !r ? ((w = navigator.userAgent), (i = w.indexOf("Windows") >= 0), (d = w.indexOf("Macintosh") >= 0), (e = (w.indexOf("Macintosh") >= 0 || w.indexOf("iPad") >= 0 || w.indexOf("iPhone") >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0), (b = w.indexOf("Linux") >= 0), (u = w?.indexOf("Mobi") >= 0), (o = !0), (c = M.getConfiguredDefaultLocale(M.localize(0, null)) || n.LANGUAGE_DEFAULT), (m = c), (f = navigator.language)) : console.error("Unable to resolve platform.");
            let s = 0;
            d ? (s = 1) : i ? (s = 3) : b && (s = 2),
                (n.isWindows = i),
                (n.isMacintosh = d),
                        ...
                        E.addEventListener("message", (N) => {
                            if (N.data && N.data.vscodeScheduleAsyncWork)
                                for (let D = 0, x = v.length; D < x; D++) {
                                    const T = v[D];
                                    if (
                                        T.id === N.data.vscodeScheduleAsyncWork
                                    ) {
            ...
            function g() {
                if (!_) {
                    ...
                    (v[0] = 1),
                        (v[1] = 2),
                        (l = new Uint16Array(v.buffer)[0] === (2 << 8) + 1);
                }
                return l;
            }
            (n.isLittleEndian = g),
                (n.isChrome = !!(
                    n.userAgent && n.userAgent.indexOf("Chrome") >= 0
                )),
                (n.isFirefox = !!(
                    n.userAgent && n.userAgent.indexOf("Firefox") >= 0
                )),
                (n.isSafari = !!(
                    !n.isChrome &&
                    n.userAgent &&
                ...
                (n.isEdge = !!(
                    n.userAgent && n.userAgent.indexOf("Edg/") >= 0
                )),
                (n.isAndroid = !!(
                    n.userAgent && n.userAgent.indexOf("Android") >= 0
                ));
        }),
        ...
        Y(X[63], J([0, 1, 62]), function (q, n, M) {
                        ...
                        if (!(R === x - 1 || N === 1))
                            if (N === 2) {
                                if (
                                    g.length < 2 ||
                                    v !== 2 ||
                                    g.charCodeAt(g.length - 1) !== p ||
                                    g.charCodeAt(g.length - 2) !== p
                                ) {
                                    if (g.length > 2) {
            ...
            n.win32 = {
                    ...
                    for (let g = r.length - 1; g >= -1; g--) {
                        ...
                        if (R === 1) f(T) && ((N = 1), (x = !0));
                            ...
                            if (((x = !0), f(v.charCodeAt(1)))) {
                                ...
                                if (F < R && F !== B) {
                                    const V = v.slice(B, F);
                                    for (B = F; F < R && f(v.charCodeAt(F)); )
                                        F++;
                                    if (F < R && F !== B) {
                                        for (
                                            B = F;
                                            F < R && !f(v.charCodeAt(F));
                ...
                relative(r, s) {
                    ...
                    if (B !== T) {
                        ...
                        if (x > T) {
                            if (s.charCodeAt(N + B) === o)
                                return _.slice(N + B + 1);
            ...
            (n.posix = {
                ...
                relative(r, s) {
                    ...
                    if (x === N)
                        if (R > N) {
                            if (s.charCodeAt(v + x) === h)
                                return s.slice(v + x + 1);
        ...
        Y(X[18], J([0, 1, 63, 17]), function (q, n, M, A) {
            ...
            class m extends u {
                ...
                get fsPath() {
                    return (
                        this._fsPath || (this._fsPath = E(this, !1)),
                        this._fsPath
                    );
                }
                toString(_ = !1) {
                ...
                toJSON() {
                    ...
                    return (
                        this._fsPath &&
                            ((_.fsPath = this._fsPath), (_._sep = c)),
            ...
            function y(l, _, g) {
                ...
                for (let N = 0; N < l.length; N++) {
                    ...
                    if (
                        ...
                        R !== -1 &&
                            ((v += encodeURIComponent(l.substring(R, N))),
                            (R = -1)),
            ...
            function S(l, _) {
                ...
                if (
                    ...
                    if (F !== -1) {
                        ...
                        (N = N.substr(F + 1)),
                            ...
                            F === -1
                                ? (v += g(B, !1, !1))
                                : ((v += g(B.substr(0, F), !1, !1)),
                                  (v += ":"),
                                  (v += g(B.substr(F + 1), !1, !0))),
                            (v += "@");
                    }
                    (N = N.toLowerCase()),
                        (F = N.lastIndexOf(":")),
                ...
                if (D) {
                    if (
                        ...
                        F >= 65 &&
                            F <= 90 &&
                            (D = `/${String.fromCharCode(F + 32)}:${D.substr(
                                3
                            )}`);
        ...
        Y(
            X[67],
            J([0, 1, 5, 9, 13, 14, 17, 6]),
            function (q, n, M, A, i, d, b, p) {
                "use strict";
                Object.defineProperty(n, "__esModule", { value: !0 }),
                    (n.create =
                        ...
                        this._handler.handleMessage(l.method, l.args).then(
                            ...
                            (v) => {
                                v.detail instanceof Error &&
                                    (v.detail = (0,
                                    M.transformErrorForSerialization)(
                                        v.detail
                                    )),
                                    this._send(
                                        new a(
                                            ...
                                            void 0,
                                            (0,
                                            M.transformErrorForSerialization)(v)
                                        )
                                    );
                            }
                        );
                    ...
                    _send(l) {
                        ...
                        if (l.type === 0)
                            for (let g = 0; g < l.args.length; g++)
                                l.args[g] instanceof ArrayBuffer &&
                                    _.push(l.args[g]);
                        else
                            l.type === 1 &&
                                l.res instanceof ArrayBuffer &&
                                _.push(l.res);
                            ...
                            (this._protocol = new f({
                                ...
                                handleEvent: (F, B) => {
                                    ...
                                    if (w(F)) {
                                        ...
                                        if (typeof V != "function")
                                            throw new Error(
                                                `Missing event ${F} on main thread host.`
                                            );
                                        return V;
                                    }
                                    throw new Error(
                                        `Malformed event name ${F}`
                                    );
                                },
                            })),
                ...
                function w(s) {
                    return (
                        s[0] === "o" &&
                        s[1] === "n" &&
                        p.isUpperAsciiLetter(s.charCodeAt(2))
                    );
                }
                function E(s) {
                    return (
                        /^onDynamic/.test(s) &&
                        p.isUpperAsciiLetter(s.charCodeAt(9))
                    );
                }
                function S(s, l, _) {
                    const g = (N) =>
                ...
                class C {
                    ...
                    _handleMessage(l, _) {
                        ...
                        if (
                            ...
                            return Promise.reject(
                                new Error(
                                    "Missing requestHandler or method: " + l
                                )
                            );
                        try {
                            return Promise.resolve(
                                this._requestHandler[l].apply(
                                    this._requestHandler,
                                    _
                                )
                            );
                    ...
                    _handleEvent(l, _) {
                        ...
                        if (E(l)) {
                            const g = this._requestHandler[l].call(
                                this._requestHandler,
                                _
                            );
                            if (typeof g != "function")
                                throw new Error(
                                    `Missing dynamic event ${l} on request handler.`
                                );
                            return g;
                        }
                        if (w(l)) {
                            ...
                            if (typeof g != "function")
                                throw new Error(
                                    `Missing event ${l} on request handler.`
                                );
                            return g;
                        }
                    ...
                    initialize(l, _, g, v) {
                        ...
                        return this._requestHandlerFactory
                            ? ((this._requestHandler =
                              ...
                              Promise.resolve(
                                  (0, d.getAllMethodNames)(this._requestHandler)
                              ))
                            : (_ &&
            ...
            (function (s) {
                ...
                function _(R) {
                    ...
                    return (
                        N ||
                            (console.info(
                                "No codicon found for CompletionItemKind " + R
                            ),
            ...
            (function (s) {
                ...
                function _(g) {
                    ...
                    return (
                        v ||
                            (console.info(
                                "No codicon found for SymbolKind " + g
                            ),
        ...
        Y(
            X[66],
            J([0, 1, 38, 9, 35, 18, 4, 2, 41, 65, 58]),
            function (q, n, M, A, i, d, b, p, h, o, L) {
                "use strict";
                Object.defineProperty(n, "__esModule", { value: !0 }),
            ...
            function (q, n, M, A, i, d, b, p, h, o, L, e, a, u, c, m) {
                ...
                class f extends b.MirrorTextModel {
                    ...
                    getValueInRange(S) {
                        ...
                        return (
                            l.push(
                                this._lines[s].substring(0, S.endColumn - 1)
                            ),
                            l.join(C)
                        );
                    }
                    offsetAt(S) {
                        return (
                            ...
                            this._lineStarts.getPrefixSum(S.lineNumber - 2) +
                                (S.column - 1)
                        );
                    }
                    positionAt(S) {
                ...
                class y {
                    ...
                    _getModels() {
                        const S = [];
                        return (
                            Object.keys(this._models).forEach((C) =>
                                S.push(this._models[C])
                            ),
                            S
                        );
                    }
                    acceptNewModel(S) {
                        this._models[S.url] = new f(
                            A.URI.parse(S.url),
                            S.lines,
                            S.EOL,
                            S.versionId
                    ...
                    async computeUnicodeHighlights(S, C, r) {
                        ...
                        return s
                            ? a.UnicodeTextModelHighlighter.computeUnicodeHighlights(
                                  s,
                                  C,
                                  r
                              )
                    ...
                    static computeDiff(S, C, r, s) {
                        ...
                        return {
                            ...
                            moves: v.moves.map((D) => [
                                ...
                                D.lineRangeMapping.original
                                    .endLineNumberExclusive,
                                D.lineRangeMapping.modified.startLineNumber,
                                D.lineRangeMapping.modified
                                    .endLineNumberExclusive,
                                N(D.changes),
                            ]),
                        };
                    ...
                    async computeMoreMinimalEdits(S, C, r) {
                        ...
                        C = C.slice(0).sort((v, R) => {
                            if (v.range && R.range)
                                return d.Range.compareRangesUsingStarts(
                                    v.range,
                                    R.range
                                );
                            const N = v.range ? 0 : 1,
                        ...
                        for (let v = 1; v < C.length; v++)
                            d.Range.getEndPosition(C[g].range).equals(
                                d.Range.getStartPosition(C[v].range)
                            )
                        ...
                        for (let { range: v, text: R, eol: N } of C) {
                            ...
                            const x = (0, M.stringDiff)(D, R, r),
                                T = s.offsetAt(
                                    d.Range.lift(v).getStartPosition()
                                );
                            for (const F of x) {
                                const B = s.positionAt(T + F.originalStart),
                                    V = s.positionAt(
                                        T + F.originalStart + F.originalLength
                                    ),
                                    k = {
                                        text: R.substr(
                                            F.modifiedStart,
                                ...
                                s.getValueInRange(k.range) !== k.text &&
                                    l.push(k);
                            }
                        }
                        return (
                    ...
                    async computeDefaultDocumentColors(S) {
                        const C = this._getModel(S);
                        return C
                            ? (0, m.computeDefaultDocumentColors)(C)
                            : null;
                    }
                        ...
                        e: for (const v of S) {
                            ...
                            if (R) {
                                for (const N of R.words(_))
                                    if (
                                        !(N === C || !isNaN(Number(N))) &&
                                        (g.add(N), g.size > y._suggestionsLimit)
                                    )
                                        break e;
                            }
                        }
                    ...
                    loadForeignModule(S, C, r) {
                        ...
                        return this._foreignModuleFactory
                            ? ((this._foreignModule =
                                  this._foreignModuleFactory(_, C)),
                              Promise.resolve(
                                  (0, c.getAllMethodNames)(this._foreignModule)
                              ))
                            : new Promise((g, v) => {
                                  q(
                                      [S],
                                      (R) => {
                                          (this._foreignModule = R.create(
                                              _,
                                              C
                                          )),
                                              g(
                                                  (0, c.getAllMethodNames)(
                                                      this._foreignModule
                                                  )
                                              );
                                      },
                    ...
                    fmr(S, C) {
                        if (
                            ...
                            return Promise.reject(
                                new Error(
                                    "Missing requestHandler or method: " + S
                                )
                            );
                        try {
                            return Promise.resolve(
                                this._foreignModule[S].apply(
                                    this._foreignModule,
                                    C
                                )
                            );
                ...
                (n.create = w),
                    typeof importScripts == "function" &&
                        (globalThis.monaco = (0, L.createMonacoBaseAPI)());
            }
        );
}).call(this);
