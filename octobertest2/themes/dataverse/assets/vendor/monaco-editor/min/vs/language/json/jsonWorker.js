    ...
    var moduleExports = (() => {
        ...
        function Ce(t, r) {
            ...
            function m() {
                ...
                if (
                    e < t.length &&
                    (t.charCodeAt(e) === 69 || t.charCodeAt(e) === 101)
                )
                    if (
                        (e++,
...
`)),
        ...
        function mt(t, r, i) {
            ...
            for (; v !== 17; ) {
                for (
                    var I = d.getTokenOffset() + d.getTokenLength() + a,
                        A = g(),
                        P = "",
                        w = !1;
                    !u && (A === 12 || A === 13);
                    ...
                    y(" ", I, C),
                        (I = d.getTokenOffset() + d.getTokenLength() + a),
                        (w = A === 12),
                        (P = w ? p() : ""),
                        (A = g());
                }
...
`.indexOf(t.charAt(r)) !== -1
        ...
        (function (t) {
            ...
            function i(e) {
                ...
                return (
                    ...
                    x.uinteger(n.startLine) &&
                    (x.undefined(n.startCharacter) ||
                        x.uinteger(n.startCharacter)) &&
                    (x.undefined(n.endCharacter) ||
                        x.uinteger(n.endCharacter)) &&
            ...
            function i(e) {
                ...
                return (
                    ...
                    (x.undefined(a.relatedInformation) ||
                        x.typedArray(a.relatedInformation, wt.is))
                );
            }
            t.is = i;
        })(ae || (ae = {}));
        ...
        (function (t) {
            ...
            function n(a) {
                var s = a;
                return (
                    x.objectLiteral(s) && x.string(s.newText) && U.is(s.range)
                );
            }
            t.is = n;
        })(Y || (Y = {}));
        ...
        (function (t) {
            ...
            function i(e) {
                ...
                return (
                    ...
                    x.objectLiteral(n) &&
                    x.string(n.label) &&
                    (x.boolean(n.needsConfirmation) ||
                        n.needsConfirmation === void 0) &&
        ...
        (function (t) {
            ...
            function n(a) {
                var s = a;
                return (
                    Y.is(s) && (je.is(s.annotationId) || X.is(s.annotationId))
                );
            }
            t.is = n;
        })(me || (me = {}));
        ...
        (function (t) {
            ...
            function i(e) {
                ...
                return (
                    x.defined(n) &&
                    Ze.is(n.textDocument) &&
                    Array.isArray(n.edits)
                );
            }
            t.is = i;
        })(Fe || (Fe = {}));
            ...
            ur = (function () {
                ...
                return (
                    ...
                    (t.prototype.manage = function (r, i) {
                        ...
                        if (i === void 0)
                            throw new Error(
                                "No annotation provided for id " + e
                            );
                        ...
                        r !== void 0
                            ? ((this._workspaceEdit = r),
                              r.documentChanges
                                  ...
                                  : r.changes &&
                                    Object.keys(r.changes).forEach(function (
                                        e
                                    ) {
                    ...
                    (t.prototype.createFile = function (r, i, e) {
                        ...
                        if (
                            (n === void 0
                                ...
                                : ((s = X.is(n)
                                      ? n
                                      : this._changeAnnotations.manage(n)),
                                  (a = Le.create(r, e, s))),
                            this._workspaceEdit.documentChanges.push(a),
                            s !== void 0)
                        )
                    ...
                    (t.prototype.renameFile = function (r, i, e, n) {
                        ...
                        if (
                            (a === void 0
                                ...
                                : ((o = X.is(a)
                                      ? a
                                      : this._changeAnnotations.manage(a)),
                                  (s = Ve.create(r, i, n, o))),
        ...
        (function (t) {
            ...
            function i(e) {
                ...
                return (
                    x.defined(n) &&
                    x.uinteger(n.tabSize) &&
                    x.boolean(n.insertSpaces)
                );
            }
            t.is = i;
        })(yr || (yr = {}));
...
` &&
        ...
        (function (t) {
            ...
            function l(d) {
                return (
                    r.call(d) === "[object Number]" && 0 <= d && d <= 2147483647
                );
            }
            t.uinteger = l;
            function u(d) {
        ...
        var Ye = class t {
                ...
                getLineOffsets() {
                    return (
                        this._lineOffsets === void 0 &&
                            (this._lineOffsets = xr(this._content, !0)),
                        this._lineOffsets
                    );
                }
                positionAt(r) {
        ...
        function Sr(t) {
            let r = t.start,
                i = t.end;
            return r.line > i.line ||
                (r.line === i.line && r.character > i.character)
                ? { start: i, end: r }
                : t;
        }
        function ln(t) {
        ...
        (function (t) {
            (t[(t.Undefined = 0)] = "Undefined"),
                ...
                (t[(t.UnexpectedEndOfComment = 257)] =
                ...
                (t[(t.InvalidEscapeCharacter = 261)] =
                ...
                (t[(t.CommaOrCloseBraceExpected = 518)] =
                ...
                return (
                    ...
                    (t.prototype.mergePropertyMatch = function (r) {
                        this.merge(r),
                            ...
                            (r.enumValueMatch ||
                                (!r.hasProblems() && r.propertiesMatches)) &&
        ...
        var kr = (function () {
            ...
            return (
                (t.prototype.getNodeFromOffset = function (r, i) {
                    if ((i === void 0 && (i = !1), this.root))
                        return Kt(this.root, r, i);
                }),
                ...
                (t.prototype.getMatchingSchemas = function (r, i, e) {
                    ...
                    var n = new xn(i, e);
                    return (
                        this.root && r && _(this.root, r, new te(), n),
                        n.schemas
                    );
                }),
                t
        ...
        function _(t, r, i, e) {
            ...
            function a() {
                    ...
                    for (
                        ...
                        if ((_(n, j, V, $), V.hasProblems() || H.push(j), !q))
                            ...
                            q.matchingSchemas.merge($),
                                (q.validationResult.propertiesMatches +=
                                    V.propertiesMatches),
                ...
                var E = function (L) {
                    ...
                    I = function (L, R, H) {
                        ...
                        _(n, q, T, S),
                            e.merge(S),
                            T.hasProblems() ? H && E(H) : R && E(R);
                    },
                    A = K(r.if);
                if ((A && I(A, K(r.then), K(r.else)), Array.isArray(r.enum))) {
                    for (
                        var P = de(n), w = !1, C = 0, F = r.enum;
                        C < F.length;
                        C++
                    ) {
                        var N = F[C];
                ...
                r.deprecationMessage &&
                    ...
                    i.problems.push({
                        location: {
                            offset: n.parent.offset,
                            length: n.parent.length,
                        },
                        severity: Z.Warning,
                ...
                if (ee(c.multipleOf)) {
                    ...
                    if (Number.isInteger(c.multipleOf)) g = m % c.multipleOf;
                        ...
                        if (b && y) {
                            var v = Math.pow(
                                10,
                                Math.abs(y.multiplier - b.multiplier)
                            );
                            y.multiplier < b.multiplier
                                ? (y.value *= v)
                                : (b.value *= v),
                                (g = y.value % b.value);
                        }
                ...
                if (Array.isArray(c.items)) {
                    for (var m = c.items, p = 0; p < m.length; p++) {
                        var g = m[p],
                            ...
                            v = u.items[p];
                        v
                            ? (_(v, b, y, d), h.mergePropertyMatch(y))
                            : u.items.length >= m.length &&
                    ...
                    if (u.items.length > m.length)
                        if (typeof c.additionalItems == "object")
                            for (var O = m.length; O < u.items.length; O++) {
                                var y = new te();
                                _(u.items[O], c.additionalItems, y, d),
                                    h.mergePropertyMatch(y);
                            }
                        else
                            c.additionalItems === !1 &&
                                h.problems.push({
            ...
            function l(u, c, h, d) {
                ...
                var w = function (Xt) {
                    for (var lt = p.indexOf(Xt); lt >= 0; )
                        p.splice(lt, 1), (lt = p.indexOf(Xt));
                };
                if (c.properties)
                    for (
                        var C = 0, F = Object.keys(c.properties);
                        C < F.length;
                        C++
                    ) {
                        var I = F[C];
                ...
                if (c.patternProperties)
                    for (
                        ...
                        for (
                            var T = q[H], S = xe(T), k = 0, j = p.slice(0);
                            k < j.length;
                            k++
                        ) {
                            var I = j[k];
                ...
                if (typeof c.additionalProperties == "object")
                    for (var V = 0, $ = p; V < $.length; V++) {
                        ...
                        if (L) {
                            var R = new te();
                            _(L, c.additionalProperties, R, d),
                                h.mergePropertyMatch(R);
                        }
                    }
        ...
        function Or(t, r) {
            ...
            function l(A, P, w, C, F) {
                if (
                    (F === void 0 && (F = Z.Error), i.length === 0 || w !== e)
                ) {
            ...
            function h(A, P) {
                return (
                    (A.length =
                        a.getTokenOffset() + a.getTokenLength() - A.offset),
                    P && o(),
                    A
                );
            }
                ...
                if (a.getToken() === 3) {
                    ...
                    for (
                        ...
                        if (a.getToken() === 5) {
                            ...
                            C &&
                                u(
                                    M("ExpectedComma", "Expected comma"),
                                    W.CommaExpected
                                );
                        var N = O(P);
                        N
            ...
            function p(A, P) {
                ...
                return L
                    ? ((w.valueNode = L),
                      (w.length = L.offset + L.length - w.offset),
                      w)
                    : u(
                          M("ValueExpected", "Value expected"),
                          W.ValueExpected,
            ...
            Cr = (function () {
                ...
                return (
                    (t.prototype.doResolve = function (r) {
                        for (
                            var i = this.contributions.length - 1;
                            i >= 0;
                            i--
                        ) {
                        ...
                        var d = !1,
                            ...
                            p = {
                                add: function (g) {
                                    ...
                                    if (y)
                                        y.documentation ||
                                            (y.documentation = g.documentation),
                                            y.detail || (y.detail = g.detail);
                                    else {
                                        if (
                                            ((b = b.replace(/[\n]/g, "\u21B5")),
                                            b.length > 60)
                        ...
                        return this.schemaService
                            ...
                            .then(function (g) {
                                ...
                                if (f && f.type === "object") {
                                    ...
                                    var A = "";
                                    y &&
                                        (A = n.evaluateSeparatorAfter(
                                            r,
                                            r.offsetAt(c.end)
                                        )),
                                        g
                                            ? n.getPropertyCompletions(
                                                  g,
                                                  e,
                                                  f,
                                                  y,
                                            ...
                                            : n.getSchemaLessPropertyCompletions(
                                                  e,
                                                  f,
                                                  v,
                                                  p
                                ...
                                return (
                                    g
                                        ...
                                        : n.getSchemaLessValueCompletions(
                                              e,
                                              f,
                                              o,
                                              r,
                                    ...
                                    n.contributions.length > 0 &&
                                        n.getContributedValueCompletions(
                                            e,
                                            f,
                                            o,
                                            r,
                                    ...
                                    n.promiseConstructor
                                        .all(b)
                                        .then(function () {
                                            if (
                                                p.getNumberOfProposals() === 0
                                            ) {
                                                var C = o;
                                                f &&
                                                    (f.type === "string" ||
                                                    ...
                                                    (C = f.offset + f.length);
                                                var F =
                                                    n.evaluateSeparatorAfter(
                                                        r,
                                                        C
                                                    );
                                                n.addFillerValueCompletions(
                                                    w,
                                                    F,
                                                    p
                                                );
                    ...
                    (t.prototype.getPropertyCompletions = function (
                        r,
                        i,
                        e,
                        n,
                                    ...
                                    Object.keys(u).forEach(function (p) {
                                        ...
                                        if (
                                            ...
                                            var b = {
                                                ...
                                                insertTextFormat: z.Snippet,
                                                filterText:
                                                    o.getFilterTextForValue(p),
                                                documentation:
                                                    o.fromMarkup(
                                                        g.markdownDescription
                                                    ) ||
                                                    g.description ||
                                                    "",
                                            };
                                            g.suggestSortText !== void 0 &&
                                                (b.sortText =
                                                    g.suggestSortText),
                                                b.insertText &&
                                                    pe(
                            ...
                            s = function (f) {
                                f.properties.forEach(function (l) {
                                    ...
                                    n.add({
                                        kind: Q.Property,
                                        label: u,
                                        insertText: a.getInsertTextForValue(
                                            u,
                                            ""
                                        ),
                                        insertTextFormat: z.Snippet,
                            ...
                            l = function (d) {
                                d.parent &&
                                    ...
                                    a.add({
                                        ...
                                        label: s.getLabelTextForMatchingNode(
                                            d,
                                            n
                                        ),
                                        insertText:
                                            s.getInsertTextForMatchingNode(
                                                d,
                                                n,
                                                f
                                            ),
                    ...
                    (t.prototype.getValueCompletions = function (
                        r,
                        i,
                        e,
                        n,
                                ...
                                if (g.node === e && !g.inverted && g.schema) {
                                    if (e.type === "array" && g.schema.items)
                                        if (Array.isArray(g.schema.items)) {
                                            var b = this.findItemAtOffset(
                                                e,
                                                a,
                                                n
                                            );
                                            b < g.schema.items.length &&
                    ...
                    (t.prototype.getContributedValueCompletions = function (
                        ...
                        if (!i)
                            ...
                            if ((!f || e <= f.offset + f.length) && i.parent) {
                                var l = Je(i.parent);
                                this.contributions.forEach(function (u) {
                                    var c = u.collectValueCompletions(
                                        n.uri,
                                        l,
                                        o,
                                        a
                    ...
                    (t.prototype.addSchemaValueCompletions = function (
                        r,
                        i,
                        e,
                        n
                        ...
                        typeof r == "object" &&
                            ...
                            Array.isArray(r.allOf) &&
                                r.allOf.forEach(function (s) {
                                    return a.addSchemaValueCompletions(
                                        s,
                                        i,
                                        e,
                                        n
                    ...
                    (t.prototype.addDefaultValueCompletions = function (
                        r,
                        i,
                        e,
                        n
                        ...
                        Array.isArray(r.examples) &&
                            r.examples.forEach(function (u) {
                                for (var c = r.type, h = u, d = n; d > 0; d--)
                                    (h = [h]), (c = "array");
                                e.add({
                            ...
                            Array.isArray(r.defaultSnippets) &&
                                r.defaultSnippets.forEach(function (u) {
                                    var c = r.type,
                                        ...
                                        p;
                                    if (se(h)) {
                                        for (var g = r.type, b = n; b > 0; b--)
                                            (h = [h]), (g = "array");
                                        (m = a.getInsertTextForSnippetValue(
                                            h,
                                            i
                                        )),
                                            (p =
                                                a.getFilterTextForSnippetValue(
                                                    h
                                                )),
                                            (d =
                                                d ||
                                                a.getLabelForSnippetValue(h));
...
` + O
                    ...
                    (t.prototype.addFillerValueCompletions = function (
                        r,
                        i,
                        e
                    ) {
                    ...
                    (t.prototype.addBooleanValueCompletion = function (
                        r,
                        i,
                        e
                    ) {
                    ...
                    (t.prototype.addDollarSchemaCompletions = function (r, i) {
                        var e = this,
                            n = this.schemaService.getRegisteredSchemaIds(
                                function (a) {
                    ...
                    (t.prototype.getInsertTextForSnippetValue = function (
                        r,
                        i
                    ) {
                        var e = function (n) {
                    ...
                    (t.prototype.getInsertTextForGuessedValue = function (
                        r,
                        i
                    ) {
                        switch (typeof r) {
                    ...
                    (t.prototype.getInsertTextForMatchingNode = function (
                        r,
                        i,
                        e
                    ) {
                        switch (r.type) {
                            ...
                            default:
                                var n =
                                    i.getText().substr(r.offset, r.length) + e;
                                return this.getInsertTextForPlainText(n);
                        }
                    }),
                    (t.prototype.getInsertTextForProperty = function (
                        r,
                        i,
                        e,
                        n
                        ...
                        if (i) {
                            if (Array.isArray(i.defaultSnippets)) {
                                if (i.defaultSnippets.length === 1) {
                                    ...
                                    se(l) &&
                                        (o = this.getInsertTextForSnippetValue(
                                            l,
                                            ""
                                        ));
                                }
...
\r\v":{[,]}`.indexOf(n.charAt(e)) === -1;
                    ...
                    (t.prototype.findItemAtOffset = function (r, i, e) {
                        for (
                            ...
                            if (e > o.offset + o.length) {
                                ...
                                var f = n.scan();
                                return f === 5 &&
                                    e >= n.getTokenOffset() + n.getTokenLength()
                                    ? s + 1
                                    : s;
                    ...
                    (t.prototype.isInComment = function (r, i, e) {
                        ...
                        for (
                            var a = n.scan();
                            a !== 17 &&
                            n.getTokenOffset() + n.getTokenLength() < e;

                        )
                            a = n.scan();
                        return (
                            (a === 12 || a === 13) && n.getTokenOffset() <= e
                        );
                    }),
                    ...
                    (t.prototype.doesSupportMarkdown = function () {
                        if (!se(this.supportsMarkdown)) {
                            ...
                            this.supportsMarkdown =
                                ...
                                r.completionItem &&
                                Array.isArray(
                                    r.completionItem.documentationFormat
                                ) &&
                                r.completionItem.documentationFormat.indexOf(
                                    fe.Markdown
                                ) !== -1;
                        }
                ...
                return (
                    (t.prototype.configure = function (r) {
                        r &&
                            ...
                            (this.commentSeverity = r.allowComments
                                ? void 0
                                : Z.Error));
                    }),
                    (t.prototype.doValidation = function (r, i, e, n) {
                        ...
                        var s = [],
                            ...
                            l = function (h) {
                                var d = e?.trailingCommas
                                        ? rt(e.trailingCommas)
                                        : Z.Error,
                                    m = e?.comments
                                        ? rt(e.comments)
                                        : a.commentSeverity,
                                    p = e?.schemaValidation
                                        ? rt(e.schemaValidation)
                                        : Z.Warning,
                                    g = e?.schemaRequest
                                        ? rt(e.schemaRequest)
                                        : Z.Warning;
                                if (h) {
                                    ...
                                    Er(h.schema) && (m = void 0),
                                        Ir(h.schema) && (d = void 0);
                                }
                                for (
                                    var I = 0, A = i.syntaxErrors;
                                    I < A.length;
                                    I++
                                ) {
                                    var P = A[I];
            ...
            if (t[0] === "#")
                switch (t.length) {
                    ...
                    case 7:
                        return {
                            red:
                                (B(t.charCodeAt(1)) * 16 + B(t.charCodeAt(2))) /
                                255,
                            green:
                                (B(t.charCodeAt(3)) * 16 + B(t.charCodeAt(4))) /
                                255,
                            blue:
                                (B(t.charCodeAt(5)) * 16 + B(t.charCodeAt(6))) /
                                255,
                            alpha: 1,
                        };
                    case 9:
                        return {
                            ...
                            blue:
                                ...
                                255,
                            alpha:
                                (B(t.charCodeAt(7)) * 16 + B(t.charCodeAt(8))) /
                                255,
                        };
                }
        }
            ...
            return (
                ...
                (t.prototype.getDetail = function (r) {
                    if (r) {
                        ...
                        if (r.type === "array")
                            return r.children.length ? void 0 : "[]";
                        if (r.type === "object")
                            return r.children.length ? void 0 : "{}";
                    }
                }),
                ...
                (t.prototype.getColorPresentations = function (r, i, e, n) {
                    ...
                    return (
                        ...
                        a.push({
                            label: u,
                            textEdit: Y.replace(n, JSON.stringify(u)),
                        }),
                        a
                    );
                }),
            ...
            for (Ne in it.properties)
                (at = it.properties[Ne]),
                    ...
                    Jt
                        ...
                        : console.log(
                              ""
                                  .concat(Ne, ": localize('schema.json.")
                                  .concat(Ne, `', "")`)
                          );
        }
        var it, at, Jt, Ne, Lr;
            ...
            var t = {
                    470: (e) => {
                                    ...
                                    if (!(h === m - 1 || d === 1))
                                        if (h !== m - 1 && d === 2) {
                                            if (
                                                u.length < 2 ||
                                                c !== 2 ||
                                                u.charCodeAt(u.length - 1) !==
                                                    46 ||
                                                u.charCodeAt(u.length - 2) !==
                                                    46
                                            ) {
                                                if (u.length > 2) {
                                                    var p = u.lastIndexOf("/");
                        ...
                        var s = {
                            ...
                            isAbsolute: function (o) {
                                return (
                                    n(o), o.length > 0 && o.charCodeAt(0) === 47
                                );
                            },
                            join: function () {
                            ...
                            relative: function (o, f) {
                                ...
                                for (
                                    ...
                                    if (g === m) {
                                        if (d > m) {
                                            if (f.charCodeAt(h + g) === 47)
                                                return f.slice(h + g + 1);
                    ...
                    447: (e, n, a) => {
                            ...
                            O = (function (T) {
                                ...
                                return (
                                    ...
                                    (S.prototype.toJSON = function () {
                                        ...
                                        return (
                                            this._fsPath &&
                                                ((k.fsPath = this._fsPath),
                                                (k._sep = v)),
                                            this._formatted &&
                                                (k.external = this._formatted),
                                            this.path && (k.path = this.path),
                                            this.scheme &&
                                                (k.scheme = this.scheme),
                                            this.authority &&
                                                (k.authority = this.authority),
                                            this.query &&
                                                (k.query = this.query),
                                            this.fragment &&
                                                (k.fragment = this.fragment),
                                            k
                                        );
                                    }),
                                    S
                        ...
                        function I(T, S) {
                            ...
                            return (
                                j !== -1 &&
                                    (k += encodeURIComponent(T.substring(j))),
                                k !== void 0 ? k : T
                            );
                        }
                        function A(T) {
                            ...
                            if (
                                ...
                                if (ne !== -1) {
                                    ...
                                    ($ = $.substr(ne + 1)),
                                        (ne = ke.indexOf(":")) === -1
                                            ? (j += k(ke, !1))
                                            : ((j += k(ke.substr(0, ne), !1)),
                                              (j += ":"),
                                              (j += k(ke.substr(ne + 1), !1))),
                                        (j += "@");
                                }
                                ...
                                if (k || arguments.length === 2)
                                    for (var j, V = 0, $ = S.length; V < $; V++)
                                        (!j && V in S) ||
                                            ...
                                            (j[V] = S[V]));
                                return T.concat(
                                    j || Array.prototype.slice.call(S)
                                );
                            },
                            q = R.posix || R;
                        (function (T) {
                            (T.joinPath = function (S) {
                                for (
                                    ...
                                    k[j - 1] = arguments[j];
                                return S.with({
                                    path: q.join.apply(q, H([S.path], k, !1)),
                                });
                            }),
                                (T.resolvePath = function (S) {
                                    ...
                                    var V = S.path || "/";
                                    return S.with({
                                        path: q.resolve.apply(q, H([V], k, !1)),
                                    });
                                }),
            ...
            Nn = (function () {
                ...
                return (
                    (t.prototype.matchesPattern = function (r) {
                        for (
                            var i = !1, e = 0, n = this.globWrappers;
                            e < n.length;
                            e++
                        ) {
                            var a = n[e],
                    ...
                    (this.service = r),
                        ...
                        e &&
                            (this.unresolvedSchema =
                                this.service.promise.resolve(new qe(e)));
                }
                return (
                    (t.prototype.getUnresolvedSchema = function () {
                        return (
                            this.unresolvedSchema ||
                                (this.unresolvedSchema =
                                    this.service.loadSchema(this.uri)),
                            this.unresolvedSchema
                        );
                    }),
                    (t.prototype.getResolvedSchema = function () {
                        ...
                        return (
                            this.resolvedSchema ||
                                (this.resolvedSchema =
                                    this.getUnresolvedSchema().then(function (
                                        i
                                    ) {
                                        return r.service.resolveSchemaContent(
                                            i,
                                            r
                                        );
                                    })),
            ...
            return (
                ...
                (t.prototype.setSchemaContributions = function (r) {
                    if (r.schemas) {
                        ...
                        for (var e in i) {
                            var n = be(e);
                            this.contributionSchemas[n] = this.addSchemaHandle(
                                n,
                                i[e]
                            );
                        }
                    ...
                    if (Array.isArray(r.schemaAssociations))
                        for (
                            ...
                            var f = o[s],
                                l = f.uris.map(be),
                                u = this.addFilePatternAssociation(
                                    f.pattern,
                                    l
                                );
                ...
                (t.prototype.resolveSchemaContent = function (r, i) {
                    ...
                    var o = this.contextService,
                        ...
                        h = function (p, g, b, y) {
                            o &&
                                !/^[A-Za-z][A-Za-z0-9+\-.+]*:\/\/.*/.test(g) &&
                                (g = o.resolveRelativePath(g, y.uri)),
                                (g = be(g));
                ...
                (t.prototype.getSchemaFromProperty = function (r, i) {
                    var e, n;
                    if (
                        ((e = i.root) === null || e === void 0
                            ? void 0
                            : e.type) === "object"
                    )
                        for (
                            var a = 0, s = i.root.properties;
                            a < s.length;
                            a++
                        ) {
                            var o = s[a];
                ...
                (t.prototype.getMatchingSchemas = function (r, i, e) {
                    if (e) {
                        ...
                        return a.getResolvedSchema().then(function (s) {
                            return i
                                .getMatchingSchemas(s.schema)
                                .filter(function (o) {
                                    return !o.inverted;
                                });
                        });
                    }
                    return this.getSchemaForResource(r.uri, i).then(function (
                        s
                    ) {
                        return s
                            ? i
...
`,
        ...
        var ft = class {
                constructor(r, i) {
                    (this._ctx = r),
                        ...
                        (this._languageService = qr({
                            ...
                            schemaRequestService: i.enableSchemaRequest
                                ? zr
                                : void 0,
                ...
                async resetSchema(r) {
                    return Promise.resolve(
                        this._languageService.resetSchema(r)
                    );
                }
                ...
                async getColorPresentations(r, i, e) {
                    ...
                    let a = this._languageService.parseJSONDocument(n),
                        s = this._languageService.getColorPresentations(
                            n,
                            a,
                            i,
                            e
                ...
                async getMatchingSchemas(r) {
                    ...
                    let e = this._languageService.parseJSONDocument(i);
                    return Promise.resolve(
                        this._languageService.getMatchingSchemas(i, e)
                    );
                }
                _getTextDocument(r) {
