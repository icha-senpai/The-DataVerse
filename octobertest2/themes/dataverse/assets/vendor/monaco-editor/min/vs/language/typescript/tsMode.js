    ...
    var moduleExports = (() => {
        ...
        var ne = (s, e) => () => (
            ...
            z = (s, e, t) => (
                ...
                H(
                    e || !s || !s.__esModule
                        ? K(t, "default", { value: s, enumerable: !0 })
                        : t,
                    s
                )
            ),
        ...
        var v = class {
            ...
            async getLanguageServiceWorker(...e) {
                ...
                return (
                    this._worker && (await this._worker.withSyncedResources(e)),
                    t
                );
            }
        };
        ...
        var k = class {
            ...
            _ = class {
                ...
                getOrCreateModel(e) {
                    ...
                    return l
                        ? r.editor.createModel(l.content, "typescript", t)
                        : null;
                }
                _containsLibFile(e) {
        ...
        var T = class extends k {
                constructor(t, i, l, c) {
                    ...
                    let u = (a) => {
                        ...
                        g = (a) => {
                            ...
                            this._listener[d] &&
                                (this._listener[d].dispose(),
                                delete this._listener[d]);
                        };
                    this._disposables.push(
                        r.editor.onDidCreateModel((a) => u(a))
                    ),
                    ...
                    this._disposables.push(this._defaults.onDidChange(o)),
                        this._disposables.push(
                            this._defaults.onDidExtraLibsChange(o)
                        ),
                ...
                async _doValidate(t) {
                    ...
                    c || l.push(i.getSyntacticDiagnostics(t.uri.toString())),
                        ...
                        g ||
                            l.push(
                                i.getSuggestionDiagnostics(t.uri.toString())
                            );
                    ...
                    let a = o
                        ...
                        d = a
                            ...
                            .reduce((p, f) => f.concat(p), [])
                            .map((p) =>
                                p.file ? r.Uri.parse(p.file.fileName) : null
                            );
                ...
                _convertRelatedInformation(t, i) {
                    ...
                    return (
                        i.forEach((c) => {
                            ...
                            let g = c.start || 0,
                                o = c.length || 1,
                                { lineNumber: a, column: d } =
                                    u.getPositionAt(g),
                                { lineNumber: p, column: f } = u.getPositionAt(
                                    g + o
                                );
                            l.push({
                                resource: u.uri,
            ...
            C = class s extends k {
                              ...
                              suggestions: d.entries.map((f) => {
                                  ...
                                  return (
                                      f.kindModifiers !== void 0 &&
                                          f.kindModifiers.indexOf(
                                              "deprecated"
                                          ) !== -1 &&
                                          y.push(
                                              r.languages.CompletionItemTag
                                                  .Deprecated
                                          ),
                                      {
                                          uri: g,
                ...
                async resolveCompletionItem(e, t) {
                    let i = e,
                        ...
                        ).getCompletionEntryDetails(l.toString(), u, i.label);
                    return o
                        ? {
                              uri: l,
                              position: c,
                              ...
                              documentation: {
                                  value: s.createDocumentationString(o),
                              },
                          }
                        : i;
                }
        ...
        var I = class s extends k {
                ...
                static _toSignatureHelpTriggerReason(t) {
                    switch (t.triggerKind) {
                        case r.languages.SignatureHelpTriggerKind
                            .TriggerCharacter:
                ...
                async provideSignatureHelp(t, i, l, c) {
                    ...
                    if (t.isDisposed()) return;
                    let a = await o.getSignatureHelpItems(u.toString(), g, {
                        triggerReason: s._toSignatureHelpTriggerReason(c),
                    });
            ...
            D = class extends k {
                async provideDocumentHighlights(e, t, i) {
                    let l = e.uri,
                        ...
                        u = await this._worker(l);
                    if (e.isDisposed()) return;
                    let g = await u.getDocumentHighlights(l.toString(), c, [
                        l.toString(),
                    ]);
                    if (!(!g || e.isDisposed()))
                        return g.flatMap((o) =>
                            o.highlightSpans.map((a) => ({
                                ...
                                kind:
                                    a.kind === "writtenReference"
                                        ? r.languages.DocumentHighlightKind
                                              .Write
                                        : r.languages.DocumentHighlightKind
                                              .Text,
                            }))
            ...
            L = class extends k {
                ...
                async provideReferences(t, i, l, c) {
                    ...
                    if (
                        ...
                        t.isDisposed() ||
                        (await this._libFiles.fetchLibFilesIfNecessary(
                            a.map((p) => r.Uri.parse(p.fileName))
                        ),
                        t.isDisposed())
                    )
                        return;
...
`,
            ...
            O = class extends x {
                async provideCodeActions(e, t, i, l) {
                    ...
                    if (e.isDisposed()) return;
                    let p = await d.getCodeFixesAtPosition(
                        c.toString(),
                        u,
                        g,
                        a,
                    ...
                    return !p || e.isDisposed()
                        ...
                        : {
                              actions: p
                                  .filter(
                                      (b) =>
                                          b.changes.filter((y) => y.isNewFile)
                                              .length === 0
                                  )
                                  .map((b) =>
            ...
            E = class extends k {
                ...
                async provideRenameEdits(t, i, l, c) {
                    let u = t.uri,
                        ...
                        a = await this._worker(u);
                    if (t.isDisposed()) return;
                    let d = await a.getRenameInfo(g, o, {
                        allowRenameOfImportPath: !1,
                    });
                    if (d.canRename === !1)
                        return {
                            edits: [],
                            rejectReason: d.localizedErrorMessage,
                        };
            ...
            N = class extends k {
                async provideInlayHints(e, t, i) {
                    ...
                    return e.isDisposed()
                        ? null
                        : {
                              hints: (await o.provideInlayHints(c, u, g)).map(
                                  (p) => ({
                                      ...p,
                                      label: p.text,
        ...
        function X(s, e) {
            ...
            function g() {
                ...
                Y(i),
                    ...
                    o.signatureHelp &&
                        i.push(
                            r.languages.registerSignatureHelpProvider(
                                e,
                                new I(c)
                            )
                        ),
                    o.hovers &&
                        i.push(r.languages.registerHoverProvider(e, new P(c))),
                    ...
                    o.rename &&
                        i.push(
                            r.languages.registerRenameProvider(e, new E(u, c))
                        ),
                    ...
                    o.codeActions &&
                        i.push(
                            r.languages.registerCodeActionProvider(e, new O(c))
                        ),
                    o.inlayHints &&
                        i.push(
                            r.languages.registerInlayHintsProvider(e, new N(c))
                        ),
