...
define("vs/language/json/jsonWorker", ["require"], (require) => {
    ...
    var moduleExports = (() => {
        ...
        function format(documentText, range, options) {
            ...
            function addEdit(text, startOffset, endOffset2) {
                if (
                    !hasError &&
                    (!range ||
                        (startOffset < rangeEnd && endOffset2 > rangeStart)) &&
        ...
        (function (ColorPresentation2) {
            ...
            function is(value) {
                ...
                return (
                    ...
                    (Is.undefined(candidate.textEdit) ||
            ...
            function is(value) {
                ...
                return (
                    ...
                    (Is.undefined(candidate.codeDescription) ||
                        Is.string(
                            (_a = candidate.codeDescription) === null ||
                                _a === void 0
                                ? void 0
                                : _a.href
                        )) &&
                    (Is.string(candidate.source) ||
                        Is.undefined(candidate.source)) &&
                    ...
                    (candidate.options === void 0 ||
                        ((candidate.options.overwrite === void 0 ||
                            ...
                            (candidate.options.ignoreIfExists === void 0 ||
                                Is.boolean(
                                    candidate.options.ignoreIfExists
                                )))) &&
                    ...
                    (candidate.options === void 0 ||
                        ((candidate.options.recursive === void 0 ||
                            ...
                            (candidate.options.ignoreIfNotExists === void 0 ||
                                Is.boolean(
                                    candidate.options.ignoreIfNotExists
                                )))) &&
                    (candidate.annotationId === void 0 ||
                        ChangeAnnotationIdentifier.is(candidate.annotationId))
                );
            ...
            (function () {
                ...
                TextEditChangeImpl2.prototype.replace = function (
                    ...
                    if (annotation === void 0) {
                        ...
                        id = annotation;
                        edit = AnnotatedTextEdit.replace(
                            range,
                            newText,
                            annotation
                        );
                ...
                TextEditChangeImpl2.prototype.delete = function (
                    range,
                    annotation
                ) {
                    var edit;
                ...
                TextEditChangeImpl2.prototype.assertChangeAnnotations =
                    function (value) {
                        if (value === void 0) {
                            throw new Error(
                ...
                function WorkspaceChange2(workspaceEdit) {
                    ...
                    if (workspaceEdit !== void 0) {
                        ...
                        if (workspaceEdit.documentChanges) {
                            ...
                            workspaceEdit.documentChanges.forEach(function (
                                change
                            ) {
                            ...
                            Object.keys(workspaceEdit.changes).forEach(
                                function (key) {
                                    var textEditChange = new TextEditChangeImpl(
                                        workspaceEdit.changes[key]
                                    );
                                    _this._textEditChanges[key] =
                                        textEditChange;
                                }
                            );
                        }
        ...
        (function (CodeLens2) {
            ...
            function is(value) {
                ...
                return (
                    Is.defined(candidate) &&
                    Range.is(candidate.range) &&
                    (Is.undefined(candidate.command) ||
                        Command.is(candidate.command))
                );
            }
            CodeLens2.is = is;
        ...
        (function (TextDocument3) {
            ...
            function applyEdits(document, edits) {
                ...
                var sortedEdits = mergeSort2(edits, function (a2, b) {
                    ...
                    if (diff === 0) {
                        return (
                            a2.range.start.character - b.range.start.character
                        );
                    }
                    return diff;
                });
        ...
        var FullTextDocument =
            ...
            (function () {
                ...
                FullTextDocument3.prototype.positionAt = function (offset) {
                    offset = Math.max(
                        Math.min(offset, this._content.length),
                        0
                    );
            ...
            update(changes, version) {
                for (let change of changes) {
                    if (_FullTextDocument.isIncremental(change)) {
                        ...
                        const diff =
                            change.text.length - (endOffset - startOffset);
                        if (diff !== 0) {
                            for (
            ...
            function applyEdits(document, edits) {
                ...
                for (const e of sortedEdits) {
                    ...
                    if (startOffset < lastModifiedOffset) {
                        ...
                        spans.push(
                            text.substring(lastModifiedOffset, startOffset)
                        );
                    }
                    if (e.newText.length) {
        ...
        (function (ErrorCode2) {
            ...
            ErrorCode2[(ErrorCode2["EnumValueMismatch"] = 1)] =
                "EnumValueMismatch";
            ...
            ErrorCode2[(ErrorCode2["InvalidEscapeCharacter"] = 261)] =
                "InvalidEscapeCharacter";
            ErrorCode2[(ErrorCode2["InvalidCharacter"] = 262)] =
                "InvalidCharacter";
            ErrorCode2[(ErrorCode2["PropertyExpected"] = 513)] =
                "PropertyExpected";
        ...
        var StringASTNodeImpl =
            ...
            (function (_super) {
                ...
                function StringASTNodeImpl2(parent, offset, length) {
                    var _this =
                        _super.call(this, parent, offset, length) || this;
                    _this.type = "string";
                    _this.value = "";
                    return _this;
                }
        ...
        var PropertyASTNodeImpl =
            ...
            (function (_super) {
                ...
                Object.defineProperty(
                    PropertyASTNodeImpl2.prototype,
                    "children",
                    {
                        get: function () {
        ...
        var SchemaCollector =
            ...
            (function () {
                ...
                SchemaCollector2.prototype.include = function (node) {
                    return (
                        (this.focusOffset === -1 ||
                            contains2(node, this.focusOffset)) &&
                        node !== this.exclude
                    );
                };
        ...
        var NoOpSchemaCollector =
            ...
            (function () {
                ...
                Object.defineProperty(
                    NoOpSchemaCollector2.prototype,
                    "schemas",
                    {
                        get: function () {
                            return [];
        ...
        var ValidationResult =
            ...
            (function () {
                ...
                ValidationResult2.prototype.mergeAll = function (
                    validationResults
                ) {
                    for (
                ...
                ValidationResult2.prototype.merge = function (
                    validationResult
                ) {
                ...
                ValidationResult2.prototype.compare = function (other) {
                    ...
                    if (
                        this.primaryValueMatches !== other.primaryValueMatches
                    ) {
                        return (
                            this.primaryValueMatches - other.primaryValueMatches
                        );
        ...
        var JSONDocument =
            ...
            (function () {
                ...
                JSONDocument2.prototype.getMatchingSchemas = function (
                    ...
                    var matchingSchemas = new SchemaCollector(
                        focusOffset,
                        exclude
                    );
                    if (this.root && schema) {
        ...
        function validate(n, schema, validationResult, matchingSchemas) {
            ...
            function _validateNumberNode(
                ...
                if (isNumber(schema2.multipleOf)) {
                    ...
                    if (Number.isInteger(schema2.multipleOf)) {
                        ...
                        var normMultipleOf = normalizeFloats(
                            schema2.multipleOf
                        );
                        ...
                        if (normMultipleOf && normValue) {
                            var multiplier = Math.pow(
                                10,
                                Math.abs(
                                    normValue.multiplier -
                                        normMultipleOf.multiplier
                                )
                            );
                            if (
                ...
                if (schema2.format) {
                    switch (schema2.format) {
                        ...
                        case "ipv6":
                            ...
                            if (
                                !node2.value ||
                                !format4.pattern.exec(node2.value)
                            ) {
                                validationResult2.problems.push({
                                    location: {
                                        offset: node2.offset,
            ...
            function _validateObjectNode(
                ...
                if (typeof schema2.additionalProperties === "object") {
                    for (
                        var _k = 0,
                            unprocessedProperties_1 = unprocessedProperties;
                    ...
                    if (unprocessedProperties.length > 0) {
                        for (
                            var _l = 0,
                                unprocessedProperties_2 = unprocessedProperties;
        ...
        function parse3(textDocument, config) {
            ...
            function _parseObject(parent) {
                ...
                var node = new ObjectASTNodeImpl(
                    parent,
                    scanner.getTokenOffset()
                );
            ...
            function _parseString(parent) {
                ...
                var node = new StringASTNodeImpl(
                    parent,
                    scanner.getTokenOffset()
                );
            ...
            function _parseNumber(parent) {
                ...
                var node = new NumberASTNodeImpl(
                    parent,
                    scanner.getTokenOffset()
                );
        ...
        var JSONCompletion =
            ...
            (function () {
                ...
                JSONCompletion2.prototype.doResolve = function (item) {
                    for (var i = this.contributions.length - 1; i >= 0; i--) {
                        var resolveCompletion =
                            this.contributions[i].resolveCompletion;
                    ...
                    return this.schemaService
                        ...
                        .then(function (schema) {
                            ...
                            if (node && node.type === "object") {
                                ...
                                properties.forEach(function (p) {
                                    if (
                                        ...
                                        proposed[p.keyNode.value] =
                                            CompletionItem.create("__");
                                    }
                                });
                                var separatorAfter_1 = "";
                                if (addValue) {
                                    separatorAfter_1 =
                                        _this.evaluateSeparatorAfter(
                                            document,
                                            document.offsetAt(
                                                overwriteRange.end
                                            )
                                ...
                                _this.contributions.forEach(function (
                                    contribution
                                ) {
                                    var collectPromise =
                                ...
                                if (
                                    ...
                                    text.charAt(
                                        offset - currentWord.length - 1
                                    ) !== '"'
                                ) {
                                    collector.add({
                                        kind: CompletionItemKind.Property,
                                        label: _this.getLabelForValue(
                                            currentWord
                                        ),
                                        insertText:
                                            _this.getInsertTextForProperty(
                                                currentWord,
                                                void 0,
                                                false,
                                                separatorAfter_1
                            ...
                            return _this.promiseConstructor
                                ...
                                .then(function () {
                                    if (
                                        collector.getNumberOfProposals() === 0
                                    ) {
                    ...
                    matchingSchemas.forEach(function (s) {
                        if (s.node === node && !s.inverted) {
                            ...
                            if (schemaProperties_1) {
                                Object.keys(schemaProperties_1).forEach(
                                    function (key) {
                                        var propertySchema =
                                            schemaProperties_1[key];
                                        if (
                            ...
                            if (
                                ...
                                var propertyNameCompletionItem = function (
                                    ...
                                    var proposal = {
                                        ...
                                        insertTextFormat:
                                            InsertTextFormat.Snippet,
                                        filterText:
                                            _this.getFilterTextForValue(name),
                                        documentation:
                                            enumDescription2 ||
                                            _this.fromMarkup(
                                    ...
                                    if (
                                        schemaPropertyNames_1.suggestSortText !==
                                        void 0
                                    ) {
                                        proposal.sortText =
                                            schemaPropertyNames_1.suggestSortText;
                                ...
                                if (schemaPropertyNames_1.enum) {
                                    for (
                                        var i = 0;
                                        i < schemaPropertyNames_1.enum.length;
                                        i++
                                    ) {
                                        ...
                                        if (
                                            ...
                                            i <
                                                schemaPropertyNames_1
                                                    .markdownEnumDescriptions
                                                    .length
                                        ) {
                                            enumDescription = _this.fromMarkup(
                                                schemaPropertyNames_1
                                                    .markdownEnumDescriptions[i]
                                            );
                                        } else if (
                ...
                JSONCompletion2.prototype.getSchemaLessPropertyCompletions =
                    function (doc, node, currentKey, collector) {
                        var _this = this;
                        var collectCompletionsForSimilarObject = function (
                            obj
                        ) {
                            obj.properties.forEach(function (p) {
                                ...
                                collector.add({
                                    ...
                                    filterText:
                                        _this.getFilterTextForValue(key),
                                    documentation: "",
                                });
                            });
                        };
                        if (node.parent) {
                            ...
                            collector.add({
                                ...
                                documentation: "",
                                filterText:
                                    this.getFilterTextForValue("$schema"),
                            });
                        }
                    };
                JSONCompletion2.prototype.getSchemaLessValueCompletions =
                    function (doc, node, offset, document, collector) {
                        var _this = this;
                        var offsetForSeparator = offset;
                        if (
                            node &&
                        ...
                        var collectSuggestionsForValues = function (value) {
                            if (
                                value.parent &&
                                !contains2(value.parent, offset, true)
                            ) {
                                collector.add({
                                    kind: _this.getSuggestionKind(value.type),
                                    label: _this.getLabelTextForMatchingNode(
                                        value,
                                        document
                                    ),
                                    insertText:
                                        _this.getInsertTextForMatchingNode(
                                            value,
                                            document,
                                            separatorAfter
                                        ),
                ...
                JSONCompletion2.prototype.getValueCompletions = function (
                    ...
                    if (
                        node &&
                        (parentKey !== void 0 || node.type === "array")
                    ) {
                        var separatorAfter = this.evaluateSeparatorAfter(
                            document,
                            offsetForSeparator
                            ...
                            if (s.node === node && !s.inverted && s.schema) {
                                if (node.type === "array" && s.schema.items) {
                                    if (Array.isArray(s.schema.items)) {
                                        var index = this.findItemAtOffset(
                                            node,
                                            document,
                                            offset
                                        );
                ...
                JSONCompletion2.prototype.getContributedValueCompletions =
                    function (
                        doc,
                        node,
                        offset,
                        ...
                        if (!node) {
                            this.contributions.forEach(function (contribution) {
                                var collectPromise =
                                    contribution.collectDefaultCompletions(
                                        document.uri,
                                        collector
                                    );
                                if (collectPromise) {
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    this.contributions.forEach(function (
                                        contribution
                                    ) {
                                        var collectPromise =
                ...
                JSONCompletion2.prototype.addDefaultValueCompletions =
                    function (schema, separatorAfter, collector, arrayDepth) {
                        var _this = this;
                        ...
                        if (Array.isArray(schema.defaultSnippets)) {
                            schema.defaultSnippets.forEach(function (s) {
                                ...
                                if (isDefined(value2)) {
                                    ...
                                    insertText =
                                        _this.getInsertTextForSnippetValue(
                                            value2,
                                            separatorAfter
                                        );
                                    filterText =
                                        _this.getFilterTextForSnippetValue(
                                            value2
                                        );
                                    label =
                                        label ||
                                        _this.getLabelForSnippetValue(value2);
                ...
                JSONCompletion2.prototype.addEnumValueCompletions = function (
                    ...
                    if (Array.isArray(schema.enum)) {
                        for (
                            var i = 0, length = schema.enum.length;
                            i < length;
                            i++
                        ) {
                ...
                JSONCompletion2.prototype.collectTypes = function (
                    schema,
                    types
                ) {
                ...
                JSONCompletion2.prototype.addDollarSchemaCompletions =
                    function (separatorAfter, collector) {
                        var _this = this;
                        var schemaIds =
                            this.schemaService.getRegisteredSchemaIds(function (
                                schema
                            ) {
                        ...
                        schemaIds.forEach(function (schemaId) {
                            return collector.add({
                                ...
                                filterText:
                                    _this.getFilterTextForValue(schemaId),
                                insertText: _this.getInsertTextForValue(
                                    schemaId,
                                    separatorAfter
                                ),
                ...
                JSONCompletion2.prototype.getFilterTextForValue = function (
                    value
                ) {
                    return JSON.stringify(value);
                };
                JSONCompletion2.prototype.getFilterTextForSnippetValue =
                    function (value) {
                ...
                JSONCompletion2.prototype.getLabelForSnippetValue = function (
                    value
                ) {
                    var label = JSON.stringify(value);
                    return label.replace(/\$\{\d+:([^}]+)\}|\$\d+/g, "$1");
                };
                JSONCompletion2.prototype.getInsertTextForPlainText = function (
                    text
                ) {
                ...
                JSONCompletion2.prototype.getInsertTextForValue = function (
                    ...
                    return this.getInsertTextForPlainText(
                        text + separatorAfter
                    );
                };
                JSONCompletion2.prototype.getInsertTextForSnippetValue =
                    function (value, separatorAfter) {
                        ...
                        return (
                            stringifyObject(value, "", replacer) +
                            separatorAfter
                        );
                    };
                JSONCompletion2.prototype.getInsertTextForGuessedValue =
                    function (value, separatorAfter) {
                        switch (typeof value) {
                            case "object":
                                if (value === null) {
                            ...
                            case "string":
                                ...
                                snippetValue = snippetValue.substr(
                                    1,
                                    snippetValue.length - 2
                                );
                                snippetValue =
                                    this.getInsertTextForPlainText(
                                        snippetValue
                                    );
                                return (
                                    '"${1:' +
                ...
                JSONCompletion2.prototype.getLabelTextForMatchingNode =
                ...
                JSONCompletion2.prototype.getInsertTextForMatchingNode =
                    function (node, document, separatorAfter) {
                        switch (node.type) {
                            case "array":
                                return this.getInsertTextForValue(
                                    [],
                    ...
                    if (propertySchema) {
                        if (Array.isArray(propertySchema.defaultSnippets)) {
                            if (propertySchema.defaultSnippets.length === 1) {
                                var body =
                                    propertySchema.defaultSnippets[0].body;
                                if (isDefined(body)) {
                            ...
                            nValueProposals +=
                                propertySchema.defaultSnippets.length;
                        }
                ...
                JSONCompletion2.prototype.getCurrentWord = function (
                    document,
                    offset
                ) {
                    var i = offset - 1;
                ...
                JSONCompletion2.prototype.doesSupportsCommitCharacters =
                    function () {
        ...
        var JSONHover =
            ...
            (function () {
                ...
                JSONHover2.prototype.doHover = function (
                    document,
                    position,
                    doc
                ) {
                    ...
                    var hoverRange = Range.create(
                        ...
                        document.positionAt(
                            hoverRangeNode.offset + hoverRangeNode.length
                        )
                    );
                        ...
                        .then(function (schema) {
                            if (schema && node) {
                                ...
                                if (markdownEnumValueDescription_1) {
                                    ...
                                    result += "`"
                                        .concat(
                                            toMarkdownCodeBlock(enumValue_1),
                                            "`: "
                                        )
            ...
            (function () {
                ...
                JSONValidation2.prototype.doValidation = function (
                    ...
                    if (schema) {
                        var id =
                            schema.id ||
                            "schemaservice://untitled/" + idCounter++;
                        var handle =
                            this.jsonSchemaService.registerExternalSchema(
                                id,
                                [],
                                schema
                            );
                ...
                JSONValidation2.prototype.getLanguageStatus = function (
                    ...
                    return {
                        schemas:
                            this.jsonSchemaService.getSchemaURIsForResource(
                                textDocument.uri,
                                jsonDocument
                            ),
                    };
        ...
        var JSONDocumentSymbols =
            ...
            (function () {
                ...
                JSONDocumentSymbols2.prototype.getSymbolKind = function (
                    nodeType
                ) {
                    switch (nodeType) {
                        case "object":
                ...
                JSONDocumentSymbols2.prototype.getKeyLabel = function (
                    property
                ) {
                    ...
                    return this.schemaService
                        ...
                        .then(function (schema) {
                            ...
                            if (schema) {
                                var limit =
                                    context &&
                                    typeof context.resultLimit === "number"
                                        ? context.resultLimit
                                        : Number.MAX_VALUE;
                                var matchingSchemas = doc.getMatchingSchemas(
                                    schema.schema
                                ...
                                for (
                                    var _i = 0,
                                        matchingSchemas_1 = matchingSchemas;
                                    _i < matchingSchemas_1.length;
                                    _i++
                                ) {
                                    var s = matchingSchemas_1[_i];
                ...
                JSONDocumentSymbols2.prototype.getColorPresentations =
                    function (document, doc, color, range) {
                        var result = [];
                    ...
                    470: (t2) => {
                        ...
                        var n = {
                            ...
                            isAbsolute: function (t3) {
                                return (
                                    e2(t3),
                                    t3.length > 0 && 47 === t3.charCodeAt(0)
                                );
                            },
                            join: function () {
                            ...
                            relative: function (t3, r3) {
                                ...
                                for (
                                    var o = 1;
                                    o < t3.length && 47 === t3.charCodeAt(o);
                                    ++o
                                );
                                for (
                            ...
                            y = (function (t3) {
                                ...
                                return (
                                    ...
                                    (e3.prototype.toJSON = function () {
                                        ...
                                        return (
                                            this._fsPath &&
                                                ((t4.fsPath = this._fsPath),
                                                (t4._sep = v)),
                                            this._formatted &&
                                                (t4.external = this._formatted),
                                            this.path && (t4.path = this.path),
                                            this.scheme &&
                                                (t4.scheme = this.scheme),
                                            this.authority &&
                                                (t4.authority = this.authority),
                                            this.query &&
                                                (t4.query = this.query),
                                            this.fragment &&
                                                (t4.fragment = this.fragment),
                                            t4
                                        );
                                    }),
                                    e3
                                        ...
                                        : 47 === t3.path.charCodeAt(0) &&
                                          ((t3.path.charCodeAt(1) >= 65 &&
                                              ...
                                              (t3.path.charCodeAt(1) >= 97 &&
                                                  t3.path.charCodeAt(1) <=
                                                      122)) &&
                                          58 === t3.path.charCodeAt(2)
                                        ? e3
                                            ? t3.path.substr(1)
                                            : t3.path[1].toLowerCase() +
                                              t3.path.substr(2)
                                        : t3.path),
                                n && (r3 = r3.replace(/\//g, "\\")),
                                r3
                                ...
                                if (r3 || 2 === arguments.length)
                                    for (
                                        ...
                                        (!n2 && o2 in e3) ||
                                            ...
                                            (n2[o2] = e3[o2]));
                                return t3.concat(
                                    n2 || Array.prototype.slice.call(e3)
                                );
                            },
                            I = j.posix || j;
                        !(function (t3) {
            ...
            return (
                (r.d = (t2, e2) => {
                    for (var n in e2)
                        r.o(e2, n) &&
                            !r.o(t2, n) &&
                            Object.defineProperty(t2, n, {
                                enumerable: true,
                                get: e2[n],
                            });
                }),
                (r.o = (t2, e2) =>
                    Object.prototype.hasOwnProperty.call(t2, e2)),
                (r.r = (t2) => {
        ...
        var FilePatternAssociation =
            ...
            (function () {
                ...
                FilePatternAssociation2.prototype.matchesPattern = function (
                    fileName
                ) {
                    var match = false;
                    for (
                        var _i = 0, _a = this.globWrappers;
                        _i < _a.length;
                        _i++
                    ) {
                        var _b = _a[_i],
            ...
            (function () {
                ...
                SchemaHandle2.prototype.getUnresolvedSchema = function () {
                    if (!this.unresolvedSchema) {
                        this.unresolvedSchema = this.service.loadSchema(
                            this.uri
                        );
                    }
            ...
            (function () {
                ...
                ResolvedSchema2.prototype.getSectionRecursive = function (
                    ...
                    if (schema.properties && typeof schema.properties[next]) {
                        ...
                        for (
                            var _i = 0,
                                _a = Object.keys(schema.patternProperties);
                            _i < _a.length;
                            _i++
                        ) {
                            var pattern = _a[_i];
        ...
        var JSONSchemaService =
            ...
            (function () {
                ...
                JSONSchemaService2.prototype.setSchemaContributions = function (
                    ...
                    if (
                        Array.isArray(schemaContributions2.schemaAssociations)
                    ) {
                        var schemaAssociations =
                            schemaContributions2.schemaAssociations;
                        for (
                            var _i = 0,
                                schemaAssociations_1 = schemaAssociations;
                ...
                JSONSchemaService2.prototype.addFilePatternAssociation =
                    function (pattern, uris) {
                ...
                JSONSchemaService2.prototype.clearExternalSchemas =
                    function () {
                        this.schemasById = {};
                        this.filePatternAssociations = [];
                        this.registeredSchemasIds = {};
                        ...
                        for (
                            ...
                            this.filePatternAssociations.push(
                                contributionAssociation
                            );
                        }
                    };
                JSONSchemaService2.prototype.getResolvedSchema = function (
                    schemaId
                ) {
                ...
                JSONSchemaService2.prototype.resolveSchemaContent = function (
                    ...
                    var mergeRef = function (
                        ...
                        if (refSegment === void 0 || refSegment.length === 0) {
                            ...
                            section = findSectionByJSONPointer(
                                sourceRoot,
                                refSegment
                            );
                        } else {
                            section = findSchemaById(
                                sourceRoot,
                                sourceHandle,
                                refSegment
                            );
                    ...
                    return resolveRefs(schema, schema, handle).then(function (
                        _
                    ) {
                        return new ResolvedSchema(schema, resolveErrors);
                    });
                };
                JSONSchemaService2.prototype.traverseNodes = function (
                    root,
                    handle
                ) {
                        ...
                        for (
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    schemaId =
                                        this.contextService.resolveRelativePath(
                                            schemaId,
                                            resource
                                        );
                                }
                ...
                JSONSchemaService2.prototype.getAssociatedSchemas = function (
                    resource
                ) {
                    var seen = /* @__PURE__ */ Object.create(null);
                    var schemas = [];
                    var normalizedResource =
                        normalizeResourceForMatching(resource);
                    for (
                ...
                JSONSchemaService2.prototype.getSchemaURIsForResource =
                    function (resource, document) {
                        var schemeId =
                            document &&
                            this.getSchemaFromProperty(resource, document);
                        if (schemeId) {
                            return [schemeId];
                        }
                ...
                JSONSchemaService2.prototype.getSchemaForResource = function (
                    ...
                    if (document) {
                        var schemeId = this.getSchemaFromProperty(
                            resource,
                            document
                        );
                        if (schemeId) {
                ...
                JSONSchemaService2.prototype.getMatchingSchemas = function (
                    ...
                    if (schema) {
                        var id =
                            schema.id ||
                            "schemaservice://untitled/matchingSchemas/" +
                                idCounter2++;
                    ...
                    return this.getSchemaForResource(
                        document.uri,
                        jsonDocument
                    ).then(function (schema2) {
                        if (schema2) {
        ...
        function getFoldingRanges(document, context) {
            ...
            while (token !== 17) {
                switch (token) {
                    case 1:
                    case 3: {
                        var startLine = document.positionAt(
                            scanner.getTokenOffset()
                        ).line;
                        var range = {
                            startLine,
                ...
                while (node) {
                    ...
                    if (
                        ...
                        if (afterCommaOffset !== -1) {
                            result.push(
                                newRange(node.offset, afterCommaOffset)
                            );
                        }
                    }
                    node = node.parent;
        ...
        function findNode(pointer, node) {
            ...
            if (node && node.type === "object") {
                var propertyNode = node.properties.find(function (
                    propertyNode2
                ) {
        ...
        function getLanguageService(params) {
            ...
            var jsonDocumentSymbols = new JSONDocumentSymbols(
                jsonSchemaService
            );
            ...
            return {
                ...
                getMatchingSchemas:
                    jsonSchemaService.getMatchingSchemas.bind(
                        jsonSchemaService
                    ),
                doResolve: jsonCompletion.doResolve.bind(jsonCompletion),
                doComplete: jsonCompletion.doComplete.bind(jsonCompletion),
                findDocumentSymbols:
                    jsonDocumentSymbols.findDocumentSymbols.bind(
                        jsonDocumentSymbols
                    ),
                findDocumentSymbols2:
                    jsonDocumentSymbols.findDocumentSymbols2.bind(
                        jsonDocumentSymbols
                    ),
                findDocumentColors:
                    jsonDocumentSymbols.findDocumentColors.bind(
                        jsonDocumentSymbols
                    ),
                getColorPresentations:
                    jsonDocumentSymbols.getColorPresentations.bind(
                        jsonDocumentSymbols
                    ),
                ...
                format: function (d, r, o) {
                    ...
                    return format2(d.getText(), range, options).map(function (
                        e
                    ) {
        ...
        var JSONWorker = class {
            ...
            async getColorPresentations(uri, color, range) {
                ...
                let colorPresentations =
                    this._languageService.getColorPresentations(
                        document,
                        jsonDocument,
                        color,
                        range
            ...
            async getFoldingRanges(uri, context) {
                ...
                let ranges = this._languageService.getFoldingRanges(
                    document,
                    context
                );
            ...
            async getMatchingSchemas(uri) {
                ...
                let jsonDocument =
                    this._languageService.parseJSONDocument(document);
                return Promise.resolve(
                    this._languageService.getMatchingSchemas(
                        document,
                        jsonDocument
                    )
                );
