    ...
    var moduleExports = (() => {
        ...
        var WorkerManager = class {
            ...
            _getClient() {
                ...
                if (!this._client) {
                    this._worker =
                        monaco_editor_core_exports.editor.createWebWorker({
        ...
        var DiagnosticsAdapter = class {
            constructor(_languageId, _worker, configChangeEvent) {
                ...
                this._disposables.push(
                    monaco_editor_core_exports.editor.onDidCreateModel(
                        onModelAdd
                    )
                );
                this._disposables.push(
                ...
                this._disposables.push(
                    configChangeEvent((_) => {
                        monaco_editor_core_exports.editor
                            ...
                            .forEach((model) => {
                                if (
                                    model.getLanguageId() === this._languageId
                                ) {
            ...
            _doValidate(resource, languageId) {
                this._worker(resource)
                    ...
                    .then((diagnostics) => {
                        ...
                        let model =
                            monaco_editor_core_exports.editor.getModel(
                                resource
                            );
        ...
        var DocumentHighlightAdapter = class {
            ...
            provideDocumentHighlights(model, position, token) {
                ...
                return this._worker(resource)
                    .then((worker2) =>
                        worker2.findDocumentHighlights(
                            resource.toString(),
                            fromPosition(position)
                        )
                    )
        ...
        function toDocumentHighlightKind(kind) {
            switch (kind) {
                case DocumentHighlightKind.Read:
                    return monaco_editor_core_exports.languages
        ...
        var DocumentSymbolAdapter = class {
            ...
            provideDocumentSymbols(model, token) {
                ...
                return this._worker(resource)
                    .then((worker2) =>
                        worker2.findDocumentSymbols(resource.toString())
                    )
                    .then((items) => {
                        if (!items) {
                            return;
        ...
        function toDocumentSymbol(symbol) {
            return {
                ...
                tags: symbol.tags ?? [],
                children: (symbol.children ?? []).map((item) =>
                    toDocumentSymbol(item)
                ),
            };
        }
        ...
        var DocumentLinkAdapter = class {
            ...
            provideLinks(model, token) {
                ...
                return this._worker(resource)
                    .then((worker2) =>
                        worker2.findDocumentLinks(resource.toString())
                    )
                    .then((items) => {
                        if (!items) {
                            return;
        ...
        var DocumentColorAdapter = class {
            ...
            provideDocumentColors(model, token) {
                ...
                return this._worker(resource)
                    .then((worker2) =>
                        worker2.findDocumentColors(resource.toString())
                    )
                    .then((infos) => {
                        if (!infos) {
                            return;
                    ...
                    .then((presentations) => {
                        ...
                        return presentations.map((presentation) => {
                            ...
                            if (presentation.textEdit) {
                                item.textEdit = toTextEdit(
                                    presentation.textEdit
                                );
                            }
                            if (presentation.additionalTextEdits) {
                                item.additionalTextEdits =
                                    presentation.additionalTextEdits.map(
                                        toTextEdit
                                    );
                            }
                            return item;
        ...
        var FoldingRangeAdapter = class {
            ...
            provideFoldingRanges(model, context, token) {
                ...
                return this._worker(resource)
                    .then((worker2) =>
                        worker2.getFoldingRanges(resource.toString(), context)
                    )
                    .then((ranges) => {
                        if (!ranges) {
                            return;
        ...
        function createTokenizationSupport(supportComments) {
            return {
                ...
                tokenize: (line, state) =>
                    tokenize(supportComments, line, state),
            };
        }
