            ...
            unformat: function (string) {
                ...
                if (value) {
                    for (
                        ...
                        if (
                            numeral._.includes(string, decimal.suffixes[power])
                        ) {
                        ...
                        if (
                            numeral._.includes(string, binary.suffixes[power])
                        ) {
    ...
    (function () {
        numeral.register("format", "exponential", {
            ...
            unformat: function (string) {
                ...
                power = numeral._.includes(string, "e-")
                    ? (power *= -1)
                    : power;
