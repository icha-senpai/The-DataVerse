...
Policy note: Prefer unminified upstream/dist builds; only commit *.min.* when no full/unminified build exists upstream — if you must ship a minified build, produce it locally and document provenance here.
