var emmetMonaco = (function (exports) {
  ...
  function parse(abbr, config) {
    var _a
    const snippets =
      ((_a = config.cache) === null || _a === void 0 ? void 0 : _a.stylesheetSnippets) ||
      convertSnippets(config.snippets)
    const result = []
    if (config.cache) {
      ...
      if (expandedAbbr && expandedText.length) {
        ...
        if (
          !completionItems.find(
            (x) =>
              x.insertText === (expandedAbbr === null || expandedAbbr === void 0 ? void 0 : expandedAbbr.insertText),
          )
        ) {
