...
var ValidationResult =
    ...
    (function () {
        ...
        ValidationResult3.prototype.mergeEnumValues = function (
            validationResult
        ) {
            if (
                !this.enumValueMatch &&
        ...
        ValidationResult3.prototype.mergePropertyMatch = function (
        ...
        ValidationResult3.prototype.compare = function (other) {
            ...
            if (this.propertiesValueMatches !== other.propertiesValueMatches) {
                return (
                    this.propertiesValueMatches - other.propertiesValueMatches
                );
            }
...
var JSONDocument =
    ...
    (function () {
        ...
        JSONDocument3.prototype.getNodeFromOffset = function (
            offset,
            includeRightBound
        ) {
            if (includeRightBound === void 0) {
        ...
        JSONDocument3.prototype.validate = function (
            textDocument,
            schema,
            severity
        ) {
                ...
                return validationResult.problems.map(function (p) {
                    ...
                    var range = Range.create(
                        ...
                        textDocument.positionAt(
                            p.location.offset + p.location.length
                        )
                    );
                    return Diagnostic.create(
                        range,
                        p.message,
                        (_a = p.severity) !== null && _a !== void 0
                            ? _a
                            : severity,
                        p.code
                    );
        ...
        JSONDocument3.prototype.getMatchingSchemas = function (
            schema,
            focusOffset,
            exclude
        ) {
                ...
                if (!bestMatch) {
                    ...
                    if (
                        ...
                        if (compareResult > 0) {
                            ...
                            bestMatch.matchingSchemas.merge(
                                subMatchingSchemas2
                            );
            ...
            if (Number.isInteger(schema2.multipleOf)) {
                ...
                if (normMultipleOf && normValue) {
                    var multiplier = Math.pow(
                        10,
                        Math.abs(
                            normValue.multiplier - normMultipleOf.multiplier
                        )
                    );
        ...
        if (Array.isArray(schema2.items)) {
            ...
            if (node2.items.length > subSchemas.length) {
                if (typeof schema2.additionalItems === "object") {
                    for (
                        var i = subSchemas.length;
                        i < node2.items.length;
                        i++
                    ) {
                        var itemValidationResult = new ValidationResult();
                        validate(
...
var ResolvedSchema =
    ...
    (function () {
        ...
        ResolvedSchema2.prototype.getSectionRecursive = function (
            path5,
            schema
        ) {
...
var JSONSchemaService =
    ...
    (function () {
        ...
        JSONSchemaService2.prototype.getRegisteredSchemaIds = function (
            filter
        ) {
            return Object.keys(this.registeredSchemasIds).filter(function (id) {
                var scheme = URI.parse(id).scheme;
                return (
                    scheme !== "schemaservice" && (!filter || filter(scheme))
                );
            });
        };
        ...
        JSONSchemaService2.prototype.setSchemaContributions = function (
            ...
            if (schemaContributions.schemas) {
                ...
                for (var id in schemas) {
                    ...
                    this.contributionSchemas[normalizedId] =
                        this.addSchemaHandle(normalizedId, schemas[id]);
                }
            }
            ...
            return this.requestService(url).then(
                ...
                function (error) {
                    ...
                    if (endsWith(errorMessage2, ".")) {
                        errorMessage2 = errorMessage2.substr(
                            0,
                            errorMessage2.length - 1
                        );
                    }
        ...
        JSONSchemaService2.prototype.resolveSchemaContent = function (
            ...
            var merge = function (target, sourceRoot, sourceURI, refSegment) {
                var path5 = refSegment
                    ? decodeURIComponent(refSegment)
                    : void 0;
            ...
            var resolveExternalLink = function (
                ...
                if (
                    ...
                    uri = contextService.resolveRelativePath(
                        uri,
                        parentSchemaURL
                    );
                }
            ...
            var resolveRefs = function (
                ...
                var handleRef = function (next2) {
                    ...
                    collectEntries(
                        next2.items,
                        next2.additionalItems,
                        next2.additionalProperties,
                        next2.not,
                        next2.contains,
                        next2.propertyNames,
                        next2.if,
        ...
        JSONSchemaService2.prototype.getSchemaForResource = function (
            ...
            if (document && document.root && document.root.type === "object") {
                var schemaProperties = document.root.properties.filter(
                    function (p) {
                        return (
                ...
                if (schemaProperties.length > 0) {
                    ...
                    if (valueNode && valueNode.type === "string") {
                        ...
                        if (schemeId) {
                            ...
                            return this.getOrAddSchemaHandle(
                                id
                            ).getResolvedSchema();
                        }
                    }
...
function getSchemaTypeName(schema) {
    ...
    return Array.isArray(schema.type)
        ...
        : schema.type || schema.closestTitle;
}
...
function getSchemaTitle(schema, url) {
    ...
    if (Object.getOwnPropertyDescriptor(schema, "name")) {
        return (
            Object.getOwnPropertyDescriptor(schema, "name").value +
            ` (${baseName})`
        );
    } else if (schema.title) {
        return schema.description
            ? schema.title + " - " + schema.description + ` (${baseName})`
...
var JSONValidation =
    ...
    (function () {
        ...
        JSONValidation2.prototype.doValidation = function (
            ...
            if (schema) {
                var id =
                    schema.id || "schemaservice://untitled/" + idCounter2++;
            ...
            if (
                ...
                if (root.type === "array") {
                    ...
                    for (var _i = 0, _a = root.items; _i < _a.length; _i++) {
                        ...
                        if (item.type === "object") {
                            for (
                                var _b = 0, _c = item.properties;
                                _b < _c.length;
                                _b++
                            ) {
                                var property = _c[_b];
                                if (
                                    property.keyNode.value === "key" &&
                                    property.valueNode
                                ) {
                                    ...
                                    result_1.push({
                                        name: getNodeValue2(property.valueNode),
                        ...
                        for (
                            ...
                            if (
                                ...
                                if (!visitedNode[nodeId]) {
                                    var color = colorFromHex(
                                        getNodeValue2(s.node)
                                    );
                                    if (color) {
    ...
    if (typeof schema !== "object") {
        console.warn(
            `Wrong schema: ${JSON.stringify(
                schema
            )}, it MUST be an Object or Boolean`
        );
        schema = {
            type: schema,
        };
...
var ValidationResult2 = class {
    ...
    mergeWarningGeneric(subValidationResult, problemTypesToMerge) {
        ...
        if ((_a = this.problems) == null ? void 0 : _a.length) {
            for (const problemType of problemTypesToMerge) {
                const bestResults = this.problems.filter(
                    (p) => p.problemType === problemType
                );
                for (const bestResult of bestResults) {
                    const mergingResult =
                        (_b = subValidationResult.problems) == null
                            ? void 0
                            : _b.find(
                                  (p) =>
                                      p.problemType === problemType &&
                                      bestResult.location.offset ===
                                          p.location.offset &&
                                      (problemType !==
                    ...
                    if (mergingResult) {
                        if (
                            (_c = mergingResult.problemArgs) == null
                                ? void 0
                                : _c.length
                        ) {
                            mergingResult.problemArgs
                                .filter(
                                    (p) => !bestResult.problemArgs.includes(p)
                                )
                                .forEach((p) => bestResult.problemArgs.push(p));
                            bestResult.message = getWarningMessage(
                                bestResult.problemType,
                                bestResult.problemArgs
                            );
                        }
    ...
    mergeSources(mergingResult, bestResult) {
        const mergingSource = mergingResult.source.replace(
            YAML_SCHEMA_PREFIX,
            ""
        );
        ...
        if (!bestResult.schemaUri.includes(mergingResult.schemaUri[0])) {
            bestResult.schemaUri = bestResult.schemaUri.concat(
                mergingResult.schemaUri
            );
        }
    }
    ...
    validate(textDocument, schema) {
        if (this.root && schema) {
            ...
            return validationResult.problems.map((p) => {
                const range = Range2.create(
                    textDocument.positionAt(p.location.offset),
                    textDocument.positionAt(
                        p.location.offset + p.location.length
                    )
                );
                const diagnostic = Diagnostic2.create(
                    range,
                    p.message,
                    p.severity,
    ...
    getMatchingSchemas(
        ...
        if (this.root && schema) {
            validate2(
                ...
                schema,
                schema,
                new ValidationResult2(this.isKubernetes),
                matchingSchemas,
                {
                    isKubernetes: this.isKubernetes,
                    disableAdditionalProperties:
...
function validate2(
    ...
    function _validateNode() {
        ...
        if (Array.isArray(schema.type)) {
            ...
            if (!matchesType(schema.type)) {
                ...
                validationResult.problems.push({
                    ...
                    message:
                        schema.errorMessage ||
                        getWarningMessage(ProblemType.typeMismatchWarning, [
                            schemaType,
                        ]),
                    source: getSchemaSource(schema, originalSchema),
                    schemaUri: getSchemaUri(schema, originalSchema),
        ...
        const testAlternatives = (alternatives, maxOneMatch) => {
            ...
            if (
                subMatches.length > 1 &&
                (subMatches.length > 1 || noPropertyMatches.length === 0) &&
                maxOneMatch
            ) {
                validationResult.problems.push({
                    location: { offset: node.offset, length: 1 },
            ...
            if (bestMatch !== null) {
                ...
                validationResult.enumValueMatch =
                    validationResult.enumValueMatch ||
                    bestMatch.validationResult.enumValueMatch;
                if (
                    (_a = bestMatch.validationResult.enumValues) == null
                        ? void 0
                        : _a.length
                ) {
                    validationResult.enumValues = (
                        validationResult.enumValues || []
                    ).concat(bestMatch.validationResult.enumValues);
                }
                matchingSchemas.merge(bestMatch.matchingSchemas);
            }
            return matches.length;
        ...
        const testCondition = (
            ...
            if (filePatternAssociation) {
                const association = new FilePatternAssociation2(
        ...
        if (ifSchema) {
            testCondition(
                ifSchema,
                schema,
                asSchema2(schema.then),
                asSchema2(schema.else)
            );
        }
        if (Array.isArray(schema.enum)) {
            ...
            for (const e of schema.enum) {
                if (
                    val === e ||
                    isAutoCompleteEqualMaybe(callFromAutoComplete, node, val, e)
                ) {
                    enumValueMatch = true;
                    break;
                }
        ...
        if (isDefined2(schema.const)) {
            const val = getNodeValue3(node);
            if (
                !equals2(val, schema.const) &&
                !isAutoCompleteEqualMaybe(
                    callFromAutoComplete,
                    node,
                    val,
                    schema.const
                ...
                validationResult.problems.push({
                    ...
                    message:
                        schema.errorMessage ||
                        getWarningMessage(ProblemType.constWarning, [
                            JSON.stringify(schema.const),
                        ]),
                    source: getSchemaSource(schema, originalSchema),
                    schemaUri: getSchemaUri(schema, originalSchema),
                ...
                case "ipv6":
                    {
                        ...
                        if (
                            !node2.value ||
                            !format2.pattern.test(node2.value)
                        ) {
                            validationResult2.problems.push({
                                location: {
                                    offset: node2.offset,
    ...
    function _validateArrayNode(
        ...
        if (Array.isArray(schema2.items)) {
            ...
            for (let index = 0; index < subSchemas.length; index++) {
                ...
                const subSchema = asSchema2(subSchemaRef);
                const itemValidationResult = new ValidationResult2(
                    isKubernetes
                );
    ...
    function _validateObjectNode(
                ...
                switch (propertyNode.valueNode.type) {
                    case "object": {
                        unprocessedNodes.push(
                            ...propertyNode.valueNode["properties"]
                        );
                        break;
                    }
                    case "array": {
                        propertyNode.valueNode["items"].forEach(
                            (sequenceNode) => {
                                if (
                                    sequenceNode &&
                                    isIterable(sequenceNode["properties"])
                                ) {
                                    unprocessedNodes.push(
                    ...
                    if (isBoolean2(propertySchema)) {
                        ...
                        propertySchema.url =
                            (_a = schema2.url) != null
                                ? _a
                                : originalSchema.url;
                        const propertyValidationResult = new ValidationResult2(
                            isKubernetes
                        );
                        validate2(
                            child,
                        ...
                        validationResult2.mergeEnumValues(
                            propertyValidationResult
                        );
                    }
                }
                        ...
                        if (child) {
                            ...
                            if (isBoolean2(propertySchema)) {
                                ...
                                const propertyValidationResult =
                                    new ValidationResult2(isKubernetes);
                                validate2(
                                    child,
                                    propertySchema,
                                    schema2,
        ...
        if (typeof schema2.additionalProperties === "object") {
            ...
            (schema2.type === "object" &&
                schema2.additionalProperties === void 0 &&
        ...
        if (
            ...
            if (
                ...
                (compareResult === 0 &&
                    ...
                    node2.type !== "null" &&
                    node2.type !== bestMatch.schema.type)
            ) {
                bestMatch = {
                    schema: subSchema,
                    validationResult: subValidationResult,
                ...
                compareResult === 0 ||
                ((node2.value === null || node2.type === "null") &&
                    node2.length === 0)
            ) {
                mergeValidationMatches(
                    bestMatch,
                    subMatchingSchemas,
                    subValidationResult
                );
...
function getSchemaSource(schema, originalSchema) {
    ...
    if (schema) {
        ...
        if (schema.title) {
            ...
            const uriString =
                (_a = schema.url) != null ? _a : originalSchema.url;
            if (uriString) {
...
function getWarningMessage(problemType, args) {
    return localize5(
        problemType,
        ProblemTypeMessages[problemType],
        args.join(" | ")
    );
}
function isAutoCompleteEqualMaybe(
    ...
    return (
        isString2(nodeValue) &&
        isString2(schemaValue) &&
        schemaValue.startsWith(nodeValue)
    );
}
...
function convertMap(node, parent, doc, lineCounter) {
    ...
    const result = new ObjectASTNodeImpl2(
        parent,
        node,
        ...toFixedOffsetLength(range, lineCounter)
    );
...
function convertPair(node, parent, doc, lineCounter) {
    ...
    const result = new PropertyASTNodeImpl2(
        parent,
        node,
        ...toFixedOffsetLength([rangeStart, rangeEnd, nodeEnd], lineCounter)
    );
    if (isAlias(keyNode)) {
        const keyAlias = new StringASTNodeImpl2(
            parent,
            keyNode,
            ...toOffsetLength(keyNode.range)
        );
...
function convertSeq(node, parent, doc, lineCounter) {
    const result = new ArrayASTNodeImpl2(
        parent,
        node,
        ...toOffsetLength(node.range)
    );
    for (const it of node.items) {
        if (isNode(it)) {
...
function convertScalar(node, parent) {
    ...
    switch (typeof node.value) {
        case "string": {
            const result = new StringASTNodeImpl2(
                parent,
                node,
                ...toOffsetLength(node.range)
            );
        ...
        case "boolean":
            return new BooleanASTNodeImpl2(
                parent,
                node,
                node.value,
                node.source,
        ...
        case "number": {
            const result = new NumberASTNodeImpl2(
                parent,
                node,
                ...toOffsetLength(node.range)
            );
...
function convertAlias(node, parent, doc, lineCounter) {
    ...
    if (resolvedNode) {
        ...
        const resultNode = new StringASTNodeImpl2(
            parent,
            node,
            ...toOffsetLength(node.range)
        );
...
function toFixedOffsetLength(range, lineCounter) {
    ...
    if (
        start.line !== end.line &&
        (lineCounter.lineStarts.length !== end.line || end.col === 1)
    ) {
        result[1]--;
    }
    return result;
        ...
        if (token.type === "document") {
            _visit([], token, (item) => {
                ...
                if (
                    ...
                    ((_a = item.value) == null ? void 0 : _a.type) === "comment"
                ) {
                    if (
                        token.offset <= offset &&
                        item.value.source.length + item.value.offset >= offset
                    ) {
                        inComment = true;
                        return visit.BREAK;
                    }
                    ...
                    item.type === "comment" &&
                    item.offset <= offset &&
                    item.offset + item.source.length >= offset
                ) {
                    inComment = true;
                    return visit.BREAK;
                }
            ...
            if (
                token.offset <= offset &&
                token.source.length + token.offset >= offset
            ) {
                return true;
            }
        }
...
var SingleYAMLDocument = class _SingleYAMLDocument extends JSONDocument2 {
    ...
    updateFromInternalDocument() {
        this.root = convertAST(
            null,
            this._internalDocument.contents,
    ...
    get warnings() {
        return this.internalDocument.warnings.map(
            YAMLErrorToYamlDocDiagnostics
        );
    }
    getNodeFromPosition(positionOffset, textBuffer, configuredIndentation) {
        ...
        const countOfSpacesAfterPosition =
            spacesAfterPositionMatch == null
                ? void 0
                : spacesAfterPositionMatch[1].length;
        let closestNode;
    ...
    getProperParentByIndentation(
        ...
        configuredIndentation = !configuredIndentation
            ? 2
            : configuredIndentation;
...
var YamlDocuments = class {
    ...
    getYamlDocument(document, parserOptions, addRootObject = false) {
        this.ensureCache(
            document,
            parserOptions != null ? parserOptions : defaultOptions,
            addRootObject
        );
    ...
    ensureCache(document, parserOptions, addRootObject) {
        ...
        if (
            ...
            (parserOptions.customTags &&
                !isArrayEqual(
                    cacheEntry.parserOptions.customTags,
                    parserOptions.customTags
                ))
        ) {
...
var TextBuffer = class {
    ...
    getLineCharCode(lineNumber, index) {
        return this.doc
            .getText(
                Range3.create(lineNumber - 1, index, lineNumber - 1, index + 1)
            )
            .charCodeAt(0);
    }
    getText(range) {
...
function parse2(text, parserOptions = defaultOptions, document) {
    ...
    const options = {
        ...
        version:
            (_a = parserOptions.yamlVersion) != null
                ? _a
                : defaultOptions.yamlVersion,
    ...
    const yamlDocs = Array.from(docs, (doc) =>
...
function getSchemaFromModeline(doc) {
    if (doc instanceof SingleYAMLDocument) {
        const yamlLanguageServerModeline = doc.lineComments.find(
            (lineComment) => {
        ...
        if (yamlLanguageServerModeline != void 0) {
            const schemaMatchs =
                yamlLanguageServerModeline.match(/\$schema=\S+/g);
...
(function (MODIFICATION_ACTIONS2) {
    ...
    MODIFICATION_ACTIONS2[(MODIFICATION_ACTIONS2["deleteAll"] = 2)] =
        "deleteAll";
...
var YAMLSchemaService = class extends JSONSchemaService {
        ...
        for (const filePattern of this.filePatternAssociations) {
            ...
            if (this.schemaUriToNameAndDescription.has(schemaUri)) {
                const { name, description, versions } =
                    this.schemaUriToNameAndDescription.get(schemaUri);
    ...
    async resolveSchemaContent(schemaToResolve, schemaURL, dependencies) {
        ...
        if (!schema07Validator(schema)) {
            ...
            resolveErrors.push(`Schema '${getSchemaTitle(
...
${errs.join("\n")}`);
    ...
    getSchemaForResource(resource, doc) {
        const resolveModelineSchema = () => {
            ...
            if (schemaFromModeline !== void 0) {
                if (
                    !schemaFromModeline.startsWith("file:") &&
                    !schemaFromModeline.startsWith("http")
                ) {
                    let appendix = "";
                    ...
                    if (!path2.isAbsolute(schemaFromModeline)) {
                        ...
                        schemaFromModeline = URI4.file(
                            path2.resolve(
                                path2.parse(resUri.fsPath).dir,
                                schemaFromModeline
                            )
                        ).toString();
                    } else {
                        schemaFromModeline =
                            URI4.file(schemaFromModeline).toString();
                    }
            ...
            return this.customSchemaProvider(resource)
                .then((schemaUri) => {
                    if (Array.isArray(schemaUri)) {
                        ...
                        return Promise.all(
                            schemaUri.map((schemaUri2) => {
                                return this.resolveCustomSchema(
                                    schemaUri2,
                                    doc
                                );
                            })
    ...
    addSchemaPriority(uri, priority) {
        ...
        if (currSchemaArray) {
            ...
            this.schemaPriorityMapping.set(
                uri,
                /* @__PURE__ */ new Set().add(priority)
            );
        }
    }
    /**
    ...
    async resolveCustomSchema(schemaUri, doc) {
        ...
        const schema = await this.resolveSchemaContent(
            unresolvedSchema,
            schemaUri,
            []
        );
    ...
    async saveSchema(schemaId, schemaContent) {
        ...
        this.schemaPriorityMapping.set(
            id,
            /* @__PURE__ */ new Set().add(SchemaPriority.Settings)
        );
    ...
    async addContent(additions) {
        ...
        if (schema) {
            const resolvedSchemaLocation = this.resolveJSONSchemaToSection(
                schema.schema,
                additions.path
            );
    ...
    loadSchema(schemaUri) {
        ...
        return super.loadSchema(schemaUri).then((unresolvedJsonSchema) => {
            if (
                ...
                unresolvedJsonSchema.schema === void 0
            ) {
                return requestService(schemaUri).then(
                    (content) => {
                        if (!content) {
                            const errorMessage = localize6(
                                "json.schema.nocontent",
                                "Unable to load schema from '{0}': No content. {1}",
                                toDisplayString2(schemaUri),
                                unresolvedJsonSchema.errors
                            );
            ...
            if (this.schemaUriToNameAndDescription.has(schemaUri)) {
                const { name, description, versions } =
                    this.schemaUriToNameAndDescription.get(schemaUri);
                unresolvedJsonSchema.schema.title =
                    name != null ? name : unresolvedJsonSchema.schema.title;
                unresolvedJsonSchema.schema.description =
                    description != null
                        ? description
                        : unresolvedJsonSchema.schema.description;
                unresolvedJsonSchema.schema.versions =
                    versions != null
                        ? versions
                        : unresolvedJsonSchema.schema.versions;
            }
    ...
    registerExternalSchema(
        ...
        return super.registerExternalSchema(
            uri,
            filePatterns,
            unresolvedSchema
        );
...
var YAMLDocumentSymbols = class {
    ...
    findDocumentSymbols(document, context = { resultLimit: Number.MAX_VALUE }) {
        ...
        try {
            ...
            for (const yamlDoc of doc["documents"]) {
                if (yamlDoc.root) {
                    results = results.concat(
                        this.jsonDocumentSymbols.findDocumentSymbols(
                            document,
                            yamlDoc,
                            context
                        )
            ...
            (_a = this.telemetry) == null
                ? void 0
                : _a.sendError("yaml.documentSymbols.error", err);
        }
        return results;
    }
    findHierarchicalDocumentSymbols(
        ...
        try {
            ...
            for (const yamlDoc of doc["documents"]) {
                if (yamlDoc.root) {
                    results = results.concat(
                        this.jsonDocumentSymbols.findDocumentSymbols2(
                            document,
                            yamlDoc,
                            context
                        )
            ...
            (_a = this.telemetry) == null
                ? void 0
                : _a.sendError("yaml.hierarchicalDocumentSymbols.error", err);
        }
        return results;
    }
};
...
var YAMLHover = class {
    ...
    doHover(document, position, isKubernetes = false) {
        ...
        try {
            ...
            (_a = this.telemetry) == null
                ? void 0
                : _a.sendError("yaml.hover.error", error);
        }
    }
    ...
    getHover(document, position, doc) {
        ...
        const hoverRange = Range4.create(
                    ...
                    matchingSchemas.every((s) => {
                        if (
                            ...
                            title =
                                title ||
                                s.schema.title ||
                                s.schema.closestTitle;
                            markdownDescription =
                                markdownDescription ||
                                s.schema.markdownDescription ||
                                this.toMarkdown(s.schema.description);
                            if (s.schema.enum) {
                                ...
                                s.schema.enum.forEach((enumValue, idx) => {
                                    ...
                                    if (
                                        !markdownEnums.some(
                                            (me) => me.value === enumValue
                                        )
                                    ) {
                                        markdownEnums.push({
                                            value: enumValue,
                                            description:
                                                markdownEnumDescriptions[idx],
                                        });
                                    }
                                });
                            }
                            if (
                                ...
                                s.schema.anyOf.forEach((childSchema, index) => {
                                    title +=
                                        ...
                                        "";
                                    markdownDescription +=
                                        childSchema.markdownDescription ||
                                        this.toMarkdown(
...
`;
                    ...
                    if (result.length > 0 && schema.schema.url) {
                        result = ensureLineBreak(result);
                        result += `Source: [${getSchemaName(schema.schema)}](${
                            schema.schema.url
                        })`;
                    }
    ...
    toMarkdown(plain) {
        if (plain) {
            ...
            if (this.indentation !== void 0) {
                const indentationMatchRegex = new RegExp(
        ...
        if (node === matchSchema.node && matchSchema.schema !== schema) {
            schema.anyOf.forEach((childSchema) => {
                if (
                    ...
                    matchSchema.schema.description ===
                        childSchema.description &&
    ...
    validate(document, yamlDoc) {
        ...
        for (const anchor of anchors) {
            if (!usedAnchors.has(anchor)) {
                const aToken = this.getAnchorNode(
                    anchorParent.get(anchor),
                    anchor
                );
                if (aToken) {
                    const range = Range5.create(
                        document.positionAt(aToken.offset),
                        document.positionAt(
                            aToken.offset + aToken.source.length
                        )
                    );
                    const warningDiagnostic = Diagnostic3.create(
                        range,
                        `Unused anchor "${aToken.source}"`,
                        DiagnosticSeverity3.Hint,
                        0
                    );
...
import {
    Diagnostic as Diagnostic4,
    DiagnosticSeverity as DiagnosticSeverity4,
    Range as Range6,
} from "vscode-languageserver-types";
...
var YAMLStyleValidator = class {
    ...
    validate(document, yamlDoc) {
        ...
        visit4(yamlDoc.internalDocument, (key, node) => {
            ...
            if (
                this.forbidMapping &&
                isMap4(node) &&
                ((_a = node.srcToken) == null ? void 0 : _a.type) ===
                    "flow-collection"
            ) {
                result.push(
                    Diagnostic4.create(
            ...
            if (
                this.forbidSequence &&
                isSeq4(node) &&
                ((_b = node.srcToken) == null ? void 0 : _b.type) ===
                    "flow-collection"
            ) {
                result.push(
                    Diagnostic4.create(
    ...
    getRangeOf(document, node) {
        return Range6.create(
            document.positionAt(node.start.offset),
            document.positionAt(node.end.pop().offset)
        );
    }
};
...
import {
    Diagnostic as Diagnostic5,
    DiagnosticSeverity as DiagnosticSeverity5,
    Range as Range7,
} from "vscode-languageserver-types";
                ...
                for (let i = 1; i < node.items.length; i++) {
                    if (compare(node.items[i - 1], node.items[i]) > 0) {
                        ...
                        result.push(
                            Diagnostic5.create(
                                range,
                                `Wrong ordering of key "${
                                    node.items[i - 1].key
                                }" in mapping`,
                                DiagnosticSeverity5.Error,
                                "mapKeyOrder"
                            )
                        );
                    }
...
function createRange2(document, node) {
    ...
    const start =
        (_f =
            (_c =
                (_a = node == null ? void 0 : node.srcToken.start[0]) == null
                    ? void 0
                    : _a.offset) != null
                ? _c
                : (_b = node == null ? void 0 : node.srcToken) == null
                ? void 0
                : _b.key.offset) != null
            ? _f
            : (_e =
                  (_d = node == null ? void 0 : node.srcToken) == null
                      ? void 0
                      : _d.sep[0]) == null
            ? void 0
            : _e.offset;
    const end =
        ((_g = node == null ? void 0 : node.srcToken) == null
            ? void 0
            : _g.value.offset) ||
        ((_i =
            (_h = node == null ? void 0 : node.srcToken) == null
                ? void 0
                : _h.sep[0]) == null
            ? void 0
            : _i.offset) ||
        ((_j = node == null ? void 0 : node.srcToken) == null
            ? void 0
            : _j.key.offset) ||
        ((_k =
            node == null
                ? void 0
                : node.srcToken.start[node.srcToken.start.length - 1]) == null
            ? void 0
            : _k.offset);
...
var yamlDiagToLSDiag = (yamlDiag, textDocument) => {
    ...
    const range = {
        start,
            ...
            ? Position2.create(
                  start.line,
                  new TextBuffer(textDocument).getLineLength(start.line)
              )
            : textDocument.positionAt(yamlDiag.location.end),
    };
    return Diagnostic6.create(
        range,
        yamlDiag.message,
        yamlDiag.severity,
        yamlDiag.code,
...
var YAMLValidation = class {
    ...
    configure(settings) {
        ...
        if (settings) {
            ...
            this.disableAdditionalProperties =
                settings.disableAdditionalProperties;
            this.yamlVersion = settings.yamlVersion;
            if (
                settings.flowMapping === "forbid" ||
                settings.flowSequence === "forbid"
            ) {
    ...
    async doValidation(textDocument, isKubernetes = false) {
        ...
        try {
            ...
            for (const currentYAMLDoc of yamlDocument.documents) {
                ...
                currentYAMLDoc.disableAdditionalProperties =
                    this.disableAdditionalProperties;
            ...
            (_a = this.telemetry) == null
                ? void 0
                : _a.sendError("yaml.validation.error", err);
        }
        let previousErr;
        ...
        for (let err of validationResult) {
            ...
            if (
                ...
                Math.abs(
                    previousErr.range.end.character - err.range.end.character
                ) >= 1
            ) {
...
var YamlLinks = class {
    ...
    findLinks(document) {
        ...
        try {
            ...
            return Promise.all(linkPromises).then((yamlLinkArray) =>
                [].concat(...yamlLinkArray)
            );
        } catch (err) {
            (_a = this.telemetry) == null
                ? void 0
                : _a.sendError("yaml.documentLink.error", err);
        }
    }
};
...
function getFoldingRanges(document, context) {
    ...
    for (const ymlDoc of doc.documents) {
        ...
        ymlDoc.visit((node) => {
            ...
            if (
                node.type === "object" &&
                ((_a = node.parent) == null ? void 0 : _a.type) === "array"
            ) {
            ...
            if (node.type === "property" && node.valueNode) {
                switch (node.valueNode.type) {
                    ...
                    case "string": {
                        ...
                        const valuePosn = document.positionAt(
                            node.valueNode.offset + node.valueNode.length
                        );
                        if (nodePosn.line !== valuePosn.line) {
                            result.push(
                                createNormalizedFolding(document, node)
                            );
                        }
                        break;
                    }
...
var FlowStyleRewriter = class {
    ...
    write(node) {
        ...
        const blockType =
            collection.start.type === "flow-map-start"
                ? "block-map"
                : "block-seq";
...
var YamlCodeActions = class {
    ...
    getCodeAction(document, params) {
        ...
        const result = [];
        result.push(
            ...this.getConvertToBooleanActions(
        ...
        result.push(
            ...this.getTabToSpaceConverting(
                params.context.diagnostics,
                document
            )
        );
        result.push(
            ...this.getUnusedAnchorsDelete(params.context.diagnostics, document)
        );
        result.push(
            ...this.getConvertToBlockStyleActions(
                params.context.diagnostics,
                document
            )
        );
        result.push(
            ...this.getKeyOrderActions(params.context.diagnostics, document)
        );
        result.push(
            ...this.getQuickFixForPropertyOrValueMismatch(
                params.context.diagnostics,
                document
            )
        );
    ...
    getJumpToSchemaActions(diagnostics) {
        var _a, _b, _c, _d, _e;
        const isOpenTextDocumentEnabled =
            (_d =
                (_c =
                    (_b =
                        (_a = this.clientCapabilities) == null
                            ? void 0
                            : _a.window) == null
                        ? void 0
                        : _b.showDocument) == null
                    ? void 0
                    : _c.support) != null
                ? _d
                : false;
        ...
        for (const diagnostic of diagnostics) {
            const schemaUri =
                ((_e = diagnostic.data) == null ? void 0 : _e.schemaUri) || [];
        ...
        for (const schemaUri of schemaUriToDiagnostic.keys()) {
            const action = CodeAction2.create(
                `Jump to schema location (${path4.basename(schemaUri)})`,
                Command2.create(
                    "JumpToSchema",
    ...
    getTabToSpaceConverting(diagnostics, document) {
        ...
        for (const diag of diagnostics) {
            if (
                diag.message === "Using tabs can lead to unpredictable results"
            ) {
                if (processedLine.includes(diag.range.start.line)) {
                    continue;
                }
                const lineContent = textBuff.getLineContent(
                    diag.range.start.line
                );
                let replacedTabs = 0;
                let newText = "";
                for (
                    let i = diag.range.start.character;
                    i <= diag.range.end.character;
                    i++
                ) {
                ...
                if (
                    ...
                    resultRange = Range10.create(
                        diag.range.start,
                        Position4.create(
                            diag.range.end.line,
                            diag.range.start.character + replacedTabs
                        )
                    );
                }
                result.push(
                    CodeAction2.create(
                        ...
                        createWorkspaceEdit(document.uri, [
                            TextEdit3.replace(resultRange, newText),
                        ]),
        ...
        if (result.length !== 0) {
            ...
            for (let i = 0; i <= textBuff.getLineCount(); i++) {
                ...
                for (let j = 0; j < lineContent.length; j++) {
                    ...
                    if (char !== " " && char !== "	") {
                        if (replacedTabs !== 0) {
                            replaceEdits.push(
                                TextEdit3.replace(
                                    Range10.create(i, j - replacedTabs, i, j),
                                    newText
                                )
                            );
                            replacedTabs = 0;
                ...
                if (replacedTabs !== 0) {
                    replaceEdits.push(
                        TextEdit3.replace(
                            Range10.create(i, 0, i, textBuff.getLineLength(i)),
                            newText
                        )
                    );
                }
    ...
    getUnusedAnchorsDelete(diagnostics, document) {
        ...
        for (const diag of diagnostics) {
            if (
                diag.message.startsWith("Unused anchor") &&
                diag.source === YAML_SOURCE
            ) {
                ...
                const lastWhitespaceChar =
                    getFirstNonWhitespaceCharacterAfterOffset(
                        lineContent,
                        range.end.character
                    );
                ...
                const action = CodeAction2.create(
                    ...
                    createWorkspaceEdit(document.uri, [TextEdit3.del(range)]),
                    CodeActionKind2.QuickFix
                );
                ...
                if (
                    ...
                    results.push(
                        CodeAction2.create(
                            "Convert to boolean",
                            createWorkspaceEdit(document.uri, [
                                TextEdit3.replace(diagnostic.range, newValue),
                            ]),
                            CodeActionKind2.QuickFix
                        )
                    );
    ...
    getKeyOrderActions(diagnostics, document) {
        ...
        for (const diagnostic of diagnostics) {
            if (
                (diagnostic == null ? void 0 : diagnostic.code) ===
                "mapKeyOrder"
            ) {
                ...
                if (node && isMap6(node.internalNode)) {
                    ...
                    if (
                        (sorted.srcToken.type === "block-map" ||
                            sorted.srcToken.type === "flow-collection") &&
                        (node.internalNode.srcToken.type === "block-map" ||
                            node.internalNode.srcToken.type ===
                                "flow-collection")
                    ) {
                        sorted.srcToken.items.sort((a2, b) => {
                            if (
                                a2.key &&
                                b.key &&
                                CST3.isScalar(a2.key) &&
                                CST3.isScalar(b.key)
                            ) {
                                return a2.key.source.localeCompare(
                                    b.key.source
                                );
                            }
                            if (!a2.key && b.key) {
                        ...
                        for (let i = 0; i < sorted.srcToken.items.length; i++) {
                            ...
                            if (
                                ...
                                ((_c = item.value) == null
                                    ? void 0
                                    : _c.type) === "single-quoted-scalar" ||
                                ((_d = item.value) == null
                                    ? void 0
                                    : _d.type) === "double-quoted-scalar"
                            ) {
                                const newLineIndex =
                                    (_g =
                                        (_f =
                                ...
                                ((_n = item.value) == null
                                    ? void 0
                                    : _n.type) === "block-scalar"
                            ) {
                                const newline = item.value.props.find(
                                    (p) => p.type === "newline"
                                );
                                if (!newline) {
                    ...
                    const replaceRange = Range10.create(
                        document.positionAt(node.offset),
                        document.positionAt(node.offset + node.length)
                    );
                    results.push(
                        CodeAction2.create(
                            ...
                            createWorkspaceEdit(document.uri, [
                                TextEdit3.replace(
                                    replaceRange,
                                    CST3.stringify(sorted.srcToken)
                                ),
                            ]),
                            CodeActionKind2.QuickFix
                        )
            ...
            for (const value of values) {
                results.push(
                    CodeAction2.create(
                        value,
                        createWorkspaceEdit(document.uri, [
                            TextEdit3.replace(diagnostic.range, value),
                        ]),
                        CodeActionKind2.QuickFix
                    )
                );
...
function doDocumentOnTypeFormatting(document, params) {
    ...
    if (params.ch === "\n") {
        ...
        if (previousLine.trimRight().endsWith(":")) {
            ...
            const subLine = currentLine.substring(
                position.character,
                currentLine.length
            );
            const isInArray = previousLine.indexOf(" - ") !== -1;
            if (subLine.trimRight().length === 0) {
                const indentationFix =
                    position.character -
                    (previousLine.length - previousLine.trimLeft().length);
        ...
        if (previousLine.trimRight().endsWith("|")) {
            return [
                TextEdit4.insert(position, " ".repeat(params.options.tabSize)),
            ];
        }
...
function addInnerSchemaUrls(schemas, result) {
    for (const subSchema of schemas) {
        if (
            !isBoolean2(subSchema) &&
            subSchema.url &&
            !result.has(subSchema.url)
        ) {
        ...
        try {
            ...
            for (const currentYAMLDoc of yamlDocument.documents) {
                ...
                if (schema == null ? void 0 : schema.schema) {
                    schemaUrls = new Map([
                        ...getSchemaUrls(
                            schema == null ? void 0 : schema.schema
                        ),
                        ...schemaUrls,
                    ]);
                }
            ...
            (_a = this.telemetry) == null
                ? void 0
                : _a.sendError("yaml.codeLens.error", err);
        }
        return result;
    }
...
import {
    ...
    InsertTextMode,
    MarkupKind as MarkupKind3,
    Position as Position6,
    Range as Range13,
    TextEdit as TextEdit5,
} from "vscode-languageserver-types";
import {
    isPair as isPair3,
    isScalar as isScalar5,
    isMap as isMap7,
    isSeq as isSeq6,
    isNode as isNode4,
} from "yaml";
...
function spacesDiff(a2, aLength, b, bLength, result) {
    ...
    if (tabsDiff === 0) {
        ...
        if (
            spacesDiff2 > 0 &&
            0 <= bSpacesCnt - 1 &&
            bSpacesCnt - 1 < a2.length &&
            bSpacesCnt < b.length
        ) {
            if (
                b.charCodeAt(bSpacesCnt) !== 32 &&
                a2.charCodeAt(bSpacesCnt - 1) === 32
            ) {
...
function stringifyObject(
    ...
    if (obj !== null && typeof obj === "object") {
        const newIndent =
            (depth === 0 && settings.shouldIndentWithTab) || depth > 0
        ...
        if (Array.isArray(obj)) {
            ...
            let result =
                (depth === 0 && settings.newLineFirst) || depth > 0 ? "\n" : "";
            ...
            for (let i = 0; i < keys.length; i++) {
                ...
                const parentArrayCompensation =
                    isObject && /^\s|-/.test(key) ? settings.indentation : "";
                ...
                if (depth === 0 && isFirstProp && !settings.indentFirstObject) {
                    ...
                    result +=
                        lineBreak + newIndent + key + colonDelimiter + value;
                }
                isFirstProp = false;
            }
            return result;
...
var YamlCompletion = class {
    ...
    configure(languageSettings, yamlSettings) {
        ...
        this.isSingleQuote =
            ((_a =
                yamlSettings == null
                    ? void 0
                    : yamlSettings.yamlFormatterSettings) == null
                ? void 0
                : _a.singleQuote) || false;
        this.configuredIndentation = languageSettings.indentation;
        this.disableDefaultProperties =
            languageSettings.disableDefaultProperties;
        this.parentSkeletonSelectedFirst =
            languageSettings.parentSkeletonSelectedFirst;
    }
    async doComplete(
        document,
        position,
        ...
        const doc = this.yamlDocument.getYamlDocument(
            document,
            { customTags: this.customTags, yamlVersion: this.yamlVersion },
            true
        );
        ...
        if (!this.configuredIndentation) {
            ...
            this.indentation = indent.insertSpaces
        ...
        let [node, foundByClosest] = currentDoc.getNodeFromPosition(
            offset,
            textBuffer,
            this.indentation.length
        );
        ...
        if (areOnlySpacesAfterPosition) {
            overwriteRange = Range13.create(
                position,
                Position6.create(position.line, lineContent.length)
            );
            ...
            if (node && isScalar5(node) && !isOnlyWhitespace && !isOnlyDash) {
                const lineToPosition = lineContent.substring(
                    0,
                    position.character
                );
                const matches =
                ...
                if (matches == null ? void 0 : matches[1]) {
                    overwriteRange = Range13.create(
                        Position6.create(
                            position.line,
                            position.character - matches[1].length
                        ),
                        Position6.create(position.line, lineContent.length)
                    );
                }
        ...
        const collector = {
            add: (completionItem, oneOfSchema) => {
                const addSuggestionForParent = function (completionItem2) {
                    var _a2;
                    const existsInYaml =
                        ((_a2 = proposed[completionItem2.label]) == null
                            ? void 0
                            : _a2.label) === existingProposeItem;
                    if (existsInYaml) {
                        return;
                    }
                    ...
                    let parentCompletion = result.items.find((item) => {
                        var _a3;
                        return (
                            ((_a3 = item.parent) == null
                                ? void 0
                                : _a3.schema) === schema &&
                            item.kind === parentCompletionKind
                        );
                    });
                    if (
                        parentCompletion &&
                        parentCompletion.parent.insertTexts.includes(
                        ...
                        parentCompletion.label =
                            parentCompletion.label || completionItem2.label;
                        parentCompletion.parent.insertTexts = [
                            completionItem2.insertText,
                        ];
                        result.items.push(parentCompletion);
                    } else {
                        parentCompletion.parent.insertTexts.push(
                            completionItem2.insertText
                        );
                    }
                };
                ...
                if (!label) {
                    console.warn(
                        `Ignoring CompletionItem without label: ${JSON.stringify(
                            completionItem
                        )}`
                    );
                    return;
                ...
                if (
                    completionItem.label.toLowerCase() === "regular expression"
                ) {
                    const docObject = completionItem.documentation;
                    const splitValues = docObject.value.split(":");
                    label =
                        splitValues.length > 0
                            ? `${this.getQuote()}\\${JSON.parse(
                                  splitValues[1]
                              )}${this.getQuote()}`
                            : completionItem.label;
                    completionItem.insertText = label;
                    completionItem.textEdit = TextEdit5.replace(
                        overwriteRange,
                        label
                    );
                } else {
                    let mdText = completionItem.insertText
                        .replace(/\${[0-9]+[:|](.*)}/g, (s, arg) => arg)
                        .replace(/\$([0-9]+)/g, "");
                    const splitMDText = mdText.split(":");
                    let value =
                        splitMDText.length > 1 ? splitMDText[1].trim() : mdText;
                    if (value && /^(['\\"\\])$/.test(value)) {
                        value = `${this.getQuote()}\\${value}${this.getQuote()}`;
                        mdText =
                            splitMDText.length > 1
                                ? splitMDText[0] + ": " + value
                                : value;
                    ...
                    if (
                        ...
                        completionItem.insertText =
                            completionItem.insertText.substr(
                                0,
                                completionItem.insertText.length - 2
                            );
                    }
                    if (
                        overwriteRange &&
                ...
                if (this.arrayPrefixIndentation) {
                    this.updateCompletionText(
                        completionItem,
                        this.arrayPrefixIndentation + completionItem.insertText
                    );
                }
                const existing = proposed[label];
                const isInsertTextDifferent =
                    (existing == null ? void 0 : existing.label) !==
                        existingProposeItem &&
                    (existing == null ? void 0 : existing.insertText) !==
                        completionItem.insertText;
                if (!existing) {
            ...
            error: (message) => {
                var _a2;
                (_a2 = this.telemetry) == null
                    ? void 0
                    : _a2.sendError("yaml.completion.error", message);
            },
            log: (message) => {
                console.log(message);
            },
        ...
        try {
            ...
            if (isModeline(lineContent) || isInComment(doc.tokens, offset)) {
                ...
                if (
                    schemaIndex !== -1 &&
                    schemaIndex + "$schema=".length <= position.character
                ) {
            ...
            if (!node) {
                if (
                    !currentDoc.internalDocument.contents ||
                    isScalar5(currentDoc.internalDocument.contents)
                ) {
                    ...
                    if (parent) {
                        if (isScalar5(node)) {
                                ...
                                if (isPair3(parent)) {
                                    if (parent.value === node) {
                                        if (
                                            ...
                                            const map = this.createTempObjNode(
                                                currentWord,
                                                node,
                                                currentDoc
                                            );
                                            const parentParent =
                                                currentDoc.getParent(parent);
                                            if (
                                                isSeq6(
                                                    currentDoc.internalDocument
                                                        .contents
                                                )
                                            ) {
                                                const index = indexOf(
                                                ...
                                                if (typeof index === "number") {
                                                    currentDoc.internalDocument.set(
                                                        index,
                                                        map
                                                    );
                                                    currentDoc.updateFromInternalDocument();
                                    ...
                                    if (parent.key === node) {
                                        ...
                                        if (
                                            ...
                                            if (
                                                ...
                                                if (
                                                    position.character >
                                                        parentPosition.character &&
                                                    position.line !==
                                                        parentPosition.line
                                                ) {
                                                    const map =
                                                        this.createTempObjNode(
                                                            currentWord,
                                                            node,
                                                            currentDoc
                                                        );
                            ...
                            if (
                                ...
                                const nextLine = textBuffer.getLineContent(
                                    position.line + 1
                                );
                                if (
                        ...
                        if (
                            lineContent.charAt(position.character - 1) !== "-"
                        ) {
                            const map = this.createTempObjNode(
                                currentWord,
                                node,
            ...
            if (node && isMap7(node)) {
                ...
                for (const p of properties) {
                    if (!currentProperty || currentProperty !== p) {
                        if (isScalar5(p.key)) {
                            proposed[p.key.value + ""] =
                                CompletionItemBase.create(existingProposeItem);
                        }
                    }
                }
            ...
            (_a = this.telemetry) == null
                ? void 0
                : _a.sendError("yaml.completion.error", err);
        }
    ...
    mergeSimpleInsertTexts(label, existingText, addingText, oneOfSchema) {
        ...
        const isNullObject = (value) => {
            ...
            return (
                index > 0 &&
                value.substring(index, value.length).trim().length === 0
            );
        };
        if (
            containsNewLineAfterColon(existingText) ||
            containsNewLineAfterColon(addingText)
        ) {
            if (
                oneOfSchema &&
                isNullObject(existingText) &&
                !isNullObject(addingText) &&
                !startWithNewLine(addingText)
            ) {
                return addingText;
            }
            return void 0;
    ...
    finalizeParentCompletion(result) {
        ...
        result.items.forEach((completionItem) => {
            if (this.isParentCompletionItem(completionItem)) {
                ...
                const reindexedTexts = reindexText(
...
${indent}`);
                ...
                completionItem.insertText =
                    this.arrayPrefixIndentation + insertText;
                if (completionItem.textEdit) {
                    completionItem.textEdit.newText = completionItem.insertText;
                }
                const mdText = insertText
                    .replace(/\${[0-9]+[:|](.*)}/g, (s, arg) => arg)
                    .replace(/\$([0-9]+)/g, "");
    ...
    addPropertyCompletions(
        ...
        const lineContent = textBuffer.getLineContent(
            overwriteRange.start.line
        );
        const hasOnlyWhitespace = lineContent.trim().length === 0;
        const hasColon = lineContent.indexOf(":") !== -1;
        const isInArray = lineContent.trimLeft().indexOf("-") === 0;
        const nodeParent = doc.getParent(node);
        const matchOriginal = matchingSchemas.find(
            (it) =>
                it.node.internalNode === originalNode && it.schema.properties
        );
        const oneOfSchema = matchingSchemas
            .filter((schema2) => schema2.schema.oneOf)
            .map((oneOfSchema2) => oneOfSchema2.schema.oneOf)[0];
        let didOneOfSchemaMatches = false;
        if (
            (oneOfSchema == null ? void 0 : oneOfSchema.length) <
            matchingSchemas.length
        ) {
            oneOfSchema == null
                ? void 0
                : oneOfSchema.forEach((property, index) => {
                      var _a2, _b2;
                      if (
                          !((_a2 = matchingSchemas[index]) == null
                              ? void 0
                              : _a2.schema.oneOf) &&
                          ((_b2 = matchingSchemas[index]) == null
                              ? void 0
                              : _b2.schema.properties) === property.properties
                      ) {
        ...
        for (const schema2 of matchingSchemas) {
            if (
                ((schema2.node.internalNode === node && !matchOriginal) ||
                    (schema2.node.internalNode === originalNode && !hasColon) ||
                    (((_a = schema2.node.parent) == null
                        ? void 0
                        : _a.internalNode) === originalNode &&
                        !hasColon)) &&
                !schema2.inverted
            ) {
                        ...
                        for (const key in schemaProperties) {
                            if (
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        (pair = node.items.find(
                                            (it) =>
                                                ...
                                                isScalar5(it.value) &&
                                                !it.value.value &&
                                                textBuffer.getPosition(
                                                    it.key.range[2]
                                                ).line ===
                                                    overwriteRange.end.line - 1
                                        )) &&
                                        pair
                                    ) {
                                        if (
                                            ...
                                            typeof propertySchema.items ===
                                                "object" &&
                                            propertySchema.items.type ===
                                                "object"
                                        ) {
                                            this.addArrayItemValueCompletion(
                                    ...
                                    const isNodeNull =
                                        (isScalar5(originalNode) &&
                                            originalNode.value === null) ||
                                        (isMap7(originalNode) &&
                                            originalNode.items.length === 0);
                                    const existsParentCompletion =
                                        ((_b = schema2.schema.required) == null
                                            ? void 0
                                            : _b.length) > 0;
                                    if (
                                        !this.parentSkeletonSelectedFirst ||
                                        !isNodeNull ||
                                        !existsParentCompletion
                                    ) {
                                        collector.add(
                                            {
                                                kind: CompletionItemKind2.Property,
                                    ...
                                    if (
                                        (_c = schema2.schema.required) == null
                                            ? void 0
                                            : _c.includes(key)
                                    ) {
                                        collector.add({
                ...
                if (
                    nodeParent &&
                    isSeq6(nodeParent) &&
                    isPrimitiveType(schema2.schema)
                ) {
                    this.addSchemaValueCompletions(
                        schema2.schema,
                        separatorAfter,
                ...
                if (
                    schema2.schema.propertyNames &&
                    schema2.schema.additionalProperties &&
                    schema2.schema.type === "object"
                ) {
                    const propertyNameSchema = asSchema2(
                        schema2.schema.propertyNames
                    );
                    if (
                        !propertyNameSchema.deprecationMessage &&
                        !propertyNameSchema.doNotSuggest
                    ) {
                        ...
                        collector.add({
                            ...
                            documentation:
                                this.fromMarkup(
                                    propertyNameSchema.markdownDescription
                                ) ||
                                propertyNameSchema.description ||
                                "",
                        });
                    }
                }
            ...
            if (
                nodeParent &&
                schema2.node.internalNode === nodeParent &&
                schema2.schema.defaultSnippets
            ) {
    ...
    getValueCompletions(
        ...
        if (isPair3(node)) {
            ...
            if (
                valueNode &&
                valueNode.range &&
                offset > valueNode.range[0] + valueNode.range[2]
            ) {
                return;
            }
                        ...
                        if (isSeq6(node) && node.items) {
                            if (Array.isArray(s.schema.items)) {
                                ...
                                (s.schema.items.type === "object" ||
                                    isAnyOfAllOfOneOfType(s.schema.items))
                            ) {
                                this.addSchemaValueCompletions(
                                    s.schema.items,
                                    separatorAfter,
    ...
    getInsertTextForProperty(
        ...
        if (propertySchema) {
            ...
            if (propertySchema.properties) {
                return `${resultText}
${
    this.getInsertTextForObject(propertySchema, separatorAfter, indent)
        .insertText
}`;
            } else if (propertySchema.items) {
                return `${resultText}
        ...
        Object.keys(schema.properties).forEach((key) => {
            ...
            if (schema.required && schema.required.indexOf(key) > -1) {
                switch (type) {
                    ...
                    case "anyOf": {
                        let value =
                            propertySchema.default || propertySchema.const;
                        if (value) {
                            if (type === "string") {
                ...
                switch (type) {
                    ...
                    case "integer":
                        insertText += `${indent}${
                            ...
                            key === "null"
                                ? this.getInsertTextForValue(key, "", "string")
                                : key
                        }: \${${insertIndex++}:${propertySchema.default}}
`;
                        break;
                    case "string":
                        insertText += `${indent}${key}: \${${insertIndex++}:${this.convertToStringValue(
                            propertySchema.default
                        )}}
`;
                        break;
    ...
    getInsertTextForValue(value, separatorAfter, type) {
        ...
        switch (typeof value) {
            case "object": {
                ...
                return this.getInsertTemplateForValue(
                    value,
                    indent,
                    { index: 1 },
                    separatorAfter
        ...
        if (typeof schema === "object") {
            ...
            if (Array.isArray(schema.allOf)) {
                schema.allOf.forEach((s) => {
                    return this.addSchemaValueCompletions(
                        s,
                        separatorAfter,
                        collector,
                        types,
            ...
            for (const s of schema.defaultSnippets) {
                ...
                if (isDefined2(value)) {
                    ...
                    const existingProps = Object.keys(
                        ...
                        (proposedProp) =>
                            collector.proposed[proposedProp].label ===
                            existingProposeItem
                    );
    ...
    getInsertTextForSnippetValue(
        ...
        return (
            stringifyObject(
                ...
                "",
                replacer,
                { ...settings, indentation: this.indentation, existingProps },
                depth
            ) + separatorAfter
        );
    }
...
\`\`\``);
    ...
    convertToStringValue(param) {
        ...
        if (typeof param === "string") {
            value = ["on", "off", "true", "false", "yes", "no"].includes(
                param.toLowerCase()
            )
...
var YamlDefinition = class {
    ...
    getDefinition(document, params) {
        ...
        try {
            ...
            if (currentDoc) {
                const [node] = currentDoc.getNodeFromPosition(
                    offset,
                    new TextBuffer(document)
                );
                if (node && isAlias3(node)) {
                    const defNode = node.resolve(currentDoc.internalDocument);
                    if (defNode && defNode.range) {
                        const targetRange = Range14.create(
                            document.positionAt(defNode.range[0]),
                            document.positionAt(defNode.range[2])
                        );
                        const selectionRange = Range14.create(
                            document.positionAt(defNode.range[0]),
                            document.positionAt(defNode.range[1])
                        );
                        return [
                            LocationLink.create(
                                document.uri,
            ...
            (_a = this.telemetry) == null
                ? void 0
                : _a.sendError("yaml.definition.error", err);
        }
        return void 0;
    }
};
...
function getSelectionRanges(document, positions) {
    ...
    return positions.map((position) => {
        ...
        return current != null
            ? current
            : SelectionRange2.create({ start: position, end: position });
    });
        ...
        for (const ymlDoc of doc.documents) {
            ...
            ymlDoc.visit((node) => {
                ...
                if (startOffset > offset) {
                    const newOffset = getStartOffsetForSpecialCases(
                        node,
                        position
                    );
            ...
            while (currentNode) {
                ...
                const isSurroundedBy = (startCharacter, endCharacter) => {
                    return (
                        trimmedText.startsWith(startCharacter) &&
                        trimmedText.endsWith(endCharacter || startCharacter)
                    );
                };
                if (
...
(function (SchemaPriority2) {
    ...
    SchemaPriority2[(SchemaPriority2["SchemaAssociation"] = 2)] =
        "SchemaAssociation";
...
function getLanguageService(params) {
    ...
    const completer = new YamlCompletion(
        schemaService,
    ...
    return {
        configure: (settings) => {
            ...
            if (settings.schemas) {
                ...
                settings.schemas.forEach((settings2) => {
                    const currPriority = settings2.priority
                        ? settings2.priority
                        : 0;
                    schemaService.addSchemaPriority(
                        settings2.uri,
                        currPriority
                    );
        ...
        findDocumentSymbols:
            yamlDocumentSymbols.findDocumentSymbols.bind(yamlDocumentSymbols),
        findDocumentSymbols2:
            yamlDocumentSymbols.findHierarchicalDocumentSymbols.bind(
                yamlDocumentSymbols
            ),
...
initialize((ctx, { enableSchemaRequest, ...languageSettings }) => {
    ...
    return {
        ...
        doDocumentOnTypeFormatting: withDocument(
            (document, position, ch, options) =>
                ls.doDocumentOnTypeFormatting(document, {
                    ch,
                    options,
                    position,
