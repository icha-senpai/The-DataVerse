(function (window, factory) {
        ...
        jStat._init = function _init(args) {
            ...
            if (isArray(args[0])) {
                ...
                if (isArray(args[0][0])) {
                    ...
                    this[0] = isFunction(args[1])
                        ? jStat.map(args[0], args[1])
                        : args[0];
                    this.length = 1;
                }
    ...
    (function (jStat, Math) {
        ...
        jStat.quantiles = function quantiles(
            arr,
            quantilesArray,
            alphap,
            betap
        ...
        jStat.histogram = function histogram(arr, binCnt) {
            ...
            for (i = 0; i < len; i++)
                bins[
                    Math.min(
                        Math.floor((arr[i] - first) / binWidth),
                        binCnt - 1
                    )
                ] += 1;
            ...
            for (var i = 0; i < funcs.length; i++)
                (function (passfunc) {
                    ...
                    jProto[passfunc] = function (fullbool, func) {
                        ...
                        if (this.length > 1) {
                            tmpthis =
                                fullbool === true ? this : this.transpose();
                ...
                (function (passfunc) {
                    jProto[passfunc] = function () {
                        ...
                        if (isFunction(args[args.length - 1])) {
                            ...
                            var curriedFunction = function curriedFunction(
                                vector
                            ) {
                                return jStat[passfunc].apply(
                                    tmpthis,
                                    [vector].concat(args)
                                );
                            };
    ...
    (function (jStat, Math) {
        ...
        jStat.erf = function erf(x) {
            var cof = [
                ...
                -2.0278578112534e-5, -1.624290004647e-6, 1.30365583558e-6,
                1.5626441722e-8, -8.5238095915e-8, 6.529054439e-9,
                5.059343495e-9, -9.91364156e-10, -2.27365122e-10, 9.6467911e-11,
                2.394038e-12, -6.886027e-12, 8.94487e-13, 3.13092e-13,
                -1.12708e-13, 3.81e-16, 7.106e-15, -1.523e-15, -9.4e-17,
                1.21e-16, -2.8e-17,
            ];
            var j = cof.length - 1;
            var isneg = false;
        ...
        jStat.erfcinv = function erfcinv(p) {
            ...
            x =
                -0.70711 *
                ((2.30753 + t * 0.27061) / (1 + t * (0.99229 + t * 0.04481)) -
                    t);
            for (; j < 2; j++) {
                err = jStat.erfc(x) - pp;
        ...
        jStat.ibetainv = function ibetainv(p, a, b) {
            ...
            for (; j < 10; j++) {
                ...
                u = err / t;
                x -= t =
                    u / (1 - 0.5 * Math.min(1, u * (a1 / x - b1 / (1 - x))));
                if (x <= 0) x = 0.5 * (x + t);
                if (x >= 1) x = 0.5 * (x + t + 1);
    ...
    (function (jStat, Math) {
                        ...
                        for (var i = 0; i < vals.length; i++)
                            (function (fnfunc) {
                                jStat[func].prototype[fnfunc] = function (x) {
                                    ...
                                    if (typeof x !== "number") {
                                        return jStat.fn.map.call(
                                            x,
                                            function (x) {
                                                return jStat[func][fnfunc](
                                                    x,
                                                    a,
                                                    b,
                                                    c
        ...
        jStat.extend(jStat.centralF, {
            ...
            pdf: function pdf(x, df1, df2) {
                ...
                return (
                    f *
                    jStat.binomial.pdf((df1 - 2) / 2, (df1 + df2 - 2) / 2, p)
                );
            },
            ...
            inv: function inv(x, df1, df2) {
                return (
                    df2 / (df1 * (1 / jStat.ibetainv(x, df1 / 2, df2 / 2) - 1))
                );
            },
        ...
        jStat.extend(jStat.cauchy, {
            pdf: function pdf(x, local, scale) {
                ...
                return (
                    scale /
                    (Math.pow(x - local, 2) + Math.pow(scale, 2)) /
                    Math.PI
                );
            },
        ...
        jStat.extend(jStat.lognormal, {
            ...
            cdf: function cdf(x, mu, sigma) {
                ...
                return (
                    ...
                    0.5 *
                        jStat.erf(
                            (Math.log(x) - mu) / Math.sqrt(2 * sigma * sigma)
                        )
                );
            },
            ...
            inv: function (p, mu, sigma) {
                return Math.exp(
                    -1.41421356237309505 * sigma * jStat.erfcinv(2 * p) + mu
                );
            },
        ...
        jStat.extend(jStat.normal, {
            ...
            cdf: function cdf(x, mean, std) {
                return (
                    0.5 * (1 + jStat.erf((x - mean) / Math.sqrt(2 * std * std)))
                );
            },
        ...
        jStat.extend(jStat.studentt, {
            ...
            sample: function sample(dof) {
                return (
                    jStat.randn() * Math.sqrt(dof / (2 * jStat.randg(dof / 2)))
                );
            },
        ...
        jStat.extend(jStat.weibull, {
            ...
            sample: function sample(scale, shape) {
                return (
                    scale * Math.pow(-Math.log(jStat._random_fn()), 1 / shape)
                );
            },
        ...
        jStat.extend(jStat.arcsine, {
            pdf: function pdf(x, a, b) {
                ...
                return x <= a || x >= b
                    ...
                    : (2 / Math.PI) *
                          Math.pow(
                              Math.pow(b - a, 2) - Math.pow(2 * x - a - b, 2),
                              -0.5
                          );
            },
            ...
            cdf: function cdf(x, a, b) {
                if (x < a) return 0;
                    ...
                    return (
                        (2 / Math.PI) * Math.asin(Math.sqrt((x - a) / (b - a)))
                    );
                return 1;
            },
        ...
        jStat.extend(jStat.tukey, {
            cdf: function cdf(q, nmeans, df) {
                ...
                var f2 = df * 0.5;
                var f2lf =
                    f2 * Math.log(df) - df * Math.log(2) - jStat.gammaln(f2);
                var f21 = f2 - 1.0;
                    ...
                    for (var jj = 1; jj <= nlegq; jj++) {
                        ...
                        if (t1 >= eps1) {
                            if (ihalfq < jj) {
                                qsqz =
                                    q *
                                    Math.sqrt((xlegq[j] * ulen + twa1) * 0.5);
                            } else {
                                qsqz =
                                    q *
                                    Math.sqrt(
                                        (-(xlegq[j] * ulen) + twa1) * 0.5
                                    );
                            }
    ...
    (function (jStat, Math) {
        ...
        jStat.extend({
            ...
            gauss_jacobi: function gauss_jacobi(a, b, x, r) {
                ...
                h = jStat.multiply(
                    jStat.multiply(jStat.inv(d), jStat.add(l, u)),
                    -1
                );
            ...
            gauss_seidel: function gauss_seidel(a, b, x, r) {
                ...
                h = jStat.multiply(
                    jStat.multiply(jStat.inv(jStat.add(d, l)), u),
                    -1
                );
            ...
            jacobi: function jacobi(a) {
                ...
                while (condition === 1) {
                    ...
                    if (a[p][p] === a[q][q])
                        ...
                        theta =
                            Math.atan((2 * a[p][q]) / (a[p][p] - a[q][q])) / 2;
    ...
    (function (jStat, Math) {
        ...
        jStat.extend({
            ...
            tscore: function tscore() {
                ...
                return args.length === 4
                    ...
                    : (args[0] - jStat.mean(args[1])) /
                          (jStat.stdev(args[1], true) /
                              Math.sqrt(args[1].length));
            },
            ...
            ttest: function ttest() {
                ...
                if (args.length === 5) {
                    tscore = Math.abs(
                        jStat.tscore(args[0], args[1], args[2], args[3])
                    );
                    return args[4] === 1
        ...
        jStat.extend(jStat.fn, {
            tscore: function tscore(value) {
                return (
                    (value - this.mean()) /
                    (this.stdev(true) / Math.sqrt(this.cols()))
                );
            },
            ...
            anovafscore: function anovafscore() {
                ...
                for (i = 0; i < args.length; i++) {
                    expVar =
                        expVar +
                        args[i].length *
                            Math.pow(jStat.mean(args[i]) - sampMean, 2);
                }
        ...
        jStat.extend({
            ...
            tci: function tci() {
                ...
                if (args.length === 4) {
                    change = Math.abs(
                        (jStat.studentt.inv(args[1] / 2, args[3] - 1) *
                            args[2]) /
                            Math.sqrt(args[3])
                    );
                } else {
        ...
        jStat.extend(jStat.fn, {
            oneSidedDifferenceOfProportions:
