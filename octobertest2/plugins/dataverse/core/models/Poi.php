...
class Poi extends Model
{
    ...
    protected $fillable = [
        ...
        'is_available','is_available_live','is_monitored','is_visible',
        'jurisdiction_name','moon_name','name','nickname','orbit_name','outpost_name','pad_types','planet_name',
        'space_station_name','star_system_name','subtype','type'
    ];
    public $rules = [];
    protected $casts = [
        ...
        'is_available'=>'boolean','is_available_live'=>'boolean','is_monitored'=>'boolean','is_visible'=>'boolean'
    ];
}
