...
class Outpost extends Model
{
    ...
    protected $guarded = ['*'];
    protected $fillable = [
        'date_added','date_modified','faction_name',
        'has_cargo_center','has_clinic','has_docking_port','has_food','has_freight_elevator','has_gravity',
        'has_habitation','has_loading_dock','has_quantum_marker','has_refinery','has_refuel',
    ...
    protected $casts = [
        ...
        'has_quantum_marker'=>'boolean','has_refinery'=>'boolean','has_refuel'=>'boolean',
