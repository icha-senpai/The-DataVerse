...
return new class extends Migration {
    public function up() {
        Schema::create('uex_space_stations', function (Blueprint $t) {
            $t->increments('id');
            ...
            $t->boolean('is_jump_point')->default(false);
            $t->boolean('is_lagrange')->default(false);
    ...
    public function down() { Schema::dropIfExists('uex_space_stations'); }
};
